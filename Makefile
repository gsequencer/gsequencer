...
AGS_TASK_OBJECTS = $(AGS_DIR)audio/task/ags_open_file.o $(AGS_DIR)audio/task/ags_link_channel.o $(AGS_DIR)audio/task/ags_change_bpm.o $(AGS_DIR)audio/task/ags_apply_synth.o $(AGS_DIR)audio/task/ags_apply_wavetable.o $(AGS_DIR)audio/task/ags_append_audio.o $(AGS_DIR)audio/task/ags_append_channel.o $(AGS_DIR)audio/task/ags_append_recall.o $(AGS_DIR)audio/task/ags_cancel_audio.o $(AGS_DIR)audio/task/ags_cancel_channel.o $(AGS_DIR)audio/task/ags_cancel_recall.o $(AGS_DIR)audio/task/ags_insert_note.o $(AGS_DIR)audio/task/ags_remove_note.o
