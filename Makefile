...
libags_a_LIBADD =
am_libags_a_OBJECTS = libags_a-ags_file_util.$(OBJEXT) \
...
am_ags_OBJECTS = ags-ags_run_order.$(OBJEXT) ags-ags_task.$(OBJEXT) \
	...
	ags-ags_recycling.$(OBJEXT) ags-ags_file_id_ref.$(OBJEXT) \
	...
	ags-ags_log.$(OBJEXT) ags-ags_recycling_thread.$(OBJEXT) \
...
ags_SOURCES = ./src/ags/audio/ags_run_order.c \
	...
	./src/ags/file/ags_file_id_ref.c ./src/ags/audio/ags_task.h \
