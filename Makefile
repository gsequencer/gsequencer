...
am_ags_OBJECTS = ags-ags_run_order.$(OBJEXT) ags-ags_task.$(OBJEXT) \
	...
	ags-ags_thread.$(OBJEXT) ags-ags_portable_thread.$(OBJEXT) \
...
ags_SOURCES = ./src/ags/audio/ags_run_order.c \
	...
	./src/ags/thread/ags_portable_thread.h \
	./src/ags/thread/ags_recycling_thread.h \
	./src/ags/thread/ags_thread.c \
	./src/ags/thread/ags_portable_thread.c \
...
ags_LDFLAGS = -ldl $(UUID_LIBS) $(LIBASOUND2_LIBS) $(LIBAO_LIBS) $(LIBXML2_LIBS) $(LIBSNDFILE_LIBS) $(LIBINSTPATCH_LIBS) $(GOBJECT_LIBS) $(GDKPIXBUF_LIBS) $(CAIRO_LIBS) $(GTK_LIBS) $(XMLRPC_LIBS) $(XMLRPC_UTIL_LIBS) $(XMLRPC_SERVER_ABYSS_LIBS) $(XMLRPC_SERVER_CGI_LIBS) $(XMLRPC_SERVER_LIBS) -lpth -lm
ags_LDADD = libags.a
...
include ./$(DEPDIR)/ags-ags_portable_thread.Po
...
ags-ags_portable_thread.o: ./src/ags/thread/ags_portable_thread.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(ags_CFLAGS) $(CFLAGS) -MT ags-ags_portable_thread.o -MD -MP -MF $(DEPDIR)/ags-ags_portable_thread.Tpo -c -o ags-ags_portable_thread.o `test -f './src/ags/thread/ags_portable_thread.c' || echo '$(srcdir)/'`./src/ags/thread/ags_portable_thread.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/ags-ags_portable_thread.Tpo $(DEPDIR)/ags-ags_portable_thread.Po
#	$(AM_V_CC)source='./src/ags/thread/ags_portable_thread.c' object='ags-ags_portable_thread.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(ags_CFLAGS) $(CFLAGS) -c -o ags-ags_portable_thread.o `test -f './src/ags/thread/ags_portable_thread.c' || echo '$(srcdir)/'`./src/ags/thread/ags_portable_thread.c

ags-ags_portable_thread.obj: ./src/ags/thread/ags_portable_thread.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(ags_CFLAGS) $(CFLAGS) -MT ags-ags_portable_thread.obj -MD -MP -MF $(DEPDIR)/ags-ags_portable_thread.Tpo -c -o ags-ags_portable_thread.obj `if test -f './src/ags/thread/ags_portable_thread.c'; then $(CYGPATH_W) './src/ags/thread/ags_portable_thread.c'; else $(CYGPATH_W) '$(srcdir)/./src/ags/thread/ags_portable_thread.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/ags-ags_portable_thread.Tpo $(DEPDIR)/ags-ags_portable_thread.Po
#	$(AM_V_CC)source='./src/ags/thread/ags_portable_thread.c' object='ags-ags_portable_thread.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(ags_CFLAGS) $(CFLAGS) -c -o ags-ags_portable_thread.obj `if test -f './src/ags/thread/ags_portable_thread.c'; then $(CYGPATH_W) './src/ags/thread/ags_portable_thread.c'; else $(CYGPATH_W) '$(srcdir)/./src/ags/thread/ags_portable_thread.c'; fi`
