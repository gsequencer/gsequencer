...
AGS_EDITOR_OBJECTS = $(AGS_DIR)X/editor/ags_toolbar.o $(AGS_DIR)X/editor/ags_notebook.o $(AGS_DIR)X/editor/ags_meter.o $(AGS_DIR)X/editor/ags_ruler.o $(AGS_DIR)X/editor/ags_sf2_chooser.o
AGS_EDITOR_CALLBACK_OBJECTS = $(AGS_DIR)X/editor/ags_toolbar_callbacks.o $(AGS_DIR)X/editor/ags_notebook_callbacks.o $(AGS_DIR)X/editor/ags_meter_callbacks.o $(AGS_DIR)X/editor/ags_ruler_callbacks.o $(AGS_DIR)X/editor/ags_sf2_chooser_callbacks.o
