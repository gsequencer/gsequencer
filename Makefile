...
am_gsequencer_OBJECTS = $(am__objects_1) \
	gsequencer-ags_audio.$(OBJEXT) \
	gsequencer-ags_audio_signal.$(OBJEXT) \
	gsequencer-ags_channel.$(OBJEXT) \
	gsequencer-ags_channel_iter.$(OBJEXT) \
	gsequencer-ags_config.$(OBJEXT) \
	gsequencer-ags_devout.$(OBJEXT) \
	gsequencer-ags_garbage_collector.$(OBJEXT) \
	gsequencer-ags_input.$(OBJEXT) gsequencer-ags_libao.$(OBJEXT) \
	gsequencer-ags_notation.$(OBJEXT) \
	gsequencer-ags_note.$(OBJEXT) gsequencer-ags_output.$(OBJEXT) \
	gsequencer-ags_pattern.$(OBJEXT) gsequencer-ags_port.$(OBJEXT) \
	gsequencer-ags_recall_audio.$(OBJEXT) \
	gsequencer-ags_recall_audio_run.$(OBJEXT) \
	gsequencer-ags_recall_audio_signal.$(OBJEXT) \
	gsequencer-ags_recall.$(OBJEXT) \
	gsequencer-ags_recall_channel.$(OBJEXT) \
	gsequencer-ags_recall_channel_run.$(OBJEXT) \
	gsequencer-ags_recall_channel_run_dummy.$(OBJEXT) \
	gsequencer-ags_recall_container.$(OBJEXT) \
	gsequencer-ags_recall_dependency.$(OBJEXT) \
	gsequencer-ags_recall_factory.$(OBJEXT) \
	gsequencer-ags_recall_id.$(OBJEXT) \
	gsequencer-ags_recall_ladspa.$(OBJEXT) \
	gsequencer-ags_recall_ladspa_run.$(OBJEXT) \
	gsequencer-ags_recall_recycling.$(OBJEXT) \
	gsequencer-ags_recall_recycling_dummy.$(OBJEXT) \
	gsequencer-ags_recycling.$(OBJEXT) \
	gsequencer-ags_recycling_container.$(OBJEXT) \
	gsequencer-ags_synths.$(OBJEXT) gsequencer-ags_task.$(OBJEXT) \
	gsequencer-ags_timestamp.$(OBJEXT) \
	gsequencer-ags_timestamp_factory.$(OBJEXT) \
	gsequencer-ags_audio_file.$(OBJEXT) \
	gsequencer-ags_audio_file_xml.$(OBJEXT) \
	gsequencer-ags_ipatch.$(OBJEXT) \
	gsequencer-ags_ipatch_sf2_reader.$(OBJEXT) \
	gsequencer-ags_sndfile.$(OBJEXT) \
	gsequencer-ags_amplifier.$(OBJEXT) \
	gsequencer-ags_buffer_audio_signal.$(OBJEXT) \
	gsequencer-ags_buffer_channel.$(OBJEXT) \
	gsequencer-ags_buffer_channel_run.$(OBJEXT) \
	gsequencer-ags_buffer_recycling.$(OBJEXT) \
	gsequencer-ags_clone_channel.$(OBJEXT) \
	gsequencer-ags_clone_channel_run.$(OBJEXT) \
	gsequencer-ags_copy_audio_signal.$(OBJEXT) \
	gsequencer-ags_copy_channel.$(OBJEXT) \
	gsequencer-ags_copy_channel_run.$(OBJEXT) \
	gsequencer-ags_copy_notation_audio.$(OBJEXT) \
	gsequencer-ags_copy_notation_audio_run.$(OBJEXT) \
	gsequencer-ags_copy_pattern_audio.$(OBJEXT) \
	gsequencer-ags_copy_pattern_audio_run.$(OBJEXT) \
	gsequencer-ags_copy_pattern_channel.$(OBJEXT) \
	gsequencer-ags_copy_pattern_channel_run.$(OBJEXT) \
	gsequencer-ags_copy_recycling.$(OBJEXT) \
	gsequencer-ags_count_beats_audio.$(OBJEXT) \
	gsequencer-ags_count_beats_audio_run.$(OBJEXT) \
	gsequencer-ags_delay_audio.$(OBJEXT) \
	gsequencer-ags_delay_audio_run.$(OBJEXT) \
	gsequencer-ags_echo.$(OBJEXT) \
	gsequencer-ags_envelope_audio_signal.$(OBJEXT) \
	gsequencer-ags_envelope_channel.$(OBJEXT) \
	gsequencer-ags_envelope_channel_run.$(OBJEXT) \
	gsequencer-ags_envelope_recycling.$(OBJEXT) \
	gsequencer-ags_loop_channel.$(OBJEXT) \
	gsequencer-ags_loop_channel_run.$(OBJEXT) \
	gsequencer-ags_mute_audio.$(OBJEXT) \
	gsequencer-ags_mute_audio_run.$(OBJEXT) \
	gsequencer-ags_mute_audio_signal.$(OBJEXT) \
	gsequencer-ags_mute_channel.$(OBJEXT) \
	gsequencer-ags_mute_channel_run.$(OBJEXT) \
	gsequencer-ags_mute_recycling.$(OBJEXT) \
	gsequencer-ags_peak_audio_signal.$(OBJEXT) \
	gsequencer-ags_peak_channel.$(OBJEXT) \
	gsequencer-ags_peak_channel_run.$(OBJEXT) \
	gsequencer-ags_peak_recycling.$(OBJEXT) \
	gsequencer-ags_play_audio.$(OBJEXT) \
	gsequencer-ags_play_audio_file.$(OBJEXT) \
	gsequencer-ags_play_audio_signal.$(OBJEXT) \
	gsequencer-ags_play_channel.$(OBJEXT) \
	gsequencer-ags_play_channel_run.$(OBJEXT) \
	gsequencer-ags_play_channel_run_master.$(OBJEXT) \
	gsequencer-ags_play_notation_audio.$(OBJEXT) \
	gsequencer-ags_play_notation_audio_run.$(OBJEXT) \
	gsequencer-ags_play_note.$(OBJEXT) \
	gsequencer-ags_play_pattern.$(OBJEXT) \
	gsequencer-ags_play_recycling.$(OBJEXT) \
	gsequencer-ags_stream_audio_signal.$(OBJEXT) \
	gsequencer-ags_stream.$(OBJEXT) \
	gsequencer-ags_stream_channel.$(OBJEXT) \
	gsequencer-ags_stream_channel_run.$(OBJEXT) \
	gsequencer-ags_stream_recycling.$(OBJEXT) \
	gsequencer-ags_volume_audio_signal.$(OBJEXT) \
	gsequencer-ags_volume_channel.$(OBJEXT) \
	gsequencer-ags_volume_channel_run.$(OBJEXT) \
	gsequencer-ags_volume_recycling.$(OBJEXT) \
	gsequencer-ags_add_audio.$(OBJEXT) \
	gsequencer-ags_add_audio_signal.$(OBJEXT) \
	gsequencer-ags_add_line_member.$(OBJEXT) \
	gsequencer-ags_add_note.$(OBJEXT) \
	gsequencer-ags_add_point_to_selection.$(OBJEXT) \
	gsequencer-ags_add_recall.$(OBJEXT) \
	gsequencer-ags_add_recall_container.$(OBJEXT) \
	gsequencer-ags_add_region_to_selection.$(OBJEXT) \
	gsequencer-ags_append_audio.$(OBJEXT) \
	gsequencer-ags_append_audio_threaded.$(OBJEXT) \
	gsequencer-ags_append_channel.$(OBJEXT) \
	gsequencer-ags_append_recall.$(OBJEXT) \
	...
	gsequencer-ags_channel_set_recycling.$(OBJEXT) \
	gsequencer-ags_display_tact.$(OBJEXT) \
	gsequencer-ags_export_output.$(OBJEXT) \
	gsequencer-ags_free_selection.$(OBJEXT) \
	gsequencer-ags_init_audio.$(OBJEXT) \
	gsequencer-ags_init_channel.$(OBJEXT) \
	gsequencer-ags_link_channel.$(OBJEXT) \
	gsequencer-ags_open_file.$(OBJEXT) \
	gsequencer-ags_open_single_file.$(OBJEXT) \
	gsequencer-ags_remove_audio.$(OBJEXT) \
	gsequencer-ags_remove_audio_signal.$(OBJEXT) \
	gsequencer-ags_remove_note.$(OBJEXT) \
	gsequencer-ags_remove_point_from_selection.$(OBJEXT) \
	gsequencer-ags_remove_recall.$(OBJEXT) \
	gsequencer-ags_remove_recall_container.$(OBJEXT) \
	gsequencer-ags_remove_region_from_selection.$(OBJEXT) \
	gsequencer-ags_resize_audio.$(OBJEXT) \
	gsequencer-ags_save_file.$(OBJEXT) \
	gsequencer-ags_scroll_on_play.$(OBJEXT) \
	gsequencer-ags_seek_devout.$(OBJEXT) \
	gsequencer-ags_set_audio_channels.$(OBJEXT) \
	gsequencer-ags_set_buffer_size.$(OBJEXT) \
	gsequencer-ags_set_devout_play_flags.$(OBJEXT) \
	gsequencer-ags_set_output_device.$(OBJEXT) \
	gsequencer-ags_set_samplerate.$(OBJEXT) \
	gsequencer-ags_start_devout.$(OBJEXT) \
	gsequencer-ags_toggle_led.$(OBJEXT) \
	gsequencer-ags_toggle_pattern_bit.$(OBJEXT) \
	gsequencer-ags_unref_audio_signal.$(OBJEXT) \
	gsequencer-ags_apply_bpm.$(OBJEXT) \
	gsequencer-ags_apply_sequencer_length.$(OBJEXT) \
	gsequencer-ags_apply_tact.$(OBJEXT) \
	gsequencer-ags_set_muted.$(OBJEXT) \
	gsequencer-ags_file.$(OBJEXT) \
	gsequencer-ags_file_gui.$(OBJEXT) \
	...
	gsequencer-ags_connectable.$(OBJEXT) \
	gsequencer-ags_combo_box_text.$(OBJEXT) \
	gsequencer-ags_container.$(OBJEXT) \
	...
	gsequencer-ags_concurrent_tree.$(OBJEXT) \
	gsequencer-ags_dynamic_connectable.$(OBJEXT) \
	gsequencer-ags_effect.$(OBJEXT) \
	gsequencer-ags_main_loop.$(OBJEXT) \
	gsequencer-ags_marshal.$(OBJEXT) \
	gsequencer-ags_mutable.$(OBJEXT) \
	gsequencer-ags_packable.$(OBJEXT) \
	gsequencer-ags_persistable.$(OBJEXT) \
	gsequencer-ags_playable.$(OBJEXT) \
	gsequencer-ags_plugin.$(OBJEXT) \
	gsequencer-ags_portlet.$(OBJEXT) \
	gsequencer-ags_runnable.$(OBJEXT) \
	gsequencer-ags_seekable.$(OBJEXT) \
	gsequencer-ags_soundcard.$(OBJEXT) \
	gsequencer-ags_stackable.$(OBJEXT) \
	gsequencer-ags_tactable.$(OBJEXT) \
	gsequencer-ags_tree_iterator.$(OBJEXT) \
	gsequencer-ags_ladspa_manager.$(OBJEXT) \
	gsequencer-ags_plugin_factory.$(OBJEXT) \
	...
	gsequencer-ags_channel_thread.$(OBJEXT) \
	gsequencer-ags_devout_thread.$(OBJEXT) \
	gsequencer-ags_export_thread.$(OBJEXT) \
	gsequencer-ags_gui_task_thread.$(OBJEXT) \
	gsequencer-ags_gui_thread.$(OBJEXT) \
	gsequencer-ags_history.$(OBJEXT) \
	gsequencer-ags_iterator_thread.$(OBJEXT) \
	gsequencer-ags_mutex_manager.$(OBJEXT) \
	gsequencer-ags_record_thread.$(OBJEXT) \
	gsequencer-ags_recycling_thread.$(OBJEXT) \
	gsequencer-ags_recycling_thread_callbacks.$(OBJEXT) \
	gsequencer-ags_returnable_thread.$(OBJEXT) \
	gsequencer-ags_single_thread.$(OBJEXT) \
	gsequencer-ags_task_completion.$(OBJEXT) \
	gsequencer-ags_task_thread.$(OBJEXT) \
	gsequencer-ags_thread_pool.$(OBJEXT) \
	gsequencer-ags_thread-posix.$(OBJEXT) \
	gsequencer-ags_timestamp_thread.$(OBJEXT) \
	gsequencer-ags_id_generator.$(OBJEXT) \
	gsequencer-ags_cartesian.$(OBJEXT) \
	gsequencer-ags_dial.$(OBJEXT) \
	gsequencer-ags_expander.$(OBJEXT) \
	gsequencer-ags_expander_set.$(OBJEXT) \
	gsequencer-ags_hindicator.$(OBJEXT) \
	gsequencer-ags_htimebar.$(OBJEXT) \
	gsequencer-ags_indicator.$(OBJEXT) \
	gsequencer-ags_led.$(OBJEXT) gsequencer-ags_menu.$(OBJEXT) \
	gsequencer-ags_menu_item.$(OBJEXT) \
	gsequencer-ags_option_menu.$(OBJEXT) \
	gsequencer-ags_ruler.$(OBJEXT) \
	gsequencer-ags_segment.$(OBJEXT) \
	gsequencer-ags_table.$(OBJEXT) \
	gsequencer-ags_timebar.$(OBJEXT) \
	gsequencer-ags_vindicator.$(OBJEXT) \
	gsequencer-ags_waveform.$(OBJEXT) \
...
am__v_CCLD_1 = 
SOURCES = $(gsequencer_SOURCES) $(midi2xml_SOURCES)
DIST_SOURCES = $(gsequencer_SOURCES) $(midi2xml_SOURCES)
...
PACKAGE_STRING = gsequencer 0.6.7
...
gsequencer_LDFLAGS = -ldl $(LDFLAGS) $(UUID_LIBS) $(LIBASOUND2_LIBS) $(LIBAO_LIBS) $(LIBXML2_LIBS) $(OPENSSL_LIBS) $(SNDFILE_LIBS) $(LIBINSTPATCH_LIBS) $(GOBJECT_LIBS) $(FONTCONFIG_LIBS) $(GDKPIXBUF_LIBS) $(CAIRO_LIBS) $(GTK_LIBS) $(XMLRPC_LIBS) $(XMLRPC_UTIL_LIBS) $(XMLRPC_SERVER_ABYSS_LIBS) $(XMLRPC_SERVER_CGI_LIBS) $(XMLRPC_SERVER_LIBS) -lm -lrt -lX11 -pthread
gsequencer_LDADD = 
gsequencerheaders = \
	...
	src/ags/thread/ags_channel_thread.h \
...
gsequencer_SOURCES = \
	...
	src/ags/thread/ags_channel_thread.c \
...
include ./$(DEPDIR)/gsequencer-ags_add_audio.Po
include ./$(DEPDIR)/gsequencer-ags_add_audio_signal.Po
include ./$(DEPDIR)/gsequencer-ags_add_line_member.Po
include ./$(DEPDIR)/gsequencer-ags_add_note.Po
include ./$(DEPDIR)/gsequencer-ags_add_point_to_selection.Po
include ./$(DEPDIR)/gsequencer-ags_add_recall.Po
include ./$(DEPDIR)/gsequencer-ags_add_recall_container.Po
include ./$(DEPDIR)/gsequencer-ags_add_region_to_selection.Po
include ./$(DEPDIR)/gsequencer-ags_amplifier.Po
include ./$(DEPDIR)/gsequencer-ags_append_audio.Po
include ./$(DEPDIR)/gsequencer-ags_append_audio_threaded.Po
include ./$(DEPDIR)/gsequencer-ags_append_channel.Po
include ./$(DEPDIR)/gsequencer-ags_append_recall.Po
include ./$(DEPDIR)/gsequencer-ags_applicable.Po
include ./$(DEPDIR)/gsequencer-ags_apply_bpm.Po
include ./$(DEPDIR)/gsequencer-ags_apply_sequencer_length.Po
include ./$(DEPDIR)/gsequencer-ags_apply_synth.Po
include ./$(DEPDIR)/gsequencer-ags_apply_tact.Po
include ./$(DEPDIR)/gsequencer-ags_apply_wavetable.Po
include ./$(DEPDIR)/gsequencer-ags_async_queue.Po
include ./$(DEPDIR)/gsequencer-ags_audio.Po
include ./$(DEPDIR)/gsequencer-ags_audio_file.Po
include ./$(DEPDIR)/gsequencer-ags_audio_file_xml.Po
include ./$(DEPDIR)/gsequencer-ags_audio_loop.Po
include ./$(DEPDIR)/gsequencer-ags_audio_preferences.Po
include ./$(DEPDIR)/gsequencer-ags_audio_preferences_callbacks.Po
include ./$(DEPDIR)/gsequencer-ags_audio_set_recycling.Po
include ./$(DEPDIR)/gsequencer-ags_audio_signal.Po
include ./$(DEPDIR)/gsequencer-ags_audio_thread.Po
include ./$(DEPDIR)/gsequencer-ags_autosave_thread.Po
include ./$(DEPDIR)/gsequencer-ags_blink_cell_pattern_cursor.Po
include ./$(DEPDIR)/gsequencer-ags_buffer_audio_signal.Po
include ./$(DEPDIR)/gsequencer-ags_buffer_channel.Po
include ./$(DEPDIR)/gsequencer-ags_buffer_channel_run.Po
include ./$(DEPDIR)/gsequencer-ags_buffer_recycling.Po
include ./$(DEPDIR)/gsequencer-ags_cancel_audio.Po
include ./$(DEPDIR)/gsequencer-ags_cancel_channel.Po
include ./$(DEPDIR)/gsequencer-ags_cancel_recall.Po
include ./$(DEPDIR)/gsequencer-ags_cartesian.Po
include ./$(DEPDIR)/gsequencer-ags_cell_pattern.Po
include ./$(DEPDIR)/gsequencer-ags_cell_pattern_callbacks.Po
include ./$(DEPDIR)/gsequencer-ags_change_indicator.Po
include ./$(DEPDIR)/gsequencer-ags_change_tact.Po
include ./$(DEPDIR)/gsequencer-ags_channel.Po
include ./$(DEPDIR)/gsequencer-ags_channel_iter.Po
include ./$(DEPDIR)/gsequencer-ags_channel_set_recycling.Po
include ./$(DEPDIR)/gsequencer-ags_channel_thread.Po
include ./$(DEPDIR)/gsequencer-ags_clone_channel.Po
include ./$(DEPDIR)/gsequencer-ags_clone_channel_run.Po
include ./$(DEPDIR)/gsequencer-ags_combo_box_text.Po
include ./$(DEPDIR)/gsequencer-ags_concurrent_tree.Po
include ./$(DEPDIR)/gsequencer-ags_config.Po
include ./$(DEPDIR)/gsequencer-ags_connectable.Po
include ./$(DEPDIR)/gsequencer-ags_container.Po
include ./$(DEPDIR)/gsequencer-ags_copy_audio_signal.Po
include ./$(DEPDIR)/gsequencer-ags_copy_channel.Po
include ./$(DEPDIR)/gsequencer-ags_copy_channel_run.Po
include ./$(DEPDIR)/gsequencer-ags_copy_notation_audio.Po
include ./$(DEPDIR)/gsequencer-ags_copy_notation_audio_run.Po
include ./$(DEPDIR)/gsequencer-ags_copy_pattern_audio.Po
include ./$(DEPDIR)/gsequencer-ags_copy_pattern_audio_run.Po
include ./$(DEPDIR)/gsequencer-ags_copy_pattern_channel.Po
include ./$(DEPDIR)/gsequencer-ags_copy_pattern_channel_run.Po
include ./$(DEPDIR)/gsequencer-ags_copy_recycling.Po
include ./$(DEPDIR)/gsequencer-ags_count_beats_audio.Po
include ./$(DEPDIR)/gsequencer-ags_count_beats_audio_run.Po
include ./$(DEPDIR)/gsequencer-ags_countable.Po
include ./$(DEPDIR)/gsequencer-ags_delay_audio.Po
include ./$(DEPDIR)/gsequencer-ags_delay_audio_run.Po
include ./$(DEPDIR)/gsequencer-ags_devout.Po
include ./$(DEPDIR)/gsequencer-ags_devout_thread.Po
include ./$(DEPDIR)/gsequencer-ags_dial.Po
...
include ./$(DEPDIR)/gsequencer-ags_dynamic_connectable.Po
include ./$(DEPDIR)/gsequencer-ags_echo.Po
include ./$(DEPDIR)/gsequencer-ags_editor.Po
include ./$(DEPDIR)/gsequencer-ags_editor_callbacks.Po
include ./$(DEPDIR)/gsequencer-ags_effect.Po
include ./$(DEPDIR)/gsequencer-ags_envelope_audio_signal.Po
include ./$(DEPDIR)/gsequencer-ags_envelope_channel.Po
include ./$(DEPDIR)/gsequencer-ags_envelope_channel_run.Po
include ./$(DEPDIR)/gsequencer-ags_envelope_recycling.Po
include ./$(DEPDIR)/gsequencer-ags_expander.Po
include ./$(DEPDIR)/gsequencer-ags_expander_set.Po
include ./$(DEPDIR)/gsequencer-ags_export_output.Po
include ./$(DEPDIR)/gsequencer-ags_export_thread.Po
...
include ./$(DEPDIR)/gsequencer-ags_garbage_collector.Po
include ./$(DEPDIR)/gsequencer-ags_generic_preferences.Po
include ./$(DEPDIR)/gsequencer-ags_generic_preferences_callbacks.Po
include ./$(DEPDIR)/gsequencer-ags_gui_task_thread.Po
include ./$(DEPDIR)/gsequencer-ags_gui_thread.Po
include ./$(DEPDIR)/gsequencer-ags_hindicator.Po
include ./$(DEPDIR)/gsequencer-ags_history.Po
include ./$(DEPDIR)/gsequencer-ags_htimebar.Po
include ./$(DEPDIR)/gsequencer-ags_id_generator.Po
include ./$(DEPDIR)/gsequencer-ags_indicator.Po
include ./$(DEPDIR)/gsequencer-ags_init_audio.Po
include ./$(DEPDIR)/gsequencer-ags_init_channel.Po
include ./$(DEPDIR)/gsequencer-ags_inline_player.Po
include ./$(DEPDIR)/gsequencer-ags_inline_player_callbacks.Po
include ./$(DEPDIR)/gsequencer-ags_input.Po
include ./$(DEPDIR)/gsequencer-ags_ipatch.Po
include ./$(DEPDIR)/gsequencer-ags_ipatch_sf2_reader.Po
include ./$(DEPDIR)/gsequencer-ags_iterator_thread.Po
include ./$(DEPDIR)/gsequencer-ags_ladspa_browser.Po
include ./$(DEPDIR)/gsequencer-ags_ladspa_browser_callbacks.Po
include ./$(DEPDIR)/gsequencer-ags_ladspa_manager.Po
include ./$(DEPDIR)/gsequencer-ags_led.Po
include ./$(DEPDIR)/gsequencer-ags_libao.Po
...
include ./$(DEPDIR)/gsequencer-ags_link_channel.Po
...
include ./$(DEPDIR)/gsequencer-ags_list.Po
include ./$(DEPDIR)/gsequencer-ags_listing_editor.Po
include ./$(DEPDIR)/gsequencer-ags_listing_editor_callbacks.Po
include ./$(DEPDIR)/gsequencer-ags_log.Po
include ./$(DEPDIR)/gsequencer-ags_loop_channel.Po
include ./$(DEPDIR)/gsequencer-ags_loop_channel_run.Po
...
include ./$(DEPDIR)/gsequencer-ags_mutable.Po
include ./$(DEPDIR)/gsequencer-ags_mute_audio.Po
include ./$(DEPDIR)/gsequencer-ags_mute_audio_run.Po
include ./$(DEPDIR)/gsequencer-ags_mute_audio_signal.Po
include ./$(DEPDIR)/gsequencer-ags_mute_channel.Po
include ./$(DEPDIR)/gsequencer-ags_mute_channel_run.Po
include ./$(DEPDIR)/gsequencer-ags_mute_recycling.Po
include ./$(DEPDIR)/gsequencer-ags_mutex_manager.Po
include ./$(DEPDIR)/gsequencer-ags_navigation.Po
include ./$(DEPDIR)/gsequencer-ags_navigation_callbacks.Po
include ./$(DEPDIR)/gsequencer-ags_notation.Po
include ./$(DEPDIR)/gsequencer-ags_note.Po
...
include ./$(DEPDIR)/gsequencer-ags_open_file.Po
include ./$(DEPDIR)/gsequencer-ags_open_single_file.Po
include ./$(DEPDIR)/gsequencer-ags_option_menu.Po
include ./$(DEPDIR)/gsequencer-ags_oscillator.Po
include ./$(DEPDIR)/gsequencer-ags_oscillator_callbacks.Po
include ./$(DEPDIR)/gsequencer-ags_output.Po
include ./$(DEPDIR)/gsequencer-ags_packable.Po
...
include ./$(DEPDIR)/gsequencer-ags_parameter.Po
include ./$(DEPDIR)/gsequencer-ags_pattern.Po
include ./$(DEPDIR)/gsequencer-ags_pattern_box.Po
include ./$(DEPDIR)/gsequencer-ags_pattern_box_callbacks.Po
include ./$(DEPDIR)/gsequencer-ags_pattern_edit.Po
include ./$(DEPDIR)/gsequencer-ags_pattern_edit_callbacks.Po
include ./$(DEPDIR)/gsequencer-ags_peak_audio_signal.Po
include ./$(DEPDIR)/gsequencer-ags_peak_channel.Po
include ./$(DEPDIR)/gsequencer-ags_peak_channel_run.Po
include ./$(DEPDIR)/gsequencer-ags_peak_recycling.Po
...
include ./$(DEPDIR)/gsequencer-ags_persistable.Po
include ./$(DEPDIR)/gsequencer-ags_play_audio.Po
include ./$(DEPDIR)/gsequencer-ags_play_audio_file.Po
include ./$(DEPDIR)/gsequencer-ags_play_audio_signal.Po
include ./$(DEPDIR)/gsequencer-ags_play_channel.Po
include ./$(DEPDIR)/gsequencer-ags_play_channel_run.Po
include ./$(DEPDIR)/gsequencer-ags_play_channel_run_master.Po
include ./$(DEPDIR)/gsequencer-ags_play_notation_audio.Po
include ./$(DEPDIR)/gsequencer-ags_play_notation_audio_run.Po
include ./$(DEPDIR)/gsequencer-ags_play_note.Po
include ./$(DEPDIR)/gsequencer-ags_play_pattern.Po
include ./$(DEPDIR)/gsequencer-ags_play_recycling.Po
include ./$(DEPDIR)/gsequencer-ags_playable.Po
include ./$(DEPDIR)/gsequencer-ags_plugin.Po
include ./$(DEPDIR)/gsequencer-ags_plugin_factory.Po
include ./$(DEPDIR)/gsequencer-ags_plugin_preferences.Po
include ./$(DEPDIR)/gsequencer-ags_plugin_preferences_callbacks.Po
include ./$(DEPDIR)/gsequencer-ags_port.Po
include ./$(DEPDIR)/gsequencer-ags_portlet.Po
...
include ./$(DEPDIR)/gsequencer-ags_recall.Po
include ./$(DEPDIR)/gsequencer-ags_recall_audio.Po
include ./$(DEPDIR)/gsequencer-ags_recall_audio_run.Po
include ./$(DEPDIR)/gsequencer-ags_recall_audio_signal.Po
include ./$(DEPDIR)/gsequencer-ags_recall_channel.Po
include ./$(DEPDIR)/gsequencer-ags_recall_channel_run.Po
include ./$(DEPDIR)/gsequencer-ags_recall_channel_run_dummy.Po
include ./$(DEPDIR)/gsequencer-ags_recall_container.Po
include ./$(DEPDIR)/gsequencer-ags_recall_dependency.Po
include ./$(DEPDIR)/gsequencer-ags_recall_factory.Po
include ./$(DEPDIR)/gsequencer-ags_recall_id.Po
include ./$(DEPDIR)/gsequencer-ags_recall_ladspa.Po
include ./$(DEPDIR)/gsequencer-ags_recall_ladspa_run.Po
include ./$(DEPDIR)/gsequencer-ags_recall_recycling.Po
include ./$(DEPDIR)/gsequencer-ags_recall_recycling_dummy.Po
include ./$(DEPDIR)/gsequencer-ags_record_thread.Po
include ./$(DEPDIR)/gsequencer-ags_recycling.Po
include ./$(DEPDIR)/gsequencer-ags_recycling_container.Po
include ./$(DEPDIR)/gsequencer-ags_recycling_thread.Po
include ./$(DEPDIR)/gsequencer-ags_recycling_thread_callbacks.Po
include ./$(DEPDIR)/gsequencer-ags_registry.Po
include ./$(DEPDIR)/gsequencer-ags_remote_task.Po
include ./$(DEPDIR)/gsequencer-ags_remove_audio.Po
include ./$(DEPDIR)/gsequencer-ags_remove_audio_signal.Po
include ./$(DEPDIR)/gsequencer-ags_remove_note.Po
include ./$(DEPDIR)/gsequencer-ags_remove_point_from_selection.Po
include ./$(DEPDIR)/gsequencer-ags_remove_recall.Po
include ./$(DEPDIR)/gsequencer-ags_remove_recall_container.Po
include ./$(DEPDIR)/gsequencer-ags_remove_region_from_selection.Po
include ./$(DEPDIR)/gsequencer-ags_resize_audio.Po
include ./$(DEPDIR)/gsequencer-ags_resize_editor.Po
include ./$(DEPDIR)/gsequencer-ags_returnable_thread.Po
include ./$(DEPDIR)/gsequencer-ags_ruler.Po
include ./$(DEPDIR)/gsequencer-ags_runnable.Po
include ./$(DEPDIR)/gsequencer-ags_save_file.Po
include ./$(DEPDIR)/gsequencer-ags_scroll_on_play.Po
include ./$(DEPDIR)/gsequencer-ags_seek_devout.Po
include ./$(DEPDIR)/gsequencer-ags_seekable.Po
include ./$(DEPDIR)/gsequencer-ags_segment.Po
...
include ./$(DEPDIR)/gsequencer-ags_set_audio_channels.Po
include ./$(DEPDIR)/gsequencer-ags_set_buffer_size.Po
include ./$(DEPDIR)/gsequencer-ags_set_devout_play_flags.Po
include ./$(DEPDIR)/gsequencer-ags_set_muted.Po
include ./$(DEPDIR)/gsequencer-ags_set_output_device.Po
include ./$(DEPDIR)/gsequencer-ags_set_samplerate.Po
include ./$(DEPDIR)/gsequencer-ags_sf2_chooser.Po
include ./$(DEPDIR)/gsequencer-ags_sf2_chooser_callbacks.Po
include ./$(DEPDIR)/gsequencer-ags_single_thread.Po
include ./$(DEPDIR)/gsequencer-ags_sndfile.Po
include ./$(DEPDIR)/gsequencer-ags_soundcard.Po
include ./$(DEPDIR)/gsequencer-ags_stackable.Po
include ./$(DEPDIR)/gsequencer-ags_start_devout.Po
include ./$(DEPDIR)/gsequencer-ags_stream.Po
include ./$(DEPDIR)/gsequencer-ags_stream_audio_signal.Po
include ./$(DEPDIR)/gsequencer-ags_stream_channel.Po
include ./$(DEPDIR)/gsequencer-ags_stream_channel_run.Po
include ./$(DEPDIR)/gsequencer-ags_stream_recycling.Po
...
include ./$(DEPDIR)/gsequencer-ags_synths.Po
include ./$(DEPDIR)/gsequencer-ags_table.Po
include ./$(DEPDIR)/gsequencer-ags_tactable.Po
include ./$(DEPDIR)/gsequencer-ags_task.Po
include ./$(DEPDIR)/gsequencer-ags_task_completion.Po
include ./$(DEPDIR)/gsequencer-ags_task_thread.Po
include ./$(DEPDIR)/gsequencer-ags_thread-posix.Po
include ./$(DEPDIR)/gsequencer-ags_thread_pool.Po
include ./$(DEPDIR)/gsequencer-ags_timebar.Po
include ./$(DEPDIR)/gsequencer-ags_timestamp.Po
include ./$(DEPDIR)/gsequencer-ags_timestamp_factory.Po
include ./$(DEPDIR)/gsequencer-ags_timestamp_thread.Po
...
include ./$(DEPDIR)/gsequencer-ags_tree_iterator.Po
include ./$(DEPDIR)/gsequencer-ags_unref_audio_signal.Po
include ./$(DEPDIR)/gsequencer-ags_vindicator.Po
include ./$(DEPDIR)/gsequencer-ags_volume_audio_signal.Po
include ./$(DEPDIR)/gsequencer-ags_volume_channel.Po
include ./$(DEPDIR)/gsequencer-ags_volume_channel_run.Po
include ./$(DEPDIR)/gsequencer-ags_volume_recycling.Po
include ./$(DEPDIR)/gsequencer-ags_waveform.Po
...
gsequencer-ags_audio.o: src/ags/audio/ags_audio.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_audio.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_audio.Tpo -c -o gsequencer-ags_audio.o `test -f 'src/ags/audio/ags_audio.c' || echo '$(srcdir)/'`src/ags/audio/ags_audio.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_audio.Tpo $(DEPDIR)/gsequencer-ags_audio.Po
#	$(AM_V_CC)source='src/ags/audio/ags_audio.c' object='gsequencer-ags_audio.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_audio.o `test -f 'src/ags/audio/ags_audio.c' || echo '$(srcdir)/'`src/ags/audio/ags_audio.c

gsequencer-ags_audio.obj: src/ags/audio/ags_audio.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_audio.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_audio.Tpo -c -o gsequencer-ags_audio.obj `if test -f 'src/ags/audio/ags_audio.c'; then $(CYGPATH_W) 'src/ags/audio/ags_audio.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_audio.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_audio.Tpo $(DEPDIR)/gsequencer-ags_audio.Po
#	$(AM_V_CC)source='src/ags/audio/ags_audio.c' object='gsequencer-ags_audio.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_audio.obj `if test -f 'src/ags/audio/ags_audio.c'; then $(CYGPATH_W) 'src/ags/audio/ags_audio.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_audio.c'; fi`

gsequencer-ags_audio_signal.o: src/ags/audio/ags_audio_signal.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_audio_signal.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_audio_signal.Tpo -c -o gsequencer-ags_audio_signal.o `test -f 'src/ags/audio/ags_audio_signal.c' || echo '$(srcdir)/'`src/ags/audio/ags_audio_signal.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_audio_signal.Tpo $(DEPDIR)/gsequencer-ags_audio_signal.Po
#	$(AM_V_CC)source='src/ags/audio/ags_audio_signal.c' object='gsequencer-ags_audio_signal.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_audio_signal.o `test -f 'src/ags/audio/ags_audio_signal.c' || echo '$(srcdir)/'`src/ags/audio/ags_audio_signal.c

gsequencer-ags_audio_signal.obj: src/ags/audio/ags_audio_signal.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_audio_signal.Tpo $(DEPDIR)/gsequencer-ags_audio_signal.Po
#	$(AM_V_CC)source='src/ags/audio/ags_audio_signal.c' object='gsequencer-ags_audio_signal.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_audio_signal.obj `if test -f 'src/ags/audio/ags_audio_signal.c'; then $(CYGPATH_W) 'src/ags/audio/ags_audio_signal.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_audio_signal.c'; fi`

gsequencer-ags_channel.o: src/ags/audio/ags_channel.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_channel.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_channel.Tpo -c -o gsequencer-ags_channel.o `test -f 'src/ags/audio/ags_channel.c' || echo '$(srcdir)/'`src/ags/audio/ags_channel.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_channel.Tpo $(DEPDIR)/gsequencer-ags_channel.Po
#	$(AM_V_CC)source='src/ags/audio/ags_channel.c' object='gsequencer-ags_channel.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_channel.o `test -f 'src/ags/audio/ags_channel.c' || echo '$(srcdir)/'`src/ags/audio/ags_channel.c

gsequencer-ags_channel.obj: src/ags/audio/ags_channel.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_channel.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_channel.Tpo -c -o gsequencer-ags_channel.obj `if test -f 'src/ags/audio/ags_channel.c'; then $(CYGPATH_W) 'src/ags/audio/ags_channel.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_channel.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_channel.Tpo $(DEPDIR)/gsequencer-ags_channel.Po
#	$(AM_V_CC)source='src/ags/audio/ags_channel.c' object='gsequencer-ags_channel.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_channel.obj `if test -f 'src/ags/audio/ags_channel.c'; then $(CYGPATH_W) 'src/ags/audio/ags_channel.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_channel.c'; fi`

gsequencer-ags_channel_iter.o: src/ags/audio/ags_channel_iter.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_channel_iter.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_channel_iter.Tpo -c -o gsequencer-ags_channel_iter.o `test -f 'src/ags/audio/ags_channel_iter.c' || echo '$(srcdir)/'`src/ags/audio/ags_channel_iter.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_channel_iter.Tpo $(DEPDIR)/gsequencer-ags_channel_iter.Po
#	$(AM_V_CC)source='src/ags/audio/ags_channel_iter.c' object='gsequencer-ags_channel_iter.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_channel_iter.o `test -f 'src/ags/audio/ags_channel_iter.c' || echo '$(srcdir)/'`src/ags/audio/ags_channel_iter.c

gsequencer-ags_channel_iter.obj: src/ags/audio/ags_channel_iter.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_channel_iter.Tpo $(DEPDIR)/gsequencer-ags_channel_iter.Po
#	$(AM_V_CC)source='src/ags/audio/ags_channel_iter.c' object='gsequencer-ags_channel_iter.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_channel_iter.obj `if test -f 'src/ags/audio/ags_channel_iter.c'; then $(CYGPATH_W) 'src/ags/audio/ags_channel_iter.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_channel_iter.c'; fi`

gsequencer-ags_config.o: src/ags/audio/ags_config.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_config.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_config.Tpo -c -o gsequencer-ags_config.o `test -f 'src/ags/audio/ags_config.c' || echo '$(srcdir)/'`src/ags/audio/ags_config.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_config.Tpo $(DEPDIR)/gsequencer-ags_config.Po
#	$(AM_V_CC)source='src/ags/audio/ags_config.c' object='gsequencer-ags_config.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_config.o `test -f 'src/ags/audio/ags_config.c' || echo '$(srcdir)/'`src/ags/audio/ags_config.c

gsequencer-ags_config.obj: src/ags/audio/ags_config.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_config.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_config.Tpo -c -o gsequencer-ags_config.obj `if test -f 'src/ags/audio/ags_config.c'; then $(CYGPATH_W) 'src/ags/audio/ags_config.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_config.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_config.Tpo $(DEPDIR)/gsequencer-ags_config.Po
#	$(AM_V_CC)source='src/ags/audio/ags_config.c' object='gsequencer-ags_config.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_config.obj `if test -f 'src/ags/audio/ags_config.c'; then $(CYGPATH_W) 'src/ags/audio/ags_config.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_config.c'; fi`

gsequencer-ags_devout.o: src/ags/audio/ags_devout.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_devout.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_devout.Tpo -c -o gsequencer-ags_devout.o `test -f 'src/ags/audio/ags_devout.c' || echo '$(srcdir)/'`src/ags/audio/ags_devout.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_devout.Tpo $(DEPDIR)/gsequencer-ags_devout.Po
#	$(AM_V_CC)source='src/ags/audio/ags_devout.c' object='gsequencer-ags_devout.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_devout.o `test -f 'src/ags/audio/ags_devout.c' || echo '$(srcdir)/'`src/ags/audio/ags_devout.c

gsequencer-ags_devout.obj: src/ags/audio/ags_devout.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_devout.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_devout.Tpo -c -o gsequencer-ags_devout.obj `if test -f 'src/ags/audio/ags_devout.c'; then $(CYGPATH_W) 'src/ags/audio/ags_devout.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_devout.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_devout.Tpo $(DEPDIR)/gsequencer-ags_devout.Po
#	$(AM_V_CC)source='src/ags/audio/ags_devout.c' object='gsequencer-ags_devout.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_devout.obj `if test -f 'src/ags/audio/ags_devout.c'; then $(CYGPATH_W) 'src/ags/audio/ags_devout.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_devout.c'; fi`

gsequencer-ags_garbage_collector.o: src/ags/audio/ags_garbage_collector.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_garbage_collector.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_garbage_collector.Tpo -c -o gsequencer-ags_garbage_collector.o `test -f 'src/ags/audio/ags_garbage_collector.c' || echo '$(srcdir)/'`src/ags/audio/ags_garbage_collector.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_garbage_collector.Tpo $(DEPDIR)/gsequencer-ags_garbage_collector.Po
#	$(AM_V_CC)source='src/ags/audio/ags_garbage_collector.c' object='gsequencer-ags_garbage_collector.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_garbage_collector.o `test -f 'src/ags/audio/ags_garbage_collector.c' || echo '$(srcdir)/'`src/ags/audio/ags_garbage_collector.c

gsequencer-ags_garbage_collector.obj: src/ags/audio/ags_garbage_collector.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_garbage_collector.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_garbage_collector.Tpo -c -o gsequencer-ags_garbage_collector.obj `if test -f 'src/ags/audio/ags_garbage_collector.c'; then $(CYGPATH_W) 'src/ags/audio/ags_garbage_collector.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_garbage_collector.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_garbage_collector.Tpo $(DEPDIR)/gsequencer-ags_garbage_collector.Po
#	$(AM_V_CC)source='src/ags/audio/ags_garbage_collector.c' object='gsequencer-ags_garbage_collector.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_garbage_collector.obj `if test -f 'src/ags/audio/ags_garbage_collector.c'; then $(CYGPATH_W) 'src/ags/audio/ags_garbage_collector.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_garbage_collector.c'; fi`

gsequencer-ags_input.o: src/ags/audio/ags_input.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_input.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_input.Tpo -c -o gsequencer-ags_input.o `test -f 'src/ags/audio/ags_input.c' || echo '$(srcdir)/'`src/ags/audio/ags_input.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_input.Tpo $(DEPDIR)/gsequencer-ags_input.Po
#	$(AM_V_CC)source='src/ags/audio/ags_input.c' object='gsequencer-ags_input.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_input.o `test -f 'src/ags/audio/ags_input.c' || echo '$(srcdir)/'`src/ags/audio/ags_input.c

gsequencer-ags_input.obj: src/ags/audio/ags_input.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_input.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_input.Tpo -c -o gsequencer-ags_input.obj `if test -f 'src/ags/audio/ags_input.c'; then $(CYGPATH_W) 'src/ags/audio/ags_input.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_input.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_input.Tpo $(DEPDIR)/gsequencer-ags_input.Po
#	$(AM_V_CC)source='src/ags/audio/ags_input.c' object='gsequencer-ags_input.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_input.obj `if test -f 'src/ags/audio/ags_input.c'; then $(CYGPATH_W) 'src/ags/audio/ags_input.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_input.c'; fi`

gsequencer-ags_libao.o: src/ags/audio/ags_libao.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_libao.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_libao.Tpo -c -o gsequencer-ags_libao.o `test -f 'src/ags/audio/ags_libao.c' || echo '$(srcdir)/'`src/ags/audio/ags_libao.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_libao.Tpo $(DEPDIR)/gsequencer-ags_libao.Po
#	$(AM_V_CC)source='src/ags/audio/ags_libao.c' object='gsequencer-ags_libao.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_libao.o `test -f 'src/ags/audio/ags_libao.c' || echo '$(srcdir)/'`src/ags/audio/ags_libao.c

gsequencer-ags_libao.obj: src/ags/audio/ags_libao.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_libao.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_libao.Tpo -c -o gsequencer-ags_libao.obj `if test -f 'src/ags/audio/ags_libao.c'; then $(CYGPATH_W) 'src/ags/audio/ags_libao.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_libao.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_libao.Tpo $(DEPDIR)/gsequencer-ags_libao.Po
#	$(AM_V_CC)source='src/ags/audio/ags_libao.c' object='gsequencer-ags_libao.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_libao.obj `if test -f 'src/ags/audio/ags_libao.c'; then $(CYGPATH_W) 'src/ags/audio/ags_libao.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_libao.c'; fi`

gsequencer-ags_notation.o: src/ags/audio/ags_notation.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_notation.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_notation.Tpo -c -o gsequencer-ags_notation.o `test -f 'src/ags/audio/ags_notation.c' || echo '$(srcdir)/'`src/ags/audio/ags_notation.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_notation.Tpo $(DEPDIR)/gsequencer-ags_notation.Po
#	$(AM_V_CC)source='src/ags/audio/ags_notation.c' object='gsequencer-ags_notation.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_notation.o `test -f 'src/ags/audio/ags_notation.c' || echo '$(srcdir)/'`src/ags/audio/ags_notation.c

gsequencer-ags_notation.obj: src/ags/audio/ags_notation.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_notation.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_notation.Tpo -c -o gsequencer-ags_notation.obj `if test -f 'src/ags/audio/ags_notation.c'; then $(CYGPATH_W) 'src/ags/audio/ags_notation.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_notation.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_notation.Tpo $(DEPDIR)/gsequencer-ags_notation.Po
#	$(AM_V_CC)source='src/ags/audio/ags_notation.c' object='gsequencer-ags_notation.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_notation.obj `if test -f 'src/ags/audio/ags_notation.c'; then $(CYGPATH_W) 'src/ags/audio/ags_notation.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_notation.c'; fi`

gsequencer-ags_note.o: src/ags/audio/ags_note.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_note.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_note.Tpo -c -o gsequencer-ags_note.o `test -f 'src/ags/audio/ags_note.c' || echo '$(srcdir)/'`src/ags/audio/ags_note.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_note.Tpo $(DEPDIR)/gsequencer-ags_note.Po
#	$(AM_V_CC)source='src/ags/audio/ags_note.c' object='gsequencer-ags_note.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_note.o `test -f 'src/ags/audio/ags_note.c' || echo '$(srcdir)/'`src/ags/audio/ags_note.c

gsequencer-ags_note.obj: src/ags/audio/ags_note.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_note.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_note.Tpo -c -o gsequencer-ags_note.obj `if test -f 'src/ags/audio/ags_note.c'; then $(CYGPATH_W) 'src/ags/audio/ags_note.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_note.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_note.Tpo $(DEPDIR)/gsequencer-ags_note.Po
#	$(AM_V_CC)source='src/ags/audio/ags_note.c' object='gsequencer-ags_note.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_note.obj `if test -f 'src/ags/audio/ags_note.c'; then $(CYGPATH_W) 'src/ags/audio/ags_note.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_note.c'; fi`

gsequencer-ags_output.o: src/ags/audio/ags_output.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_output.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_output.Tpo -c -o gsequencer-ags_output.o `test -f 'src/ags/audio/ags_output.c' || echo '$(srcdir)/'`src/ags/audio/ags_output.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_output.Tpo $(DEPDIR)/gsequencer-ags_output.Po
#	$(AM_V_CC)source='src/ags/audio/ags_output.c' object='gsequencer-ags_output.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_output.o `test -f 'src/ags/audio/ags_output.c' || echo '$(srcdir)/'`src/ags/audio/ags_output.c

gsequencer-ags_output.obj: src/ags/audio/ags_output.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_output.Tpo $(DEPDIR)/gsequencer-ags_output.Po
#	$(AM_V_CC)source='src/ags/audio/ags_output.c' object='gsequencer-ags_output.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_output.obj `if test -f 'src/ags/audio/ags_output.c'; then $(CYGPATH_W) 'src/ags/audio/ags_output.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_output.c'; fi`

gsequencer-ags_pattern.o: src/ags/audio/ags_pattern.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_pattern.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_pattern.Tpo -c -o gsequencer-ags_pattern.o `test -f 'src/ags/audio/ags_pattern.c' || echo '$(srcdir)/'`src/ags/audio/ags_pattern.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_pattern.Tpo $(DEPDIR)/gsequencer-ags_pattern.Po
#	$(AM_V_CC)source='src/ags/audio/ags_pattern.c' object='gsequencer-ags_pattern.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_pattern.o `test -f 'src/ags/audio/ags_pattern.c' || echo '$(srcdir)/'`src/ags/audio/ags_pattern.c

gsequencer-ags_pattern.obj: src/ags/audio/ags_pattern.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_pattern.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_pattern.Tpo -c -o gsequencer-ags_pattern.obj `if test -f 'src/ags/audio/ags_pattern.c'; then $(CYGPATH_W) 'src/ags/audio/ags_pattern.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_pattern.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_pattern.Tpo $(DEPDIR)/gsequencer-ags_pattern.Po
#	$(AM_V_CC)source='src/ags/audio/ags_pattern.c' object='gsequencer-ags_pattern.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_pattern.obj `if test -f 'src/ags/audio/ags_pattern.c'; then $(CYGPATH_W) 'src/ags/audio/ags_pattern.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_pattern.c'; fi`

gsequencer-ags_port.o: src/ags/audio/ags_port.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_port.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_port.Tpo -c -o gsequencer-ags_port.o `test -f 'src/ags/audio/ags_port.c' || echo '$(srcdir)/'`src/ags/audio/ags_port.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_port.Tpo $(DEPDIR)/gsequencer-ags_port.Po
#	$(AM_V_CC)source='src/ags/audio/ags_port.c' object='gsequencer-ags_port.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_port.o `test -f 'src/ags/audio/ags_port.c' || echo '$(srcdir)/'`src/ags/audio/ags_port.c

gsequencer-ags_port.obj: src/ags/audio/ags_port.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_port.Tpo $(DEPDIR)/gsequencer-ags_port.Po
#	$(AM_V_CC)source='src/ags/audio/ags_port.c' object='gsequencer-ags_port.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_port.obj `if test -f 'src/ags/audio/ags_port.c'; then $(CYGPATH_W) 'src/ags/audio/ags_port.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_port.c'; fi`

gsequencer-ags_recall_audio.o: src/ags/audio/ags_recall_audio.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recall_audio.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_recall_audio.Tpo -c -o gsequencer-ags_recall_audio.o `test -f 'src/ags/audio/ags_recall_audio.c' || echo '$(srcdir)/'`src/ags/audio/ags_recall_audio.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recall_audio.Tpo $(DEPDIR)/gsequencer-ags_recall_audio.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recall_audio.c' object='gsequencer-ags_recall_audio.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recall_audio.o `test -f 'src/ags/audio/ags_recall_audio.c' || echo '$(srcdir)/'`src/ags/audio/ags_recall_audio.c

gsequencer-ags_recall_audio.obj: src/ags/audio/ags_recall_audio.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recall_audio.Tpo $(DEPDIR)/gsequencer-ags_recall_audio.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recall_audio.c' object='gsequencer-ags_recall_audio.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recall_audio.obj `if test -f 'src/ags/audio/ags_recall_audio.c'; then $(CYGPATH_W) 'src/ags/audio/ags_recall_audio.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_recall_audio.c'; fi`

gsequencer-ags_recall_audio_run.o: src/ags/audio/ags_recall_audio_run.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recall_audio_run.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_recall_audio_run.Tpo -c -o gsequencer-ags_recall_audio_run.o `test -f 'src/ags/audio/ags_recall_audio_run.c' || echo '$(srcdir)/'`src/ags/audio/ags_recall_audio_run.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recall_audio_run.Tpo $(DEPDIR)/gsequencer-ags_recall_audio_run.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recall_audio_run.c' object='gsequencer-ags_recall_audio_run.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recall_audio_run.o `test -f 'src/ags/audio/ags_recall_audio_run.c' || echo '$(srcdir)/'`src/ags/audio/ags_recall_audio_run.c

gsequencer-ags_recall_audio_run.obj: src/ags/audio/ags_recall_audio_run.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recall_audio_run.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_recall_audio_run.Tpo -c -o gsequencer-ags_recall_audio_run.obj `if test -f 'src/ags/audio/ags_recall_audio_run.c'; then $(CYGPATH_W) 'src/ags/audio/ags_recall_audio_run.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_recall_audio_run.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recall_audio_run.Tpo $(DEPDIR)/gsequencer-ags_recall_audio_run.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recall_audio_run.c' object='gsequencer-ags_recall_audio_run.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recall_audio_run.obj `if test -f 'src/ags/audio/ags_recall_audio_run.c'; then $(CYGPATH_W) 'src/ags/audio/ags_recall_audio_run.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_recall_audio_run.c'; fi`

gsequencer-ags_recall_audio_signal.o: src/ags/audio/ags_recall_audio_signal.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recall_audio_signal.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_recall_audio_signal.Tpo -c -o gsequencer-ags_recall_audio_signal.o `test -f 'src/ags/audio/ags_recall_audio_signal.c' || echo '$(srcdir)/'`src/ags/audio/ags_recall_audio_signal.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recall_audio_signal.Tpo $(DEPDIR)/gsequencer-ags_recall_audio_signal.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recall_audio_signal.c' object='gsequencer-ags_recall_audio_signal.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recall_audio_signal.o `test -f 'src/ags/audio/ags_recall_audio_signal.c' || echo '$(srcdir)/'`src/ags/audio/ags_recall_audio_signal.c

gsequencer-ags_recall_audio_signal.obj: src/ags/audio/ags_recall_audio_signal.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recall_audio_signal.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_recall_audio_signal.Tpo -c -o gsequencer-ags_recall_audio_signal.obj `if test -f 'src/ags/audio/ags_recall_audio_signal.c'; then $(CYGPATH_W) 'src/ags/audio/ags_recall_audio_signal.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_recall_audio_signal.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recall_audio_signal.Tpo $(DEPDIR)/gsequencer-ags_recall_audio_signal.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recall_audio_signal.c' object='gsequencer-ags_recall_audio_signal.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recall_audio_signal.obj `if test -f 'src/ags/audio/ags_recall_audio_signal.c'; then $(CYGPATH_W) 'src/ags/audio/ags_recall_audio_signal.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_recall_audio_signal.c'; fi`

gsequencer-ags_recall.o: src/ags/audio/ags_recall.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recall.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_recall.Tpo -c -o gsequencer-ags_recall.o `test -f 'src/ags/audio/ags_recall.c' || echo '$(srcdir)/'`src/ags/audio/ags_recall.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recall.Tpo $(DEPDIR)/gsequencer-ags_recall.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recall.c' object='gsequencer-ags_recall.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recall.o `test -f 'src/ags/audio/ags_recall.c' || echo '$(srcdir)/'`src/ags/audio/ags_recall.c

gsequencer-ags_recall.obj: src/ags/audio/ags_recall.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recall.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_recall.Tpo -c -o gsequencer-ags_recall.obj `if test -f 'src/ags/audio/ags_recall.c'; then $(CYGPATH_W) 'src/ags/audio/ags_recall.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_recall.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recall.Tpo $(DEPDIR)/gsequencer-ags_recall.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recall.c' object='gsequencer-ags_recall.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recall.obj `if test -f 'src/ags/audio/ags_recall.c'; then $(CYGPATH_W) 'src/ags/audio/ags_recall.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_recall.c'; fi`

gsequencer-ags_recall_channel.o: src/ags/audio/ags_recall_channel.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recall_channel.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_recall_channel.Tpo -c -o gsequencer-ags_recall_channel.o `test -f 'src/ags/audio/ags_recall_channel.c' || echo '$(srcdir)/'`src/ags/audio/ags_recall_channel.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recall_channel.Tpo $(DEPDIR)/gsequencer-ags_recall_channel.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recall_channel.c' object='gsequencer-ags_recall_channel.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recall_channel.o `test -f 'src/ags/audio/ags_recall_channel.c' || echo '$(srcdir)/'`src/ags/audio/ags_recall_channel.c

gsequencer-ags_recall_channel.obj: src/ags/audio/ags_recall_channel.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recall_channel.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_recall_channel.Tpo -c -o gsequencer-ags_recall_channel.obj `if test -f 'src/ags/audio/ags_recall_channel.c'; then $(CYGPATH_W) 'src/ags/audio/ags_recall_channel.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_recall_channel.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recall_channel.Tpo $(DEPDIR)/gsequencer-ags_recall_channel.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recall_channel.c' object='gsequencer-ags_recall_channel.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recall_channel.obj `if test -f 'src/ags/audio/ags_recall_channel.c'; then $(CYGPATH_W) 'src/ags/audio/ags_recall_channel.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_recall_channel.c'; fi`

gsequencer-ags_recall_channel_run.o: src/ags/audio/ags_recall_channel_run.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recall_channel_run.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_recall_channel_run.Tpo -c -o gsequencer-ags_recall_channel_run.o `test -f 'src/ags/audio/ags_recall_channel_run.c' || echo '$(srcdir)/'`src/ags/audio/ags_recall_channel_run.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recall_channel_run.Tpo $(DEPDIR)/gsequencer-ags_recall_channel_run.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recall_channel_run.c' object='gsequencer-ags_recall_channel_run.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recall_channel_run.o `test -f 'src/ags/audio/ags_recall_channel_run.c' || echo '$(srcdir)/'`src/ags/audio/ags_recall_channel_run.c

gsequencer-ags_recall_channel_run.obj: src/ags/audio/ags_recall_channel_run.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recall_channel_run.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_recall_channel_run.Tpo -c -o gsequencer-ags_recall_channel_run.obj `if test -f 'src/ags/audio/ags_recall_channel_run.c'; then $(CYGPATH_W) 'src/ags/audio/ags_recall_channel_run.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_recall_channel_run.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recall_channel_run.Tpo $(DEPDIR)/gsequencer-ags_recall_channel_run.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recall_channel_run.c' object='gsequencer-ags_recall_channel_run.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recall_channel_run.obj `if test -f 'src/ags/audio/ags_recall_channel_run.c'; then $(CYGPATH_W) 'src/ags/audio/ags_recall_channel_run.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_recall_channel_run.c'; fi`

gsequencer-ags_recall_channel_run_dummy.o: src/ags/audio/ags_recall_channel_run_dummy.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recall_channel_run_dummy.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_recall_channel_run_dummy.Tpo -c -o gsequencer-ags_recall_channel_run_dummy.o `test -f 'src/ags/audio/ags_recall_channel_run_dummy.c' || echo '$(srcdir)/'`src/ags/audio/ags_recall_channel_run_dummy.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recall_channel_run_dummy.Tpo $(DEPDIR)/gsequencer-ags_recall_channel_run_dummy.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recall_channel_run_dummy.c' object='gsequencer-ags_recall_channel_run_dummy.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recall_channel_run_dummy.o `test -f 'src/ags/audio/ags_recall_channel_run_dummy.c' || echo '$(srcdir)/'`src/ags/audio/ags_recall_channel_run_dummy.c

gsequencer-ags_recall_channel_run_dummy.obj: src/ags/audio/ags_recall_channel_run_dummy.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recall_channel_run_dummy.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_recall_channel_run_dummy.Tpo -c -o gsequencer-ags_recall_channel_run_dummy.obj `if test -f 'src/ags/audio/ags_recall_channel_run_dummy.c'; then $(CYGPATH_W) 'src/ags/audio/ags_recall_channel_run_dummy.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_recall_channel_run_dummy.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recall_channel_run_dummy.Tpo $(DEPDIR)/gsequencer-ags_recall_channel_run_dummy.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recall_channel_run_dummy.c' object='gsequencer-ags_recall_channel_run_dummy.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recall_channel_run_dummy.obj `if test -f 'src/ags/audio/ags_recall_channel_run_dummy.c'; then $(CYGPATH_W) 'src/ags/audio/ags_recall_channel_run_dummy.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_recall_channel_run_dummy.c'; fi`

gsequencer-ags_recall_container.o: src/ags/audio/ags_recall_container.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recall_container.Tpo $(DEPDIR)/gsequencer-ags_recall_container.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recall_container.c' object='gsequencer-ags_recall_container.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recall_container.o `test -f 'src/ags/audio/ags_recall_container.c' || echo '$(srcdir)/'`src/ags/audio/ags_recall_container.c

gsequencer-ags_recall_container.obj: src/ags/audio/ags_recall_container.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recall_container.Tpo $(DEPDIR)/gsequencer-ags_recall_container.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recall_container.c' object='gsequencer-ags_recall_container.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recall_container.obj `if test -f 'src/ags/audio/ags_recall_container.c'; then $(CYGPATH_W) 'src/ags/audio/ags_recall_container.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_recall_container.c'; fi`

gsequencer-ags_recall_dependency.o: src/ags/audio/ags_recall_dependency.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recall_dependency.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_recall_dependency.Tpo -c -o gsequencer-ags_recall_dependency.o `test -f 'src/ags/audio/ags_recall_dependency.c' || echo '$(srcdir)/'`src/ags/audio/ags_recall_dependency.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recall_dependency.Tpo $(DEPDIR)/gsequencer-ags_recall_dependency.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recall_dependency.c' object='gsequencer-ags_recall_dependency.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recall_dependency.o `test -f 'src/ags/audio/ags_recall_dependency.c' || echo '$(srcdir)/'`src/ags/audio/ags_recall_dependency.c

gsequencer-ags_recall_dependency.obj: src/ags/audio/ags_recall_dependency.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recall_dependency.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_recall_dependency.Tpo -c -o gsequencer-ags_recall_dependency.obj `if test -f 'src/ags/audio/ags_recall_dependency.c'; then $(CYGPATH_W) 'src/ags/audio/ags_recall_dependency.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_recall_dependency.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recall_dependency.Tpo $(DEPDIR)/gsequencer-ags_recall_dependency.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recall_dependency.c' object='gsequencer-ags_recall_dependency.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recall_dependency.obj `if test -f 'src/ags/audio/ags_recall_dependency.c'; then $(CYGPATH_W) 'src/ags/audio/ags_recall_dependency.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_recall_dependency.c'; fi`

gsequencer-ags_recall_factory.o: src/ags/audio/ags_recall_factory.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recall_factory.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_recall_factory.Tpo -c -o gsequencer-ags_recall_factory.o `test -f 'src/ags/audio/ags_recall_factory.c' || echo '$(srcdir)/'`src/ags/audio/ags_recall_factory.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recall_factory.Tpo $(DEPDIR)/gsequencer-ags_recall_factory.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recall_factory.c' object='gsequencer-ags_recall_factory.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recall_factory.o `test -f 'src/ags/audio/ags_recall_factory.c' || echo '$(srcdir)/'`src/ags/audio/ags_recall_factory.c

gsequencer-ags_recall_factory.obj: src/ags/audio/ags_recall_factory.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recall_factory.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_recall_factory.Tpo -c -o gsequencer-ags_recall_factory.obj `if test -f 'src/ags/audio/ags_recall_factory.c'; then $(CYGPATH_W) 'src/ags/audio/ags_recall_factory.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_recall_factory.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recall_factory.Tpo $(DEPDIR)/gsequencer-ags_recall_factory.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recall_factory.c' object='gsequencer-ags_recall_factory.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recall_factory.obj `if test -f 'src/ags/audio/ags_recall_factory.c'; then $(CYGPATH_W) 'src/ags/audio/ags_recall_factory.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_recall_factory.c'; fi`

gsequencer-ags_recall_id.o: src/ags/audio/ags_recall_id.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recall_id.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_recall_id.Tpo -c -o gsequencer-ags_recall_id.o `test -f 'src/ags/audio/ags_recall_id.c' || echo '$(srcdir)/'`src/ags/audio/ags_recall_id.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recall_id.Tpo $(DEPDIR)/gsequencer-ags_recall_id.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recall_id.c' object='gsequencer-ags_recall_id.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recall_id.o `test -f 'src/ags/audio/ags_recall_id.c' || echo '$(srcdir)/'`src/ags/audio/ags_recall_id.c

gsequencer-ags_recall_id.obj: src/ags/audio/ags_recall_id.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recall_id.Tpo $(DEPDIR)/gsequencer-ags_recall_id.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recall_id.c' object='gsequencer-ags_recall_id.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recall_id.obj `if test -f 'src/ags/audio/ags_recall_id.c'; then $(CYGPATH_W) 'src/ags/audio/ags_recall_id.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_recall_id.c'; fi`

gsequencer-ags_recall_ladspa.o: src/ags/audio/ags_recall_ladspa.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recall_ladspa.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_recall_ladspa.Tpo -c -o gsequencer-ags_recall_ladspa.o `test -f 'src/ags/audio/ags_recall_ladspa.c' || echo '$(srcdir)/'`src/ags/audio/ags_recall_ladspa.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recall_ladspa.Tpo $(DEPDIR)/gsequencer-ags_recall_ladspa.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recall_ladspa.c' object='gsequencer-ags_recall_ladspa.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recall_ladspa.o `test -f 'src/ags/audio/ags_recall_ladspa.c' || echo '$(srcdir)/'`src/ags/audio/ags_recall_ladspa.c

gsequencer-ags_recall_ladspa.obj: src/ags/audio/ags_recall_ladspa.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recall_ladspa.Tpo $(DEPDIR)/gsequencer-ags_recall_ladspa.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recall_ladspa.c' object='gsequencer-ags_recall_ladspa.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recall_ladspa.obj `if test -f 'src/ags/audio/ags_recall_ladspa.c'; then $(CYGPATH_W) 'src/ags/audio/ags_recall_ladspa.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_recall_ladspa.c'; fi`

gsequencer-ags_recall_ladspa_run.o: src/ags/audio/ags_recall_ladspa_run.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recall_ladspa_run.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_recall_ladspa_run.Tpo -c -o gsequencer-ags_recall_ladspa_run.o `test -f 'src/ags/audio/ags_recall_ladspa_run.c' || echo '$(srcdir)/'`src/ags/audio/ags_recall_ladspa_run.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recall_ladspa_run.Tpo $(DEPDIR)/gsequencer-ags_recall_ladspa_run.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recall_ladspa_run.c' object='gsequencer-ags_recall_ladspa_run.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recall_ladspa_run.o `test -f 'src/ags/audio/ags_recall_ladspa_run.c' || echo '$(srcdir)/'`src/ags/audio/ags_recall_ladspa_run.c

gsequencer-ags_recall_ladspa_run.obj: src/ags/audio/ags_recall_ladspa_run.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recall_ladspa_run.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_recall_ladspa_run.Tpo -c -o gsequencer-ags_recall_ladspa_run.obj `if test -f 'src/ags/audio/ags_recall_ladspa_run.c'; then $(CYGPATH_W) 'src/ags/audio/ags_recall_ladspa_run.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_recall_ladspa_run.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recall_ladspa_run.Tpo $(DEPDIR)/gsequencer-ags_recall_ladspa_run.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recall_ladspa_run.c' object='gsequencer-ags_recall_ladspa_run.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recall_ladspa_run.obj `if test -f 'src/ags/audio/ags_recall_ladspa_run.c'; then $(CYGPATH_W) 'src/ags/audio/ags_recall_ladspa_run.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_recall_ladspa_run.c'; fi`

gsequencer-ags_recall_recycling.o: src/ags/audio/ags_recall_recycling.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recall_recycling.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_recall_recycling.Tpo -c -o gsequencer-ags_recall_recycling.o `test -f 'src/ags/audio/ags_recall_recycling.c' || echo '$(srcdir)/'`src/ags/audio/ags_recall_recycling.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recall_recycling.Tpo $(DEPDIR)/gsequencer-ags_recall_recycling.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recall_recycling.c' object='gsequencer-ags_recall_recycling.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recall_recycling.o `test -f 'src/ags/audio/ags_recall_recycling.c' || echo '$(srcdir)/'`src/ags/audio/ags_recall_recycling.c

gsequencer-ags_recall_recycling.obj: src/ags/audio/ags_recall_recycling.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recall_recycling.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_recall_recycling.Tpo -c -o gsequencer-ags_recall_recycling.obj `if test -f 'src/ags/audio/ags_recall_recycling.c'; then $(CYGPATH_W) 'src/ags/audio/ags_recall_recycling.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_recall_recycling.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recall_recycling.Tpo $(DEPDIR)/gsequencer-ags_recall_recycling.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recall_recycling.c' object='gsequencer-ags_recall_recycling.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recall_recycling.obj `if test -f 'src/ags/audio/ags_recall_recycling.c'; then $(CYGPATH_W) 'src/ags/audio/ags_recall_recycling.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_recall_recycling.c'; fi`

gsequencer-ags_recall_recycling_dummy.o: src/ags/audio/ags_recall_recycling_dummy.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recall_recycling_dummy.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_recall_recycling_dummy.Tpo -c -o gsequencer-ags_recall_recycling_dummy.o `test -f 'src/ags/audio/ags_recall_recycling_dummy.c' || echo '$(srcdir)/'`src/ags/audio/ags_recall_recycling_dummy.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recall_recycling_dummy.Tpo $(DEPDIR)/gsequencer-ags_recall_recycling_dummy.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recall_recycling_dummy.c' object='gsequencer-ags_recall_recycling_dummy.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recall_recycling_dummy.o `test -f 'src/ags/audio/ags_recall_recycling_dummy.c' || echo '$(srcdir)/'`src/ags/audio/ags_recall_recycling_dummy.c

gsequencer-ags_recall_recycling_dummy.obj: src/ags/audio/ags_recall_recycling_dummy.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recall_recycling_dummy.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_recall_recycling_dummy.Tpo -c -o gsequencer-ags_recall_recycling_dummy.obj `if test -f 'src/ags/audio/ags_recall_recycling_dummy.c'; then $(CYGPATH_W) 'src/ags/audio/ags_recall_recycling_dummy.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_recall_recycling_dummy.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recall_recycling_dummy.Tpo $(DEPDIR)/gsequencer-ags_recall_recycling_dummy.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recall_recycling_dummy.c' object='gsequencer-ags_recall_recycling_dummy.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recall_recycling_dummy.obj `if test -f 'src/ags/audio/ags_recall_recycling_dummy.c'; then $(CYGPATH_W) 'src/ags/audio/ags_recall_recycling_dummy.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_recall_recycling_dummy.c'; fi`

gsequencer-ags_recycling.o: src/ags/audio/ags_recycling.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recycling.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_recycling.Tpo -c -o gsequencer-ags_recycling.o `test -f 'src/ags/audio/ags_recycling.c' || echo '$(srcdir)/'`src/ags/audio/ags_recycling.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recycling.Tpo $(DEPDIR)/gsequencer-ags_recycling.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recycling.c' object='gsequencer-ags_recycling.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recycling.o `test -f 'src/ags/audio/ags_recycling.c' || echo '$(srcdir)/'`src/ags/audio/ags_recycling.c

gsequencer-ags_recycling.obj: src/ags/audio/ags_recycling.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recycling.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_recycling.Tpo -c -o gsequencer-ags_recycling.obj `if test -f 'src/ags/audio/ags_recycling.c'; then $(CYGPATH_W) 'src/ags/audio/ags_recycling.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_recycling.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recycling.Tpo $(DEPDIR)/gsequencer-ags_recycling.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recycling.c' object='gsequencer-ags_recycling.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recycling.obj `if test -f 'src/ags/audio/ags_recycling.c'; then $(CYGPATH_W) 'src/ags/audio/ags_recycling.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_recycling.c'; fi`

gsequencer-ags_recycling_container.o: src/ags/audio/ags_recycling_container.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recycling_container.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_recycling_container.Tpo -c -o gsequencer-ags_recycling_container.o `test -f 'src/ags/audio/ags_recycling_container.c' || echo '$(srcdir)/'`src/ags/audio/ags_recycling_container.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recycling_container.Tpo $(DEPDIR)/gsequencer-ags_recycling_container.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recycling_container.c' object='gsequencer-ags_recycling_container.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recycling_container.o `test -f 'src/ags/audio/ags_recycling_container.c' || echo '$(srcdir)/'`src/ags/audio/ags_recycling_container.c

gsequencer-ags_recycling_container.obj: src/ags/audio/ags_recycling_container.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recycling_container.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_recycling_container.Tpo -c -o gsequencer-ags_recycling_container.obj `if test -f 'src/ags/audio/ags_recycling_container.c'; then $(CYGPATH_W) 'src/ags/audio/ags_recycling_container.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_recycling_container.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recycling_container.Tpo $(DEPDIR)/gsequencer-ags_recycling_container.Po
#	$(AM_V_CC)source='src/ags/audio/ags_recycling_container.c' object='gsequencer-ags_recycling_container.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recycling_container.obj `if test -f 'src/ags/audio/ags_recycling_container.c'; then $(CYGPATH_W) 'src/ags/audio/ags_recycling_container.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_recycling_container.c'; fi`

gsequencer-ags_synths.o: src/ags/audio/ags_synths.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_synths.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_synths.Tpo -c -o gsequencer-ags_synths.o `test -f 'src/ags/audio/ags_synths.c' || echo '$(srcdir)/'`src/ags/audio/ags_synths.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_synths.Tpo $(DEPDIR)/gsequencer-ags_synths.Po
#	$(AM_V_CC)source='src/ags/audio/ags_synths.c' object='gsequencer-ags_synths.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_synths.o `test -f 'src/ags/audio/ags_synths.c' || echo '$(srcdir)/'`src/ags/audio/ags_synths.c

gsequencer-ags_synths.obj: src/ags/audio/ags_synths.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_synths.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_synths.Tpo -c -o gsequencer-ags_synths.obj `if test -f 'src/ags/audio/ags_synths.c'; then $(CYGPATH_W) 'src/ags/audio/ags_synths.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_synths.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_synths.Tpo $(DEPDIR)/gsequencer-ags_synths.Po
#	$(AM_V_CC)source='src/ags/audio/ags_synths.c' object='gsequencer-ags_synths.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_synths.obj `if test -f 'src/ags/audio/ags_synths.c'; then $(CYGPATH_W) 'src/ags/audio/ags_synths.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_synths.c'; fi`

gsequencer-ags_task.o: src/ags/audio/ags_task.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_task.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_task.Tpo -c -o gsequencer-ags_task.o `test -f 'src/ags/audio/ags_task.c' || echo '$(srcdir)/'`src/ags/audio/ags_task.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_task.Tpo $(DEPDIR)/gsequencer-ags_task.Po
#	$(AM_V_CC)source='src/ags/audio/ags_task.c' object='gsequencer-ags_task.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_task.o `test -f 'src/ags/audio/ags_task.c' || echo '$(srcdir)/'`src/ags/audio/ags_task.c

gsequencer-ags_task.obj: src/ags/audio/ags_task.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_task.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_task.Tpo -c -o gsequencer-ags_task.obj `if test -f 'src/ags/audio/ags_task.c'; then $(CYGPATH_W) 'src/ags/audio/ags_task.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_task.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_task.Tpo $(DEPDIR)/gsequencer-ags_task.Po
#	$(AM_V_CC)source='src/ags/audio/ags_task.c' object='gsequencer-ags_task.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_task.obj `if test -f 'src/ags/audio/ags_task.c'; then $(CYGPATH_W) 'src/ags/audio/ags_task.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_task.c'; fi`

gsequencer-ags_timestamp.o: src/ags/audio/ags_timestamp.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_timestamp.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_timestamp.Tpo -c -o gsequencer-ags_timestamp.o `test -f 'src/ags/audio/ags_timestamp.c' || echo '$(srcdir)/'`src/ags/audio/ags_timestamp.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_timestamp.Tpo $(DEPDIR)/gsequencer-ags_timestamp.Po
#	$(AM_V_CC)source='src/ags/audio/ags_timestamp.c' object='gsequencer-ags_timestamp.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_timestamp.o `test -f 'src/ags/audio/ags_timestamp.c' || echo '$(srcdir)/'`src/ags/audio/ags_timestamp.c

gsequencer-ags_timestamp.obj: src/ags/audio/ags_timestamp.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_timestamp.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_timestamp.Tpo -c -o gsequencer-ags_timestamp.obj `if test -f 'src/ags/audio/ags_timestamp.c'; then $(CYGPATH_W) 'src/ags/audio/ags_timestamp.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_timestamp.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_timestamp.Tpo $(DEPDIR)/gsequencer-ags_timestamp.Po
#	$(AM_V_CC)source='src/ags/audio/ags_timestamp.c' object='gsequencer-ags_timestamp.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_timestamp.obj `if test -f 'src/ags/audio/ags_timestamp.c'; then $(CYGPATH_W) 'src/ags/audio/ags_timestamp.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_timestamp.c'; fi`

gsequencer-ags_timestamp_factory.o: src/ags/audio/ags_timestamp_factory.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_timestamp_factory.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_timestamp_factory.Tpo -c -o gsequencer-ags_timestamp_factory.o `test -f 'src/ags/audio/ags_timestamp_factory.c' || echo '$(srcdir)/'`src/ags/audio/ags_timestamp_factory.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_timestamp_factory.Tpo $(DEPDIR)/gsequencer-ags_timestamp_factory.Po
#	$(AM_V_CC)source='src/ags/audio/ags_timestamp_factory.c' object='gsequencer-ags_timestamp_factory.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_timestamp_factory.o `test -f 'src/ags/audio/ags_timestamp_factory.c' || echo '$(srcdir)/'`src/ags/audio/ags_timestamp_factory.c

gsequencer-ags_timestamp_factory.obj: src/ags/audio/ags_timestamp_factory.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_timestamp_factory.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_timestamp_factory.Tpo -c -o gsequencer-ags_timestamp_factory.obj `if test -f 'src/ags/audio/ags_timestamp_factory.c'; then $(CYGPATH_W) 'src/ags/audio/ags_timestamp_factory.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_timestamp_factory.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_timestamp_factory.Tpo $(DEPDIR)/gsequencer-ags_timestamp_factory.Po
#	$(AM_V_CC)source='src/ags/audio/ags_timestamp_factory.c' object='gsequencer-ags_timestamp_factory.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_timestamp_factory.obj `if test -f 'src/ags/audio/ags_timestamp_factory.c'; then $(CYGPATH_W) 'src/ags/audio/ags_timestamp_factory.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/ags_timestamp_factory.c'; fi`

gsequencer-ags_audio_file.o: src/ags/audio/file/ags_audio_file.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_audio_file.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_audio_file.Tpo -c -o gsequencer-ags_audio_file.o `test -f 'src/ags/audio/file/ags_audio_file.c' || echo '$(srcdir)/'`src/ags/audio/file/ags_audio_file.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_audio_file.Tpo $(DEPDIR)/gsequencer-ags_audio_file.Po
#	$(AM_V_CC)source='src/ags/audio/file/ags_audio_file.c' object='gsequencer-ags_audio_file.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_audio_file.o `test -f 'src/ags/audio/file/ags_audio_file.c' || echo '$(srcdir)/'`src/ags/audio/file/ags_audio_file.c

gsequencer-ags_audio_file.obj: src/ags/audio/file/ags_audio_file.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_audio_file.Tpo $(DEPDIR)/gsequencer-ags_audio_file.Po
#	$(AM_V_CC)source='src/ags/audio/file/ags_audio_file.c' object='gsequencer-ags_audio_file.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_audio_file.obj `if test -f 'src/ags/audio/file/ags_audio_file.c'; then $(CYGPATH_W) 'src/ags/audio/file/ags_audio_file.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/file/ags_audio_file.c'; fi`

gsequencer-ags_audio_file_xml.o: src/ags/audio/file/ags_audio_file_xml.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_audio_file_xml.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_audio_file_xml.Tpo -c -o gsequencer-ags_audio_file_xml.o `test -f 'src/ags/audio/file/ags_audio_file_xml.c' || echo '$(srcdir)/'`src/ags/audio/file/ags_audio_file_xml.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_audio_file_xml.Tpo $(DEPDIR)/gsequencer-ags_audio_file_xml.Po
#	$(AM_V_CC)source='src/ags/audio/file/ags_audio_file_xml.c' object='gsequencer-ags_audio_file_xml.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_audio_file_xml.o `test -f 'src/ags/audio/file/ags_audio_file_xml.c' || echo '$(srcdir)/'`src/ags/audio/file/ags_audio_file_xml.c

gsequencer-ags_audio_file_xml.obj: src/ags/audio/file/ags_audio_file_xml.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_audio_file_xml.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_audio_file_xml.Tpo -c -o gsequencer-ags_audio_file_xml.obj `if test -f 'src/ags/audio/file/ags_audio_file_xml.c'; then $(CYGPATH_W) 'src/ags/audio/file/ags_audio_file_xml.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/file/ags_audio_file_xml.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_audio_file_xml.Tpo $(DEPDIR)/gsequencer-ags_audio_file_xml.Po
#	$(AM_V_CC)source='src/ags/audio/file/ags_audio_file_xml.c' object='gsequencer-ags_audio_file_xml.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_audio_file_xml.obj `if test -f 'src/ags/audio/file/ags_audio_file_xml.c'; then $(CYGPATH_W) 'src/ags/audio/file/ags_audio_file_xml.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/file/ags_audio_file_xml.c'; fi`

gsequencer-ags_ipatch.o: src/ags/audio/file/ags_ipatch.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_ipatch.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_ipatch.Tpo -c -o gsequencer-ags_ipatch.o `test -f 'src/ags/audio/file/ags_ipatch.c' || echo '$(srcdir)/'`src/ags/audio/file/ags_ipatch.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_ipatch.Tpo $(DEPDIR)/gsequencer-ags_ipatch.Po
#	$(AM_V_CC)source='src/ags/audio/file/ags_ipatch.c' object='gsequencer-ags_ipatch.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_ipatch.o `test -f 'src/ags/audio/file/ags_ipatch.c' || echo '$(srcdir)/'`src/ags/audio/file/ags_ipatch.c

gsequencer-ags_ipatch.obj: src/ags/audio/file/ags_ipatch.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_ipatch.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_ipatch.Tpo -c -o gsequencer-ags_ipatch.obj `if test -f 'src/ags/audio/file/ags_ipatch.c'; then $(CYGPATH_W) 'src/ags/audio/file/ags_ipatch.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/file/ags_ipatch.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_ipatch.Tpo $(DEPDIR)/gsequencer-ags_ipatch.Po
#	$(AM_V_CC)source='src/ags/audio/file/ags_ipatch.c' object='gsequencer-ags_ipatch.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_ipatch.obj `if test -f 'src/ags/audio/file/ags_ipatch.c'; then $(CYGPATH_W) 'src/ags/audio/file/ags_ipatch.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/file/ags_ipatch.c'; fi`

gsequencer-ags_ipatch_sf2_reader.o: src/ags/audio/file/ags_ipatch_sf2_reader.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_ipatch_sf2_reader.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_ipatch_sf2_reader.Tpo -c -o gsequencer-ags_ipatch_sf2_reader.o `test -f 'src/ags/audio/file/ags_ipatch_sf2_reader.c' || echo '$(srcdir)/'`src/ags/audio/file/ags_ipatch_sf2_reader.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_ipatch_sf2_reader.Tpo $(DEPDIR)/gsequencer-ags_ipatch_sf2_reader.Po
#	$(AM_V_CC)source='src/ags/audio/file/ags_ipatch_sf2_reader.c' object='gsequencer-ags_ipatch_sf2_reader.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_ipatch_sf2_reader.o `test -f 'src/ags/audio/file/ags_ipatch_sf2_reader.c' || echo '$(srcdir)/'`src/ags/audio/file/ags_ipatch_sf2_reader.c

gsequencer-ags_ipatch_sf2_reader.obj: src/ags/audio/file/ags_ipatch_sf2_reader.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_ipatch_sf2_reader.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_ipatch_sf2_reader.Tpo -c -o gsequencer-ags_ipatch_sf2_reader.obj `if test -f 'src/ags/audio/file/ags_ipatch_sf2_reader.c'; then $(CYGPATH_W) 'src/ags/audio/file/ags_ipatch_sf2_reader.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/file/ags_ipatch_sf2_reader.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_ipatch_sf2_reader.Tpo $(DEPDIR)/gsequencer-ags_ipatch_sf2_reader.Po
#	$(AM_V_CC)source='src/ags/audio/file/ags_ipatch_sf2_reader.c' object='gsequencer-ags_ipatch_sf2_reader.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_ipatch_sf2_reader.obj `if test -f 'src/ags/audio/file/ags_ipatch_sf2_reader.c'; then $(CYGPATH_W) 'src/ags/audio/file/ags_ipatch_sf2_reader.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/file/ags_ipatch_sf2_reader.c'; fi`

gsequencer-ags_sndfile.o: src/ags/audio/file/ags_sndfile.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_sndfile.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_sndfile.Tpo -c -o gsequencer-ags_sndfile.o `test -f 'src/ags/audio/file/ags_sndfile.c' || echo '$(srcdir)/'`src/ags/audio/file/ags_sndfile.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_sndfile.Tpo $(DEPDIR)/gsequencer-ags_sndfile.Po
#	$(AM_V_CC)source='src/ags/audio/file/ags_sndfile.c' object='gsequencer-ags_sndfile.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_sndfile.o `test -f 'src/ags/audio/file/ags_sndfile.c' || echo '$(srcdir)/'`src/ags/audio/file/ags_sndfile.c

gsequencer-ags_sndfile.obj: src/ags/audio/file/ags_sndfile.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_sndfile.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_sndfile.Tpo -c -o gsequencer-ags_sndfile.obj `if test -f 'src/ags/audio/file/ags_sndfile.c'; then $(CYGPATH_W) 'src/ags/audio/file/ags_sndfile.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/file/ags_sndfile.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_sndfile.Tpo $(DEPDIR)/gsequencer-ags_sndfile.Po
#	$(AM_V_CC)source='src/ags/audio/file/ags_sndfile.c' object='gsequencer-ags_sndfile.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_sndfile.obj `if test -f 'src/ags/audio/file/ags_sndfile.c'; then $(CYGPATH_W) 'src/ags/audio/file/ags_sndfile.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/file/ags_sndfile.c'; fi`

gsequencer-ags_amplifier.o: src/ags/audio/recall/ags_amplifier.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_amplifier.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_amplifier.Tpo -c -o gsequencer-ags_amplifier.o `test -f 'src/ags/audio/recall/ags_amplifier.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_amplifier.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_amplifier.Tpo $(DEPDIR)/gsequencer-ags_amplifier.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_amplifier.c' object='gsequencer-ags_amplifier.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_amplifier.o `test -f 'src/ags/audio/recall/ags_amplifier.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_amplifier.c

gsequencer-ags_amplifier.obj: src/ags/audio/recall/ags_amplifier.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_amplifier.Tpo $(DEPDIR)/gsequencer-ags_amplifier.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_amplifier.c' object='gsequencer-ags_amplifier.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_amplifier.obj `if test -f 'src/ags/audio/recall/ags_amplifier.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_amplifier.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_amplifier.c'; fi`

gsequencer-ags_buffer_audio_signal.o: src/ags/audio/recall/ags_buffer_audio_signal.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_buffer_audio_signal.Tpo $(DEPDIR)/gsequencer-ags_buffer_audio_signal.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_buffer_audio_signal.c' object='gsequencer-ags_buffer_audio_signal.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_buffer_audio_signal.o `test -f 'src/ags/audio/recall/ags_buffer_audio_signal.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_buffer_audio_signal.c

gsequencer-ags_buffer_audio_signal.obj: src/ags/audio/recall/ags_buffer_audio_signal.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_buffer_audio_signal.Tpo $(DEPDIR)/gsequencer-ags_buffer_audio_signal.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_buffer_audio_signal.c' object='gsequencer-ags_buffer_audio_signal.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_buffer_audio_signal.obj `if test -f 'src/ags/audio/recall/ags_buffer_audio_signal.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_buffer_audio_signal.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_buffer_audio_signal.c'; fi`

gsequencer-ags_buffer_channel.o: src/ags/audio/recall/ags_buffer_channel.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_buffer_channel.Tpo $(DEPDIR)/gsequencer-ags_buffer_channel.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_buffer_channel.c' object='gsequencer-ags_buffer_channel.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_buffer_channel.o `test -f 'src/ags/audio/recall/ags_buffer_channel.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_buffer_channel.c

gsequencer-ags_buffer_channel.obj: src/ags/audio/recall/ags_buffer_channel.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_buffer_channel.Tpo $(DEPDIR)/gsequencer-ags_buffer_channel.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_buffer_channel.c' object='gsequencer-ags_buffer_channel.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_buffer_channel.obj `if test -f 'src/ags/audio/recall/ags_buffer_channel.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_buffer_channel.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_buffer_channel.c'; fi`

gsequencer-ags_buffer_channel_run.o: src/ags/audio/recall/ags_buffer_channel_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_buffer_channel_run.Tpo $(DEPDIR)/gsequencer-ags_buffer_channel_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_buffer_channel_run.c' object='gsequencer-ags_buffer_channel_run.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_buffer_channel_run.o `test -f 'src/ags/audio/recall/ags_buffer_channel_run.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_buffer_channel_run.c

gsequencer-ags_buffer_channel_run.obj: src/ags/audio/recall/ags_buffer_channel_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_buffer_channel_run.Tpo $(DEPDIR)/gsequencer-ags_buffer_channel_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_buffer_channel_run.c' object='gsequencer-ags_buffer_channel_run.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_buffer_channel_run.obj `if test -f 'src/ags/audio/recall/ags_buffer_channel_run.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_buffer_channel_run.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_buffer_channel_run.c'; fi`

gsequencer-ags_buffer_recycling.o: src/ags/audio/recall/ags_buffer_recycling.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_buffer_recycling.Tpo $(DEPDIR)/gsequencer-ags_buffer_recycling.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_buffer_recycling.c' object='gsequencer-ags_buffer_recycling.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_buffer_recycling.o `test -f 'src/ags/audio/recall/ags_buffer_recycling.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_buffer_recycling.c

gsequencer-ags_buffer_recycling.obj: src/ags/audio/recall/ags_buffer_recycling.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_buffer_recycling.Tpo $(DEPDIR)/gsequencer-ags_buffer_recycling.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_buffer_recycling.c' object='gsequencer-ags_buffer_recycling.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_buffer_recycling.obj `if test -f 'src/ags/audio/recall/ags_buffer_recycling.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_buffer_recycling.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_buffer_recycling.c'; fi`

gsequencer-ags_clone_channel.o: src/ags/audio/recall/ags_clone_channel.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_clone_channel.Tpo $(DEPDIR)/gsequencer-ags_clone_channel.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_clone_channel.c' object='gsequencer-ags_clone_channel.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_clone_channel.o `test -f 'src/ags/audio/recall/ags_clone_channel.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_clone_channel.c

gsequencer-ags_clone_channel.obj: src/ags/audio/recall/ags_clone_channel.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_clone_channel.Tpo $(DEPDIR)/gsequencer-ags_clone_channel.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_clone_channel.c' object='gsequencer-ags_clone_channel.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_clone_channel.obj `if test -f 'src/ags/audio/recall/ags_clone_channel.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_clone_channel.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_clone_channel.c'; fi`

gsequencer-ags_clone_channel_run.o: src/ags/audio/recall/ags_clone_channel_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_clone_channel_run.Tpo $(DEPDIR)/gsequencer-ags_clone_channel_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_clone_channel_run.c' object='gsequencer-ags_clone_channel_run.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_clone_channel_run.o `test -f 'src/ags/audio/recall/ags_clone_channel_run.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_clone_channel_run.c

gsequencer-ags_clone_channel_run.obj: src/ags/audio/recall/ags_clone_channel_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_clone_channel_run.Tpo $(DEPDIR)/gsequencer-ags_clone_channel_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_clone_channel_run.c' object='gsequencer-ags_clone_channel_run.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_clone_channel_run.obj `if test -f 'src/ags/audio/recall/ags_clone_channel_run.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_clone_channel_run.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_clone_channel_run.c'; fi`

gsequencer-ags_copy_audio_signal.o: src/ags/audio/recall/ags_copy_audio_signal.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_copy_audio_signal.Tpo $(DEPDIR)/gsequencer-ags_copy_audio_signal.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_copy_audio_signal.c' object='gsequencer-ags_copy_audio_signal.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_copy_audio_signal.o `test -f 'src/ags/audio/recall/ags_copy_audio_signal.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_copy_audio_signal.c

gsequencer-ags_copy_audio_signal.obj: src/ags/audio/recall/ags_copy_audio_signal.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_copy_audio_signal.Tpo $(DEPDIR)/gsequencer-ags_copy_audio_signal.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_copy_audio_signal.c' object='gsequencer-ags_copy_audio_signal.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_copy_audio_signal.obj `if test -f 'src/ags/audio/recall/ags_copy_audio_signal.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_copy_audio_signal.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_copy_audio_signal.c'; fi`

gsequencer-ags_copy_channel.o: src/ags/audio/recall/ags_copy_channel.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_copy_channel.Tpo $(DEPDIR)/gsequencer-ags_copy_channel.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_copy_channel.c' object='gsequencer-ags_copy_channel.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_copy_channel.o `test -f 'src/ags/audio/recall/ags_copy_channel.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_copy_channel.c

gsequencer-ags_copy_channel.obj: src/ags/audio/recall/ags_copy_channel.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_copy_channel.Tpo $(DEPDIR)/gsequencer-ags_copy_channel.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_copy_channel.c' object='gsequencer-ags_copy_channel.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_copy_channel.obj `if test -f 'src/ags/audio/recall/ags_copy_channel.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_copy_channel.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_copy_channel.c'; fi`

gsequencer-ags_copy_channel_run.o: src/ags/audio/recall/ags_copy_channel_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_copy_channel_run.Tpo $(DEPDIR)/gsequencer-ags_copy_channel_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_copy_channel_run.c' object='gsequencer-ags_copy_channel_run.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_copy_channel_run.o `test -f 'src/ags/audio/recall/ags_copy_channel_run.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_copy_channel_run.c

gsequencer-ags_copy_channel_run.obj: src/ags/audio/recall/ags_copy_channel_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_copy_channel_run.Tpo $(DEPDIR)/gsequencer-ags_copy_channel_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_copy_channel_run.c' object='gsequencer-ags_copy_channel_run.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_copy_channel_run.obj `if test -f 'src/ags/audio/recall/ags_copy_channel_run.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_copy_channel_run.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_copy_channel_run.c'; fi`

gsequencer-ags_copy_notation_audio.o: src/ags/audio/recall/ags_copy_notation_audio.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_copy_notation_audio.Tpo $(DEPDIR)/gsequencer-ags_copy_notation_audio.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_copy_notation_audio.c' object='gsequencer-ags_copy_notation_audio.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_copy_notation_audio.o `test -f 'src/ags/audio/recall/ags_copy_notation_audio.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_copy_notation_audio.c

gsequencer-ags_copy_notation_audio.obj: src/ags/audio/recall/ags_copy_notation_audio.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_copy_notation_audio.Tpo $(DEPDIR)/gsequencer-ags_copy_notation_audio.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_copy_notation_audio.c' object='gsequencer-ags_copy_notation_audio.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_copy_notation_audio.obj `if test -f 'src/ags/audio/recall/ags_copy_notation_audio.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_copy_notation_audio.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_copy_notation_audio.c'; fi`

gsequencer-ags_copy_notation_audio_run.o: src/ags/audio/recall/ags_copy_notation_audio_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_copy_notation_audio_run.Tpo $(DEPDIR)/gsequencer-ags_copy_notation_audio_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_copy_notation_audio_run.c' object='gsequencer-ags_copy_notation_audio_run.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_copy_notation_audio_run.o `test -f 'src/ags/audio/recall/ags_copy_notation_audio_run.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_copy_notation_audio_run.c

gsequencer-ags_copy_notation_audio_run.obj: src/ags/audio/recall/ags_copy_notation_audio_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_copy_notation_audio_run.Tpo $(DEPDIR)/gsequencer-ags_copy_notation_audio_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_copy_notation_audio_run.c' object='gsequencer-ags_copy_notation_audio_run.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_copy_notation_audio_run.obj `if test -f 'src/ags/audio/recall/ags_copy_notation_audio_run.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_copy_notation_audio_run.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_copy_notation_audio_run.c'; fi`

gsequencer-ags_copy_pattern_audio.o: src/ags/audio/recall/ags_copy_pattern_audio.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_copy_pattern_audio.Tpo $(DEPDIR)/gsequencer-ags_copy_pattern_audio.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_copy_pattern_audio.c' object='gsequencer-ags_copy_pattern_audio.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_copy_pattern_audio.o `test -f 'src/ags/audio/recall/ags_copy_pattern_audio.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_copy_pattern_audio.c

gsequencer-ags_copy_pattern_audio.obj: src/ags/audio/recall/ags_copy_pattern_audio.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_copy_pattern_audio.Tpo $(DEPDIR)/gsequencer-ags_copy_pattern_audio.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_copy_pattern_audio.c' object='gsequencer-ags_copy_pattern_audio.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_copy_pattern_audio.obj `if test -f 'src/ags/audio/recall/ags_copy_pattern_audio.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_copy_pattern_audio.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_copy_pattern_audio.c'; fi`

gsequencer-ags_copy_pattern_audio_run.o: src/ags/audio/recall/ags_copy_pattern_audio_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_copy_pattern_audio_run.Tpo $(DEPDIR)/gsequencer-ags_copy_pattern_audio_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_copy_pattern_audio_run.c' object='gsequencer-ags_copy_pattern_audio_run.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_copy_pattern_audio_run.o `test -f 'src/ags/audio/recall/ags_copy_pattern_audio_run.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_copy_pattern_audio_run.c

gsequencer-ags_copy_pattern_audio_run.obj: src/ags/audio/recall/ags_copy_pattern_audio_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_copy_pattern_audio_run.Tpo $(DEPDIR)/gsequencer-ags_copy_pattern_audio_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_copy_pattern_audio_run.c' object='gsequencer-ags_copy_pattern_audio_run.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_copy_pattern_audio_run.obj `if test -f 'src/ags/audio/recall/ags_copy_pattern_audio_run.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_copy_pattern_audio_run.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_copy_pattern_audio_run.c'; fi`

gsequencer-ags_copy_pattern_channel.o: src/ags/audio/recall/ags_copy_pattern_channel.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_copy_pattern_channel.Tpo $(DEPDIR)/gsequencer-ags_copy_pattern_channel.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_copy_pattern_channel.c' object='gsequencer-ags_copy_pattern_channel.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_copy_pattern_channel.o `test -f 'src/ags/audio/recall/ags_copy_pattern_channel.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_copy_pattern_channel.c

gsequencer-ags_copy_pattern_channel.obj: src/ags/audio/recall/ags_copy_pattern_channel.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_copy_pattern_channel.Tpo $(DEPDIR)/gsequencer-ags_copy_pattern_channel.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_copy_pattern_channel.c' object='gsequencer-ags_copy_pattern_channel.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_copy_pattern_channel.obj `if test -f 'src/ags/audio/recall/ags_copy_pattern_channel.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_copy_pattern_channel.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_copy_pattern_channel.c'; fi`

gsequencer-ags_copy_pattern_channel_run.o: src/ags/audio/recall/ags_copy_pattern_channel_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_copy_pattern_channel_run.Tpo $(DEPDIR)/gsequencer-ags_copy_pattern_channel_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_copy_pattern_channel_run.c' object='gsequencer-ags_copy_pattern_channel_run.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_copy_pattern_channel_run.o `test -f 'src/ags/audio/recall/ags_copy_pattern_channel_run.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_copy_pattern_channel_run.c

gsequencer-ags_copy_pattern_channel_run.obj: src/ags/audio/recall/ags_copy_pattern_channel_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_copy_pattern_channel_run.Tpo $(DEPDIR)/gsequencer-ags_copy_pattern_channel_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_copy_pattern_channel_run.c' object='gsequencer-ags_copy_pattern_channel_run.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_copy_pattern_channel_run.obj `if test -f 'src/ags/audio/recall/ags_copy_pattern_channel_run.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_copy_pattern_channel_run.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_copy_pattern_channel_run.c'; fi`

gsequencer-ags_copy_recycling.o: src/ags/audio/recall/ags_copy_recycling.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_copy_recycling.Tpo $(DEPDIR)/gsequencer-ags_copy_recycling.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_copy_recycling.c' object='gsequencer-ags_copy_recycling.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_copy_recycling.o `test -f 'src/ags/audio/recall/ags_copy_recycling.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_copy_recycling.c

gsequencer-ags_copy_recycling.obj: src/ags/audio/recall/ags_copy_recycling.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_copy_recycling.Tpo $(DEPDIR)/gsequencer-ags_copy_recycling.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_copy_recycling.c' object='gsequencer-ags_copy_recycling.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_copy_recycling.obj `if test -f 'src/ags/audio/recall/ags_copy_recycling.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_copy_recycling.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_copy_recycling.c'; fi`

gsequencer-ags_count_beats_audio.o: src/ags/audio/recall/ags_count_beats_audio.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_count_beats_audio.Tpo $(DEPDIR)/gsequencer-ags_count_beats_audio.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_count_beats_audio.c' object='gsequencer-ags_count_beats_audio.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_count_beats_audio.o `test -f 'src/ags/audio/recall/ags_count_beats_audio.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_count_beats_audio.c

gsequencer-ags_count_beats_audio.obj: src/ags/audio/recall/ags_count_beats_audio.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_count_beats_audio.Tpo $(DEPDIR)/gsequencer-ags_count_beats_audio.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_count_beats_audio.c' object='gsequencer-ags_count_beats_audio.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_count_beats_audio.obj `if test -f 'src/ags/audio/recall/ags_count_beats_audio.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_count_beats_audio.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_count_beats_audio.c'; fi`

gsequencer-ags_count_beats_audio_run.o: src/ags/audio/recall/ags_count_beats_audio_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_count_beats_audio_run.Tpo $(DEPDIR)/gsequencer-ags_count_beats_audio_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_count_beats_audio_run.c' object='gsequencer-ags_count_beats_audio_run.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_count_beats_audio_run.o `test -f 'src/ags/audio/recall/ags_count_beats_audio_run.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_count_beats_audio_run.c

gsequencer-ags_count_beats_audio_run.obj: src/ags/audio/recall/ags_count_beats_audio_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_count_beats_audio_run.Tpo $(DEPDIR)/gsequencer-ags_count_beats_audio_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_count_beats_audio_run.c' object='gsequencer-ags_count_beats_audio_run.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_count_beats_audio_run.obj `if test -f 'src/ags/audio/recall/ags_count_beats_audio_run.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_count_beats_audio_run.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_count_beats_audio_run.c'; fi`

gsequencer-ags_delay_audio.o: src/ags/audio/recall/ags_delay_audio.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_delay_audio.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_delay_audio.Tpo -c -o gsequencer-ags_delay_audio.o `test -f 'src/ags/audio/recall/ags_delay_audio.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_delay_audio.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_delay_audio.Tpo $(DEPDIR)/gsequencer-ags_delay_audio.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_delay_audio.c' object='gsequencer-ags_delay_audio.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_delay_audio.o `test -f 'src/ags/audio/recall/ags_delay_audio.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_delay_audio.c

gsequencer-ags_delay_audio.obj: src/ags/audio/recall/ags_delay_audio.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_delay_audio.Tpo $(DEPDIR)/gsequencer-ags_delay_audio.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_delay_audio.c' object='gsequencer-ags_delay_audio.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_delay_audio.obj `if test -f 'src/ags/audio/recall/ags_delay_audio.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_delay_audio.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_delay_audio.c'; fi`

gsequencer-ags_delay_audio_run.o: src/ags/audio/recall/ags_delay_audio_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_delay_audio_run.Tpo $(DEPDIR)/gsequencer-ags_delay_audio_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_delay_audio_run.c' object='gsequencer-ags_delay_audio_run.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_delay_audio_run.o `test -f 'src/ags/audio/recall/ags_delay_audio_run.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_delay_audio_run.c

gsequencer-ags_delay_audio_run.obj: src/ags/audio/recall/ags_delay_audio_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_delay_audio_run.Tpo $(DEPDIR)/gsequencer-ags_delay_audio_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_delay_audio_run.c' object='gsequencer-ags_delay_audio_run.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_delay_audio_run.obj `if test -f 'src/ags/audio/recall/ags_delay_audio_run.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_delay_audio_run.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_delay_audio_run.c'; fi`

gsequencer-ags_echo.o: src/ags/audio/recall/ags_echo.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_echo.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_echo.Tpo -c -o gsequencer-ags_echo.o `test -f 'src/ags/audio/recall/ags_echo.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_echo.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_echo.Tpo $(DEPDIR)/gsequencer-ags_echo.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_echo.c' object='gsequencer-ags_echo.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_echo.o `test -f 'src/ags/audio/recall/ags_echo.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_echo.c

gsequencer-ags_echo.obj: src/ags/audio/recall/ags_echo.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_echo.Tpo $(DEPDIR)/gsequencer-ags_echo.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_echo.c' object='gsequencer-ags_echo.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_echo.obj `if test -f 'src/ags/audio/recall/ags_echo.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_echo.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_echo.c'; fi`

gsequencer-ags_envelope_audio_signal.o: src/ags/audio/recall/ags_envelope_audio_signal.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_envelope_audio_signal.Tpo $(DEPDIR)/gsequencer-ags_envelope_audio_signal.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_envelope_audio_signal.c' object='gsequencer-ags_envelope_audio_signal.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_envelope_audio_signal.o `test -f 'src/ags/audio/recall/ags_envelope_audio_signal.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_envelope_audio_signal.c

gsequencer-ags_envelope_audio_signal.obj: src/ags/audio/recall/ags_envelope_audio_signal.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_envelope_audio_signal.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_envelope_audio_signal.Tpo -c -o gsequencer-ags_envelope_audio_signal.obj `if test -f 'src/ags/audio/recall/ags_envelope_audio_signal.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_envelope_audio_signal.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_envelope_audio_signal.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_envelope_audio_signal.Tpo $(DEPDIR)/gsequencer-ags_envelope_audio_signal.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_envelope_audio_signal.c' object='gsequencer-ags_envelope_audio_signal.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_envelope_audio_signal.obj `if test -f 'src/ags/audio/recall/ags_envelope_audio_signal.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_envelope_audio_signal.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_envelope_audio_signal.c'; fi`

gsequencer-ags_envelope_channel.o: src/ags/audio/recall/ags_envelope_channel.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_envelope_channel.Tpo $(DEPDIR)/gsequencer-ags_envelope_channel.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_envelope_channel.c' object='gsequencer-ags_envelope_channel.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_envelope_channel.o `test -f 'src/ags/audio/recall/ags_envelope_channel.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_envelope_channel.c

gsequencer-ags_envelope_channel.obj: src/ags/audio/recall/ags_envelope_channel.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_envelope_channel.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_envelope_channel.Tpo -c -o gsequencer-ags_envelope_channel.obj `if test -f 'src/ags/audio/recall/ags_envelope_channel.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_envelope_channel.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_envelope_channel.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_envelope_channel.Tpo $(DEPDIR)/gsequencer-ags_envelope_channel.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_envelope_channel.c' object='gsequencer-ags_envelope_channel.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_envelope_channel.obj `if test -f 'src/ags/audio/recall/ags_envelope_channel.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_envelope_channel.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_envelope_channel.c'; fi`

gsequencer-ags_envelope_channel_run.o: src/ags/audio/recall/ags_envelope_channel_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_envelope_channel_run.Tpo $(DEPDIR)/gsequencer-ags_envelope_channel_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_envelope_channel_run.c' object='gsequencer-ags_envelope_channel_run.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_envelope_channel_run.o `test -f 'src/ags/audio/recall/ags_envelope_channel_run.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_envelope_channel_run.c

gsequencer-ags_envelope_channel_run.obj: src/ags/audio/recall/ags_envelope_channel_run.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_envelope_channel_run.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_envelope_channel_run.Tpo -c -o gsequencer-ags_envelope_channel_run.obj `if test -f 'src/ags/audio/recall/ags_envelope_channel_run.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_envelope_channel_run.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_envelope_channel_run.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_envelope_channel_run.Tpo $(DEPDIR)/gsequencer-ags_envelope_channel_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_envelope_channel_run.c' object='gsequencer-ags_envelope_channel_run.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_envelope_channel_run.obj `if test -f 'src/ags/audio/recall/ags_envelope_channel_run.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_envelope_channel_run.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_envelope_channel_run.c'; fi`

gsequencer-ags_envelope_recycling.o: src/ags/audio/recall/ags_envelope_recycling.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_envelope_recycling.Tpo $(DEPDIR)/gsequencer-ags_envelope_recycling.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_envelope_recycling.c' object='gsequencer-ags_envelope_recycling.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_envelope_recycling.o `test -f 'src/ags/audio/recall/ags_envelope_recycling.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_envelope_recycling.c

gsequencer-ags_envelope_recycling.obj: src/ags/audio/recall/ags_envelope_recycling.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_envelope_recycling.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_envelope_recycling.Tpo -c -o gsequencer-ags_envelope_recycling.obj `if test -f 'src/ags/audio/recall/ags_envelope_recycling.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_envelope_recycling.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_envelope_recycling.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_envelope_recycling.Tpo $(DEPDIR)/gsequencer-ags_envelope_recycling.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_envelope_recycling.c' object='gsequencer-ags_envelope_recycling.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_envelope_recycling.obj `if test -f 'src/ags/audio/recall/ags_envelope_recycling.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_envelope_recycling.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_envelope_recycling.c'; fi`

gsequencer-ags_loop_channel.o: src/ags/audio/recall/ags_loop_channel.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_loop_channel.Tpo $(DEPDIR)/gsequencer-ags_loop_channel.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_loop_channel.c' object='gsequencer-ags_loop_channel.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_loop_channel.o `test -f 'src/ags/audio/recall/ags_loop_channel.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_loop_channel.c

gsequencer-ags_loop_channel.obj: src/ags/audio/recall/ags_loop_channel.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_loop_channel.Tpo $(DEPDIR)/gsequencer-ags_loop_channel.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_loop_channel.c' object='gsequencer-ags_loop_channel.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_loop_channel.obj `if test -f 'src/ags/audio/recall/ags_loop_channel.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_loop_channel.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_loop_channel.c'; fi`

gsequencer-ags_loop_channel_run.o: src/ags/audio/recall/ags_loop_channel_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_loop_channel_run.Tpo $(DEPDIR)/gsequencer-ags_loop_channel_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_loop_channel_run.c' object='gsequencer-ags_loop_channel_run.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_loop_channel_run.o `test -f 'src/ags/audio/recall/ags_loop_channel_run.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_loop_channel_run.c

gsequencer-ags_loop_channel_run.obj: src/ags/audio/recall/ags_loop_channel_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_loop_channel_run.Tpo $(DEPDIR)/gsequencer-ags_loop_channel_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_loop_channel_run.c' object='gsequencer-ags_loop_channel_run.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_loop_channel_run.obj `if test -f 'src/ags/audio/recall/ags_loop_channel_run.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_loop_channel_run.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_loop_channel_run.c'; fi`

gsequencer-ags_mute_audio.o: src/ags/audio/recall/ags_mute_audio.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_mute_audio.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_mute_audio.Tpo -c -o gsequencer-ags_mute_audio.o `test -f 'src/ags/audio/recall/ags_mute_audio.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_mute_audio.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_mute_audio.Tpo $(DEPDIR)/gsequencer-ags_mute_audio.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_mute_audio.c' object='gsequencer-ags_mute_audio.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_mute_audio.o `test -f 'src/ags/audio/recall/ags_mute_audio.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_mute_audio.c

gsequencer-ags_mute_audio.obj: src/ags/audio/recall/ags_mute_audio.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_mute_audio.Tpo $(DEPDIR)/gsequencer-ags_mute_audio.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_mute_audio.c' object='gsequencer-ags_mute_audio.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_mute_audio.obj `if test -f 'src/ags/audio/recall/ags_mute_audio.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_mute_audio.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_mute_audio.c'; fi`

gsequencer-ags_mute_audio_run.o: src/ags/audio/recall/ags_mute_audio_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_mute_audio_run.Tpo $(DEPDIR)/gsequencer-ags_mute_audio_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_mute_audio_run.c' object='gsequencer-ags_mute_audio_run.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_mute_audio_run.o `test -f 'src/ags/audio/recall/ags_mute_audio_run.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_mute_audio_run.c

gsequencer-ags_mute_audio_run.obj: src/ags/audio/recall/ags_mute_audio_run.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_mute_audio_run.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_mute_audio_run.Tpo -c -o gsequencer-ags_mute_audio_run.obj `if test -f 'src/ags/audio/recall/ags_mute_audio_run.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_mute_audio_run.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_mute_audio_run.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_mute_audio_run.Tpo $(DEPDIR)/gsequencer-ags_mute_audio_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_mute_audio_run.c' object='gsequencer-ags_mute_audio_run.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_mute_audio_run.obj `if test -f 'src/ags/audio/recall/ags_mute_audio_run.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_mute_audio_run.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_mute_audio_run.c'; fi`

gsequencer-ags_mute_audio_signal.o: src/ags/audio/recall/ags_mute_audio_signal.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_mute_audio_signal.Tpo $(DEPDIR)/gsequencer-ags_mute_audio_signal.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_mute_audio_signal.c' object='gsequencer-ags_mute_audio_signal.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_mute_audio_signal.o `test -f 'src/ags/audio/recall/ags_mute_audio_signal.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_mute_audio_signal.c

gsequencer-ags_mute_audio_signal.obj: src/ags/audio/recall/ags_mute_audio_signal.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_mute_audio_signal.Tpo $(DEPDIR)/gsequencer-ags_mute_audio_signal.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_mute_audio_signal.c' object='gsequencer-ags_mute_audio_signal.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_mute_audio_signal.obj `if test -f 'src/ags/audio/recall/ags_mute_audio_signal.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_mute_audio_signal.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_mute_audio_signal.c'; fi`

gsequencer-ags_mute_channel.o: src/ags/audio/recall/ags_mute_channel.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_mute_channel.Tpo $(DEPDIR)/gsequencer-ags_mute_channel.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_mute_channel.c' object='gsequencer-ags_mute_channel.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_mute_channel.o `test -f 'src/ags/audio/recall/ags_mute_channel.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_mute_channel.c

gsequencer-ags_mute_channel.obj: src/ags/audio/recall/ags_mute_channel.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_mute_channel.Tpo $(DEPDIR)/gsequencer-ags_mute_channel.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_mute_channel.c' object='gsequencer-ags_mute_channel.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_mute_channel.obj `if test -f 'src/ags/audio/recall/ags_mute_channel.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_mute_channel.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_mute_channel.c'; fi`

gsequencer-ags_mute_channel_run.o: src/ags/audio/recall/ags_mute_channel_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_mute_channel_run.Tpo $(DEPDIR)/gsequencer-ags_mute_channel_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_mute_channel_run.c' object='gsequencer-ags_mute_channel_run.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_mute_channel_run.o `test -f 'src/ags/audio/recall/ags_mute_channel_run.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_mute_channel_run.c

gsequencer-ags_mute_channel_run.obj: src/ags/audio/recall/ags_mute_channel_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_mute_channel_run.Tpo $(DEPDIR)/gsequencer-ags_mute_channel_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_mute_channel_run.c' object='gsequencer-ags_mute_channel_run.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_mute_channel_run.obj `if test -f 'src/ags/audio/recall/ags_mute_channel_run.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_mute_channel_run.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_mute_channel_run.c'; fi`

gsequencer-ags_mute_recycling.o: src/ags/audio/recall/ags_mute_recycling.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_mute_recycling.Tpo $(DEPDIR)/gsequencer-ags_mute_recycling.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_mute_recycling.c' object='gsequencer-ags_mute_recycling.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_mute_recycling.o `test -f 'src/ags/audio/recall/ags_mute_recycling.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_mute_recycling.c

gsequencer-ags_mute_recycling.obj: src/ags/audio/recall/ags_mute_recycling.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_mute_recycling.Tpo $(DEPDIR)/gsequencer-ags_mute_recycling.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_mute_recycling.c' object='gsequencer-ags_mute_recycling.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_mute_recycling.obj `if test -f 'src/ags/audio/recall/ags_mute_recycling.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_mute_recycling.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_mute_recycling.c'; fi`

gsequencer-ags_peak_audio_signal.o: src/ags/audio/recall/ags_peak_audio_signal.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_peak_audio_signal.Tpo $(DEPDIR)/gsequencer-ags_peak_audio_signal.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_peak_audio_signal.c' object='gsequencer-ags_peak_audio_signal.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_peak_audio_signal.o `test -f 'src/ags/audio/recall/ags_peak_audio_signal.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_peak_audio_signal.c

gsequencer-ags_peak_audio_signal.obj: src/ags/audio/recall/ags_peak_audio_signal.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_peak_audio_signal.Tpo $(DEPDIR)/gsequencer-ags_peak_audio_signal.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_peak_audio_signal.c' object='gsequencer-ags_peak_audio_signal.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_peak_audio_signal.obj `if test -f 'src/ags/audio/recall/ags_peak_audio_signal.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_peak_audio_signal.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_peak_audio_signal.c'; fi`

gsequencer-ags_peak_channel.o: src/ags/audio/recall/ags_peak_channel.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_peak_channel.Tpo $(DEPDIR)/gsequencer-ags_peak_channel.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_peak_channel.c' object='gsequencer-ags_peak_channel.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_peak_channel.o `test -f 'src/ags/audio/recall/ags_peak_channel.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_peak_channel.c

gsequencer-ags_peak_channel.obj: src/ags/audio/recall/ags_peak_channel.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_peak_channel.Tpo $(DEPDIR)/gsequencer-ags_peak_channel.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_peak_channel.c' object='gsequencer-ags_peak_channel.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_peak_channel.obj `if test -f 'src/ags/audio/recall/ags_peak_channel.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_peak_channel.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_peak_channel.c'; fi`

gsequencer-ags_peak_channel_run.o: src/ags/audio/recall/ags_peak_channel_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_peak_channel_run.Tpo $(DEPDIR)/gsequencer-ags_peak_channel_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_peak_channel_run.c' object='gsequencer-ags_peak_channel_run.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_peak_channel_run.o `test -f 'src/ags/audio/recall/ags_peak_channel_run.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_peak_channel_run.c

gsequencer-ags_peak_channel_run.obj: src/ags/audio/recall/ags_peak_channel_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_peak_channel_run.Tpo $(DEPDIR)/gsequencer-ags_peak_channel_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_peak_channel_run.c' object='gsequencer-ags_peak_channel_run.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_peak_channel_run.obj `if test -f 'src/ags/audio/recall/ags_peak_channel_run.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_peak_channel_run.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_peak_channel_run.c'; fi`

gsequencer-ags_peak_recycling.o: src/ags/audio/recall/ags_peak_recycling.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_peak_recycling.Tpo $(DEPDIR)/gsequencer-ags_peak_recycling.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_peak_recycling.c' object='gsequencer-ags_peak_recycling.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_peak_recycling.o `test -f 'src/ags/audio/recall/ags_peak_recycling.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_peak_recycling.c

gsequencer-ags_peak_recycling.obj: src/ags/audio/recall/ags_peak_recycling.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_peak_recycling.Tpo $(DEPDIR)/gsequencer-ags_peak_recycling.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_peak_recycling.c' object='gsequencer-ags_peak_recycling.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_peak_recycling.obj `if test -f 'src/ags/audio/recall/ags_peak_recycling.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_peak_recycling.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_peak_recycling.c'; fi`

gsequencer-ags_play_audio.o: src/ags/audio/recall/ags_play_audio.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_play_audio.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_play_audio.Tpo -c -o gsequencer-ags_play_audio.o `test -f 'src/ags/audio/recall/ags_play_audio.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_play_audio.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_play_audio.Tpo $(DEPDIR)/gsequencer-ags_play_audio.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_play_audio.c' object='gsequencer-ags_play_audio.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_play_audio.o `test -f 'src/ags/audio/recall/ags_play_audio.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_play_audio.c

gsequencer-ags_play_audio.obj: src/ags/audio/recall/ags_play_audio.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_play_audio.Tpo $(DEPDIR)/gsequencer-ags_play_audio.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_play_audio.c' object='gsequencer-ags_play_audio.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_play_audio.obj `if test -f 'src/ags/audio/recall/ags_play_audio.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_play_audio.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_play_audio.c'; fi`

gsequencer-ags_play_audio_file.o: src/ags/audio/recall/ags_play_audio_file.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_play_audio_file.Tpo $(DEPDIR)/gsequencer-ags_play_audio_file.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_play_audio_file.c' object='gsequencer-ags_play_audio_file.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_play_audio_file.o `test -f 'src/ags/audio/recall/ags_play_audio_file.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_play_audio_file.c

gsequencer-ags_play_audio_file.obj: src/ags/audio/recall/ags_play_audio_file.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_play_audio_file.Tpo $(DEPDIR)/gsequencer-ags_play_audio_file.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_play_audio_file.c' object='gsequencer-ags_play_audio_file.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_play_audio_file.obj `if test -f 'src/ags/audio/recall/ags_play_audio_file.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_play_audio_file.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_play_audio_file.c'; fi`

gsequencer-ags_play_audio_signal.o: src/ags/audio/recall/ags_play_audio_signal.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_play_audio_signal.Tpo $(DEPDIR)/gsequencer-ags_play_audio_signal.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_play_audio_signal.c' object='gsequencer-ags_play_audio_signal.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_play_audio_signal.o `test -f 'src/ags/audio/recall/ags_play_audio_signal.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_play_audio_signal.c

gsequencer-ags_play_audio_signal.obj: src/ags/audio/recall/ags_play_audio_signal.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_play_audio_signal.Tpo $(DEPDIR)/gsequencer-ags_play_audio_signal.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_play_audio_signal.c' object='gsequencer-ags_play_audio_signal.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_play_audio_signal.obj `if test -f 'src/ags/audio/recall/ags_play_audio_signal.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_play_audio_signal.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_play_audio_signal.c'; fi`

gsequencer-ags_play_channel.o: src/ags/audio/recall/ags_play_channel.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_play_channel.Tpo $(DEPDIR)/gsequencer-ags_play_channel.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_play_channel.c' object='gsequencer-ags_play_channel.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_play_channel.o `test -f 'src/ags/audio/recall/ags_play_channel.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_play_channel.c

gsequencer-ags_play_channel.obj: src/ags/audio/recall/ags_play_channel.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_play_channel.Tpo $(DEPDIR)/gsequencer-ags_play_channel.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_play_channel.c' object='gsequencer-ags_play_channel.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_play_channel.obj `if test -f 'src/ags/audio/recall/ags_play_channel.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_play_channel.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_play_channel.c'; fi`

gsequencer-ags_play_channel_run.o: src/ags/audio/recall/ags_play_channel_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_play_channel_run.Tpo $(DEPDIR)/gsequencer-ags_play_channel_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_play_channel_run.c' object='gsequencer-ags_play_channel_run.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_play_channel_run.o `test -f 'src/ags/audio/recall/ags_play_channel_run.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_play_channel_run.c

gsequencer-ags_play_channel_run.obj: src/ags/audio/recall/ags_play_channel_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_play_channel_run.Tpo $(DEPDIR)/gsequencer-ags_play_channel_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_play_channel_run.c' object='gsequencer-ags_play_channel_run.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_play_channel_run.obj `if test -f 'src/ags/audio/recall/ags_play_channel_run.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_play_channel_run.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_play_channel_run.c'; fi`

gsequencer-ags_play_channel_run_master.o: src/ags/audio/recall/ags_play_channel_run_master.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_play_channel_run_master.Tpo $(DEPDIR)/gsequencer-ags_play_channel_run_master.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_play_channel_run_master.c' object='gsequencer-ags_play_channel_run_master.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_play_channel_run_master.o `test -f 'src/ags/audio/recall/ags_play_channel_run_master.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_play_channel_run_master.c

gsequencer-ags_play_channel_run_master.obj: src/ags/audio/recall/ags_play_channel_run_master.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_play_channel_run_master.Tpo $(DEPDIR)/gsequencer-ags_play_channel_run_master.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_play_channel_run_master.c' object='gsequencer-ags_play_channel_run_master.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_play_channel_run_master.obj `if test -f 'src/ags/audio/recall/ags_play_channel_run_master.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_play_channel_run_master.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_play_channel_run_master.c'; fi`

gsequencer-ags_play_notation_audio.o: src/ags/audio/recall/ags_play_notation_audio.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_play_notation_audio.Tpo $(DEPDIR)/gsequencer-ags_play_notation_audio.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_play_notation_audio.c' object='gsequencer-ags_play_notation_audio.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_play_notation_audio.o `test -f 'src/ags/audio/recall/ags_play_notation_audio.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_play_notation_audio.c

gsequencer-ags_play_notation_audio.obj: src/ags/audio/recall/ags_play_notation_audio.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_play_notation_audio.Tpo $(DEPDIR)/gsequencer-ags_play_notation_audio.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_play_notation_audio.c' object='gsequencer-ags_play_notation_audio.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_play_notation_audio.obj `if test -f 'src/ags/audio/recall/ags_play_notation_audio.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_play_notation_audio.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_play_notation_audio.c'; fi`

gsequencer-ags_play_notation_audio_run.o: src/ags/audio/recall/ags_play_notation_audio_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_play_notation_audio_run.Tpo $(DEPDIR)/gsequencer-ags_play_notation_audio_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_play_notation_audio_run.c' object='gsequencer-ags_play_notation_audio_run.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_play_notation_audio_run.o `test -f 'src/ags/audio/recall/ags_play_notation_audio_run.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_play_notation_audio_run.c

gsequencer-ags_play_notation_audio_run.obj: src/ags/audio/recall/ags_play_notation_audio_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_play_notation_audio_run.Tpo $(DEPDIR)/gsequencer-ags_play_notation_audio_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_play_notation_audio_run.c' object='gsequencer-ags_play_notation_audio_run.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_play_notation_audio_run.obj `if test -f 'src/ags/audio/recall/ags_play_notation_audio_run.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_play_notation_audio_run.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_play_notation_audio_run.c'; fi`

gsequencer-ags_play_note.o: src/ags/audio/recall/ags_play_note.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_play_note.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_play_note.Tpo -c -o gsequencer-ags_play_note.o `test -f 'src/ags/audio/recall/ags_play_note.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_play_note.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_play_note.Tpo $(DEPDIR)/gsequencer-ags_play_note.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_play_note.c' object='gsequencer-ags_play_note.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_play_note.o `test -f 'src/ags/audio/recall/ags_play_note.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_play_note.c

gsequencer-ags_play_note.obj: src/ags/audio/recall/ags_play_note.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_play_note.Tpo $(DEPDIR)/gsequencer-ags_play_note.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_play_note.c' object='gsequencer-ags_play_note.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_play_note.obj `if test -f 'src/ags/audio/recall/ags_play_note.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_play_note.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_play_note.c'; fi`

gsequencer-ags_play_pattern.o: src/ags/audio/recall/ags_play_pattern.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_play_pattern.Tpo $(DEPDIR)/gsequencer-ags_play_pattern.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_play_pattern.c' object='gsequencer-ags_play_pattern.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_play_pattern.o `test -f 'src/ags/audio/recall/ags_play_pattern.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_play_pattern.c

gsequencer-ags_play_pattern.obj: src/ags/audio/recall/ags_play_pattern.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_play_pattern.Tpo $(DEPDIR)/gsequencer-ags_play_pattern.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_play_pattern.c' object='gsequencer-ags_play_pattern.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_play_pattern.obj `if test -f 'src/ags/audio/recall/ags_play_pattern.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_play_pattern.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_play_pattern.c'; fi`

gsequencer-ags_play_recycling.o: src/ags/audio/recall/ags_play_recycling.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_play_recycling.Tpo $(DEPDIR)/gsequencer-ags_play_recycling.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_play_recycling.c' object='gsequencer-ags_play_recycling.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_play_recycling.o `test -f 'src/ags/audio/recall/ags_play_recycling.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_play_recycling.c

gsequencer-ags_play_recycling.obj: src/ags/audio/recall/ags_play_recycling.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_play_recycling.Tpo $(DEPDIR)/gsequencer-ags_play_recycling.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_play_recycling.c' object='gsequencer-ags_play_recycling.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_play_recycling.obj `if test -f 'src/ags/audio/recall/ags_play_recycling.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_play_recycling.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_play_recycling.c'; fi`

gsequencer-ags_stream_audio_signal.o: src/ags/audio/recall/ags_stream_audio_signal.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_stream_audio_signal.Tpo $(DEPDIR)/gsequencer-ags_stream_audio_signal.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_stream_audio_signal.c' object='gsequencer-ags_stream_audio_signal.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_stream_audio_signal.o `test -f 'src/ags/audio/recall/ags_stream_audio_signal.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_stream_audio_signal.c

gsequencer-ags_stream_audio_signal.obj: src/ags/audio/recall/ags_stream_audio_signal.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_stream_audio_signal.Tpo $(DEPDIR)/gsequencer-ags_stream_audio_signal.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_stream_audio_signal.c' object='gsequencer-ags_stream_audio_signal.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_stream_audio_signal.obj `if test -f 'src/ags/audio/recall/ags_stream_audio_signal.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_stream_audio_signal.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_stream_audio_signal.c'; fi`

gsequencer-ags_stream.o: src/ags/audio/recall/ags_stream.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_stream.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_stream.Tpo -c -o gsequencer-ags_stream.o `test -f 'src/ags/audio/recall/ags_stream.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_stream.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_stream.Tpo $(DEPDIR)/gsequencer-ags_stream.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_stream.c' object='gsequencer-ags_stream.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_stream.o `test -f 'src/ags/audio/recall/ags_stream.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_stream.c

gsequencer-ags_stream.obj: src/ags/audio/recall/ags_stream.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_stream.Tpo $(DEPDIR)/gsequencer-ags_stream.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_stream.c' object='gsequencer-ags_stream.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_stream.obj `if test -f 'src/ags/audio/recall/ags_stream.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_stream.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_stream.c'; fi`

gsequencer-ags_stream_channel.o: src/ags/audio/recall/ags_stream_channel.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_stream_channel.Tpo $(DEPDIR)/gsequencer-ags_stream_channel.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_stream_channel.c' object='gsequencer-ags_stream_channel.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_stream_channel.o `test -f 'src/ags/audio/recall/ags_stream_channel.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_stream_channel.c

gsequencer-ags_stream_channel.obj: src/ags/audio/recall/ags_stream_channel.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_stream_channel.Tpo $(DEPDIR)/gsequencer-ags_stream_channel.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_stream_channel.c' object='gsequencer-ags_stream_channel.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_stream_channel.obj `if test -f 'src/ags/audio/recall/ags_stream_channel.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_stream_channel.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_stream_channel.c'; fi`

gsequencer-ags_stream_channel_run.o: src/ags/audio/recall/ags_stream_channel_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_stream_channel_run.Tpo $(DEPDIR)/gsequencer-ags_stream_channel_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_stream_channel_run.c' object='gsequencer-ags_stream_channel_run.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_stream_channel_run.o `test -f 'src/ags/audio/recall/ags_stream_channel_run.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_stream_channel_run.c

gsequencer-ags_stream_channel_run.obj: src/ags/audio/recall/ags_stream_channel_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_stream_channel_run.Tpo $(DEPDIR)/gsequencer-ags_stream_channel_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_stream_channel_run.c' object='gsequencer-ags_stream_channel_run.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_stream_channel_run.obj `if test -f 'src/ags/audio/recall/ags_stream_channel_run.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_stream_channel_run.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_stream_channel_run.c'; fi`

gsequencer-ags_stream_recycling.o: src/ags/audio/recall/ags_stream_recycling.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_stream_recycling.Tpo $(DEPDIR)/gsequencer-ags_stream_recycling.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_stream_recycling.c' object='gsequencer-ags_stream_recycling.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_stream_recycling.o `test -f 'src/ags/audio/recall/ags_stream_recycling.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_stream_recycling.c

gsequencer-ags_stream_recycling.obj: src/ags/audio/recall/ags_stream_recycling.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_stream_recycling.Tpo $(DEPDIR)/gsequencer-ags_stream_recycling.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_stream_recycling.c' object='gsequencer-ags_stream_recycling.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_stream_recycling.obj `if test -f 'src/ags/audio/recall/ags_stream_recycling.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_stream_recycling.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_stream_recycling.c'; fi`

gsequencer-ags_volume_audio_signal.o: src/ags/audio/recall/ags_volume_audio_signal.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_volume_audio_signal.Tpo $(DEPDIR)/gsequencer-ags_volume_audio_signal.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_volume_audio_signal.c' object='gsequencer-ags_volume_audio_signal.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_volume_audio_signal.o `test -f 'src/ags/audio/recall/ags_volume_audio_signal.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_volume_audio_signal.c

gsequencer-ags_volume_audio_signal.obj: src/ags/audio/recall/ags_volume_audio_signal.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_volume_audio_signal.Tpo $(DEPDIR)/gsequencer-ags_volume_audio_signal.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_volume_audio_signal.c' object='gsequencer-ags_volume_audio_signal.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_volume_audio_signal.obj `if test -f 'src/ags/audio/recall/ags_volume_audio_signal.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_volume_audio_signal.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_volume_audio_signal.c'; fi`

gsequencer-ags_volume_channel.o: src/ags/audio/recall/ags_volume_channel.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_volume_channel.Tpo $(DEPDIR)/gsequencer-ags_volume_channel.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_volume_channel.c' object='gsequencer-ags_volume_channel.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_volume_channel.o `test -f 'src/ags/audio/recall/ags_volume_channel.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_volume_channel.c

gsequencer-ags_volume_channel.obj: src/ags/audio/recall/ags_volume_channel.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_volume_channel.Tpo $(DEPDIR)/gsequencer-ags_volume_channel.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_volume_channel.c' object='gsequencer-ags_volume_channel.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_volume_channel.obj `if test -f 'src/ags/audio/recall/ags_volume_channel.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_volume_channel.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_volume_channel.c'; fi`

gsequencer-ags_volume_channel_run.o: src/ags/audio/recall/ags_volume_channel_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_volume_channel_run.Tpo $(DEPDIR)/gsequencer-ags_volume_channel_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_volume_channel_run.c' object='gsequencer-ags_volume_channel_run.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_volume_channel_run.o `test -f 'src/ags/audio/recall/ags_volume_channel_run.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_volume_channel_run.c

gsequencer-ags_volume_channel_run.obj: src/ags/audio/recall/ags_volume_channel_run.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_volume_channel_run.Tpo $(DEPDIR)/gsequencer-ags_volume_channel_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_volume_channel_run.c' object='gsequencer-ags_volume_channel_run.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_volume_channel_run.obj `if test -f 'src/ags/audio/recall/ags_volume_channel_run.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_volume_channel_run.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_volume_channel_run.c'; fi`

gsequencer-ags_volume_recycling.o: src/ags/audio/recall/ags_volume_recycling.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_volume_recycling.Tpo $(DEPDIR)/gsequencer-ags_volume_recycling.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_volume_recycling.c' object='gsequencer-ags_volume_recycling.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_volume_recycling.o `test -f 'src/ags/audio/recall/ags_volume_recycling.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_volume_recycling.c

gsequencer-ags_volume_recycling.obj: src/ags/audio/recall/ags_volume_recycling.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_volume_recycling.Tpo $(DEPDIR)/gsequencer-ags_volume_recycling.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_volume_recycling.c' object='gsequencer-ags_volume_recycling.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_volume_recycling.obj `if test -f 'src/ags/audio/recall/ags_volume_recycling.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_volume_recycling.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_volume_recycling.c'; fi`

gsequencer-ags_add_audio.o: src/ags/audio/task/ags_add_audio.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_add_audio.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_add_audio.Tpo -c -o gsequencer-ags_add_audio.o `test -f 'src/ags/audio/task/ags_add_audio.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_add_audio.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_add_audio.Tpo $(DEPDIR)/gsequencer-ags_add_audio.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_add_audio.c' object='gsequencer-ags_add_audio.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_add_audio.o `test -f 'src/ags/audio/task/ags_add_audio.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_add_audio.c

gsequencer-ags_add_audio.obj: src/ags/audio/task/ags_add_audio.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_add_audio.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_add_audio.Tpo -c -o gsequencer-ags_add_audio.obj `if test -f 'src/ags/audio/task/ags_add_audio.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_add_audio.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_add_audio.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_add_audio.Tpo $(DEPDIR)/gsequencer-ags_add_audio.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_add_audio.c' object='gsequencer-ags_add_audio.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_add_audio.obj `if test -f 'src/ags/audio/task/ags_add_audio.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_add_audio.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_add_audio.c'; fi`

gsequencer-ags_add_audio_signal.o: src/ags/audio/task/ags_add_audio_signal.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_add_audio_signal.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_add_audio_signal.Tpo -c -o gsequencer-ags_add_audio_signal.o `test -f 'src/ags/audio/task/ags_add_audio_signal.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_add_audio_signal.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_add_audio_signal.Tpo $(DEPDIR)/gsequencer-ags_add_audio_signal.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_add_audio_signal.c' object='gsequencer-ags_add_audio_signal.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_add_audio_signal.o `test -f 'src/ags/audio/task/ags_add_audio_signal.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_add_audio_signal.c

gsequencer-ags_add_audio_signal.obj: src/ags/audio/task/ags_add_audio_signal.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_add_audio_signal.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_add_audio_signal.Tpo -c -o gsequencer-ags_add_audio_signal.obj `if test -f 'src/ags/audio/task/ags_add_audio_signal.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_add_audio_signal.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_add_audio_signal.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_add_audio_signal.Tpo $(DEPDIR)/gsequencer-ags_add_audio_signal.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_add_audio_signal.c' object='gsequencer-ags_add_audio_signal.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_add_audio_signal.obj `if test -f 'src/ags/audio/task/ags_add_audio_signal.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_add_audio_signal.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_add_audio_signal.c'; fi`
...
gsequencer-ags_add_note.o: src/ags/audio/task/ags_add_note.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_add_note.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_add_note.Tpo -c -o gsequencer-ags_add_note.o `test -f 'src/ags/audio/task/ags_add_note.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_add_note.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_add_note.Tpo $(DEPDIR)/gsequencer-ags_add_note.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_add_note.c' object='gsequencer-ags_add_note.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_add_note.o `test -f 'src/ags/audio/task/ags_add_note.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_add_note.c

gsequencer-ags_add_note.obj: src/ags/audio/task/ags_add_note.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_add_note.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_add_note.Tpo -c -o gsequencer-ags_add_note.obj `if test -f 'src/ags/audio/task/ags_add_note.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_add_note.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_add_note.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_add_note.Tpo $(DEPDIR)/gsequencer-ags_add_note.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_add_note.c' object='gsequencer-ags_add_note.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_add_note.obj `if test -f 'src/ags/audio/task/ags_add_note.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_add_note.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_add_note.c'; fi`
...
gsequencer-ags_add_recall.o: src/ags/audio/task/ags_add_recall.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_add_recall.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_add_recall.Tpo -c -o gsequencer-ags_add_recall.o `test -f 'src/ags/audio/task/ags_add_recall.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_add_recall.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_add_recall.Tpo $(DEPDIR)/gsequencer-ags_add_recall.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_add_recall.c' object='gsequencer-ags_add_recall.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_add_recall.o `test -f 'src/ags/audio/task/ags_add_recall.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_add_recall.c

gsequencer-ags_add_recall.obj: src/ags/audio/task/ags_add_recall.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_add_recall.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_add_recall.Tpo -c -o gsequencer-ags_add_recall.obj `if test -f 'src/ags/audio/task/ags_add_recall.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_add_recall.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_add_recall.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_add_recall.Tpo $(DEPDIR)/gsequencer-ags_add_recall.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_add_recall.c' object='gsequencer-ags_add_recall.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_add_recall.obj `if test -f 'src/ags/audio/task/ags_add_recall.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_add_recall.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_add_recall.c'; fi`

gsequencer-ags_add_recall_container.o: src/ags/audio/task/ags_add_recall_container.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_add_recall_container.Tpo $(DEPDIR)/gsequencer-ags_add_recall_container.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_add_recall_container.c' object='gsequencer-ags_add_recall_container.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_add_recall_container.o `test -f 'src/ags/audio/task/ags_add_recall_container.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_add_recall_container.c

gsequencer-ags_add_recall_container.obj: src/ags/audio/task/ags_add_recall_container.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_add_recall_container.Tpo $(DEPDIR)/gsequencer-ags_add_recall_container.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_add_recall_container.c' object='gsequencer-ags_add_recall_container.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
...
gsequencer-ags_append_audio.o: src/ags/audio/task/ags_append_audio.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_append_audio.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_append_audio.Tpo -c -o gsequencer-ags_append_audio.o `test -f 'src/ags/audio/task/ags_append_audio.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_append_audio.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_append_audio.Tpo $(DEPDIR)/gsequencer-ags_append_audio.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_append_audio.c' object='gsequencer-ags_append_audio.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_append_audio.o `test -f 'src/ags/audio/task/ags_append_audio.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_append_audio.c

gsequencer-ags_append_audio.obj: src/ags/audio/task/ags_append_audio.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_append_audio.Tpo $(DEPDIR)/gsequencer-ags_append_audio.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_append_audio.c' object='gsequencer-ags_append_audio.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_append_audio.obj `if test -f 'src/ags/audio/task/ags_append_audio.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_append_audio.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_append_audio.c'; fi`

gsequencer-ags_append_audio_threaded.o: src/ags/audio/task/ags_append_audio_threaded.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_append_audio_threaded.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_append_audio_threaded.Tpo -c -o gsequencer-ags_append_audio_threaded.o `test -f 'src/ags/audio/task/ags_append_audio_threaded.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_append_audio_threaded.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_append_audio_threaded.Tpo $(DEPDIR)/gsequencer-ags_append_audio_threaded.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_append_audio_threaded.c' object='gsequencer-ags_append_audio_threaded.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_append_audio_threaded.o `test -f 'src/ags/audio/task/ags_append_audio_threaded.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_append_audio_threaded.c

gsequencer-ags_append_audio_threaded.obj: src/ags/audio/task/ags_append_audio_threaded.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_append_audio_threaded.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_append_audio_threaded.Tpo -c -o gsequencer-ags_append_audio_threaded.obj `if test -f 'src/ags/audio/task/ags_append_audio_threaded.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_append_audio_threaded.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_append_audio_threaded.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_append_audio_threaded.Tpo $(DEPDIR)/gsequencer-ags_append_audio_threaded.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_append_audio_threaded.c' object='gsequencer-ags_append_audio_threaded.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_append_audio_threaded.obj `if test -f 'src/ags/audio/task/ags_append_audio_threaded.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_append_audio_threaded.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_append_audio_threaded.c'; fi`

gsequencer-ags_append_channel.o: src/ags/audio/task/ags_append_channel.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_append_channel.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_append_channel.Tpo -c -o gsequencer-ags_append_channel.o `test -f 'src/ags/audio/task/ags_append_channel.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_append_channel.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_append_channel.Tpo $(DEPDIR)/gsequencer-ags_append_channel.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_append_channel.c' object='gsequencer-ags_append_channel.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_append_channel.o `test -f 'src/ags/audio/task/ags_append_channel.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_append_channel.c

gsequencer-ags_append_channel.obj: src/ags/audio/task/ags_append_channel.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_append_channel.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_append_channel.Tpo -c -o gsequencer-ags_append_channel.obj `if test -f 'src/ags/audio/task/ags_append_channel.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_append_channel.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_append_channel.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_append_channel.Tpo $(DEPDIR)/gsequencer-ags_append_channel.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_append_channel.c' object='gsequencer-ags_append_channel.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_append_channel.obj `if test -f 'src/ags/audio/task/ags_append_channel.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_append_channel.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_append_channel.c'; fi`

gsequencer-ags_append_recall.o: src/ags/audio/task/ags_append_recall.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_append_recall.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_append_recall.Tpo -c -o gsequencer-ags_append_recall.o `test -f 'src/ags/audio/task/ags_append_recall.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_append_recall.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_append_recall.Tpo $(DEPDIR)/gsequencer-ags_append_recall.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_append_recall.c' object='gsequencer-ags_append_recall.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_append_recall.o `test -f 'src/ags/audio/task/ags_append_recall.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_append_recall.c

gsequencer-ags_append_recall.obj: src/ags/audio/task/ags_append_recall.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_append_recall.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_append_recall.Tpo -c -o gsequencer-ags_append_recall.obj `if test -f 'src/ags/audio/task/ags_append_recall.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_append_recall.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_append_recall.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_append_recall.Tpo $(DEPDIR)/gsequencer-ags_append_recall.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_append_recall.c' object='gsequencer-ags_append_recall.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_append_recall.obj `if test -f 'src/ags/audio/task/ags_append_recall.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_append_recall.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_append_recall.c'; fi`

gsequencer-ags_apply_synth.o: src/ags/audio/task/ags_apply_synth.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_apply_synth.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_apply_synth.Tpo -c -o gsequencer-ags_apply_synth.o `test -f 'src/ags/audio/task/ags_apply_synth.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_apply_synth.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_apply_synth.Tpo $(DEPDIR)/gsequencer-ags_apply_synth.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_apply_synth.c' object='gsequencer-ags_apply_synth.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_apply_synth.o `test -f 'src/ags/audio/task/ags_apply_synth.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_apply_synth.c

gsequencer-ags_apply_synth.obj: src/ags/audio/task/ags_apply_synth.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_apply_synth.Tpo $(DEPDIR)/gsequencer-ags_apply_synth.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_apply_synth.c' object='gsequencer-ags_apply_synth.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_apply_synth.obj `if test -f 'src/ags/audio/task/ags_apply_synth.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_apply_synth.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_apply_synth.c'; fi`

gsequencer-ags_apply_wavetable.o: src/ags/audio/task/ags_apply_wavetable.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_apply_wavetable.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_apply_wavetable.Tpo -c -o gsequencer-ags_apply_wavetable.o `test -f 'src/ags/audio/task/ags_apply_wavetable.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_apply_wavetable.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_apply_wavetable.Tpo $(DEPDIR)/gsequencer-ags_apply_wavetable.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_apply_wavetable.c' object='gsequencer-ags_apply_wavetable.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_apply_wavetable.o `test -f 'src/ags/audio/task/ags_apply_wavetable.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_apply_wavetable.c

gsequencer-ags_apply_wavetable.obj: src/ags/audio/task/ags_apply_wavetable.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_apply_wavetable.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_apply_wavetable.Tpo -c -o gsequencer-ags_apply_wavetable.obj `if test -f 'src/ags/audio/task/ags_apply_wavetable.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_apply_wavetable.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_apply_wavetable.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_apply_wavetable.Tpo $(DEPDIR)/gsequencer-ags_apply_wavetable.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_apply_wavetable.c' object='gsequencer-ags_apply_wavetable.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_apply_wavetable.obj `if test -f 'src/ags/audio/task/ags_apply_wavetable.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_apply_wavetable.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_apply_wavetable.c'; fi`

gsequencer-ags_audio_set_recycling.o: src/ags/audio/task/ags_audio_set_recycling.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_audio_set_recycling.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_audio_set_recycling.Tpo -c -o gsequencer-ags_audio_set_recycling.o `test -f 'src/ags/audio/task/ags_audio_set_recycling.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_audio_set_recycling.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_audio_set_recycling.Tpo $(DEPDIR)/gsequencer-ags_audio_set_recycling.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_audio_set_recycling.c' object='gsequencer-ags_audio_set_recycling.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_audio_set_recycling.o `test -f 'src/ags/audio/task/ags_audio_set_recycling.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_audio_set_recycling.c

gsequencer-ags_audio_set_recycling.obj: src/ags/audio/task/ags_audio_set_recycling.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_audio_set_recycling.Tpo $(DEPDIR)/gsequencer-ags_audio_set_recycling.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_audio_set_recycling.c' object='gsequencer-ags_audio_set_recycling.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
...
gsequencer-ags_blink_cell_pattern_cursor.o: src/ags/audio/task/ags_blink_cell_pattern_cursor.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_blink_cell_pattern_cursor.Tpo $(DEPDIR)/gsequencer-ags_blink_cell_pattern_cursor.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_blink_cell_pattern_cursor.c' object='gsequencer-ags_blink_cell_pattern_cursor.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_blink_cell_pattern_cursor.o `test -f 'src/ags/audio/task/ags_blink_cell_pattern_cursor.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_blink_cell_pattern_cursor.c
...
gsequencer-ags_blink_cell_pattern_cursor.obj: src/ags/audio/task/ags_blink_cell_pattern_cursor.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_blink_cell_pattern_cursor.Tpo $(DEPDIR)/gsequencer-ags_blink_cell_pattern_cursor.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_blink_cell_pattern_cursor.c' object='gsequencer-ags_blink_cell_pattern_cursor.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
...
gsequencer-ags_cancel_audio.o: src/ags/audio/task/ags_cancel_audio.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_cancel_audio.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_cancel_audio.Tpo -c -o gsequencer-ags_cancel_audio.o `test -f 'src/ags/audio/task/ags_cancel_audio.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_cancel_audio.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_cancel_audio.Tpo $(DEPDIR)/gsequencer-ags_cancel_audio.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_cancel_audio.c' object='gsequencer-ags_cancel_audio.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_cancel_audio.o `test -f 'src/ags/audio/task/ags_cancel_audio.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_cancel_audio.c

gsequencer-ags_cancel_audio.obj: src/ags/audio/task/ags_cancel_audio.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_cancel_audio.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_cancel_audio.Tpo -c -o gsequencer-ags_cancel_audio.obj `if test -f 'src/ags/audio/task/ags_cancel_audio.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_cancel_audio.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_cancel_audio.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_cancel_audio.Tpo $(DEPDIR)/gsequencer-ags_cancel_audio.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_cancel_audio.c' object='gsequencer-ags_cancel_audio.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_cancel_audio.obj `if test -f 'src/ags/audio/task/ags_cancel_audio.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_cancel_audio.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_cancel_audio.c'; fi`

gsequencer-ags_cancel_channel.o: src/ags/audio/task/ags_cancel_channel.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_cancel_channel.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_cancel_channel.Tpo -c -o gsequencer-ags_cancel_channel.o `test -f 'src/ags/audio/task/ags_cancel_channel.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_cancel_channel.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_cancel_channel.Tpo $(DEPDIR)/gsequencer-ags_cancel_channel.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_cancel_channel.c' object='gsequencer-ags_cancel_channel.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_cancel_channel.o `test -f 'src/ags/audio/task/ags_cancel_channel.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_cancel_channel.c

gsequencer-ags_cancel_channel.obj: src/ags/audio/task/ags_cancel_channel.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_cancel_channel.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_cancel_channel.Tpo -c -o gsequencer-ags_cancel_channel.obj `if test -f 'src/ags/audio/task/ags_cancel_channel.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_cancel_channel.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_cancel_channel.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_cancel_channel.Tpo $(DEPDIR)/gsequencer-ags_cancel_channel.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_cancel_channel.c' object='gsequencer-ags_cancel_channel.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_cancel_channel.obj `if test -f 'src/ags/audio/task/ags_cancel_channel.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_cancel_channel.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_cancel_channel.c'; fi`

gsequencer-ags_cancel_recall.o: src/ags/audio/task/ags_cancel_recall.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_cancel_recall.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_cancel_recall.Tpo -c -o gsequencer-ags_cancel_recall.o `test -f 'src/ags/audio/task/ags_cancel_recall.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_cancel_recall.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_cancel_recall.Tpo $(DEPDIR)/gsequencer-ags_cancel_recall.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_cancel_recall.c' object='gsequencer-ags_cancel_recall.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_cancel_recall.o `test -f 'src/ags/audio/task/ags_cancel_recall.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_cancel_recall.c

gsequencer-ags_cancel_recall.obj: src/ags/audio/task/ags_cancel_recall.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_cancel_recall.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_cancel_recall.Tpo -c -o gsequencer-ags_cancel_recall.obj `if test -f 'src/ags/audio/task/ags_cancel_recall.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_cancel_recall.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_cancel_recall.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_cancel_recall.Tpo $(DEPDIR)/gsequencer-ags_cancel_recall.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_cancel_recall.c' object='gsequencer-ags_cancel_recall.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_cancel_recall.obj `if test -f 'src/ags/audio/task/ags_cancel_recall.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_cancel_recall.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_cancel_recall.c'; fi`
...
gsequencer-ags_channel_set_recycling.o: src/ags/audio/task/ags_channel_set_recycling.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_channel_set_recycling.Tpo $(DEPDIR)/gsequencer-ags_channel_set_recycling.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_channel_set_recycling.c' object='gsequencer-ags_channel_set_recycling.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_channel_set_recycling.o `test -f 'src/ags/audio/task/ags_channel_set_recycling.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_channel_set_recycling.c

gsequencer-ags_channel_set_recycling.obj: src/ags/audio/task/ags_channel_set_recycling.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_channel_set_recycling.Tpo $(DEPDIR)/gsequencer-ags_channel_set_recycling.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_channel_set_recycling.c' object='gsequencer-ags_channel_set_recycling.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
...
gsequencer-ags_export_output.o: src/ags/audio/task/ags_export_output.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_export_output.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_export_output.Tpo -c -o gsequencer-ags_export_output.o `test -f 'src/ags/audio/task/ags_export_output.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_export_output.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_export_output.Tpo $(DEPDIR)/gsequencer-ags_export_output.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_export_output.c' object='gsequencer-ags_export_output.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_export_output.o `test -f 'src/ags/audio/task/ags_export_output.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_export_output.c

gsequencer-ags_export_output.obj: src/ags/audio/task/ags_export_output.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_export_output.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_export_output.Tpo -c -o gsequencer-ags_export_output.obj `if test -f 'src/ags/audio/task/ags_export_output.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_export_output.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_export_output.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_export_output.Tpo $(DEPDIR)/gsequencer-ags_export_output.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_export_output.c' object='gsequencer-ags_export_output.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_export_output.obj `if test -f 'src/ags/audio/task/ags_export_output.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_export_output.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_export_output.c'; fi`
...
gsequencer-ags_init_audio.o: src/ags/audio/task/ags_init_audio.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_init_audio.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_init_audio.Tpo -c -o gsequencer-ags_init_audio.o `test -f 'src/ags/audio/task/ags_init_audio.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_init_audio.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_init_audio.Tpo $(DEPDIR)/gsequencer-ags_init_audio.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_init_audio.c' object='gsequencer-ags_init_audio.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_init_audio.o `test -f 'src/ags/audio/task/ags_init_audio.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_init_audio.c

gsequencer-ags_init_audio.obj: src/ags/audio/task/ags_init_audio.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_init_audio.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_init_audio.Tpo -c -o gsequencer-ags_init_audio.obj `if test -f 'src/ags/audio/task/ags_init_audio.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_init_audio.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_init_audio.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_init_audio.Tpo $(DEPDIR)/gsequencer-ags_init_audio.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_init_audio.c' object='gsequencer-ags_init_audio.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_init_audio.obj `if test -f 'src/ags/audio/task/ags_init_audio.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_init_audio.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_init_audio.c'; fi`

gsequencer-ags_init_channel.o: src/ags/audio/task/ags_init_channel.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_init_channel.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_init_channel.Tpo -c -o gsequencer-ags_init_channel.o `test -f 'src/ags/audio/task/ags_init_channel.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_init_channel.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_init_channel.Tpo $(DEPDIR)/gsequencer-ags_init_channel.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_init_channel.c' object='gsequencer-ags_init_channel.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_init_channel.o `test -f 'src/ags/audio/task/ags_init_channel.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_init_channel.c

gsequencer-ags_init_channel.obj: src/ags/audio/task/ags_init_channel.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_init_channel.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_init_channel.Tpo -c -o gsequencer-ags_init_channel.obj `if test -f 'src/ags/audio/task/ags_init_channel.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_init_channel.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_init_channel.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_init_channel.Tpo $(DEPDIR)/gsequencer-ags_init_channel.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_init_channel.c' object='gsequencer-ags_init_channel.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_init_channel.obj `if test -f 'src/ags/audio/task/ags_init_channel.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_init_channel.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_init_channel.c'; fi`

gsequencer-ags_link_channel.o: src/ags/audio/task/ags_link_channel.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_link_channel.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_link_channel.Tpo -c -o gsequencer-ags_link_channel.o `test -f 'src/ags/audio/task/ags_link_channel.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_link_channel.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_link_channel.Tpo $(DEPDIR)/gsequencer-ags_link_channel.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_link_channel.c' object='gsequencer-ags_link_channel.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_link_channel.o `test -f 'src/ags/audio/task/ags_link_channel.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_link_channel.c

gsequencer-ags_link_channel.obj: src/ags/audio/task/ags_link_channel.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_link_channel.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_link_channel.Tpo -c -o gsequencer-ags_link_channel.obj `if test -f 'src/ags/audio/task/ags_link_channel.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_link_channel.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_link_channel.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_link_channel.Tpo $(DEPDIR)/gsequencer-ags_link_channel.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_link_channel.c' object='gsequencer-ags_link_channel.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_link_channel.obj `if test -f 'src/ags/audio/task/ags_link_channel.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_link_channel.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_link_channel.c'; fi`

gsequencer-ags_open_file.o: src/ags/audio/task/ags_open_file.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_open_file.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_open_file.Tpo -c -o gsequencer-ags_open_file.o `test -f 'src/ags/audio/task/ags_open_file.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_open_file.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_open_file.Tpo $(DEPDIR)/gsequencer-ags_open_file.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_open_file.c' object='gsequencer-ags_open_file.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_open_file.o `test -f 'src/ags/audio/task/ags_open_file.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_open_file.c

gsequencer-ags_open_file.obj: src/ags/audio/task/ags_open_file.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_open_file.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_open_file.Tpo -c -o gsequencer-ags_open_file.obj `if test -f 'src/ags/audio/task/ags_open_file.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_open_file.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_open_file.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_open_file.Tpo $(DEPDIR)/gsequencer-ags_open_file.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_open_file.c' object='gsequencer-ags_open_file.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_open_file.obj `if test -f 'src/ags/audio/task/ags_open_file.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_open_file.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_open_file.c'; fi`

gsequencer-ags_open_single_file.o: src/ags/audio/task/ags_open_single_file.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_open_single_file.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_open_single_file.Tpo -c -o gsequencer-ags_open_single_file.o `test -f 'src/ags/audio/task/ags_open_single_file.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_open_single_file.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_open_single_file.Tpo $(DEPDIR)/gsequencer-ags_open_single_file.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_open_single_file.c' object='gsequencer-ags_open_single_file.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_open_single_file.o `test -f 'src/ags/audio/task/ags_open_single_file.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_open_single_file.c

gsequencer-ags_open_single_file.obj: src/ags/audio/task/ags_open_single_file.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_open_single_file.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_open_single_file.Tpo -c -o gsequencer-ags_open_single_file.obj `if test -f 'src/ags/audio/task/ags_open_single_file.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_open_single_file.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_open_single_file.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_open_single_file.Tpo $(DEPDIR)/gsequencer-ags_open_single_file.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_open_single_file.c' object='gsequencer-ags_open_single_file.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_open_single_file.obj `if test -f 'src/ags/audio/task/ags_open_single_file.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_open_single_file.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_open_single_file.c'; fi`

gsequencer-ags_remove_audio.o: src/ags/audio/task/ags_remove_audio.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_remove_audio.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_remove_audio.Tpo -c -o gsequencer-ags_remove_audio.o `test -f 'src/ags/audio/task/ags_remove_audio.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_remove_audio.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_remove_audio.Tpo $(DEPDIR)/gsequencer-ags_remove_audio.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_remove_audio.c' object='gsequencer-ags_remove_audio.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_remove_audio.o `test -f 'src/ags/audio/task/ags_remove_audio.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_remove_audio.c

gsequencer-ags_remove_audio.obj: src/ags/audio/task/ags_remove_audio.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_remove_audio.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_remove_audio.Tpo -c -o gsequencer-ags_remove_audio.obj `if test -f 'src/ags/audio/task/ags_remove_audio.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_remove_audio.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_remove_audio.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_remove_audio.Tpo $(DEPDIR)/gsequencer-ags_remove_audio.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_remove_audio.c' object='gsequencer-ags_remove_audio.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_remove_audio.obj `if test -f 'src/ags/audio/task/ags_remove_audio.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_remove_audio.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_remove_audio.c'; fi`

gsequencer-ags_remove_audio_signal.o: src/ags/audio/task/ags_remove_audio_signal.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_remove_audio_signal.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_remove_audio_signal.Tpo -c -o gsequencer-ags_remove_audio_signal.o `test -f 'src/ags/audio/task/ags_remove_audio_signal.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_remove_audio_signal.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_remove_audio_signal.Tpo $(DEPDIR)/gsequencer-ags_remove_audio_signal.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_remove_audio_signal.c' object='gsequencer-ags_remove_audio_signal.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_remove_audio_signal.o `test -f 'src/ags/audio/task/ags_remove_audio_signal.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_remove_audio_signal.c

gsequencer-ags_remove_audio_signal.obj: src/ags/audio/task/ags_remove_audio_signal.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_remove_audio_signal.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_remove_audio_signal.Tpo -c -o gsequencer-ags_remove_audio_signal.obj `if test -f 'src/ags/audio/task/ags_remove_audio_signal.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_remove_audio_signal.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_remove_audio_signal.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_remove_audio_signal.Tpo $(DEPDIR)/gsequencer-ags_remove_audio_signal.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_remove_audio_signal.c' object='gsequencer-ags_remove_audio_signal.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_remove_audio_signal.obj `if test -f 'src/ags/audio/task/ags_remove_audio_signal.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_remove_audio_signal.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_remove_audio_signal.c'; fi`

gsequencer-ags_remove_note.o: src/ags/audio/task/ags_remove_note.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_remove_note.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_remove_note.Tpo -c -o gsequencer-ags_remove_note.o `test -f 'src/ags/audio/task/ags_remove_note.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_remove_note.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_remove_note.Tpo $(DEPDIR)/gsequencer-ags_remove_note.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_remove_note.c' object='gsequencer-ags_remove_note.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_remove_note.o `test -f 'src/ags/audio/task/ags_remove_note.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_remove_note.c

gsequencer-ags_remove_note.obj: src/ags/audio/task/ags_remove_note.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_remove_note.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_remove_note.Tpo -c -o gsequencer-ags_remove_note.obj `if test -f 'src/ags/audio/task/ags_remove_note.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_remove_note.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_remove_note.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_remove_note.Tpo $(DEPDIR)/gsequencer-ags_remove_note.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_remove_note.c' object='gsequencer-ags_remove_note.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_remove_note.obj `if test -f 'src/ags/audio/task/ags_remove_note.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_remove_note.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_remove_note.c'; fi`
...
gsequencer-ags_remove_recall.o: src/ags/audio/task/ags_remove_recall.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_remove_recall.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_remove_recall.Tpo -c -o gsequencer-ags_remove_recall.o `test -f 'src/ags/audio/task/ags_remove_recall.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_remove_recall.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_remove_recall.Tpo $(DEPDIR)/gsequencer-ags_remove_recall.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_remove_recall.c' object='gsequencer-ags_remove_recall.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_remove_recall.o `test -f 'src/ags/audio/task/ags_remove_recall.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_remove_recall.c

gsequencer-ags_remove_recall.obj: src/ags/audio/task/ags_remove_recall.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_remove_recall.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_remove_recall.Tpo -c -o gsequencer-ags_remove_recall.obj `if test -f 'src/ags/audio/task/ags_remove_recall.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_remove_recall.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_remove_recall.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_remove_recall.Tpo $(DEPDIR)/gsequencer-ags_remove_recall.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_remove_recall.c' object='gsequencer-ags_remove_recall.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_remove_recall.obj `if test -f 'src/ags/audio/task/ags_remove_recall.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_remove_recall.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_remove_recall.c'; fi`

gsequencer-ags_remove_recall_container.o: src/ags/audio/task/ags_remove_recall_container.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_remove_recall_container.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_remove_recall_container.Tpo -c -o gsequencer-ags_remove_recall_container.o `test -f 'src/ags/audio/task/ags_remove_recall_container.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_remove_recall_container.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_remove_recall_container.Tpo $(DEPDIR)/gsequencer-ags_remove_recall_container.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_remove_recall_container.c' object='gsequencer-ags_remove_recall_container.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_remove_recall_container.o `test -f 'src/ags/audio/task/ags_remove_recall_container.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_remove_recall_container.c

gsequencer-ags_remove_recall_container.obj: src/ags/audio/task/ags_remove_recall_container.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_remove_recall_container.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_remove_recall_container.Tpo -c -o gsequencer-ags_remove_recall_container.obj `if test -f 'src/ags/audio/task/ags_remove_recall_container.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_remove_recall_container.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_remove_recall_container.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_remove_recall_container.Tpo $(DEPDIR)/gsequencer-ags_remove_recall_container.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_remove_recall_container.c' object='gsequencer-ags_remove_recall_container.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_remove_recall_container.obj `if test -f 'src/ags/audio/task/ags_remove_recall_container.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_remove_recall_container.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_remove_recall_container.c'; fi`

gsequencer-ags_remove_region_from_selection.o: src/ags/audio/task/ags_remove_region_from_selection.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_remove_region_from_selection.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_remove_region_from_selection.Tpo -c -o gsequencer-ags_remove_region_from_selection.o `test -f 'src/ags/audio/task/ags_remove_region_from_selection.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_remove_region_from_selection.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_remove_region_from_selection.Tpo $(DEPDIR)/gsequencer-ags_remove_region_from_selection.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_remove_region_from_selection.c' object='gsequencer-ags_remove_region_from_selection.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_remove_region_from_selection.o `test -f 'src/ags/audio/task/ags_remove_region_from_selection.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_remove_region_from_selection.c

gsequencer-ags_remove_region_from_selection.obj: src/ags/audio/task/ags_remove_region_from_selection.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_remove_region_from_selection.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_remove_region_from_selection.Tpo -c -o gsequencer-ags_remove_region_from_selection.obj `if test -f 'src/ags/audio/task/ags_remove_region_from_selection.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_remove_region_from_selection.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_remove_region_from_selection.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_remove_region_from_selection.Tpo $(DEPDIR)/gsequencer-ags_remove_region_from_selection.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_remove_region_from_selection.c' object='gsequencer-ags_remove_region_from_selection.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_remove_region_from_selection.obj `if test -f 'src/ags/audio/task/ags_remove_region_from_selection.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_remove_region_from_selection.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_remove_region_from_selection.c'; fi`

gsequencer-ags_resize_audio.o: src/ags/audio/task/ags_resize_audio.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_resize_audio.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_resize_audio.Tpo -c -o gsequencer-ags_resize_audio.o `test -f 'src/ags/audio/task/ags_resize_audio.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_resize_audio.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_resize_audio.Tpo $(DEPDIR)/gsequencer-ags_resize_audio.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_resize_audio.c' object='gsequencer-ags_resize_audio.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_resize_audio.o `test -f 'src/ags/audio/task/ags_resize_audio.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_resize_audio.c

gsequencer-ags_resize_audio.obj: src/ags/audio/task/ags_resize_audio.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_resize_audio.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_resize_audio.Tpo -c -o gsequencer-ags_resize_audio.obj `if test -f 'src/ags/audio/task/ags_resize_audio.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_resize_audio.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_resize_audio.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_resize_audio.Tpo $(DEPDIR)/gsequencer-ags_resize_audio.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_resize_audio.c' object='gsequencer-ags_resize_audio.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_resize_audio.obj `if test -f 'src/ags/audio/task/ags_resize_audio.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_resize_audio.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_resize_audio.c'; fi`
...
gsequencer-ags_seek_devout.o: src/ags/audio/task/ags_seek_devout.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_seek_devout.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_seek_devout.Tpo -c -o gsequencer-ags_seek_devout.o `test -f 'src/ags/audio/task/ags_seek_devout.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_seek_devout.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_seek_devout.Tpo $(DEPDIR)/gsequencer-ags_seek_devout.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_seek_devout.c' object='gsequencer-ags_seek_devout.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_seek_devout.o `test -f 'src/ags/audio/task/ags_seek_devout.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_seek_devout.c

gsequencer-ags_seek_devout.obj: src/ags/audio/task/ags_seek_devout.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_seek_devout.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_seek_devout.Tpo -c -o gsequencer-ags_seek_devout.obj `if test -f 'src/ags/audio/task/ags_seek_devout.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_seek_devout.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_seek_devout.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_seek_devout.Tpo $(DEPDIR)/gsequencer-ags_seek_devout.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_seek_devout.c' object='gsequencer-ags_seek_devout.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_seek_devout.obj `if test -f 'src/ags/audio/task/ags_seek_devout.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_seek_devout.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_seek_devout.c'; fi`

gsequencer-ags_set_audio_channels.o: src/ags/audio/task/ags_set_audio_channels.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_set_audio_channels.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_set_audio_channels.Tpo -c -o gsequencer-ags_set_audio_channels.o `test -f 'src/ags/audio/task/ags_set_audio_channels.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_set_audio_channels.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_set_audio_channels.Tpo $(DEPDIR)/gsequencer-ags_set_audio_channels.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_set_audio_channels.c' object='gsequencer-ags_set_audio_channels.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_set_audio_channels.o `test -f 'src/ags/audio/task/ags_set_audio_channels.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_set_audio_channels.c

gsequencer-ags_set_audio_channels.obj: src/ags/audio/task/ags_set_audio_channels.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_set_audio_channels.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_set_audio_channels.Tpo -c -o gsequencer-ags_set_audio_channels.obj `if test -f 'src/ags/audio/task/ags_set_audio_channels.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_set_audio_channels.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_set_audio_channels.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_set_audio_channels.Tpo $(DEPDIR)/gsequencer-ags_set_audio_channels.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_set_audio_channels.c' object='gsequencer-ags_set_audio_channels.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_set_audio_channels.obj `if test -f 'src/ags/audio/task/ags_set_audio_channels.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_set_audio_channels.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_set_audio_channels.c'; fi`

gsequencer-ags_set_buffer_size.o: src/ags/audio/task/ags_set_buffer_size.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_set_buffer_size.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_set_buffer_size.Tpo -c -o gsequencer-ags_set_buffer_size.o `test -f 'src/ags/audio/task/ags_set_buffer_size.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_set_buffer_size.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_set_buffer_size.Tpo $(DEPDIR)/gsequencer-ags_set_buffer_size.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_set_buffer_size.c' object='gsequencer-ags_set_buffer_size.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_set_buffer_size.o `test -f 'src/ags/audio/task/ags_set_buffer_size.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_set_buffer_size.c

gsequencer-ags_set_buffer_size.obj: src/ags/audio/task/ags_set_buffer_size.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_set_buffer_size.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_set_buffer_size.Tpo -c -o gsequencer-ags_set_buffer_size.obj `if test -f 'src/ags/audio/task/ags_set_buffer_size.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_set_buffer_size.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_set_buffer_size.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_set_buffer_size.Tpo $(DEPDIR)/gsequencer-ags_set_buffer_size.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_set_buffer_size.c' object='gsequencer-ags_set_buffer_size.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_set_buffer_size.obj `if test -f 'src/ags/audio/task/ags_set_buffer_size.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_set_buffer_size.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_set_buffer_size.c'; fi`

gsequencer-ags_set_devout_play_flags.o: src/ags/audio/task/ags_set_devout_play_flags.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_set_devout_play_flags.Tpo $(DEPDIR)/gsequencer-ags_set_devout_play_flags.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_set_devout_play_flags.c' object='gsequencer-ags_set_devout_play_flags.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_set_devout_play_flags.o `test -f 'src/ags/audio/task/ags_set_devout_play_flags.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_set_devout_play_flags.c
...
gsequencer-ags_set_devout_play_flags.obj: src/ags/audio/task/ags_set_devout_play_flags.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_set_devout_play_flags.Tpo $(DEPDIR)/gsequencer-ags_set_devout_play_flags.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_set_devout_play_flags.c' object='gsequencer-ags_set_devout_play_flags.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_set_devout_play_flags.obj `if test -f 'src/ags/audio/task/ags_set_devout_play_flags.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_set_devout_play_flags.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_set_devout_play_flags.c'; fi`

gsequencer-ags_set_output_device.o: src/ags/audio/task/ags_set_output_device.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_set_output_device.Tpo $(DEPDIR)/gsequencer-ags_set_output_device.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_set_output_device.c' object='gsequencer-ags_set_output_device.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_set_output_device.o `test -f 'src/ags/audio/task/ags_set_output_device.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_set_output_device.c

gsequencer-ags_set_output_device.obj: src/ags/audio/task/ags_set_output_device.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_set_output_device.Tpo $(DEPDIR)/gsequencer-ags_set_output_device.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_set_output_device.c' object='gsequencer-ags_set_output_device.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_set_output_device.obj `if test -f 'src/ags/audio/task/ags_set_output_device.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_set_output_device.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_set_output_device.c'; fi`

gsequencer-ags_set_samplerate.o: src/ags/audio/task/ags_set_samplerate.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_set_samplerate.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_set_samplerate.Tpo -c -o gsequencer-ags_set_samplerate.o `test -f 'src/ags/audio/task/ags_set_samplerate.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_set_samplerate.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_set_samplerate.Tpo $(DEPDIR)/gsequencer-ags_set_samplerate.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_set_samplerate.c' object='gsequencer-ags_set_samplerate.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_set_samplerate.o `test -f 'src/ags/audio/task/ags_set_samplerate.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_set_samplerate.c

gsequencer-ags_set_samplerate.obj: src/ags/audio/task/ags_set_samplerate.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_set_samplerate.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_set_samplerate.Tpo -c -o gsequencer-ags_set_samplerate.obj `if test -f 'src/ags/audio/task/ags_set_samplerate.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_set_samplerate.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_set_samplerate.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_set_samplerate.Tpo $(DEPDIR)/gsequencer-ags_set_samplerate.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_set_samplerate.c' object='gsequencer-ags_set_samplerate.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_set_samplerate.obj `if test -f 'src/ags/audio/task/ags_set_samplerate.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_set_samplerate.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_set_samplerate.c'; fi`

gsequencer-ags_start_devout.o: src/ags/audio/task/ags_start_devout.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_start_devout.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_start_devout.Tpo -c -o gsequencer-ags_start_devout.o `test -f 'src/ags/audio/task/ags_start_devout.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_start_devout.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_start_devout.Tpo $(DEPDIR)/gsequencer-ags_start_devout.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_start_devout.c' object='gsequencer-ags_start_devout.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_start_devout.o `test -f 'src/ags/audio/task/ags_start_devout.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_start_devout.c

gsequencer-ags_start_devout.obj: src/ags/audio/task/ags_start_devout.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_start_devout.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_start_devout.Tpo -c -o gsequencer-ags_start_devout.obj `if test -f 'src/ags/audio/task/ags_start_devout.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_start_devout.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_start_devout.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_start_devout.Tpo $(DEPDIR)/gsequencer-ags_start_devout.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_start_devout.c' object='gsequencer-ags_start_devout.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_start_devout.obj `if test -f 'src/ags/audio/task/ags_start_devout.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_start_devout.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_start_devout.c'; fi`
...
gsequencer-ags_unref_audio_signal.o: src/ags/audio/task/ags_unref_audio_signal.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_unref_audio_signal.Tpo $(DEPDIR)/gsequencer-ags_unref_audio_signal.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_unref_audio_signal.c' object='gsequencer-ags_unref_audio_signal.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_unref_audio_signal.o `test -f 'src/ags/audio/task/ags_unref_audio_signal.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_unref_audio_signal.c

gsequencer-ags_unref_audio_signal.obj: src/ags/audio/task/ags_unref_audio_signal.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_unref_audio_signal.Tpo $(DEPDIR)/gsequencer-ags_unref_audio_signal.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_unref_audio_signal.c' object='gsequencer-ags_unref_audio_signal.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_unref_audio_signal.obj `if test -f 'src/ags/audio/task/ags_unref_audio_signal.c'; then $(CYGPATH_W) 'src/ags/audio/task/ags_unref_audio_signal.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/ags_unref_audio_signal.c'; fi`

gsequencer-ags_apply_bpm.o: src/ags/audio/task/recall/ags_apply_bpm.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_apply_bpm.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_apply_bpm.Tpo -c -o gsequencer-ags_apply_bpm.o `test -f 'src/ags/audio/task/recall/ags_apply_bpm.c' || echo '$(srcdir)/'`src/ags/audio/task/recall/ags_apply_bpm.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_apply_bpm.Tpo $(DEPDIR)/gsequencer-ags_apply_bpm.Po
#	$(AM_V_CC)source='src/ags/audio/task/recall/ags_apply_bpm.c' object='gsequencer-ags_apply_bpm.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_apply_bpm.o `test -f 'src/ags/audio/task/recall/ags_apply_bpm.c' || echo '$(srcdir)/'`src/ags/audio/task/recall/ags_apply_bpm.c

gsequencer-ags_apply_bpm.obj: src/ags/audio/task/recall/ags_apply_bpm.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_apply_bpm.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_apply_bpm.Tpo -c -o gsequencer-ags_apply_bpm.obj `if test -f 'src/ags/audio/task/recall/ags_apply_bpm.c'; then $(CYGPATH_W) 'src/ags/audio/task/recall/ags_apply_bpm.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/recall/ags_apply_bpm.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_apply_bpm.Tpo $(DEPDIR)/gsequencer-ags_apply_bpm.Po
#	$(AM_V_CC)source='src/ags/audio/task/recall/ags_apply_bpm.c' object='gsequencer-ags_apply_bpm.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_apply_bpm.obj `if test -f 'src/ags/audio/task/recall/ags_apply_bpm.c'; then $(CYGPATH_W) 'src/ags/audio/task/recall/ags_apply_bpm.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/recall/ags_apply_bpm.c'; fi`

gsequencer-ags_apply_sequencer_length.o: src/ags/audio/task/recall/ags_apply_sequencer_length.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_apply_sequencer_length.Tpo $(DEPDIR)/gsequencer-ags_apply_sequencer_length.Po
#	$(AM_V_CC)source='src/ags/audio/task/recall/ags_apply_sequencer_length.c' object='gsequencer-ags_apply_sequencer_length.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_apply_sequencer_length.o `test -f 'src/ags/audio/task/recall/ags_apply_sequencer_length.c' || echo '$(srcdir)/'`src/ags/audio/task/recall/ags_apply_sequencer_length.c

gsequencer-ags_apply_sequencer_length.obj: src/ags/audio/task/recall/ags_apply_sequencer_length.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_apply_sequencer_length.Tpo $(DEPDIR)/gsequencer-ags_apply_sequencer_length.Po
#	$(AM_V_CC)source='src/ags/audio/task/recall/ags_apply_sequencer_length.c' object='gsequencer-ags_apply_sequencer_length.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_apply_sequencer_length.obj `if test -f 'src/ags/audio/task/recall/ags_apply_sequencer_length.c'; then $(CYGPATH_W) 'src/ags/audio/task/recall/ags_apply_sequencer_length.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/recall/ags_apply_sequencer_length.c'; fi`

gsequencer-ags_apply_tact.o: src/ags/audio/task/recall/ags_apply_tact.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_apply_tact.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_apply_tact.Tpo -c -o gsequencer-ags_apply_tact.o `test -f 'src/ags/audio/task/recall/ags_apply_tact.c' || echo '$(srcdir)/'`src/ags/audio/task/recall/ags_apply_tact.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_apply_tact.Tpo $(DEPDIR)/gsequencer-ags_apply_tact.Po
#	$(AM_V_CC)source='src/ags/audio/task/recall/ags_apply_tact.c' object='gsequencer-ags_apply_tact.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_apply_tact.o `test -f 'src/ags/audio/task/recall/ags_apply_tact.c' || echo '$(srcdir)/'`src/ags/audio/task/recall/ags_apply_tact.c

gsequencer-ags_apply_tact.obj: src/ags/audio/task/recall/ags_apply_tact.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_apply_tact.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_apply_tact.Tpo -c -o gsequencer-ags_apply_tact.obj `if test -f 'src/ags/audio/task/recall/ags_apply_tact.c'; then $(CYGPATH_W) 'src/ags/audio/task/recall/ags_apply_tact.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/recall/ags_apply_tact.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_apply_tact.Tpo $(DEPDIR)/gsequencer-ags_apply_tact.Po
#	$(AM_V_CC)source='src/ags/audio/task/recall/ags_apply_tact.c' object='gsequencer-ags_apply_tact.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_apply_tact.obj `if test -f 'src/ags/audio/task/recall/ags_apply_tact.c'; then $(CYGPATH_W) 'src/ags/audio/task/recall/ags_apply_tact.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/recall/ags_apply_tact.c'; fi`

gsequencer-ags_set_muted.o: src/ags/audio/task/recall/ags_set_muted.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_set_muted.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_set_muted.Tpo -c -o gsequencer-ags_set_muted.o `test -f 'src/ags/audio/task/recall/ags_set_muted.c' || echo '$(srcdir)/'`src/ags/audio/task/recall/ags_set_muted.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_set_muted.Tpo $(DEPDIR)/gsequencer-ags_set_muted.Po
#	$(AM_V_CC)source='src/ags/audio/task/recall/ags_set_muted.c' object='gsequencer-ags_set_muted.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_set_muted.o `test -f 'src/ags/audio/task/recall/ags_set_muted.c' || echo '$(srcdir)/'`src/ags/audio/task/recall/ags_set_muted.c

gsequencer-ags_set_muted.obj: src/ags/audio/task/recall/ags_set_muted.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_set_muted.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_set_muted.Tpo -c -o gsequencer-ags_set_muted.obj `if test -f 'src/ags/audio/task/recall/ags_set_muted.c'; then $(CYGPATH_W) 'src/ags/audio/task/recall/ags_set_muted.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/recall/ags_set_muted.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_set_muted.Tpo $(DEPDIR)/gsequencer-ags_set_muted.Po
#	$(AM_V_CC)source='src/ags/audio/task/recall/ags_set_muted.c' object='gsequencer-ags_set_muted.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_set_muted.obj `if test -f 'src/ags/audio/task/recall/ags_set_muted.c'; then $(CYGPATH_W) 'src/ags/audio/task/recall/ags_set_muted.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/task/recall/ags_set_muted.c'; fi`
...
gsequencer-ags_connectable.o: src/ags-lib/object/ags_connectable.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_connectable.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_connectable.Tpo -c -o gsequencer-ags_connectable.o `test -f 'src/ags-lib/object/ags_connectable.c' || echo '$(srcdir)/'`src/ags-lib/object/ags_connectable.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_connectable.Tpo $(DEPDIR)/gsequencer-ags_connectable.Po
#	$(AM_V_CC)source='src/ags-lib/object/ags_connectable.c' object='gsequencer-ags_connectable.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_connectable.o `test -f 'src/ags-lib/object/ags_connectable.c' || echo '$(srcdir)/'`src/ags-lib/object/ags_connectable.c

gsequencer-ags_connectable.obj: src/ags-lib/object/ags_connectable.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_connectable.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_connectable.Tpo -c -o gsequencer-ags_connectable.obj `if test -f 'src/ags-lib/object/ags_connectable.c'; then $(CYGPATH_W) 'src/ags-lib/object/ags_connectable.c'; else $(CYGPATH_W) '$(srcdir)/src/ags-lib/object/ags_connectable.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_connectable.Tpo $(DEPDIR)/gsequencer-ags_connectable.Po
#	$(AM_V_CC)source='src/ags-lib/object/ags_connectable.c' object='gsequencer-ags_connectable.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_connectable.obj `if test -f 'src/ags-lib/object/ags_connectable.c'; then $(CYGPATH_W) 'src/ags-lib/object/ags_connectable.c'; else $(CYGPATH_W) '$(srcdir)/src/ags-lib/object/ags_connectable.c'; fi`

gsequencer-ags_combo_box_text.o: src/ags/lib/ags_combo_box_text.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_combo_box_text.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_combo_box_text.Tpo -c -o gsequencer-ags_combo_box_text.o `test -f 'src/ags/lib/ags_combo_box_text.c' || echo '$(srcdir)/'`src/ags/lib/ags_combo_box_text.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_combo_box_text.Tpo $(DEPDIR)/gsequencer-ags_combo_box_text.Po
#	$(AM_V_CC)source='src/ags/lib/ags_combo_box_text.c' object='gsequencer-ags_combo_box_text.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_combo_box_text.o `test -f 'src/ags/lib/ags_combo_box_text.c' || echo '$(srcdir)/'`src/ags/lib/ags_combo_box_text.c

gsequencer-ags_combo_box_text.obj: src/ags/lib/ags_combo_box_text.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_combo_box_text.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_combo_box_text.Tpo -c -o gsequencer-ags_combo_box_text.obj `if test -f 'src/ags/lib/ags_combo_box_text.c'; then $(CYGPATH_W) 'src/ags/lib/ags_combo_box_text.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/lib/ags_combo_box_text.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_combo_box_text.Tpo $(DEPDIR)/gsequencer-ags_combo_box_text.Po
#	$(AM_V_CC)source='src/ags/lib/ags_combo_box_text.c' object='gsequencer-ags_combo_box_text.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_combo_box_text.obj `if test -f 'src/ags/lib/ags_combo_box_text.c'; then $(CYGPATH_W) 'src/ags/lib/ags_combo_box_text.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/lib/ags_combo_box_text.c'; fi`

gsequencer-ags_container.o: src/ags/lib/ags_container.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_container.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_container.Tpo -c -o gsequencer-ags_container.o `test -f 'src/ags/lib/ags_container.c' || echo '$(srcdir)/'`src/ags/lib/ags_container.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_container.Tpo $(DEPDIR)/gsequencer-ags_container.Po
#	$(AM_V_CC)source='src/ags/lib/ags_container.c' object='gsequencer-ags_container.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_container.o `test -f 'src/ags/lib/ags_container.c' || echo '$(srcdir)/'`src/ags/lib/ags_container.c

gsequencer-ags_container.obj: src/ags/lib/ags_container.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_container.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_container.Tpo -c -o gsequencer-ags_container.obj `if test -f 'src/ags/lib/ags_container.c'; then $(CYGPATH_W) 'src/ags/lib/ags_container.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/lib/ags_container.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_container.Tpo $(DEPDIR)/gsequencer-ags_container.Po
#	$(AM_V_CC)source='src/ags/lib/ags_container.c' object='gsequencer-ags_container.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_container.obj `if test -f 'src/ags/lib/ags_container.c'; then $(CYGPATH_W) 'src/ags/lib/ags_container.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/lib/ags_container.c'; fi`

gsequencer-ags_list.o: src/ags/lib/ags_list.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_list.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_list.Tpo -c -o gsequencer-ags_list.o `test -f 'src/ags/lib/ags_list.c' || echo '$(srcdir)/'`src/ags/lib/ags_list.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_list.Tpo $(DEPDIR)/gsequencer-ags_list.Po
#	$(AM_V_CC)source='src/ags/lib/ags_list.c' object='gsequencer-ags_list.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_list.o `test -f 'src/ags/lib/ags_list.c' || echo '$(srcdir)/'`src/ags/lib/ags_list.c

gsequencer-ags_list.obj: src/ags/lib/ags_list.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_list.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_list.Tpo -c -o gsequencer-ags_list.obj `if test -f 'src/ags/lib/ags_list.c'; then $(CYGPATH_W) 'src/ags/lib/ags_list.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/lib/ags_list.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_list.Tpo $(DEPDIR)/gsequencer-ags_list.Po
#	$(AM_V_CC)source='src/ags/lib/ags_list.c' object='gsequencer-ags_list.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_list.obj `if test -f 'src/ags/lib/ags_list.c'; then $(CYGPATH_W) 'src/ags/lib/ags_list.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/lib/ags_list.c'; fi`

gsequencer-ags_log.o: src/ags/lib/ags_log.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_log.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_log.Tpo -c -o gsequencer-ags_log.o `test -f 'src/ags/lib/ags_log.c' || echo '$(srcdir)/'`src/ags/lib/ags_log.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_log.Tpo $(DEPDIR)/gsequencer-ags_log.Po
#	$(AM_V_CC)source='src/ags/lib/ags_log.c' object='gsequencer-ags_log.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_log.o `test -f 'src/ags/lib/ags_log.c' || echo '$(srcdir)/'`src/ags/lib/ags_log.c

gsequencer-ags_log.obj: src/ags/lib/ags_log.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_log.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_log.Tpo -c -o gsequencer-ags_log.obj `if test -f 'src/ags/lib/ags_log.c'; then $(CYGPATH_W) 'src/ags/lib/ags_log.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/lib/ags_log.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_log.Tpo $(DEPDIR)/gsequencer-ags_log.Po
#	$(AM_V_CC)source='src/ags/lib/ags_log.c' object='gsequencer-ags_log.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_log.obj `if test -f 'src/ags/lib/ags_log.c'; then $(CYGPATH_W) 'src/ags/lib/ags_log.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/lib/ags_log.c'; fi`

gsequencer-ags_parameter.o: src/ags/lib/ags_parameter.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_parameter.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_parameter.Tpo -c -o gsequencer-ags_parameter.o `test -f 'src/ags/lib/ags_parameter.c' || echo '$(srcdir)/'`src/ags/lib/ags_parameter.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_parameter.Tpo $(DEPDIR)/gsequencer-ags_parameter.Po
#	$(AM_V_CC)source='src/ags/lib/ags_parameter.c' object='gsequencer-ags_parameter.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_parameter.o `test -f 'src/ags/lib/ags_parameter.c' || echo '$(srcdir)/'`src/ags/lib/ags_parameter.c

gsequencer-ags_parameter.obj: src/ags/lib/ags_parameter.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_parameter.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_parameter.Tpo -c -o gsequencer-ags_parameter.obj `if test -f 'src/ags/lib/ags_parameter.c'; then $(CYGPATH_W) 'src/ags/lib/ags_parameter.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/lib/ags_parameter.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_parameter.Tpo $(DEPDIR)/gsequencer-ags_parameter.Po
#	$(AM_V_CC)source='src/ags/lib/ags_parameter.c' object='gsequencer-ags_parameter.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_parameter.obj `if test -f 'src/ags/lib/ags_parameter.c'; then $(CYGPATH_W) 'src/ags/lib/ags_parameter.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/lib/ags_parameter.c'; fi`
...
gsequencer-ags_applicable.o: src/ags/object/ags_applicable.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_applicable.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_applicable.Tpo -c -o gsequencer-ags_applicable.o `test -f 'src/ags/object/ags_applicable.c' || echo '$(srcdir)/'`src/ags/object/ags_applicable.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_applicable.Tpo $(DEPDIR)/gsequencer-ags_applicable.Po
#	$(AM_V_CC)source='src/ags/object/ags_applicable.c' object='gsequencer-ags_applicable.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_applicable.o `test -f 'src/ags/object/ags_applicable.c' || echo '$(srcdir)/'`src/ags/object/ags_applicable.c

gsequencer-ags_applicable.obj: src/ags/object/ags_applicable.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_applicable.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_applicable.Tpo -c -o gsequencer-ags_applicable.obj `if test -f 'src/ags/object/ags_applicable.c'; then $(CYGPATH_W) 'src/ags/object/ags_applicable.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_applicable.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_applicable.Tpo $(DEPDIR)/gsequencer-ags_applicable.Po
#	$(AM_V_CC)source='src/ags/object/ags_applicable.c' object='gsequencer-ags_applicable.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_applicable.obj `if test -f 'src/ags/object/ags_applicable.c'; then $(CYGPATH_W) 'src/ags/object/ags_applicable.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_applicable.c'; fi`

gsequencer-ags_async_queue.o: src/ags/object/ags_async_queue.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_async_queue.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_async_queue.Tpo -c -o gsequencer-ags_async_queue.o `test -f 'src/ags/object/ags_async_queue.c' || echo '$(srcdir)/'`src/ags/object/ags_async_queue.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_async_queue.Tpo $(DEPDIR)/gsequencer-ags_async_queue.Po
#	$(AM_V_CC)source='src/ags/object/ags_async_queue.c' object='gsequencer-ags_async_queue.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_async_queue.o `test -f 'src/ags/object/ags_async_queue.c' || echo '$(srcdir)/'`src/ags/object/ags_async_queue.c
...
gsequencer-ags_async_queue.obj: src/ags/object/ags_async_queue.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_async_queue.Tpo $(DEPDIR)/gsequencer-ags_async_queue.Po
#	$(AM_V_CC)source='src/ags/object/ags_async_queue.c' object='gsequencer-ags_async_queue.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_async_queue.obj `if test -f 'src/ags/object/ags_async_queue.c'; then $(CYGPATH_W) 'src/ags/object/ags_async_queue.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_async_queue.c'; fi`

gsequencer-ags_countable.o: src/ags/object/ags_countable.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_countable.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_countable.Tpo -c -o gsequencer-ags_countable.o `test -f 'src/ags/object/ags_countable.c' || echo '$(srcdir)/'`src/ags/object/ags_countable.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_countable.Tpo $(DEPDIR)/gsequencer-ags_countable.Po
#	$(AM_V_CC)source='src/ags/object/ags_countable.c' object='gsequencer-ags_countable.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_countable.o `test -f 'src/ags/object/ags_countable.c' || echo '$(srcdir)/'`src/ags/object/ags_countable.c

gsequencer-ags_countable.obj: src/ags/object/ags_countable.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_countable.Tpo $(DEPDIR)/gsequencer-ags_countable.Po
#	$(AM_V_CC)source='src/ags/object/ags_countable.c' object='gsequencer-ags_countable.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_countable.obj `if test -f 'src/ags/object/ags_countable.c'; then $(CYGPATH_W) 'src/ags/object/ags_countable.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_countable.c'; fi`

gsequencer-ags_concurrent_tree.o: src/ags/object/ags_concurrent_tree.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_concurrent_tree.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_concurrent_tree.Tpo -c -o gsequencer-ags_concurrent_tree.o `test -f 'src/ags/object/ags_concurrent_tree.c' || echo '$(srcdir)/'`src/ags/object/ags_concurrent_tree.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_concurrent_tree.Tpo $(DEPDIR)/gsequencer-ags_concurrent_tree.Po
#	$(AM_V_CC)source='src/ags/object/ags_concurrent_tree.c' object='gsequencer-ags_concurrent_tree.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_concurrent_tree.o `test -f 'src/ags/object/ags_concurrent_tree.c' || echo '$(srcdir)/'`src/ags/object/ags_concurrent_tree.c

gsequencer-ags_concurrent_tree.obj: src/ags/object/ags_concurrent_tree.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_concurrent_tree.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_concurrent_tree.Tpo -c -o gsequencer-ags_concurrent_tree.obj `if test -f 'src/ags/object/ags_concurrent_tree.c'; then $(CYGPATH_W) 'src/ags/object/ags_concurrent_tree.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_concurrent_tree.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_concurrent_tree.Tpo $(DEPDIR)/gsequencer-ags_concurrent_tree.Po
#	$(AM_V_CC)source='src/ags/object/ags_concurrent_tree.c' object='gsequencer-ags_concurrent_tree.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_concurrent_tree.obj `if test -f 'src/ags/object/ags_concurrent_tree.c'; then $(CYGPATH_W) 'src/ags/object/ags_concurrent_tree.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_concurrent_tree.c'; fi`

gsequencer-ags_dynamic_connectable.o: src/ags/object/ags_dynamic_connectable.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_dynamic_connectable.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_dynamic_connectable.Tpo -c -o gsequencer-ags_dynamic_connectable.o `test -f 'src/ags/object/ags_dynamic_connectable.c' || echo '$(srcdir)/'`src/ags/object/ags_dynamic_connectable.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_dynamic_connectable.Tpo $(DEPDIR)/gsequencer-ags_dynamic_connectable.Po
#	$(AM_V_CC)source='src/ags/object/ags_dynamic_connectable.c' object='gsequencer-ags_dynamic_connectable.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_dynamic_connectable.o `test -f 'src/ags/object/ags_dynamic_connectable.c' || echo '$(srcdir)/'`src/ags/object/ags_dynamic_connectable.c

gsequencer-ags_dynamic_connectable.obj: src/ags/object/ags_dynamic_connectable.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_dynamic_connectable.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_dynamic_connectable.Tpo -c -o gsequencer-ags_dynamic_connectable.obj `if test -f 'src/ags/object/ags_dynamic_connectable.c'; then $(CYGPATH_W) 'src/ags/object/ags_dynamic_connectable.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_dynamic_connectable.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_dynamic_connectable.Tpo $(DEPDIR)/gsequencer-ags_dynamic_connectable.Po
#	$(AM_V_CC)source='src/ags/object/ags_dynamic_connectable.c' object='gsequencer-ags_dynamic_connectable.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_dynamic_connectable.obj `if test -f 'src/ags/object/ags_dynamic_connectable.c'; then $(CYGPATH_W) 'src/ags/object/ags_dynamic_connectable.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_dynamic_connectable.c'; fi`

gsequencer-ags_effect.o: src/ags/object/ags_effect.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_effect.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_effect.Tpo -c -o gsequencer-ags_effect.o `test -f 'src/ags/object/ags_effect.c' || echo '$(srcdir)/'`src/ags/object/ags_effect.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_effect.Tpo $(DEPDIR)/gsequencer-ags_effect.Po
#	$(AM_V_CC)source='src/ags/object/ags_effect.c' object='gsequencer-ags_effect.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_effect.o `test -f 'src/ags/object/ags_effect.c' || echo '$(srcdir)/'`src/ags/object/ags_effect.c

gsequencer-ags_effect.obj: src/ags/object/ags_effect.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_effect.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_effect.Tpo -c -o gsequencer-ags_effect.obj `if test -f 'src/ags/object/ags_effect.c'; then $(CYGPATH_W) 'src/ags/object/ags_effect.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_effect.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_effect.Tpo $(DEPDIR)/gsequencer-ags_effect.Po
#	$(AM_V_CC)source='src/ags/object/ags_effect.c' object='gsequencer-ags_effect.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_effect.obj `if test -f 'src/ags/object/ags_effect.c'; then $(CYGPATH_W) 'src/ags/object/ags_effect.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_effect.c'; fi`

gsequencer-ags_main_loop.o: src/ags/object/ags_main_loop.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_main_loop.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_main_loop.Tpo -c -o gsequencer-ags_main_loop.o `test -f 'src/ags/object/ags_main_loop.c' || echo '$(srcdir)/'`src/ags/object/ags_main_loop.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_main_loop.Tpo $(DEPDIR)/gsequencer-ags_main_loop.Po
#	$(AM_V_CC)source='src/ags/object/ags_main_loop.c' object='gsequencer-ags_main_loop.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_main_loop.o `test -f 'src/ags/object/ags_main_loop.c' || echo '$(srcdir)/'`src/ags/object/ags_main_loop.c

gsequencer-ags_main_loop.obj: src/ags/object/ags_main_loop.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_main_loop.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_main_loop.Tpo -c -o gsequencer-ags_main_loop.obj `if test -f 'src/ags/object/ags_main_loop.c'; then $(CYGPATH_W) 'src/ags/object/ags_main_loop.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_main_loop.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_main_loop.Tpo $(DEPDIR)/gsequencer-ags_main_loop.Po
#	$(AM_V_CC)source='src/ags/object/ags_main_loop.c' object='gsequencer-ags_main_loop.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_main_loop.obj `if test -f 'src/ags/object/ags_main_loop.c'; then $(CYGPATH_W) 'src/ags/object/ags_main_loop.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_main_loop.c'; fi`

gsequencer-ags_marshal.o: src/ags/object/ags_marshal.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_marshal.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_marshal.Tpo -c -o gsequencer-ags_marshal.o `test -f 'src/ags/object/ags_marshal.c' || echo '$(srcdir)/'`src/ags/object/ags_marshal.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_marshal.Tpo $(DEPDIR)/gsequencer-ags_marshal.Po
#	$(AM_V_CC)source='src/ags/object/ags_marshal.c' object='gsequencer-ags_marshal.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_marshal.o `test -f 'src/ags/object/ags_marshal.c' || echo '$(srcdir)/'`src/ags/object/ags_marshal.c

gsequencer-ags_marshal.obj: src/ags/object/ags_marshal.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_marshal.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_marshal.Tpo -c -o gsequencer-ags_marshal.obj `if test -f 'src/ags/object/ags_marshal.c'; then $(CYGPATH_W) 'src/ags/object/ags_marshal.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_marshal.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_marshal.Tpo $(DEPDIR)/gsequencer-ags_marshal.Po
#	$(AM_V_CC)source='src/ags/object/ags_marshal.c' object='gsequencer-ags_marshal.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_marshal.obj `if test -f 'src/ags/object/ags_marshal.c'; then $(CYGPATH_W) 'src/ags/object/ags_marshal.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_marshal.c'; fi`

gsequencer-ags_mutable.o: src/ags/object/ags_mutable.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_mutable.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_mutable.Tpo -c -o gsequencer-ags_mutable.o `test -f 'src/ags/object/ags_mutable.c' || echo '$(srcdir)/'`src/ags/object/ags_mutable.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_mutable.Tpo $(DEPDIR)/gsequencer-ags_mutable.Po
#	$(AM_V_CC)source='src/ags/object/ags_mutable.c' object='gsequencer-ags_mutable.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_mutable.o `test -f 'src/ags/object/ags_mutable.c' || echo '$(srcdir)/'`src/ags/object/ags_mutable.c

gsequencer-ags_mutable.obj: src/ags/object/ags_mutable.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_mutable.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_mutable.Tpo -c -o gsequencer-ags_mutable.obj `if test -f 'src/ags/object/ags_mutable.c'; then $(CYGPATH_W) 'src/ags/object/ags_mutable.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_mutable.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_mutable.Tpo $(DEPDIR)/gsequencer-ags_mutable.Po
#	$(AM_V_CC)source='src/ags/object/ags_mutable.c' object='gsequencer-ags_mutable.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_mutable.obj `if test -f 'src/ags/object/ags_mutable.c'; then $(CYGPATH_W) 'src/ags/object/ags_mutable.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_mutable.c'; fi`

gsequencer-ags_packable.o: src/ags/object/ags_packable.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_packable.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_packable.Tpo -c -o gsequencer-ags_packable.o `test -f 'src/ags/object/ags_packable.c' || echo '$(srcdir)/'`src/ags/object/ags_packable.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_packable.Tpo $(DEPDIR)/gsequencer-ags_packable.Po
#	$(AM_V_CC)source='src/ags/object/ags_packable.c' object='gsequencer-ags_packable.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_packable.o `test -f 'src/ags/object/ags_packable.c' || echo '$(srcdir)/'`src/ags/object/ags_packable.c

gsequencer-ags_packable.obj: src/ags/object/ags_packable.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_packable.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_packable.Tpo -c -o gsequencer-ags_packable.obj `if test -f 'src/ags/object/ags_packable.c'; then $(CYGPATH_W) 'src/ags/object/ags_packable.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_packable.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_packable.Tpo $(DEPDIR)/gsequencer-ags_packable.Po
#	$(AM_V_CC)source='src/ags/object/ags_packable.c' object='gsequencer-ags_packable.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_packable.obj `if test -f 'src/ags/object/ags_packable.c'; then $(CYGPATH_W) 'src/ags/object/ags_packable.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_packable.c'; fi`

gsequencer-ags_persistable.o: src/ags/object/ags_persistable.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_persistable.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_persistable.Tpo -c -o gsequencer-ags_persistable.o `test -f 'src/ags/object/ags_persistable.c' || echo '$(srcdir)/'`src/ags/object/ags_persistable.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_persistable.Tpo $(DEPDIR)/gsequencer-ags_persistable.Po
#	$(AM_V_CC)source='src/ags/object/ags_persistable.c' object='gsequencer-ags_persistable.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_persistable.o `test -f 'src/ags/object/ags_persistable.c' || echo '$(srcdir)/'`src/ags/object/ags_persistable.c

gsequencer-ags_persistable.obj: src/ags/object/ags_persistable.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_persistable.Tpo $(DEPDIR)/gsequencer-ags_persistable.Po
#	$(AM_V_CC)source='src/ags/object/ags_persistable.c' object='gsequencer-ags_persistable.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_persistable.obj `if test -f 'src/ags/object/ags_persistable.c'; then $(CYGPATH_W) 'src/ags/object/ags_persistable.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_persistable.c'; fi`

gsequencer-ags_playable.o: src/ags/object/ags_playable.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_playable.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_playable.Tpo -c -o gsequencer-ags_playable.o `test -f 'src/ags/object/ags_playable.c' || echo '$(srcdir)/'`src/ags/object/ags_playable.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_playable.Tpo $(DEPDIR)/gsequencer-ags_playable.Po
#	$(AM_V_CC)source='src/ags/object/ags_playable.c' object='gsequencer-ags_playable.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_playable.o `test -f 'src/ags/object/ags_playable.c' || echo '$(srcdir)/'`src/ags/object/ags_playable.c

gsequencer-ags_playable.obj: src/ags/object/ags_playable.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_playable.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_playable.Tpo -c -o gsequencer-ags_playable.obj `if test -f 'src/ags/object/ags_playable.c'; then $(CYGPATH_W) 'src/ags/object/ags_playable.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_playable.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_playable.Tpo $(DEPDIR)/gsequencer-ags_playable.Po
#	$(AM_V_CC)source='src/ags/object/ags_playable.c' object='gsequencer-ags_playable.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_playable.obj `if test -f 'src/ags/object/ags_playable.c'; then $(CYGPATH_W) 'src/ags/object/ags_playable.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_playable.c'; fi`

gsequencer-ags_plugin.o: src/ags/object/ags_plugin.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_plugin.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_plugin.Tpo -c -o gsequencer-ags_plugin.o `test -f 'src/ags/object/ags_plugin.c' || echo '$(srcdir)/'`src/ags/object/ags_plugin.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_plugin.Tpo $(DEPDIR)/gsequencer-ags_plugin.Po
#	$(AM_V_CC)source='src/ags/object/ags_plugin.c' object='gsequencer-ags_plugin.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_plugin.o `test -f 'src/ags/object/ags_plugin.c' || echo '$(srcdir)/'`src/ags/object/ags_plugin.c

gsequencer-ags_plugin.obj: src/ags/object/ags_plugin.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_plugin.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_plugin.Tpo -c -o gsequencer-ags_plugin.obj `if test -f 'src/ags/object/ags_plugin.c'; then $(CYGPATH_W) 'src/ags/object/ags_plugin.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_plugin.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_plugin.Tpo $(DEPDIR)/gsequencer-ags_plugin.Po
#	$(AM_V_CC)source='src/ags/object/ags_plugin.c' object='gsequencer-ags_plugin.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_plugin.obj `if test -f 'src/ags/object/ags_plugin.c'; then $(CYGPATH_W) 'src/ags/object/ags_plugin.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_plugin.c'; fi`

gsequencer-ags_portlet.o: src/ags/object/ags_portlet.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_portlet.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_portlet.Tpo -c -o gsequencer-ags_portlet.o `test -f 'src/ags/object/ags_portlet.c' || echo '$(srcdir)/'`src/ags/object/ags_portlet.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_portlet.Tpo $(DEPDIR)/gsequencer-ags_portlet.Po
#	$(AM_V_CC)source='src/ags/object/ags_portlet.c' object='gsequencer-ags_portlet.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_portlet.o `test -f 'src/ags/object/ags_portlet.c' || echo '$(srcdir)/'`src/ags/object/ags_portlet.c

gsequencer-ags_portlet.obj: src/ags/object/ags_portlet.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_portlet.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_portlet.Tpo -c -o gsequencer-ags_portlet.obj `if test -f 'src/ags/object/ags_portlet.c'; then $(CYGPATH_W) 'src/ags/object/ags_portlet.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_portlet.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_portlet.Tpo $(DEPDIR)/gsequencer-ags_portlet.Po
#	$(AM_V_CC)source='src/ags/object/ags_portlet.c' object='gsequencer-ags_portlet.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_portlet.obj `if test -f 'src/ags/object/ags_portlet.c'; then $(CYGPATH_W) 'src/ags/object/ags_portlet.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_portlet.c'; fi`

gsequencer-ags_runnable.o: src/ags/object/ags_runnable.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_runnable.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_runnable.Tpo -c -o gsequencer-ags_runnable.o `test -f 'src/ags/object/ags_runnable.c' || echo '$(srcdir)/'`src/ags/object/ags_runnable.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_runnable.Tpo $(DEPDIR)/gsequencer-ags_runnable.Po
#	$(AM_V_CC)source='src/ags/object/ags_runnable.c' object='gsequencer-ags_runnable.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_runnable.o `test -f 'src/ags/object/ags_runnable.c' || echo '$(srcdir)/'`src/ags/object/ags_runnable.c

gsequencer-ags_runnable.obj: src/ags/object/ags_runnable.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_runnable.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_runnable.Tpo -c -o gsequencer-ags_runnable.obj `if test -f 'src/ags/object/ags_runnable.c'; then $(CYGPATH_W) 'src/ags/object/ags_runnable.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_runnable.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_runnable.Tpo $(DEPDIR)/gsequencer-ags_runnable.Po
#	$(AM_V_CC)source='src/ags/object/ags_runnable.c' object='gsequencer-ags_runnable.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_runnable.obj `if test -f 'src/ags/object/ags_runnable.c'; then $(CYGPATH_W) 'src/ags/object/ags_runnable.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_runnable.c'; fi`

gsequencer-ags_seekable.o: src/ags/object/ags_seekable.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_seekable.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_seekable.Tpo -c -o gsequencer-ags_seekable.o `test -f 'src/ags/object/ags_seekable.c' || echo '$(srcdir)/'`src/ags/object/ags_seekable.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_seekable.Tpo $(DEPDIR)/gsequencer-ags_seekable.Po
#	$(AM_V_CC)source='src/ags/object/ags_seekable.c' object='gsequencer-ags_seekable.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_seekable.o `test -f 'src/ags/object/ags_seekable.c' || echo '$(srcdir)/'`src/ags/object/ags_seekable.c

gsequencer-ags_seekable.obj: src/ags/object/ags_seekable.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_seekable.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_seekable.Tpo -c -o gsequencer-ags_seekable.obj `if test -f 'src/ags/object/ags_seekable.c'; then $(CYGPATH_W) 'src/ags/object/ags_seekable.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_seekable.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_seekable.Tpo $(DEPDIR)/gsequencer-ags_seekable.Po
#	$(AM_V_CC)source='src/ags/object/ags_seekable.c' object='gsequencer-ags_seekable.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_seekable.obj `if test -f 'src/ags/object/ags_seekable.c'; then $(CYGPATH_W) 'src/ags/object/ags_seekable.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_seekable.c'; fi`

gsequencer-ags_soundcard.o: src/ags/object/ags_soundcard.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_soundcard.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_soundcard.Tpo -c -o gsequencer-ags_soundcard.o `test -f 'src/ags/object/ags_soundcard.c' || echo '$(srcdir)/'`src/ags/object/ags_soundcard.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_soundcard.Tpo $(DEPDIR)/gsequencer-ags_soundcard.Po
#	$(AM_V_CC)source='src/ags/object/ags_soundcard.c' object='gsequencer-ags_soundcard.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_soundcard.o `test -f 'src/ags/object/ags_soundcard.c' || echo '$(srcdir)/'`src/ags/object/ags_soundcard.c

gsequencer-ags_soundcard.obj: src/ags/object/ags_soundcard.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_soundcard.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_soundcard.Tpo -c -o gsequencer-ags_soundcard.obj `if test -f 'src/ags/object/ags_soundcard.c'; then $(CYGPATH_W) 'src/ags/object/ags_soundcard.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_soundcard.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_soundcard.Tpo $(DEPDIR)/gsequencer-ags_soundcard.Po
#	$(AM_V_CC)source='src/ags/object/ags_soundcard.c' object='gsequencer-ags_soundcard.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_soundcard.obj `if test -f 'src/ags/object/ags_soundcard.c'; then $(CYGPATH_W) 'src/ags/object/ags_soundcard.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_soundcard.c'; fi`

gsequencer-ags_stackable.o: src/ags/object/ags_stackable.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_stackable.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_stackable.Tpo -c -o gsequencer-ags_stackable.o `test -f 'src/ags/object/ags_stackable.c' || echo '$(srcdir)/'`src/ags/object/ags_stackable.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_stackable.Tpo $(DEPDIR)/gsequencer-ags_stackable.Po
#	$(AM_V_CC)source='src/ags/object/ags_stackable.c' object='gsequencer-ags_stackable.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_stackable.o `test -f 'src/ags/object/ags_stackable.c' || echo '$(srcdir)/'`src/ags/object/ags_stackable.c

gsequencer-ags_stackable.obj: src/ags/object/ags_stackable.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_stackable.Tpo $(DEPDIR)/gsequencer-ags_stackable.Po
#	$(AM_V_CC)source='src/ags/object/ags_stackable.c' object='gsequencer-ags_stackable.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_stackable.obj `if test -f 'src/ags/object/ags_stackable.c'; then $(CYGPATH_W) 'src/ags/object/ags_stackable.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_stackable.c'; fi`

gsequencer-ags_tactable.o: src/ags/object/ags_tactable.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_tactable.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_tactable.Tpo -c -o gsequencer-ags_tactable.o `test -f 'src/ags/object/ags_tactable.c' || echo '$(srcdir)/'`src/ags/object/ags_tactable.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_tactable.Tpo $(DEPDIR)/gsequencer-ags_tactable.Po
#	$(AM_V_CC)source='src/ags/object/ags_tactable.c' object='gsequencer-ags_tactable.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_tactable.o `test -f 'src/ags/object/ags_tactable.c' || echo '$(srcdir)/'`src/ags/object/ags_tactable.c

gsequencer-ags_tactable.obj: src/ags/object/ags_tactable.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_tactable.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_tactable.Tpo -c -o gsequencer-ags_tactable.obj `if test -f 'src/ags/object/ags_tactable.c'; then $(CYGPATH_W) 'src/ags/object/ags_tactable.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_tactable.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_tactable.Tpo $(DEPDIR)/gsequencer-ags_tactable.Po
#	$(AM_V_CC)source='src/ags/object/ags_tactable.c' object='gsequencer-ags_tactable.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_tactable.obj `if test -f 'src/ags/object/ags_tactable.c'; then $(CYGPATH_W) 'src/ags/object/ags_tactable.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_tactable.c'; fi`

gsequencer-ags_tree_iterator.o: src/ags/object/ags_tree_iterator.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_tree_iterator.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_tree_iterator.Tpo -c -o gsequencer-ags_tree_iterator.o `test -f 'src/ags/object/ags_tree_iterator.c' || echo '$(srcdir)/'`src/ags/object/ags_tree_iterator.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_tree_iterator.Tpo $(DEPDIR)/gsequencer-ags_tree_iterator.Po
#	$(AM_V_CC)source='src/ags/object/ags_tree_iterator.c' object='gsequencer-ags_tree_iterator.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_tree_iterator.o `test -f 'src/ags/object/ags_tree_iterator.c' || echo '$(srcdir)/'`src/ags/object/ags_tree_iterator.c

gsequencer-ags_tree_iterator.obj: src/ags/object/ags_tree_iterator.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_tree_iterator.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_tree_iterator.Tpo -c -o gsequencer-ags_tree_iterator.obj `if test -f 'src/ags/object/ags_tree_iterator.c'; then $(CYGPATH_W) 'src/ags/object/ags_tree_iterator.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_tree_iterator.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_tree_iterator.Tpo $(DEPDIR)/gsequencer-ags_tree_iterator.Po
#	$(AM_V_CC)source='src/ags/object/ags_tree_iterator.c' object='gsequencer-ags_tree_iterator.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_tree_iterator.obj `if test -f 'src/ags/object/ags_tree_iterator.c'; then $(CYGPATH_W) 'src/ags/object/ags_tree_iterator.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/object/ags_tree_iterator.c'; fi`

gsequencer-ags_ladspa_manager.o: src/ags/plugin/ags_ladspa_manager.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_ladspa_manager.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_ladspa_manager.Tpo -c -o gsequencer-ags_ladspa_manager.o `test -f 'src/ags/plugin/ags_ladspa_manager.c' || echo '$(srcdir)/'`src/ags/plugin/ags_ladspa_manager.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_ladspa_manager.Tpo $(DEPDIR)/gsequencer-ags_ladspa_manager.Po
#	$(AM_V_CC)source='src/ags/plugin/ags_ladspa_manager.c' object='gsequencer-ags_ladspa_manager.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_ladspa_manager.o `test -f 'src/ags/plugin/ags_ladspa_manager.c' || echo '$(srcdir)/'`src/ags/plugin/ags_ladspa_manager.c

gsequencer-ags_ladspa_manager.obj: src/ags/plugin/ags_ladspa_manager.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_ladspa_manager.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_ladspa_manager.Tpo -c -o gsequencer-ags_ladspa_manager.obj `if test -f 'src/ags/plugin/ags_ladspa_manager.c'; then $(CYGPATH_W) 'src/ags/plugin/ags_ladspa_manager.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/plugin/ags_ladspa_manager.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_ladspa_manager.Tpo $(DEPDIR)/gsequencer-ags_ladspa_manager.Po
#	$(AM_V_CC)source='src/ags/plugin/ags_ladspa_manager.c' object='gsequencer-ags_ladspa_manager.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_ladspa_manager.obj `if test -f 'src/ags/plugin/ags_ladspa_manager.c'; then $(CYGPATH_W) 'src/ags/plugin/ags_ladspa_manager.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/plugin/ags_ladspa_manager.c'; fi`

gsequencer-ags_plugin_factory.o: src/ags/plugin/ags_plugin_factory.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_plugin_factory.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_plugin_factory.Tpo -c -o gsequencer-ags_plugin_factory.o `test -f 'src/ags/plugin/ags_plugin_factory.c' || echo '$(srcdir)/'`src/ags/plugin/ags_plugin_factory.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_plugin_factory.Tpo $(DEPDIR)/gsequencer-ags_plugin_factory.Po
#	$(AM_V_CC)source='src/ags/plugin/ags_plugin_factory.c' object='gsequencer-ags_plugin_factory.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_plugin_factory.o `test -f 'src/ags/plugin/ags_plugin_factory.c' || echo '$(srcdir)/'`src/ags/plugin/ags_plugin_factory.c

gsequencer-ags_plugin_factory.obj: src/ags/plugin/ags_plugin_factory.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_plugin_factory.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_plugin_factory.Tpo -c -o gsequencer-ags_plugin_factory.obj `if test -f 'src/ags/plugin/ags_plugin_factory.c'; then $(CYGPATH_W) 'src/ags/plugin/ags_plugin_factory.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/plugin/ags_plugin_factory.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_plugin_factory.Tpo $(DEPDIR)/gsequencer-ags_plugin_factory.Po
#	$(AM_V_CC)source='src/ags/plugin/ags_plugin_factory.c' object='gsequencer-ags_plugin_factory.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_plugin_factory.obj `if test -f 'src/ags/plugin/ags_plugin_factory.c'; then $(CYGPATH_W) 'src/ags/plugin/ags_plugin_factory.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/plugin/ags_plugin_factory.c'; fi`
...
gsequencer-ags_audio_loop.o: src/ags/thread/ags_audio_loop.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_audio_loop.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_audio_loop.Tpo -c -o gsequencer-ags_audio_loop.o `test -f 'src/ags/thread/ags_audio_loop.c' || echo '$(srcdir)/'`src/ags/thread/ags_audio_loop.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_audio_loop.Tpo $(DEPDIR)/gsequencer-ags_audio_loop.Po
#	$(AM_V_CC)source='src/ags/thread/ags_audio_loop.c' object='gsequencer-ags_audio_loop.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_audio_loop.o `test -f 'src/ags/thread/ags_audio_loop.c' || echo '$(srcdir)/'`src/ags/thread/ags_audio_loop.c

gsequencer-ags_audio_loop.obj: src/ags/thread/ags_audio_loop.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_audio_loop.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_audio_loop.Tpo -c -o gsequencer-ags_audio_loop.obj `if test -f 'src/ags/thread/ags_audio_loop.c'; then $(CYGPATH_W) 'src/ags/thread/ags_audio_loop.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_audio_loop.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_audio_loop.Tpo $(DEPDIR)/gsequencer-ags_audio_loop.Po
#	$(AM_V_CC)source='src/ags/thread/ags_audio_loop.c' object='gsequencer-ags_audio_loop.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_audio_loop.obj `if test -f 'src/ags/thread/ags_audio_loop.c'; then $(CYGPATH_W) 'src/ags/thread/ags_audio_loop.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_audio_loop.c'; fi`

gsequencer-ags_audio_thread.o: src/ags/thread/ags_audio_thread.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_audio_thread.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_audio_thread.Tpo -c -o gsequencer-ags_audio_thread.o `test -f 'src/ags/thread/ags_audio_thread.c' || echo '$(srcdir)/'`src/ags/thread/ags_audio_thread.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_audio_thread.Tpo $(DEPDIR)/gsequencer-ags_audio_thread.Po
#	$(AM_V_CC)source='src/ags/thread/ags_audio_thread.c' object='gsequencer-ags_audio_thread.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_audio_thread.o `test -f 'src/ags/thread/ags_audio_thread.c' || echo '$(srcdir)/'`src/ags/thread/ags_audio_thread.c

gsequencer-ags_audio_thread.obj: src/ags/thread/ags_audio_thread.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_audio_thread.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_audio_thread.Tpo -c -o gsequencer-ags_audio_thread.obj `if test -f 'src/ags/thread/ags_audio_thread.c'; then $(CYGPATH_W) 'src/ags/thread/ags_audio_thread.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_audio_thread.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_audio_thread.Tpo $(DEPDIR)/gsequencer-ags_audio_thread.Po
#	$(AM_V_CC)source='src/ags/thread/ags_audio_thread.c' object='gsequencer-ags_audio_thread.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_audio_thread.obj `if test -f 'src/ags/thread/ags_audio_thread.c'; then $(CYGPATH_W) 'src/ags/thread/ags_audio_thread.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_audio_thread.c'; fi`

gsequencer-ags_autosave_thread.o: src/ags/thread/ags_autosave_thread.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_autosave_thread.Tpo $(DEPDIR)/gsequencer-ags_autosave_thread.Po
#	$(AM_V_CC)source='src/ags/thread/ags_autosave_thread.c' object='gsequencer-ags_autosave_thread.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_autosave_thread.o `test -f 'src/ags/thread/ags_autosave_thread.c' || echo '$(srcdir)/'`src/ags/thread/ags_autosave_thread.c

gsequencer-ags_autosave_thread.obj: src/ags/thread/ags_autosave_thread.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_autosave_thread.Tpo $(DEPDIR)/gsequencer-ags_autosave_thread.Po
#	$(AM_V_CC)source='src/ags/thread/ags_autosave_thread.c' object='gsequencer-ags_autosave_thread.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_autosave_thread.obj `if test -f 'src/ags/thread/ags_autosave_thread.c'; then $(CYGPATH_W) 'src/ags/thread/ags_autosave_thread.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_autosave_thread.c'; fi`

gsequencer-ags_channel_thread.o: src/ags/thread/ags_channel_thread.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_channel_thread.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_channel_thread.Tpo -c -o gsequencer-ags_channel_thread.o `test -f 'src/ags/thread/ags_channel_thread.c' || echo '$(srcdir)/'`src/ags/thread/ags_channel_thread.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_channel_thread.Tpo $(DEPDIR)/gsequencer-ags_channel_thread.Po
#	$(AM_V_CC)source='src/ags/thread/ags_channel_thread.c' object='gsequencer-ags_channel_thread.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_channel_thread.o `test -f 'src/ags/thread/ags_channel_thread.c' || echo '$(srcdir)/'`src/ags/thread/ags_channel_thread.c

gsequencer-ags_channel_thread.obj: src/ags/thread/ags_channel_thread.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_channel_thread.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_channel_thread.Tpo -c -o gsequencer-ags_channel_thread.obj `if test -f 'src/ags/thread/ags_channel_thread.c'; then $(CYGPATH_W) 'src/ags/thread/ags_channel_thread.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_channel_thread.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_channel_thread.Tpo $(DEPDIR)/gsequencer-ags_channel_thread.Po
#	$(AM_V_CC)source='src/ags/thread/ags_channel_thread.c' object='gsequencer-ags_channel_thread.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_channel_thread.obj `if test -f 'src/ags/thread/ags_channel_thread.c'; then $(CYGPATH_W) 'src/ags/thread/ags_channel_thread.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_channel_thread.c'; fi`

gsequencer-ags_devout_thread.o: src/ags/thread/ags_devout_thread.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_devout_thread.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_devout_thread.Tpo -c -o gsequencer-ags_devout_thread.o `test -f 'src/ags/thread/ags_devout_thread.c' || echo '$(srcdir)/'`src/ags/thread/ags_devout_thread.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_devout_thread.Tpo $(DEPDIR)/gsequencer-ags_devout_thread.Po
#	$(AM_V_CC)source='src/ags/thread/ags_devout_thread.c' object='gsequencer-ags_devout_thread.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_devout_thread.o `test -f 'src/ags/thread/ags_devout_thread.c' || echo '$(srcdir)/'`src/ags/thread/ags_devout_thread.c

gsequencer-ags_devout_thread.obj: src/ags/thread/ags_devout_thread.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_devout_thread.Tpo $(DEPDIR)/gsequencer-ags_devout_thread.Po
#	$(AM_V_CC)source='src/ags/thread/ags_devout_thread.c' object='gsequencer-ags_devout_thread.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_devout_thread.obj `if test -f 'src/ags/thread/ags_devout_thread.c'; then $(CYGPATH_W) 'src/ags/thread/ags_devout_thread.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_devout_thread.c'; fi`

gsequencer-ags_export_thread.o: src/ags/thread/ags_export_thread.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_export_thread.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_export_thread.Tpo -c -o gsequencer-ags_export_thread.o `test -f 'src/ags/thread/ags_export_thread.c' || echo '$(srcdir)/'`src/ags/thread/ags_export_thread.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_export_thread.Tpo $(DEPDIR)/gsequencer-ags_export_thread.Po
#	$(AM_V_CC)source='src/ags/thread/ags_export_thread.c' object='gsequencer-ags_export_thread.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_export_thread.o `test -f 'src/ags/thread/ags_export_thread.c' || echo '$(srcdir)/'`src/ags/thread/ags_export_thread.c

gsequencer-ags_export_thread.obj: src/ags/thread/ags_export_thread.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_export_thread.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_export_thread.Tpo -c -o gsequencer-ags_export_thread.obj `if test -f 'src/ags/thread/ags_export_thread.c'; then $(CYGPATH_W) 'src/ags/thread/ags_export_thread.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_export_thread.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_export_thread.Tpo $(DEPDIR)/gsequencer-ags_export_thread.Po
#	$(AM_V_CC)source='src/ags/thread/ags_export_thread.c' object='gsequencer-ags_export_thread.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_export_thread.obj `if test -f 'src/ags/thread/ags_export_thread.c'; then $(CYGPATH_W) 'src/ags/thread/ags_export_thread.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_export_thread.c'; fi`

gsequencer-ags_gui_task_thread.o: src/ags/thread/ags_gui_task_thread.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_gui_task_thread.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_gui_task_thread.Tpo -c -o gsequencer-ags_gui_task_thread.o `test -f 'src/ags/thread/ags_gui_task_thread.c' || echo '$(srcdir)/'`src/ags/thread/ags_gui_task_thread.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_gui_task_thread.Tpo $(DEPDIR)/gsequencer-ags_gui_task_thread.Po
#	$(AM_V_CC)source='src/ags/thread/ags_gui_task_thread.c' object='gsequencer-ags_gui_task_thread.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_gui_task_thread.o `test -f 'src/ags/thread/ags_gui_task_thread.c' || echo '$(srcdir)/'`src/ags/thread/ags_gui_task_thread.c

gsequencer-ags_gui_task_thread.obj: src/ags/thread/ags_gui_task_thread.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_gui_task_thread.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_gui_task_thread.Tpo -c -o gsequencer-ags_gui_task_thread.obj `if test -f 'src/ags/thread/ags_gui_task_thread.c'; then $(CYGPATH_W) 'src/ags/thread/ags_gui_task_thread.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_gui_task_thread.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_gui_task_thread.Tpo $(DEPDIR)/gsequencer-ags_gui_task_thread.Po
#	$(AM_V_CC)source='src/ags/thread/ags_gui_task_thread.c' object='gsequencer-ags_gui_task_thread.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_gui_task_thread.obj `if test -f 'src/ags/thread/ags_gui_task_thread.c'; then $(CYGPATH_W) 'src/ags/thread/ags_gui_task_thread.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_gui_task_thread.c'; fi`

gsequencer-ags_gui_thread.o: src/ags/thread/ags_gui_thread.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_gui_thread.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_gui_thread.Tpo -c -o gsequencer-ags_gui_thread.o `test -f 'src/ags/thread/ags_gui_thread.c' || echo '$(srcdir)/'`src/ags/thread/ags_gui_thread.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_gui_thread.Tpo $(DEPDIR)/gsequencer-ags_gui_thread.Po
#	$(AM_V_CC)source='src/ags/thread/ags_gui_thread.c' object='gsequencer-ags_gui_thread.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_gui_thread.o `test -f 'src/ags/thread/ags_gui_thread.c' || echo '$(srcdir)/'`src/ags/thread/ags_gui_thread.c

gsequencer-ags_gui_thread.obj: src/ags/thread/ags_gui_thread.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_gui_thread.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_gui_thread.Tpo -c -o gsequencer-ags_gui_thread.obj `if test -f 'src/ags/thread/ags_gui_thread.c'; then $(CYGPATH_W) 'src/ags/thread/ags_gui_thread.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_gui_thread.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_gui_thread.Tpo $(DEPDIR)/gsequencer-ags_gui_thread.Po
#	$(AM_V_CC)source='src/ags/thread/ags_gui_thread.c' object='gsequencer-ags_gui_thread.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_gui_thread.obj `if test -f 'src/ags/thread/ags_gui_thread.c'; then $(CYGPATH_W) 'src/ags/thread/ags_gui_thread.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_gui_thread.c'; fi`

gsequencer-ags_history.o: src/ags/thread/ags_history.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_history.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_history.Tpo -c -o gsequencer-ags_history.o `test -f 'src/ags/thread/ags_history.c' || echo '$(srcdir)/'`src/ags/thread/ags_history.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_history.Tpo $(DEPDIR)/gsequencer-ags_history.Po
#	$(AM_V_CC)source='src/ags/thread/ags_history.c' object='gsequencer-ags_history.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_history.o `test -f 'src/ags/thread/ags_history.c' || echo '$(srcdir)/'`src/ags/thread/ags_history.c

gsequencer-ags_history.obj: src/ags/thread/ags_history.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_history.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_history.Tpo -c -o gsequencer-ags_history.obj `if test -f 'src/ags/thread/ags_history.c'; then $(CYGPATH_W) 'src/ags/thread/ags_history.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_history.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_history.Tpo $(DEPDIR)/gsequencer-ags_history.Po
#	$(AM_V_CC)source='src/ags/thread/ags_history.c' object='gsequencer-ags_history.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_history.obj `if test -f 'src/ags/thread/ags_history.c'; then $(CYGPATH_W) 'src/ags/thread/ags_history.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_history.c'; fi`

gsequencer-ags_iterator_thread.o: src/ags/thread/ags_iterator_thread.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_iterator_thread.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_iterator_thread.Tpo -c -o gsequencer-ags_iterator_thread.o `test -f 'src/ags/thread/ags_iterator_thread.c' || echo '$(srcdir)/'`src/ags/thread/ags_iterator_thread.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_iterator_thread.Tpo $(DEPDIR)/gsequencer-ags_iterator_thread.Po
#	$(AM_V_CC)source='src/ags/thread/ags_iterator_thread.c' object='gsequencer-ags_iterator_thread.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_iterator_thread.o `test -f 'src/ags/thread/ags_iterator_thread.c' || echo '$(srcdir)/'`src/ags/thread/ags_iterator_thread.c

gsequencer-ags_iterator_thread.obj: src/ags/thread/ags_iterator_thread.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_iterator_thread.Tpo $(DEPDIR)/gsequencer-ags_iterator_thread.Po
#	$(AM_V_CC)source='src/ags/thread/ags_iterator_thread.c' object='gsequencer-ags_iterator_thread.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_iterator_thread.obj `if test -f 'src/ags/thread/ags_iterator_thread.c'; then $(CYGPATH_W) 'src/ags/thread/ags_iterator_thread.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_iterator_thread.c'; fi`

gsequencer-ags_mutex_manager.o: src/ags/thread/ags_mutex_manager.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_mutex_manager.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_mutex_manager.Tpo -c -o gsequencer-ags_mutex_manager.o `test -f 'src/ags/thread/ags_mutex_manager.c' || echo '$(srcdir)/'`src/ags/thread/ags_mutex_manager.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_mutex_manager.Tpo $(DEPDIR)/gsequencer-ags_mutex_manager.Po
#	$(AM_V_CC)source='src/ags/thread/ags_mutex_manager.c' object='gsequencer-ags_mutex_manager.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_mutex_manager.o `test -f 'src/ags/thread/ags_mutex_manager.c' || echo '$(srcdir)/'`src/ags/thread/ags_mutex_manager.c

gsequencer-ags_mutex_manager.obj: src/ags/thread/ags_mutex_manager.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_mutex_manager.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_mutex_manager.Tpo -c -o gsequencer-ags_mutex_manager.obj `if test -f 'src/ags/thread/ags_mutex_manager.c'; then $(CYGPATH_W) 'src/ags/thread/ags_mutex_manager.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_mutex_manager.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_mutex_manager.Tpo $(DEPDIR)/gsequencer-ags_mutex_manager.Po
#	$(AM_V_CC)source='src/ags/thread/ags_mutex_manager.c' object='gsequencer-ags_mutex_manager.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_mutex_manager.obj `if test -f 'src/ags/thread/ags_mutex_manager.c'; then $(CYGPATH_W) 'src/ags/thread/ags_mutex_manager.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_mutex_manager.c'; fi`

gsequencer-ags_record_thread.o: src/ags/thread/ags_record_thread.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_record_thread.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_record_thread.Tpo -c -o gsequencer-ags_record_thread.o `test -f 'src/ags/thread/ags_record_thread.c' || echo '$(srcdir)/'`src/ags/thread/ags_record_thread.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_record_thread.Tpo $(DEPDIR)/gsequencer-ags_record_thread.Po
#	$(AM_V_CC)source='src/ags/thread/ags_record_thread.c' object='gsequencer-ags_record_thread.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_record_thread.o `test -f 'src/ags/thread/ags_record_thread.c' || echo '$(srcdir)/'`src/ags/thread/ags_record_thread.c

gsequencer-ags_record_thread.obj: src/ags/thread/ags_record_thread.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_record_thread.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_record_thread.Tpo -c -o gsequencer-ags_record_thread.obj `if test -f 'src/ags/thread/ags_record_thread.c'; then $(CYGPATH_W) 'src/ags/thread/ags_record_thread.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_record_thread.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_record_thread.Tpo $(DEPDIR)/gsequencer-ags_record_thread.Po
#	$(AM_V_CC)source='src/ags/thread/ags_record_thread.c' object='gsequencer-ags_record_thread.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_record_thread.obj `if test -f 'src/ags/thread/ags_record_thread.c'; then $(CYGPATH_W) 'src/ags/thread/ags_record_thread.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_record_thread.c'; fi`

gsequencer-ags_recycling_thread.o: src/ags/thread/ags_recycling_thread.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recycling_thread.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_recycling_thread.Tpo -c -o gsequencer-ags_recycling_thread.o `test -f 'src/ags/thread/ags_recycling_thread.c' || echo '$(srcdir)/'`src/ags/thread/ags_recycling_thread.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recycling_thread.Tpo $(DEPDIR)/gsequencer-ags_recycling_thread.Po
#	$(AM_V_CC)source='src/ags/thread/ags_recycling_thread.c' object='gsequencer-ags_recycling_thread.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recycling_thread.o `test -f 'src/ags/thread/ags_recycling_thread.c' || echo '$(srcdir)/'`src/ags/thread/ags_recycling_thread.c

gsequencer-ags_recycling_thread.obj: src/ags/thread/ags_recycling_thread.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recycling_thread.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_recycling_thread.Tpo -c -o gsequencer-ags_recycling_thread.obj `if test -f 'src/ags/thread/ags_recycling_thread.c'; then $(CYGPATH_W) 'src/ags/thread/ags_recycling_thread.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_recycling_thread.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recycling_thread.Tpo $(DEPDIR)/gsequencer-ags_recycling_thread.Po
#	$(AM_V_CC)source='src/ags/thread/ags_recycling_thread.c' object='gsequencer-ags_recycling_thread.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recycling_thread.obj `if test -f 'src/ags/thread/ags_recycling_thread.c'; then $(CYGPATH_W) 'src/ags/thread/ags_recycling_thread.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_recycling_thread.c'; fi`

gsequencer-ags_recycling_thread_callbacks.o: src/ags/thread/ags_recycling_thread_callbacks.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recycling_thread_callbacks.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_recycling_thread_callbacks.Tpo -c -o gsequencer-ags_recycling_thread_callbacks.o `test -f 'src/ags/thread/ags_recycling_thread_callbacks.c' || echo '$(srcdir)/'`src/ags/thread/ags_recycling_thread_callbacks.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recycling_thread_callbacks.Tpo $(DEPDIR)/gsequencer-ags_recycling_thread_callbacks.Po
#	$(AM_V_CC)source='src/ags/thread/ags_recycling_thread_callbacks.c' object='gsequencer-ags_recycling_thread_callbacks.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recycling_thread_callbacks.o `test -f 'src/ags/thread/ags_recycling_thread_callbacks.c' || echo '$(srcdir)/'`src/ags/thread/ags_recycling_thread_callbacks.c

gsequencer-ags_recycling_thread_callbacks.obj: src/ags/thread/ags_recycling_thread_callbacks.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_recycling_thread_callbacks.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_recycling_thread_callbacks.Tpo -c -o gsequencer-ags_recycling_thread_callbacks.obj `if test -f 'src/ags/thread/ags_recycling_thread_callbacks.c'; then $(CYGPATH_W) 'src/ags/thread/ags_recycling_thread_callbacks.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_recycling_thread_callbacks.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_recycling_thread_callbacks.Tpo $(DEPDIR)/gsequencer-ags_recycling_thread_callbacks.Po
#	$(AM_V_CC)source='src/ags/thread/ags_recycling_thread_callbacks.c' object='gsequencer-ags_recycling_thread_callbacks.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_recycling_thread_callbacks.obj `if test -f 'src/ags/thread/ags_recycling_thread_callbacks.c'; then $(CYGPATH_W) 'src/ags/thread/ags_recycling_thread_callbacks.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_recycling_thread_callbacks.c'; fi`

gsequencer-ags_returnable_thread.o: src/ags/thread/ags_returnable_thread.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_returnable_thread.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_returnable_thread.Tpo -c -o gsequencer-ags_returnable_thread.o `test -f 'src/ags/thread/ags_returnable_thread.c' || echo '$(srcdir)/'`src/ags/thread/ags_returnable_thread.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_returnable_thread.Tpo $(DEPDIR)/gsequencer-ags_returnable_thread.Po
#	$(AM_V_CC)source='src/ags/thread/ags_returnable_thread.c' object='gsequencer-ags_returnable_thread.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_returnable_thread.o `test -f 'src/ags/thread/ags_returnable_thread.c' || echo '$(srcdir)/'`src/ags/thread/ags_returnable_thread.c

gsequencer-ags_returnable_thread.obj: src/ags/thread/ags_returnable_thread.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_returnable_thread.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_returnable_thread.Tpo -c -o gsequencer-ags_returnable_thread.obj `if test -f 'src/ags/thread/ags_returnable_thread.c'; then $(CYGPATH_W) 'src/ags/thread/ags_returnable_thread.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_returnable_thread.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_returnable_thread.Tpo $(DEPDIR)/gsequencer-ags_returnable_thread.Po
#	$(AM_V_CC)source='src/ags/thread/ags_returnable_thread.c' object='gsequencer-ags_returnable_thread.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_returnable_thread.obj `if test -f 'src/ags/thread/ags_returnable_thread.c'; then $(CYGPATH_W) 'src/ags/thread/ags_returnable_thread.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_returnable_thread.c'; fi`

gsequencer-ags_single_thread.o: src/ags/thread/ags_single_thread.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_single_thread.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_single_thread.Tpo -c -o gsequencer-ags_single_thread.o `test -f 'src/ags/thread/ags_single_thread.c' || echo '$(srcdir)/'`src/ags/thread/ags_single_thread.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_single_thread.Tpo $(DEPDIR)/gsequencer-ags_single_thread.Po
#	$(AM_V_CC)source='src/ags/thread/ags_single_thread.c' object='gsequencer-ags_single_thread.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_single_thread.o `test -f 'src/ags/thread/ags_single_thread.c' || echo '$(srcdir)/'`src/ags/thread/ags_single_thread.c

gsequencer-ags_single_thread.obj: src/ags/thread/ags_single_thread.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_single_thread.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_single_thread.Tpo -c -o gsequencer-ags_single_thread.obj `if test -f 'src/ags/thread/ags_single_thread.c'; then $(CYGPATH_W) 'src/ags/thread/ags_single_thread.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_single_thread.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_single_thread.Tpo $(DEPDIR)/gsequencer-ags_single_thread.Po
#	$(AM_V_CC)source='src/ags/thread/ags_single_thread.c' object='gsequencer-ags_single_thread.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_single_thread.obj `if test -f 'src/ags/thread/ags_single_thread.c'; then $(CYGPATH_W) 'src/ags/thread/ags_single_thread.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_single_thread.c'; fi`

gsequencer-ags_task_completion.o: src/ags/thread/ags_task_completion.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_task_completion.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_task_completion.Tpo -c -o gsequencer-ags_task_completion.o `test -f 'src/ags/thread/ags_task_completion.c' || echo '$(srcdir)/'`src/ags/thread/ags_task_completion.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_task_completion.Tpo $(DEPDIR)/gsequencer-ags_task_completion.Po
#	$(AM_V_CC)source='src/ags/thread/ags_task_completion.c' object='gsequencer-ags_task_completion.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_task_completion.o `test -f 'src/ags/thread/ags_task_completion.c' || echo '$(srcdir)/'`src/ags/thread/ags_task_completion.c

gsequencer-ags_task_completion.obj: src/ags/thread/ags_task_completion.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_task_completion.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_task_completion.Tpo -c -o gsequencer-ags_task_completion.obj `if test -f 'src/ags/thread/ags_task_completion.c'; then $(CYGPATH_W) 'src/ags/thread/ags_task_completion.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_task_completion.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_task_completion.Tpo $(DEPDIR)/gsequencer-ags_task_completion.Po
#	$(AM_V_CC)source='src/ags/thread/ags_task_completion.c' object='gsequencer-ags_task_completion.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_task_completion.obj `if test -f 'src/ags/thread/ags_task_completion.c'; then $(CYGPATH_W) 'src/ags/thread/ags_task_completion.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_task_completion.c'; fi`

gsequencer-ags_task_thread.o: src/ags/thread/ags_task_thread.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_task_thread.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_task_thread.Tpo -c -o gsequencer-ags_task_thread.o `test -f 'src/ags/thread/ags_task_thread.c' || echo '$(srcdir)/'`src/ags/thread/ags_task_thread.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_task_thread.Tpo $(DEPDIR)/gsequencer-ags_task_thread.Po
#	$(AM_V_CC)source='src/ags/thread/ags_task_thread.c' object='gsequencer-ags_task_thread.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_task_thread.o `test -f 'src/ags/thread/ags_task_thread.c' || echo '$(srcdir)/'`src/ags/thread/ags_task_thread.c

gsequencer-ags_task_thread.obj: src/ags/thread/ags_task_thread.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_task_thread.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_task_thread.Tpo -c -o gsequencer-ags_task_thread.obj `if test -f 'src/ags/thread/ags_task_thread.c'; then $(CYGPATH_W) 'src/ags/thread/ags_task_thread.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_task_thread.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_task_thread.Tpo $(DEPDIR)/gsequencer-ags_task_thread.Po
#	$(AM_V_CC)source='src/ags/thread/ags_task_thread.c' object='gsequencer-ags_task_thread.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_task_thread.obj `if test -f 'src/ags/thread/ags_task_thread.c'; then $(CYGPATH_W) 'src/ags/thread/ags_task_thread.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_task_thread.c'; fi`

gsequencer-ags_thread_pool.o: src/ags/thread/ags_thread_pool.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_thread_pool.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_thread_pool.Tpo -c -o gsequencer-ags_thread_pool.o `test -f 'src/ags/thread/ags_thread_pool.c' || echo '$(srcdir)/'`src/ags/thread/ags_thread_pool.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_thread_pool.Tpo $(DEPDIR)/gsequencer-ags_thread_pool.Po
#	$(AM_V_CC)source='src/ags/thread/ags_thread_pool.c' object='gsequencer-ags_thread_pool.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_thread_pool.o `test -f 'src/ags/thread/ags_thread_pool.c' || echo '$(srcdir)/'`src/ags/thread/ags_thread_pool.c

gsequencer-ags_thread_pool.obj: src/ags/thread/ags_thread_pool.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_thread_pool.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_thread_pool.Tpo -c -o gsequencer-ags_thread_pool.obj `if test -f 'src/ags/thread/ags_thread_pool.c'; then $(CYGPATH_W) 'src/ags/thread/ags_thread_pool.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_thread_pool.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_thread_pool.Tpo $(DEPDIR)/gsequencer-ags_thread_pool.Po
#	$(AM_V_CC)source='src/ags/thread/ags_thread_pool.c' object='gsequencer-ags_thread_pool.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_thread_pool.obj `if test -f 'src/ags/thread/ags_thread_pool.c'; then $(CYGPATH_W) 'src/ags/thread/ags_thread_pool.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_thread_pool.c'; fi`

gsequencer-ags_thread-posix.o: src/ags/thread/ags_thread-posix.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_thread-posix.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_thread-posix.Tpo -c -o gsequencer-ags_thread-posix.o `test -f 'src/ags/thread/ags_thread-posix.c' || echo '$(srcdir)/'`src/ags/thread/ags_thread-posix.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_thread-posix.Tpo $(DEPDIR)/gsequencer-ags_thread-posix.Po
#	$(AM_V_CC)source='src/ags/thread/ags_thread-posix.c' object='gsequencer-ags_thread-posix.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_thread-posix.o `test -f 'src/ags/thread/ags_thread-posix.c' || echo '$(srcdir)/'`src/ags/thread/ags_thread-posix.c

gsequencer-ags_thread-posix.obj: src/ags/thread/ags_thread-posix.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_thread-posix.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_thread-posix.Tpo -c -o gsequencer-ags_thread-posix.obj `if test -f 'src/ags/thread/ags_thread-posix.c'; then $(CYGPATH_W) 'src/ags/thread/ags_thread-posix.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_thread-posix.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_thread-posix.Tpo $(DEPDIR)/gsequencer-ags_thread-posix.Po
#	$(AM_V_CC)source='src/ags/thread/ags_thread-posix.c' object='gsequencer-ags_thread-posix.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_thread-posix.obj `if test -f 'src/ags/thread/ags_thread-posix.c'; then $(CYGPATH_W) 'src/ags/thread/ags_thread-posix.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_thread-posix.c'; fi`

gsequencer-ags_timestamp_thread.o: src/ags/thread/ags_timestamp_thread.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_timestamp_thread.Tpo $(DEPDIR)/gsequencer-ags_timestamp_thread.Po
#	$(AM_V_CC)source='src/ags/thread/ags_timestamp_thread.c' object='gsequencer-ags_timestamp_thread.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_timestamp_thread.o `test -f 'src/ags/thread/ags_timestamp_thread.c' || echo '$(srcdir)/'`src/ags/thread/ags_timestamp_thread.c

gsequencer-ags_timestamp_thread.obj: src/ags/thread/ags_timestamp_thread.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_timestamp_thread.Tpo $(DEPDIR)/gsequencer-ags_timestamp_thread.Po
#	$(AM_V_CC)source='src/ags/thread/ags_timestamp_thread.c' object='gsequencer-ags_timestamp_thread.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_timestamp_thread.obj `if test -f 'src/ags/thread/ags_timestamp_thread.c'; then $(CYGPATH_W) 'src/ags/thread/ags_timestamp_thread.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/thread/ags_timestamp_thread.c'; fi`

gsequencer-ags_id_generator.o: src/ags/util/ags_id_generator.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_id_generator.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_id_generator.Tpo -c -o gsequencer-ags_id_generator.o `test -f 'src/ags/util/ags_id_generator.c' || echo '$(srcdir)/'`src/ags/util/ags_id_generator.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_id_generator.Tpo $(DEPDIR)/gsequencer-ags_id_generator.Po
#	$(AM_V_CC)source='src/ags/util/ags_id_generator.c' object='gsequencer-ags_id_generator.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_id_generator.o `test -f 'src/ags/util/ags_id_generator.c' || echo '$(srcdir)/'`src/ags/util/ags_id_generator.c

gsequencer-ags_id_generator.obj: src/ags/util/ags_id_generator.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_id_generator.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_id_generator.Tpo -c -o gsequencer-ags_id_generator.obj `if test -f 'src/ags/util/ags_id_generator.c'; then $(CYGPATH_W) 'src/ags/util/ags_id_generator.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/util/ags_id_generator.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_id_generator.Tpo $(DEPDIR)/gsequencer-ags_id_generator.Po
#	$(AM_V_CC)source='src/ags/util/ags_id_generator.c' object='gsequencer-ags_id_generator.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_id_generator.obj `if test -f 'src/ags/util/ags_id_generator.c'; then $(CYGPATH_W) 'src/ags/util/ags_id_generator.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/util/ags_id_generator.c'; fi`

gsequencer-ags_cartesian.o: src/ags/widget/ags_cartesian.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_cartesian.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_cartesian.Tpo -c -o gsequencer-ags_cartesian.o `test -f 'src/ags/widget/ags_cartesian.c' || echo '$(srcdir)/'`src/ags/widget/ags_cartesian.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_cartesian.Tpo $(DEPDIR)/gsequencer-ags_cartesian.Po
#	$(AM_V_CC)source='src/ags/widget/ags_cartesian.c' object='gsequencer-ags_cartesian.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_cartesian.o `test -f 'src/ags/widget/ags_cartesian.c' || echo '$(srcdir)/'`src/ags/widget/ags_cartesian.c

gsequencer-ags_cartesian.obj: src/ags/widget/ags_cartesian.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_cartesian.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_cartesian.Tpo -c -o gsequencer-ags_cartesian.obj `if test -f 'src/ags/widget/ags_cartesian.c'; then $(CYGPATH_W) 'src/ags/widget/ags_cartesian.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_cartesian.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_cartesian.Tpo $(DEPDIR)/gsequencer-ags_cartesian.Po
#	$(AM_V_CC)source='src/ags/widget/ags_cartesian.c' object='gsequencer-ags_cartesian.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_cartesian.obj `if test -f 'src/ags/widget/ags_cartesian.c'; then $(CYGPATH_W) 'src/ags/widget/ags_cartesian.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_cartesian.c'; fi`

gsequencer-ags_dial.o: src/ags/widget/ags_dial.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_dial.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_dial.Tpo -c -o gsequencer-ags_dial.o `test -f 'src/ags/widget/ags_dial.c' || echo '$(srcdir)/'`src/ags/widget/ags_dial.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_dial.Tpo $(DEPDIR)/gsequencer-ags_dial.Po
#	$(AM_V_CC)source='src/ags/widget/ags_dial.c' object='gsequencer-ags_dial.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_dial.o `test -f 'src/ags/widget/ags_dial.c' || echo '$(srcdir)/'`src/ags/widget/ags_dial.c

gsequencer-ags_dial.obj: src/ags/widget/ags_dial.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_dial.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_dial.Tpo -c -o gsequencer-ags_dial.obj `if test -f 'src/ags/widget/ags_dial.c'; then $(CYGPATH_W) 'src/ags/widget/ags_dial.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_dial.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_dial.Tpo $(DEPDIR)/gsequencer-ags_dial.Po
#	$(AM_V_CC)source='src/ags/widget/ags_dial.c' object='gsequencer-ags_dial.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_dial.obj `if test -f 'src/ags/widget/ags_dial.c'; then $(CYGPATH_W) 'src/ags/widget/ags_dial.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_dial.c'; fi`

gsequencer-ags_expander.o: src/ags/widget/ags_expander.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_expander.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_expander.Tpo -c -o gsequencer-ags_expander.o `test -f 'src/ags/widget/ags_expander.c' || echo '$(srcdir)/'`src/ags/widget/ags_expander.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_expander.Tpo $(DEPDIR)/gsequencer-ags_expander.Po
#	$(AM_V_CC)source='src/ags/widget/ags_expander.c' object='gsequencer-ags_expander.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_expander.o `test -f 'src/ags/widget/ags_expander.c' || echo '$(srcdir)/'`src/ags/widget/ags_expander.c

gsequencer-ags_expander.obj: src/ags/widget/ags_expander.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_expander.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_expander.Tpo -c -o gsequencer-ags_expander.obj `if test -f 'src/ags/widget/ags_expander.c'; then $(CYGPATH_W) 'src/ags/widget/ags_expander.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_expander.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_expander.Tpo $(DEPDIR)/gsequencer-ags_expander.Po
#	$(AM_V_CC)source='src/ags/widget/ags_expander.c' object='gsequencer-ags_expander.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_expander.obj `if test -f 'src/ags/widget/ags_expander.c'; then $(CYGPATH_W) 'src/ags/widget/ags_expander.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_expander.c'; fi`

gsequencer-ags_expander_set.o: src/ags/widget/ags_expander_set.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_expander_set.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_expander_set.Tpo -c -o gsequencer-ags_expander_set.o `test -f 'src/ags/widget/ags_expander_set.c' || echo '$(srcdir)/'`src/ags/widget/ags_expander_set.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_expander_set.Tpo $(DEPDIR)/gsequencer-ags_expander_set.Po
#	$(AM_V_CC)source='src/ags/widget/ags_expander_set.c' object='gsequencer-ags_expander_set.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_expander_set.o `test -f 'src/ags/widget/ags_expander_set.c' || echo '$(srcdir)/'`src/ags/widget/ags_expander_set.c

gsequencer-ags_expander_set.obj: src/ags/widget/ags_expander_set.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_expander_set.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_expander_set.Tpo -c -o gsequencer-ags_expander_set.obj `if test -f 'src/ags/widget/ags_expander_set.c'; then $(CYGPATH_W) 'src/ags/widget/ags_expander_set.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_expander_set.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_expander_set.Tpo $(DEPDIR)/gsequencer-ags_expander_set.Po
#	$(AM_V_CC)source='src/ags/widget/ags_expander_set.c' object='gsequencer-ags_expander_set.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_expander_set.obj `if test -f 'src/ags/widget/ags_expander_set.c'; then $(CYGPATH_W) 'src/ags/widget/ags_expander_set.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_expander_set.c'; fi`

gsequencer-ags_hindicator.o: src/ags/widget/ags_hindicator.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_hindicator.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_hindicator.Tpo -c -o gsequencer-ags_hindicator.o `test -f 'src/ags/widget/ags_hindicator.c' || echo '$(srcdir)/'`src/ags/widget/ags_hindicator.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_hindicator.Tpo $(DEPDIR)/gsequencer-ags_hindicator.Po
#	$(AM_V_CC)source='src/ags/widget/ags_hindicator.c' object='gsequencer-ags_hindicator.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_hindicator.o `test -f 'src/ags/widget/ags_hindicator.c' || echo '$(srcdir)/'`src/ags/widget/ags_hindicator.c

gsequencer-ags_hindicator.obj: src/ags/widget/ags_hindicator.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_hindicator.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_hindicator.Tpo -c -o gsequencer-ags_hindicator.obj `if test -f 'src/ags/widget/ags_hindicator.c'; then $(CYGPATH_W) 'src/ags/widget/ags_hindicator.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_hindicator.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_hindicator.Tpo $(DEPDIR)/gsequencer-ags_hindicator.Po
#	$(AM_V_CC)source='src/ags/widget/ags_hindicator.c' object='gsequencer-ags_hindicator.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_hindicator.obj `if test -f 'src/ags/widget/ags_hindicator.c'; then $(CYGPATH_W) 'src/ags/widget/ags_hindicator.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_hindicator.c'; fi`

gsequencer-ags_htimebar.o: src/ags/widget/ags_htimebar.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_htimebar.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_htimebar.Tpo -c -o gsequencer-ags_htimebar.o `test -f 'src/ags/widget/ags_htimebar.c' || echo '$(srcdir)/'`src/ags/widget/ags_htimebar.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_htimebar.Tpo $(DEPDIR)/gsequencer-ags_htimebar.Po
#	$(AM_V_CC)source='src/ags/widget/ags_htimebar.c' object='gsequencer-ags_htimebar.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_htimebar.o `test -f 'src/ags/widget/ags_htimebar.c' || echo '$(srcdir)/'`src/ags/widget/ags_htimebar.c

gsequencer-ags_htimebar.obj: src/ags/widget/ags_htimebar.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_htimebar.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_htimebar.Tpo -c -o gsequencer-ags_htimebar.obj `if test -f 'src/ags/widget/ags_htimebar.c'; then $(CYGPATH_W) 'src/ags/widget/ags_htimebar.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_htimebar.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_htimebar.Tpo $(DEPDIR)/gsequencer-ags_htimebar.Po
#	$(AM_V_CC)source='src/ags/widget/ags_htimebar.c' object='gsequencer-ags_htimebar.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_htimebar.obj `if test -f 'src/ags/widget/ags_htimebar.c'; then $(CYGPATH_W) 'src/ags/widget/ags_htimebar.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_htimebar.c'; fi`

gsequencer-ags_indicator.o: src/ags/widget/ags_indicator.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_indicator.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_indicator.Tpo -c -o gsequencer-ags_indicator.o `test -f 'src/ags/widget/ags_indicator.c' || echo '$(srcdir)/'`src/ags/widget/ags_indicator.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_indicator.Tpo $(DEPDIR)/gsequencer-ags_indicator.Po
#	$(AM_V_CC)source='src/ags/widget/ags_indicator.c' object='gsequencer-ags_indicator.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_indicator.o `test -f 'src/ags/widget/ags_indicator.c' || echo '$(srcdir)/'`src/ags/widget/ags_indicator.c

gsequencer-ags_indicator.obj: src/ags/widget/ags_indicator.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_indicator.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_indicator.Tpo -c -o gsequencer-ags_indicator.obj `if test -f 'src/ags/widget/ags_indicator.c'; then $(CYGPATH_W) 'src/ags/widget/ags_indicator.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_indicator.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_indicator.Tpo $(DEPDIR)/gsequencer-ags_indicator.Po
#	$(AM_V_CC)source='src/ags/widget/ags_indicator.c' object='gsequencer-ags_indicator.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_indicator.obj `if test -f 'src/ags/widget/ags_indicator.c'; then $(CYGPATH_W) 'src/ags/widget/ags_indicator.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_indicator.c'; fi`

gsequencer-ags_led.o: src/ags/widget/ags_led.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_led.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_led.Tpo -c -o gsequencer-ags_led.o `test -f 'src/ags/widget/ags_led.c' || echo '$(srcdir)/'`src/ags/widget/ags_led.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_led.Tpo $(DEPDIR)/gsequencer-ags_led.Po
#	$(AM_V_CC)source='src/ags/widget/ags_led.c' object='gsequencer-ags_led.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_led.o `test -f 'src/ags/widget/ags_led.c' || echo '$(srcdir)/'`src/ags/widget/ags_led.c

gsequencer-ags_led.obj: src/ags/widget/ags_led.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_led.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_led.Tpo -c -o gsequencer-ags_led.obj `if test -f 'src/ags/widget/ags_led.c'; then $(CYGPATH_W) 'src/ags/widget/ags_led.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_led.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_led.Tpo $(DEPDIR)/gsequencer-ags_led.Po
#	$(AM_V_CC)source='src/ags/widget/ags_led.c' object='gsequencer-ags_led.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_led.obj `if test -f 'src/ags/widget/ags_led.c'; then $(CYGPATH_W) 'src/ags/widget/ags_led.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_led.c'; fi`

gsequencer-ags_menu.o: src/ags/widget/ags_menu.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_menu.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_menu.Tpo -c -o gsequencer-ags_menu.o `test -f 'src/ags/widget/ags_menu.c' || echo '$(srcdir)/'`src/ags/widget/ags_menu.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_menu.Tpo $(DEPDIR)/gsequencer-ags_menu.Po
#	$(AM_V_CC)source='src/ags/widget/ags_menu.c' object='gsequencer-ags_menu.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_menu.o `test -f 'src/ags/widget/ags_menu.c' || echo '$(srcdir)/'`src/ags/widget/ags_menu.c

gsequencer-ags_menu.obj: src/ags/widget/ags_menu.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_menu.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_menu.Tpo -c -o gsequencer-ags_menu.obj `if test -f 'src/ags/widget/ags_menu.c'; then $(CYGPATH_W) 'src/ags/widget/ags_menu.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_menu.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_menu.Tpo $(DEPDIR)/gsequencer-ags_menu.Po
#	$(AM_V_CC)source='src/ags/widget/ags_menu.c' object='gsequencer-ags_menu.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_menu.obj `if test -f 'src/ags/widget/ags_menu.c'; then $(CYGPATH_W) 'src/ags/widget/ags_menu.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_menu.c'; fi`

gsequencer-ags_menu_item.o: src/ags/widget/ags_menu_item.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_menu_item.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_menu_item.Tpo -c -o gsequencer-ags_menu_item.o `test -f 'src/ags/widget/ags_menu_item.c' || echo '$(srcdir)/'`src/ags/widget/ags_menu_item.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_menu_item.Tpo $(DEPDIR)/gsequencer-ags_menu_item.Po
#	$(AM_V_CC)source='src/ags/widget/ags_menu_item.c' object='gsequencer-ags_menu_item.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_menu_item.o `test -f 'src/ags/widget/ags_menu_item.c' || echo '$(srcdir)/'`src/ags/widget/ags_menu_item.c

gsequencer-ags_menu_item.obj: src/ags/widget/ags_menu_item.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_menu_item.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_menu_item.Tpo -c -o gsequencer-ags_menu_item.obj `if test -f 'src/ags/widget/ags_menu_item.c'; then $(CYGPATH_W) 'src/ags/widget/ags_menu_item.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_menu_item.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_menu_item.Tpo $(DEPDIR)/gsequencer-ags_menu_item.Po
#	$(AM_V_CC)source='src/ags/widget/ags_menu_item.c' object='gsequencer-ags_menu_item.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_menu_item.obj `if test -f 'src/ags/widget/ags_menu_item.c'; then $(CYGPATH_W) 'src/ags/widget/ags_menu_item.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_menu_item.c'; fi`

gsequencer-ags_option_menu.o: src/ags/widget/ags_option_menu.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_option_menu.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_option_menu.Tpo -c -o gsequencer-ags_option_menu.o `test -f 'src/ags/widget/ags_option_menu.c' || echo '$(srcdir)/'`src/ags/widget/ags_option_menu.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_option_menu.Tpo $(DEPDIR)/gsequencer-ags_option_menu.Po
#	$(AM_V_CC)source='src/ags/widget/ags_option_menu.c' object='gsequencer-ags_option_menu.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_option_menu.o `test -f 'src/ags/widget/ags_option_menu.c' || echo '$(srcdir)/'`src/ags/widget/ags_option_menu.c

gsequencer-ags_option_menu.obj: src/ags/widget/ags_option_menu.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_option_menu.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_option_menu.Tpo -c -o gsequencer-ags_option_menu.obj `if test -f 'src/ags/widget/ags_option_menu.c'; then $(CYGPATH_W) 'src/ags/widget/ags_option_menu.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_option_menu.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_option_menu.Tpo $(DEPDIR)/gsequencer-ags_option_menu.Po
#	$(AM_V_CC)source='src/ags/widget/ags_option_menu.c' object='gsequencer-ags_option_menu.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_option_menu.obj `if test -f 'src/ags/widget/ags_option_menu.c'; then $(CYGPATH_W) 'src/ags/widget/ags_option_menu.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_option_menu.c'; fi`

gsequencer-ags_ruler.o: src/ags/widget/ags_ruler.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_ruler.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_ruler.Tpo -c -o gsequencer-ags_ruler.o `test -f 'src/ags/widget/ags_ruler.c' || echo '$(srcdir)/'`src/ags/widget/ags_ruler.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_ruler.Tpo $(DEPDIR)/gsequencer-ags_ruler.Po
#	$(AM_V_CC)source='src/ags/widget/ags_ruler.c' object='gsequencer-ags_ruler.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_ruler.o `test -f 'src/ags/widget/ags_ruler.c' || echo '$(srcdir)/'`src/ags/widget/ags_ruler.c

gsequencer-ags_ruler.obj: src/ags/widget/ags_ruler.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_ruler.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_ruler.Tpo -c -o gsequencer-ags_ruler.obj `if test -f 'src/ags/widget/ags_ruler.c'; then $(CYGPATH_W) 'src/ags/widget/ags_ruler.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_ruler.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_ruler.Tpo $(DEPDIR)/gsequencer-ags_ruler.Po
#	$(AM_V_CC)source='src/ags/widget/ags_ruler.c' object='gsequencer-ags_ruler.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_ruler.obj `if test -f 'src/ags/widget/ags_ruler.c'; then $(CYGPATH_W) 'src/ags/widget/ags_ruler.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_ruler.c'; fi`

gsequencer-ags_segment.o: src/ags/widget/ags_segment.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_segment.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_segment.Tpo -c -o gsequencer-ags_segment.o `test -f 'src/ags/widget/ags_segment.c' || echo '$(srcdir)/'`src/ags/widget/ags_segment.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_segment.Tpo $(DEPDIR)/gsequencer-ags_segment.Po
#	$(AM_V_CC)source='src/ags/widget/ags_segment.c' object='gsequencer-ags_segment.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_segment.o `test -f 'src/ags/widget/ags_segment.c' || echo '$(srcdir)/'`src/ags/widget/ags_segment.c

gsequencer-ags_segment.obj: src/ags/widget/ags_segment.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_segment.Tpo $(DEPDIR)/gsequencer-ags_segment.Po
#	$(AM_V_CC)source='src/ags/widget/ags_segment.c' object='gsequencer-ags_segment.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_segment.obj `if test -f 'src/ags/widget/ags_segment.c'; then $(CYGPATH_W) 'src/ags/widget/ags_segment.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_segment.c'; fi`

gsequencer-ags_table.o: src/ags/widget/ags_table.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_table.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_table.Tpo -c -o gsequencer-ags_table.o `test -f 'src/ags/widget/ags_table.c' || echo '$(srcdir)/'`src/ags/widget/ags_table.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_table.Tpo $(DEPDIR)/gsequencer-ags_table.Po
#	$(AM_V_CC)source='src/ags/widget/ags_table.c' object='gsequencer-ags_table.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_table.o `test -f 'src/ags/widget/ags_table.c' || echo '$(srcdir)/'`src/ags/widget/ags_table.c

gsequencer-ags_table.obj: src/ags/widget/ags_table.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_table.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_table.Tpo -c -o gsequencer-ags_table.obj `if test -f 'src/ags/widget/ags_table.c'; then $(CYGPATH_W) 'src/ags/widget/ags_table.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_table.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_table.Tpo $(DEPDIR)/gsequencer-ags_table.Po
#	$(AM_V_CC)source='src/ags/widget/ags_table.c' object='gsequencer-ags_table.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_table.obj `if test -f 'src/ags/widget/ags_table.c'; then $(CYGPATH_W) 'src/ags/widget/ags_table.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_table.c'; fi`

gsequencer-ags_timebar.o: src/ags/widget/ags_timebar.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_timebar.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_timebar.Tpo -c -o gsequencer-ags_timebar.o `test -f 'src/ags/widget/ags_timebar.c' || echo '$(srcdir)/'`src/ags/widget/ags_timebar.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_timebar.Tpo $(DEPDIR)/gsequencer-ags_timebar.Po
#	$(AM_V_CC)source='src/ags/widget/ags_timebar.c' object='gsequencer-ags_timebar.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_timebar.o `test -f 'src/ags/widget/ags_timebar.c' || echo '$(srcdir)/'`src/ags/widget/ags_timebar.c

gsequencer-ags_timebar.obj: src/ags/widget/ags_timebar.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_timebar.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_timebar.Tpo -c -o gsequencer-ags_timebar.obj `if test -f 'src/ags/widget/ags_timebar.c'; then $(CYGPATH_W) 'src/ags/widget/ags_timebar.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_timebar.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_timebar.Tpo $(DEPDIR)/gsequencer-ags_timebar.Po
#	$(AM_V_CC)source='src/ags/widget/ags_timebar.c' object='gsequencer-ags_timebar.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_timebar.obj `if test -f 'src/ags/widget/ags_timebar.c'; then $(CYGPATH_W) 'src/ags/widget/ags_timebar.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_timebar.c'; fi`

gsequencer-ags_vindicator.o: src/ags/widget/ags_vindicator.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_vindicator.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_vindicator.Tpo -c -o gsequencer-ags_vindicator.o `test -f 'src/ags/widget/ags_vindicator.c' || echo '$(srcdir)/'`src/ags/widget/ags_vindicator.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_vindicator.Tpo $(DEPDIR)/gsequencer-ags_vindicator.Po
#	$(AM_V_CC)source='src/ags/widget/ags_vindicator.c' object='gsequencer-ags_vindicator.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_vindicator.o `test -f 'src/ags/widget/ags_vindicator.c' || echo '$(srcdir)/'`src/ags/widget/ags_vindicator.c

gsequencer-ags_vindicator.obj: src/ags/widget/ags_vindicator.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_vindicator.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_vindicator.Tpo -c -o gsequencer-ags_vindicator.obj `if test -f 'src/ags/widget/ags_vindicator.c'; then $(CYGPATH_W) 'src/ags/widget/ags_vindicator.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_vindicator.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_vindicator.Tpo $(DEPDIR)/gsequencer-ags_vindicator.Po
#	$(AM_V_CC)source='src/ags/widget/ags_vindicator.c' object='gsequencer-ags_vindicator.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_vindicator.obj `if test -f 'src/ags/widget/ags_vindicator.c'; then $(CYGPATH_W) 'src/ags/widget/ags_vindicator.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_vindicator.c'; fi`

gsequencer-ags_waveform.o: src/ags/widget/ags_waveform.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_waveform.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_waveform.Tpo -c -o gsequencer-ags_waveform.o `test -f 'src/ags/widget/ags_waveform.c' || echo '$(srcdir)/'`src/ags/widget/ags_waveform.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_waveform.Tpo $(DEPDIR)/gsequencer-ags_waveform.Po
#	$(AM_V_CC)source='src/ags/widget/ags_waveform.c' object='gsequencer-ags_waveform.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_waveform.o `test -f 'src/ags/widget/ags_waveform.c' || echo '$(srcdir)/'`src/ags/widget/ags_waveform.c

gsequencer-ags_waveform.obj: src/ags/widget/ags_waveform.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_waveform.obj -MD -MP -MF $(DEPDIR)/gsequencer-ags_waveform.Tpo -c -o gsequencer-ags_waveform.obj `if test -f 'src/ags/widget/ags_waveform.c'; then $(CYGPATH_W) 'src/ags/widget/ags_waveform.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_waveform.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_waveform.Tpo $(DEPDIR)/gsequencer-ags_waveform.Po
#	$(AM_V_CC)source='src/ags/widget/ags_waveform.c' object='gsequencer-ags_waveform.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_waveform.obj `if test -f 'src/ags/widget/ags_waveform.c'; then $(CYGPATH_W) 'src/ags/widget/ags_waveform.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/widget/ags_waveform.c'; fi`
...
gsequencer-ags_cell_pattern.o: src/ags/X/machine/ags_cell_pattern.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_cell_pattern.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_cell_pattern.Tpo -c -o gsequencer-ags_cell_pattern.o `test -f 'src/ags/X/machine/ags_cell_pattern.c' || echo '$(srcdir)/'`src/ags/X/machine/ags_cell_pattern.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_cell_pattern.Tpo $(DEPDIR)/gsequencer-ags_cell_pattern.Po
#	$(AM_V_CC)source='src/ags/X/machine/ags_cell_pattern.c' object='gsequencer-ags_cell_pattern.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_cell_pattern.o `test -f 'src/ags/X/machine/ags_cell_pattern.c' || echo '$(srcdir)/'`src/ags/X/machine/ags_cell_pattern.c
...
gsequencer-ags_cell_pattern.obj: src/ags/X/machine/ags_cell_pattern.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_cell_pattern.Tpo $(DEPDIR)/gsequencer-ags_cell_pattern.Po
#	$(AM_V_CC)source='src/ags/X/machine/ags_cell_pattern.c' object='gsequencer-ags_cell_pattern.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_cell_pattern.obj `if test -f 'src/ags/X/machine/ags_cell_pattern.c'; then $(CYGPATH_W) 'src/ags/X/machine/ags_cell_pattern.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/X/machine/ags_cell_pattern.c'; fi`
...
gsequencer-ags_cell_pattern_callbacks.o: src/ags/X/machine/ags_cell_pattern_callbacks.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_cell_pattern_callbacks.Tpo $(DEPDIR)/gsequencer-ags_cell_pattern_callbacks.Po
#	$(AM_V_CC)source='src/ags/X/machine/ags_cell_pattern_callbacks.c' object='gsequencer-ags_cell_pattern_callbacks.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_cell_pattern_callbacks.o `test -f 'src/ags/X/machine/ags_cell_pattern_callbacks.c' || echo '$(srcdir)/'`src/ags/X/machine/ags_cell_pattern_callbacks.c
...
gsequencer-ags_cell_pattern_callbacks.obj: src/ags/X/machine/ags_cell_pattern_callbacks.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_cell_pattern_callbacks.Tpo $(DEPDIR)/gsequencer-ags_cell_pattern_callbacks.Po
#	$(AM_V_CC)source='src/ags/X/machine/ags_cell_pattern_callbacks.c' object='gsequencer-ags_cell_pattern_callbacks.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
...
gsequencer-ags_pattern_box_callbacks.o: src/ags/X/machine/ags_pattern_box_callbacks.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_pattern_box_callbacks.Tpo $(DEPDIR)/gsequencer-ags_pattern_box_callbacks.Po
#	$(AM_V_CC)source='src/ags/X/machine/ags_pattern_box_callbacks.c' object='gsequencer-ags_pattern_box_callbacks.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_pattern_box_callbacks.o `test -f 'src/ags/X/machine/ags_pattern_box_callbacks.c' || echo '$(srcdir)/'`src/ags/X/machine/ags_pattern_box_callbacks.c
...
gsequencer-ags_pattern_box_callbacks.obj: src/ags/X/machine/ags_pattern_box_callbacks.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_pattern_box_callbacks.Tpo $(DEPDIR)/gsequencer-ags_pattern_box_callbacks.Po
#	$(AM_V_CC)source='src/ags/X/machine/ags_pattern_box_callbacks.c' object='gsequencer-ags_pattern_box_callbacks.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
...
gsequencer-ags_pattern_box.o: src/ags/X/machine/ags_pattern_box.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -MT gsequencer-ags_pattern_box.o -MD -MP -MF $(DEPDIR)/gsequencer-ags_pattern_box.Tpo -c -o gsequencer-ags_pattern_box.o `test -f 'src/ags/X/machine/ags_pattern_box.c' || echo '$(srcdir)/'`src/ags/X/machine/ags_pattern_box.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_pattern_box.Tpo $(DEPDIR)/gsequencer-ags_pattern_box.Po
#	$(AM_V_CC)source='src/ags/X/machine/ags_pattern_box.c' object='gsequencer-ags_pattern_box.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_pattern_box.o `test -f 'src/ags/X/machine/ags_pattern_box.c' || echo '$(srcdir)/'`src/ags/X/machine/ags_pattern_box.c
...
gsequencer-ags_pattern_box.obj: src/ags/X/machine/ags_pattern_box.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_pattern_box.Tpo $(DEPDIR)/gsequencer-ags_pattern_box.Po
#	$(AM_V_CC)source='src/ags/X/machine/ags_pattern_box.c' object='gsequencer-ags_pattern_box.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_pattern_box.obj `if test -f 'src/ags/X/machine/ags_pattern_box.c'; then $(CYGPATH_W) 'src/ags/X/machine/ags_pattern_box.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/X/machine/ags_pattern_box.c'; fi`
