...
am_gsequencer_OBJECTS = $(am__objects_1) \
	...
	gsequencer-ags_start_read_file.$(OBJEXT) \
...
PACKAGE_STRING = gsequencer 0.6.41
...
gsequencerheaders = \
	...
	src/ags/audio/task/ags_start_read_file.h \
...
gsequencer_SOURCES = \
	...
	src/ags/audio/task/ags_start_read_file.c \
...
include ./$(DEPDIR)/gsequencer-ags_start_read_file.Po
...
gsequencer-ags_start_read_file.o: src/ags/audio/task/ags_start_read_file.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_start_read_file.Tpo $(DEPDIR)/gsequencer-ags_start_read_file.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_start_read_file.c' object='gsequencer-ags_start_read_file.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(gsequencer_CFLAGS) $(CFLAGS) -c -o gsequencer-ags_start_read_file.o `test -f 'src/ags/audio/task/ags_start_read_file.c' || echo '$(srcdir)/'`src/ags/audio/task/ags_start_read_file.c

gsequencer-ags_start_read_file.obj: src/ags/audio/task/ags_start_read_file.c
	...
	$(AM_V_at)$(am__mv) $(DEPDIR)/gsequencer-ags_start_read_file.Tpo $(DEPDIR)/gsequencer-ags_start_read_file.Po
#	$(AM_V_CC)source='src/ags/audio/task/ags_start_read_file.c' object='gsequencer-ags_start_read_file.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
