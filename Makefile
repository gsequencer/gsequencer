...
am__objects_1 =
am_ags_OBJECTS = $(am__objects_1) ags-ags_audio.$(OBJEXT) \
	ags-ags_audio_signal.$(OBJEXT) ags-ags_channel.$(OBJEXT) \
	ags-ags_channel_iter.$(OBJEXT) ags-ags_config.$(OBJEXT) \
	ags-ags_devout.$(OBJEXT) ags-ags_garbage_collector.$(OBJEXT) \
	ags-ags_input.$(OBJEXT) ags-ags_libao.$(OBJEXT) \
	ags-ags_notation.$(OBJEXT) ags-ags_note.$(OBJEXT) \
	ags-ags_output.$(OBJEXT) ags-ags_pattern.$(OBJEXT) \
	ags-ags_port.$(OBJEXT) ags-ags_recall_audio.$(OBJEXT) \
	ags-ags_recall_audio_run.$(OBJEXT) \
	ags-ags_recall_audio_signal.$(OBJEXT) ags-ags_recall.$(OBJEXT) \
	ags-ags_recall_channel.$(OBJEXT) \
	ags-ags_recall_channel_run.$(OBJEXT) \
	ags-ags_recall_channel_run_dummy.$(OBJEXT) \
	ags-ags_recall_container.$(OBJEXT) \
	ags-ags_recall_dependency.$(OBJEXT) \
	ags-ags_recall_factory.$(OBJEXT) ags-ags_recall_id.$(OBJEXT) \
	ags-ags_recall_ladspa.$(OBJEXT) \
	ags-ags_recall_ladspa_run.$(OBJEXT) \
	ags-ags_recall_recycling.$(OBJEXT) \
	ags-ags_recall_recycling_dummy.$(OBJEXT) \
	ags-ags_recycling.$(OBJEXT) \
	ags-ags_recycling_container.$(OBJEXT) ags-ags_synths.$(OBJEXT) \
	ags-ags_task.$(OBJEXT) ags-ags_timestamp.$(OBJEXT) \
	ags-ags_timestamp_factory.$(OBJEXT) \
	ags-ags_audio_file.$(OBJEXT) ags-ags_audio_file_xml.$(OBJEXT) \
	ags-ags_ipatch.$(OBJEXT) ags-ags_ipatch_sf2_reader.$(OBJEXT) \
	ags-ags_sndfile.$(OBJEXT) ags-ags_amplifier.$(OBJEXT) \
	...
	ags-ags_delay_audio.$(OBJEXT) \
	ags-ags_delay_audio_run.$(OBJEXT) ags-ags_echo.$(OBJEXT) \
	ags-ags_loop_channel.$(OBJEXT) \
	ags-ags_loop_channel_run.$(OBJEXT) \
	ags-ags_mute_audio.$(OBJEXT) ags-ags_mute_audio_run.$(OBJEXT) \
	...
	ags-ags_peak_recycling.$(OBJEXT) ags-ags_play_audio.$(OBJEXT) \
	...
	ags-ags_play_note.$(OBJEXT) ags-ags_play_pattern.$(OBJEXT) \
	ags-ags_play_recycling.$(OBJEXT) \
	ags-ags_stream_audio_signal.$(OBJEXT) ags-ags_stream.$(OBJEXT) \
	...
	ags-ags_volume_recycling.$(OBJEXT) ags-ags_add_audio.$(OBJEXT) \
	ags-ags_add_audio_signal.$(OBJEXT) \
	ags-ags_add_line_member.$(OBJEXT) ags-ags_add_note.$(OBJEXT) \
	ags-ags_add_point_to_selection.$(OBJEXT) \
	ags-ags_add_recall.$(OBJEXT) \
	...
	ags-ags_append_recall.$(OBJEXT) ags-ags_apply_synth.$(OBJEXT) \
	...
	ags-ags_change_tact.$(OBJEXT) \
	ags-ags_channel_set_recycling.$(OBJEXT) \
	ags-ags_display_tact.$(OBJEXT) ags-ags_export_output.$(OBJEXT) \
	ags-ags_free_selection.$(OBJEXT) ags-ags_init_audio.$(OBJEXT) \
	ags-ags_init_channel.$(OBJEXT) ags-ags_link_channel.$(OBJEXT) \
	...
	ags-ags_resize_audio.$(OBJEXT) ags-ags_save_file.$(OBJEXT) \
	ags-ags_scroll_on_play.$(OBJEXT) ags-ags_seek_devout.$(OBJEXT) \
	...
	ags-ags_start_devout.$(OBJEXT) ags-ags_toggle_led.$(OBJEXT) \
	ags-ags_toggle_pattern_bit.$(OBJEXT) \
	ags-ags_unref_audio_signal.$(OBJEXT) \
	ags-ags_apply_bpm.$(OBJEXT) \
	ags-ags_apply_sequencer_length.$(OBJEXT) \
	ags-ags_apply_tact.$(OBJEXT) ags-ags_set_muted.$(OBJEXT) \
	ags-ags_file.$(OBJEXT) ags-ags_file_gui.$(OBJEXT) \
	ags-ags_file_id_ref.$(OBJEXT) ags-ags_file_launch.$(OBJEXT) \
	ags-ags_file_link.$(OBJEXT) ags-ags_file_lookup.$(OBJEXT) \
	ags-ags_file_sound.$(OBJEXT) ags-ags_file_thread.$(OBJEXT) \
	ags-ags_file_util.$(OBJEXT) ags-ags_connectable.$(OBJEXT) \
	ags-ags_combo_box_text.$(OBJEXT) ags-ags_container.$(OBJEXT) \
	ags-ags_list.$(OBJEXT) ags-ags_log.$(OBJEXT) \
	ags-ags_parameter.$(OBJEXT) ags-main.$(OBJEXT) \
	ags-ags_applicable.$(OBJEXT) ags-ags_countable.$(OBJEXT) \
	ags-ags_dynamic_connectable.$(OBJEXT) ags-ags_effect.$(OBJEXT) \
	ags-ags_main_loop.$(OBJEXT) ags-ags_marshal.$(OBJEXT) \
	ags-ags_mutable.$(OBJEXT) ags-ags_packable.$(OBJEXT) \
	ags-ags_persistable.$(OBJEXT) ags-ags_playable.$(OBJEXT) \
	ags-ags_plugin.$(OBJEXT) ags-ags_portlet.$(OBJEXT) \
	ags-ags_runnable.$(OBJEXT) ags-ags_seekable.$(OBJEXT) \
	ags-ags_soundcard.$(OBJEXT) ags-ags_stackable.$(OBJEXT) \
	ags-ags_tactable.$(OBJEXT) ags-ags_tree_iterator.$(OBJEXT) \
	ags-ags_ladspa_manager.$(OBJEXT) \
	ags-ags_plugin_factory.$(OBJEXT) ags-ags_registry.$(OBJEXT) \
	ags-ags_remote_task.$(OBJEXT) ags-ags_server.$(OBJEXT) \
	ags-ags_async_queue.$(OBJEXT) ags-ags_audio_loop.$(OBJEXT) \
	ags-ags_autosave_thread.$(OBJEXT) \
	ags-ags_devout_thread.$(OBJEXT) \
	ags-ags_export_thread.$(OBJEXT) \
	ags-ags_gui_task_thread.$(OBJEXT) ags-ags_gui_thread.$(OBJEXT) \
	ags-ags_history.$(OBJEXT) ags-ags_iterator_thread.$(OBJEXT) \
	ags-ags_mutex_manager.$(OBJEXT) \
	ags-ags_record_thread.$(OBJEXT) \
	ags-ags_recycling_thread.$(OBJEXT) \
	ags-ags_recycling_thread_callbacks.$(OBJEXT) \
	ags-ags_returnable_thread.$(OBJEXT) \
	ags-ags_single_thread.$(OBJEXT) \
	ags-ags_task_completion.$(OBJEXT) \
	ags-ags_task_thread.$(OBJEXT) ags-ags_thread_pool.$(OBJEXT) \
	ags-ags_thread-posix.$(OBJEXT) \
	ags-ags_timestamp_thread.$(OBJEXT) \
	ags-ags_id_generator.$(OBJEXT) ags-ags_cartesian.$(OBJEXT) \
	ags-ags_dial.$(OBJEXT) ags-ags_expander.$(OBJEXT) \
	ags-ags_expander_set.$(OBJEXT) ags-ags_hindicator.$(OBJEXT) \
	ags-ags_htimebar.$(OBJEXT) ags-ags_indicator.$(OBJEXT) \
	ags-ags_led.$(OBJEXT) ags-ags_menu.$(OBJEXT) \
	ags-ags_menu_item.$(OBJEXT) ags-ags_option_menu.$(OBJEXT) \
	ags-ags_ruler.$(OBJEXT) ags-ags_segment.$(OBJEXT) \
	ags-ags_table.$(OBJEXT) ags-ags_timebar.$(OBJEXT) \
	ags-ags_vindicator.$(OBJEXT) ags-ags_waveform.$(OBJEXT) \
	ags-ags_audio_preferences.$(OBJEXT) \
	ags-ags_audio_preferences_callbacks.$(OBJEXT) \
	ags-ags_editor.$(OBJEXT) ags-ags_editor_callbacks.$(OBJEXT) \
	...
	ags-ags_line.$(OBJEXT) ags-ags_line_callbacks.$(OBJEXT) \
	...
	ags-ags_machine.$(OBJEXT) ags-ags_machine_callbacks.$(OBJEXT) \
	ags-ags_machine_editor.$(OBJEXT) \
	ags-ags_machine_editor_callbacks.$(OBJEXT) \
	ags-ags_menu_bar.$(OBJEXT) \
	ags-ags_menu_bar_callbacks.$(OBJEXT) \
	ags-ags_navigation.$(OBJEXT) \
	ags-ags_navigation_callbacks.$(OBJEXT) ags-ags_pad.$(OBJEXT) \
	ags-ags_pad_callbacks.$(OBJEXT) ags-ags_pad_editor.$(OBJEXT) \
	...
	ags-ags_window.$(OBJEXT) ags-ags_window_callbacks.$(OBJEXT) \
	...
	ags-ags_meter.$(OBJEXT) ags-ags_meter_callbacks.$(OBJEXT) \
	...
	ags-ags_toolbar.$(OBJEXT) ags-ags_toolbar_callbacks.$(OBJEXT) \
	ags-ags_drum.$(OBJEXT) ags-ags_drum_callbacks.$(OBJEXT) \
	...
	ags-ags_ffplayer.$(OBJEXT) \
	ags-ags_ffplayer_callbacks.$(OBJEXT) ags-ags_matrix.$(OBJEXT) \
	ags-ags_matrix_callbacks.$(OBJEXT) ags-ags_mixer.$(OBJEXT) \
	ags-ags_mixer_callbacks.$(OBJEXT) \
	ags-ags_mixer_input_line.$(OBJEXT) \
	ags-ags_mixer_input_pad.$(OBJEXT) ags-ags_oscillator.$(OBJEXT) \
	ags-ags_oscillator_callbacks.$(OBJEXT) ags-ags_panel.$(OBJEXT) \
	ags-ags_panel_callbacks.$(OBJEXT) \
	ags-ags_panel_input_line.$(OBJEXT) \
	ags-ags_panel_input_pad.$(OBJEXT) ags-ags_synth.$(OBJEXT) \
...
EXTRA_DIST = gsequencer.share acsite.m4 ags.1 midi2xml.1 README \
	gsequencer-documentation ags.desktop.in $(userdoc) \
...
include ./$(DEPDIR)/ags-ags_mute_audio_run.Po
...
ags-ags_mute_audio_run.o: src/ags/audio/recall/ags_mute_audio_run.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(ags_CFLAGS) $(CFLAGS) -MT ags-ags_mute_audio_run.o -MD -MP -MF $(DEPDIR)/ags-ags_mute_audio_run.Tpo -c -o ags-ags_mute_audio_run.o `test -f 'src/ags/audio/recall/ags_mute_audio_run.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_mute_audio_run.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/ags-ags_mute_audio_run.Tpo $(DEPDIR)/ags-ags_mute_audio_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_mute_audio_run.c' object='ags-ags_mute_audio_run.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(ags_CFLAGS) $(CFLAGS) -c -o ags-ags_mute_audio_run.o `test -f 'src/ags/audio/recall/ags_mute_audio_run.c' || echo '$(srcdir)/'`src/ags/audio/recall/ags_mute_audio_run.c

ags-ags_mute_audio_run.obj: src/ags/audio/recall/ags_mute_audio_run.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(ags_CFLAGS) $(CFLAGS) -MT ags-ags_mute_audio_run.obj -MD -MP -MF $(DEPDIR)/ags-ags_mute_audio_run.Tpo -c -o ags-ags_mute_audio_run.obj `if test -f 'src/ags/audio/recall/ags_mute_audio_run.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_mute_audio_run.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_mute_audio_run.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/ags-ags_mute_audio_run.Tpo $(DEPDIR)/ags-ags_mute_audio_run.Po
#	$(AM_V_CC)source='src/ags/audio/recall/ags_mute_audio_run.c' object='ags-ags_mute_audio_run.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(ags_CFLAGS) $(CFLAGS) -c -o ags-ags_mute_audio_run.obj `if test -f 'src/ags/audio/recall/ags_mute_audio_run.c'; then $(CYGPATH_W) 'src/ags/audio/recall/ags_mute_audio_run.c'; else $(CYGPATH_W) '$(srcdir)/src/ags/audio/recall/ags_mute_audio_run.c'; fi`
...
uninstall-hook:
	...
	rm $(DESTDIR)/$(datadir)/doc-base/gsequencer-documentation
