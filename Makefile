...
AGS_X_OBJECTS = $(AGS_DIR)X/ags_window.o $(AGS_DIR)X/ags_menu_bar.o $(AGS_DIR)X/ags_machine.o $(AGS_DIR)X/ags_pad.o $(AGS_DIR)X/ags_line.o $(AGS_DIR)X/ags_editor.o $(AGS_DIR)X/ags_navigation.o $(AGS_DIR)X/ags_machine_editor.o $(AGS_DIR)X/ags_machine_property_editor.o $(AGS_DIR)X/ags_pad_editor.o $(AGS_DIR)X/ags_line_editor.o $(AGS_DIR)X/ags_link_editor.o $(AGS_DIR)X/ags_line_member_editor.o $(AGS_DIR)X/ags_machine_link_editor.o $(AGS_DIR)X/ags_machine_resize_editor.o $(AGS_DIR)X/ags_machine_line_member_editor.o

AGS_X_CALLBACK_OBJECTS = $(AGS_DIR)X/ags_window_callbacks.o $(AGS_DIR)X/ags_menu_bar_callbacks.o $(AGS_DIR)X/ags_machine_callbacks.o $(AGS_DIR)X/ags_pad_callbacks.o $(AGS_DIR)X/ags_line_callbacks.o $(AGS_DIR)X/ags_editor_callbacks.o  $(AGS_DIR)X/ags_navigation_callbacks.o $(AGS_DIR)X/ags_machine_editor_callbacks.o $(AGS_DIR)X/ags_machine_property_editor_callbacks.o $(AGS_DIR)X/ags_pad_editor_callbacks.o $(AGS_DIR)X/ags_line_editor_callbacks.o $(AGS_DIR)X/ags_link_editor_callbacks.o $(AGS_DIR)X/ags_line_member_editor_callbacks.o $(AGS_DIR)X/ags_machine_link_editor_callbacks.o $(AGS_DIR)X/ags_machine_resize_editor_callbacks.o $(AGS_DIR)X/ags_machine_line_member_editor_callbacks.o
...
AGS_OBJECT_OBJECTS = $(AGS_DIR)object/ags_connectable.o $(AGS_DIR)object/ags_run_connectable.o $(AGS_DIR)object/ags_marshal.o
