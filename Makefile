...
AGS_AUDIO_OBJECTS = $(AGS_DIR)audio/ags_devout.o $(AGS_DIR)audio/ags_task.o $(AGS_DIR)audio/ags_audio.o $(AGS_DIR)audio/ags_channel.o $(AGS_DIR)audio/ags_input.o $(AGS_DIR)audio/ags_output.o $(AGS_DIR)audio/ags_recycling.o $(AGS_DIR)audio/ags_audio_signal.o $(AGS_DIR)audio/ags_pattern.o $(AGS_DIR)audio/ags_notation.o $(AGS_DIR)audio/ags_note.o $(AGS_DIR)audio/ags_recall_container.o $(AGS_DIR)audio/ags_recall.o $(AGS_DIR)audio/ags_recall_manager.o $(AGS_DIR)audio/ags_recall_id.o $(AGS_DIR)audio/ags_run_order.o $(AGS_DIR)audio/ags_recall_audio.o $(AGS_DIR)audio/ags_recall_audio_run.o $(AGS_DIR)audio/ags_recall_channel.o $(AGS_DIR)audio/ags_recall_channel_run.o $(AGS_DIR)audio/ags_garbage_collector.o $(AGS_DIR)audio/ags_synths.o

AGS_TASK_OBJECTS = $(AGS_DIR)audio/task/ags_open_file.o $(AGS_DIR)audio/task/ags_link_channel.o $(AGS_DIR)audio/task/ags_change_bpm.o $(AGS_DIR)audio/task/ags_apply_synth.o $(AGS_DIR)audio/task/ags_apply_wavetable.o $(AGS_DIR)audio/task/ags_append_audio.o $(AGS_DIR)audio/task/ags_append_channel.o $(AGS_DIR)audio/task/ags_append_recall.o $(AGS_DIR)audio/task/ags_cancel_audio.o $(AGS_DIR)audio/task/ags_cancel_channel.o $(AGS_DIR)audio/task/ags_cancel_recall.o $(AGS_DIR)audio/task/ags_add_note.o $(AGS_DIR)audio/task/ags_remove_note.o $(AGS_DIR)audio/task/ags_add_point_to_selection.o $(AGS_DIR)audio/task/ags_remove_point_from_selection.o $(AGS_DIR)audio/task/ags_add_region_to_selection.o $(AGS_DIR)audio/task/ags_remove_region_from_selection.o $(AGS_DIR)audio/task/ags_free_selection.o
...
AGS_AUDIO_FILE_OBJECTS = $(AGS_DIR)audio/file/ags_audio_file.o $(AGS_DIR)audio/file/ags_audio_file_xml.o $(AGS_DIR)audio/file/ags_sndfile.o
