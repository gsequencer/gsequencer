...
#include <ags/GSequencer/editor/ags_position_sheet_cursor_dialog.h>
#include <ags/GSequencer/editor/ags_add_sheet_page_dialog.h>
#include <ags/GSequencer/editor/ags_remove_sheet_page_dialog.h>
