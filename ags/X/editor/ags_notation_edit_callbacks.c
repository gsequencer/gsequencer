...
void ags_notation_edit_drawing_area_button_press_position_cursor(AgsNotationEdit *notation_edit, GdkEventButton *event);
void ags_notation_edit_drawing_area_button_press_add_note(AgsNotationEdit *notation_edit, GdkEventButton *event);
void ags_notation_edit_drawing_area_button_press_select_note(AgsNotationEdit *notation_edit, GdkEventButton *event);

void ags_notation_edit_drawing_area_button_release_position_cursor(AgsNotationEdit *notation_edit, GdkEventButton *event);
void ags_notation_edit_drawing_area_button_release_add_note(AgsNotationEdit *notation_edit, GdkEventButton *event);
void ags_notation_edit_drawing_area_button_release_delete_note(AgsNotationEdit *notation_edit, GdkEventButton *event);
void ags_notation_edit_drawing_area_button_release_select_note(AgsNotationEdit *notation_edit, GdkEventButton *event);

void ags_notation_edit_drawing_area_motion_notify_position_cursor(AgsNotationEdit *notation_edit, GdkEventMotion *event);
void ags_notation_edit_drawing_area_motion_notify_add_note(AgsNotationEdit *notation_edit, GdkEventMotion *event);
void ags_notation_edit_drawing_area_motion_notify_select_note(AgsNotationEdit *notation_edit, GdkEventMotion *event);
...
void
ags_notation_edit_drawing_area_button_press_position_cursor(AgsNotationEdit *notation_edit, GdkEventButton *event)
{
...
void
ags_notation_edit_drawing_area_button_press_add_note(AgsNotationEdit *notation_edit, GdkEventButton *event)
{
  AgsNotationEditor *notation_editor;
  AgsNotationToolbar *notation_toolbar;
...
void
ags_notation_edit_drawing_area_button_press_select_note(AgsNotationEdit *notation_edit, GdkEventButton *event)
{
...
ags_notation_edit_drawing_area_button_press_event(GtkWidget *widget, GdkEventButton *event, AgsNotationEdit *notation_edit)
{
  ...
  if((machine = notation_editor->selected_machine) != NULL &&
    ...
    if(notation_toolbar->selected_edit_mode == notation_toolbar->position){
      ...
      ags_notation_edit_drawing_area_button_press_position_cursor(notation_edit, event);
    }else if(notation_toolbar->selected_edit_mode == notation_toolbar->edit){
      notation_edit->mode = AGS_NOTATION_EDIT_ADD_NOTE;

      ags_notation_edit_drawing_area_button_press_add_note(notation_edit, event);
      ...
      ags_notation_edit_drawing_area_button_press_select_note(notation_edit, event);
    }
  }
...
void
ags_notation_edit_drawing_area_button_release_position_cursor(AgsNotationEdit *notation_edit, GdkEventButton *event)
{
  AgsNotationEditor *notation_editor;
  AgsNotationToolbar *notation_toolbar;
...
void
ags_notation_edit_drawing_area_button_release_add_note(AgsNotationEdit *notation_edit, GdkEventButton *event)
{
  AgsNotationEditor *notation_editor;
  AgsNotationToolbar *notation_toolbar;
...
void
ags_notation_edit_drawing_area_button_release_delete_note(AgsNotationEdit *notation_edit, GdkEventButton *event)
{
  AgsNotationEditor *notation_editor;
  AgsNotationToolbar *notation_toolbar;
...
ags_notation_edit_drawing_area_button_release_event(GtkWidget *widget, GdkEventButton *event, AgsNotationEdit *notation_edit)
{
  ...
  if((machine = notation_editor->selected_machine) != NULL &&
    ...
    if(notation_edit->mode == AGS_NOTATION_EDIT_POSITION_CURSOR){
      ags_notation_edit_drawing_area_button_release_position_cursor(notation_edit, event);
      
      //      notation_edit->mode = AGS_NOTATION_EDIT_NO_EDIT_MODE;
    }else if(notation_edit->mode == AGS_NOTATION_EDIT_ADD_NOTE){
      ags_notation_edit_drawing_area_button_release_add_note(notation_edit, event);

      notation_edit->mode = AGS_NOTATION_EDIT_NO_EDIT_MODE;
    }else if(notation_edit->mode == AGS_NOTATION_EDIT_DELETE_NOTE){
      ags_notation_edit_drawing_area_button_release_delete_note(notation_edit, event);

      notation_edit->mode = AGS_NOTATION_EDIT_NO_EDIT_MODE;
    }else if(notation_edit->mode == AGS_NOTATION_EDIT_SELECT_NOTE){
      ags_notation_edit_drawing_area_button_release_select_note(notation_edit, event);
...
void
ags_notation_edit_drawing_area_motion_notify_position_cursor(AgsNotationEdit *notation_edit, GdkEventMotion *event)
{
  AgsNotationEditor *notation_editor;
  AgsNotationToolbar *notation_toolbar;
...
void
ags_notation_edit_drawing_area_motion_notify_add_note(AgsNotationEdit *notation_edit, GdkEventMotion *event)
{
  AgsNotationEditor *notation_editor;
  AgsNotationToolbar *notation_toolbar;
...
void
ags_notation_edit_drawing_area_motion_notify_select_note(AgsNotationEdit *notation_edit, GdkEventMotion *event)
{
...
ags_notation_edit_drawing_area_motion_notify_event(GtkWidget *widget, GdkEventMotion *event, AgsNotationEdit *notation_edit)
{
  ...
  if((machine = notation_editor->selected_machine) != NULL &&
    ...
    if(notation_edit->mode == AGS_NOTATION_EDIT_POSITION_CURSOR){
      ags_notation_edit_drawing_area_motion_notify_position_cursor(notation_edit, event);
    }else if(notation_edit->mode == AGS_NOTATION_EDIT_ADD_NOTE){
      ags_notation_edit_drawing_area_motion_notify_add_note(notation_edit, event);
    }else if(notation_edit->mode == AGS_NOTATION_EDIT_DELETE_NOTE){
      //NOTE:JK: only takes action on release
    }else if(notation_edit->mode == AGS_NOTATION_EDIT_SELECT_NOTE){
      ags_notation_edit_drawing_area_motion_notify_select_note(notation_edit, event);
    }
  }
