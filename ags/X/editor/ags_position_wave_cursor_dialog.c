...
ags_position_wave_cursor_dialog_class_init(AgsPositionWaveCursorDialogClass *position_wave_cursor_dialog)
{
  ...
  /* properties */
  /**
   * AgsPositionWaveCursorDialog:application-context:
   *
...
ags_position_wave_cursor_dialog_init(AgsPositionWaveCursorDialog *position_wave_cursor_dialog)
{
  ...
  gtk_toggle_button_set_active(position_wave_cursor_dialog->set_focus,
			       TRUE);
					     ...
					     GParamSpec *param_spec)
{
  ...
  case PROP_APPLICATION_CONTEXT:
    {
      ...
      if((AgsApplicationContext *) position_wave_cursor_dialog->application_context == application_context){
	return;
      }
      
      if(position_wave_cursor_dialog->application_context != NULL){
	g_object_unref(position_wave_cursor_dialog->application_context);
      }
	...
	g_object_ref(application_context);
      ...
      position_wave_cursor_dialog->application_context = (GObject *) application_context;
    }
    break;
  case PROP_MAIN_WINDOW:
	...
	g_object_ref(main_window);
      ...
      position_wave_cursor_dialog->main_window = (GObject *) main_window;
    }
    break;
  default:
					     ...
					     GParamSpec *param_spec)
{
  ...
  case PROP_APPLICATION_CONTEXT:
    {
      g_value_set_object(value, position_wave_cursor_dialog->application_context);
    }
    break;
  case PROP_MAIN_WINDOW:
    {
...
ags_position_wave_cursor_dialog_apply(AgsApplicable *applicable)
{
  ...
  window = position_wave_cursor_dialog->main_window;
  ...
  current_page = gtk_notebook_get_current_page(wave_editor->notebook);
  ...
  if(gtk_toggle_button_get_active(position_wave_cursor_dialog->set_focus)){
