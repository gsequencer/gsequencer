...
ags_app_action_util_add_stargazer_synth()
{
  ...
  /* create stargazer synth */
  stargazer_synth = (AgsStargazerSynth *) ags_machine_util_new_stargazer_synth();

  add_audio = ags_add_audio_new(AGS_MACHINE(stargazer_synth)->audio);
  ags_ui_provider_schedule_task(AGS_UI_PROVIDER(application_context),
				(AgsTask *) add_audio);
}
...
ags_app_action_util_add_quantum_synth()
{
  ...
  /* create quantum synth */
  quantum_synth = (AgsQuantumSynth *) ags_machine_util_new_quantum_synth();

  add_audio = ags_add_audio_new(AGS_MACHINE(quantum_synth)->audio);
  ags_ui_provider_schedule_task(AGS_UI_PROVIDER(application_context),
				(AgsTask *) add_audio);
}
...
ags_app_action_util_add_abyss_synth()
{
  ...
  /* create abyss synth */
  abyss_synth = (AgsAbyssSynth *) ags_machine_util_new_abyss_synth();

  add_audio = ags_add_audio_new(AGS_MACHINE(abyss_synth)->audio);
  ags_ui_provider_schedule_task(AGS_UI_PROVIDER(application_context),
				(AgsTask *) add_audio);
}
