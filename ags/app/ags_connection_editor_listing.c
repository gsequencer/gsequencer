...
static void ags_connection_editor_listing_class_init(AgsConnectionEditorListingClass *connection_editor_listing);
static void ags_connection_editor_listing_connectable_interface_init(AgsConnectableInterface *connectable);
static void ags_connection_editor_listing_applicable_interface_init(AgsApplicableInterface *applicable);
static void ags_connection_editor_listing_init(AgsConnectionEditorListing *connection_editor_listing);
static void ags_connection_editor_listing_set_property(GObject *gobject,
						       guint prop_id,
						       const GValue *value,
						       GParamSpec *param_spec);
static void ags_connection_editor_listing_get_property(GObject *gobject,
						       guint prop_id,
						       GValue *value,
						       GParamSpec *param_spec);

static void ags_connection_editor_listing_connect(AgsConnectable *connectable);
static void ags_connection_editor_listing_disconnect(AgsConnectable *connectable);

static void ags_connection_editor_listing_set_update(AgsApplicable *applicable, gboolean update);
static void ags_connection_editor_listing_apply(AgsApplicable *applicable);
static void ags_connection_editor_listing_reset(AgsApplicable *applicable);
...
ags_connection_editor_listing_get_type(void)
{
  ...
  if(g_once_init_enter(&g_define_type_id__static)){
    ...
    g_once_init_leave(&g_define_type_id__static, ags_type_connection_editor_listing);
  }
