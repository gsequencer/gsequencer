...
static void ags_machine_editor_dialog_class_init(AgsMachineEditorDialogClass *machine_editor_dialog);
static void ags_machine_editor_dialog_init(AgsMachineEditorDialog *machine_editor_dialog);

static void ags_machine_editor_dialog_activate_button_callback(GtkButton *activate_button,
							       AgsMachineEditorDialog *machine_editor_dialog);

static gboolean ags_machine_editor_dialog_key_pressed_callback(GtkEventControllerKey *event_controller,
							       guint keyval,
							       guint keycode,
							       GdkModifierType state,
							       AgsMachineEditorDialog *machine_editor_dialog);
static void ags_machine_editor_dialog_key_released_callback(GtkEventControllerKey *event_controller,
							    guint keyval,
							    guint keycode,
							    GdkModifierType state,
							    AgsMachineEditorDialog *machine_editor_dialog);
static gboolean ags_machine_editor_dialog_modifiers_callback(GtkEventControllerKey *event_controller,
...
ags_machine_editor_dialog_get_type(void)
{
  ...
  if(g_once_init_enter(&g_define_type_id__static)){
    ...
    g_once_init_leave(&g_define_type_id__static, ags_type_machine_editor_dialog);
  }
