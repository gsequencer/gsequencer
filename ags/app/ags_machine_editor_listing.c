...
ags_machine_editor_listing_get_type(void)
{
  ...
  if(g_once_init_enter(&g_define_type_id__static)){
    ...
    g_once_init_leave(&g_define_type_id__static, ags_type_machine_editor_listing);
  }
...
ags_machine_editor_listing_init(AgsMachineEditorListing *machine_editor_listing)
{
  ...
  gtk_widget_set_halign((GtkWidget *) machine_editor_listing->enabled,
			GTK_ALIGN_START);
  gtk_widget_set_valign((GtkWidget *) machine_editor_listing->enabled,
			GTK_ALIGN_START);
...
ags_machine_editor_listing_reset(AgsApplicable *applicable)
{
  ...
  machine_editor = (AgsMachineEditor *) gtk_widget_get_ancestor((GtkWidget *) machine_editor_listing,
