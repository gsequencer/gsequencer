...
void ags_menu_action_add_hybrid_fm_synth_callback(GtkWidget *menu_item, gpointer data);
...
void ags_menu_action_meta_data_callback(GtkWidget *menu_item, gpointer data);
