...
ags_midi_dialog_get_type(void)
{
  ...
  if(g_once_init_enter(&g_define_type_id__static)){
    ...
    g_once_init_leave(&g_define_type_id__static, ags_type_midi_dialog);
  }
...
ags_midi_dialog_init(AgsMidiDialog *midi_dialog)
{
  ...
  gtk_widget_set_margin_end((GtkWidget *) midi_dialog->activate_button,
			    6);
  gtk_widget_set_margin_bottom((GtkWidget *) midi_dialog->activate_button,
			       6);  
