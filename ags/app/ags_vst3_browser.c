...
static void ags_vst3_browser_class_init(AgsVst3BrowserClass *vst3_browser);
static void ags_vst3_browser_connectable_interface_init(AgsConnectableInterface *connectable);
static void ags_vst3_browser_applicable_interface_init(AgsApplicableInterface *applicable);
static void ags_vst3_browser_init(AgsVst3Browser *vst3_browser);

static void ags_vst3_browser_connect(AgsConnectable *connectable);
static void ags_vst3_browser_disconnect(AgsConnectable *connectable);

static void ags_vst3_browser_set_update(AgsApplicable *applicable, gboolean update);
static void ags_vst3_browser_apply(AgsApplicable *applicable);
static void ags_vst3_browser_reset(AgsApplicable *applicable);
...
ags_vst3_browser_get_type(void)
{
  ...
  if(g_once_init_enter(&g_define_type_id__static)){
    ...
    g_once_init_leave(&g_define_type_id__static, ags_type_vst3_browser);
  }
