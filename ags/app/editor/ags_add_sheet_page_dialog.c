...
static void ags_add_sheet_page_dialog_class_init(AgsAddSheetPageDialogClass *add_sheet_page_dialog);
static void ags_add_sheet_page_dialog_connectable_interface_init(AgsConnectableInterface *connectable);
static void ags_add_sheet_page_dialog_applicable_interface_init(AgsApplicableInterface *applicable);
static void ags_add_sheet_page_dialog_init(AgsAddSheetPageDialog *add_sheet_page_dialog);
static void ags_add_sheet_page_dialog_finalize(GObject *gobject);
static void ags_add_sheet_page_dialog_connect(AgsConnectable *connectable);
static void ags_add_sheet_page_dialog_disconnect(AgsConnectable *connectable);
static void ags_add_sheet_page_dialog_set_update(AgsApplicable *applicable, gboolean update);
static void ags_add_sheet_page_dialog_apply(AgsApplicable *applicable);
static void ags_add_sheet_page_dialog_reset(AgsApplicable *applicable);
...
ags_add_sheet_page_dialog_get_type(void)
{
  ...
  if(g_once_init_enter(&g_define_type_id__static)){
    ...
    g_once_init_leave(&g_define_type_id__static, ags_type_add_sheet_page_dialog);
  }
