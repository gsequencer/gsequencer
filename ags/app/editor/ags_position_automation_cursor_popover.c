...
static void ags_position_automation_cursor_popover_class_init(AgsPositionAutomationCursorPopoverClass *position_automation_cursor_popover);
static void ags_position_automation_cursor_popover_connectable_interface_init(AgsConnectableInterface *connectable);
static void ags_position_automation_cursor_popover_applicable_interface_init(AgsApplicableInterface *applicable);
static void ags_position_automation_cursor_popover_init(AgsPositionAutomationCursorPopover *position_automation_cursor_popover);
static void ags_position_automation_cursor_popover_finalize(GObject *gobject);

static gboolean ags_position_automation_cursor_popover_is_connected(AgsConnectable *connectable);
static void ags_position_automation_cursor_popover_connect(AgsConnectable *connectable);
static void ags_position_automation_cursor_popover_disconnect(AgsConnectable *connectable);

static void ags_position_automation_cursor_popover_set_update(AgsApplicable *applicable, gboolean update);
static void ags_position_automation_cursor_popover_apply(AgsApplicable *applicable);
static void ags_position_automation_cursor_popover_reset(AgsApplicable *applicable);

static gboolean ags_position_automation_cursor_popover_key_pressed_callback(GtkEventControllerKey *event_controller,
									    guint keyval,
									    guint keycode,
									    GdkModifierType state,
									    AgsPositionAutomationCursorPopover *position_automation_cursor_popover);
static void ags_position_automation_cursor_popover_key_released_callback(GtkEventControllerKey *event_controller,
									 guint keyval,
									 guint keycode,
									 GdkModifierType state,
									 AgsPositionAutomationCursorPopover *position_automation_cursor_popover);
static gboolean ags_position_automation_cursor_popover_modifiers_callback(GtkEventControllerKey *event_controller,
									  GdkModifierType keyval,
									  AgsPositionAutomationCursorPopover *position_automation_cursor_popover);

static void ags_position_automation_cursor_popover_activate_button_callback(GtkButton *activate_button,
									    AgsPositionAutomationCursorPopover *position_automation_cursor_popover);
...
ags_position_automation_cursor_popover_init(AgsPositionAutomationCursorPopover *position_automation_cursor_popover)
{
  ...
  /* position x - tact */
  position_automation_cursor_popover->position_x_tact = (GtkSpinButton *) gtk_spin_button_new_with_range(0.0,
													 AGS_POSITION_AUTOMATION_CURSOR_MAX_BEATS,
													 1.0);
  gtk_spin_button_set_digits(position_automation_cursor_popover->position_x_tact,
			     0);
  gtk_editable_set_width_chars(GTK_EDITABLE(position_automation_cursor_popover->position_x_tact),
			       6);
  gtk_spin_button_set_value(position_automation_cursor_popover->position_x_tact,
			    0.0);
  gtk_box_append((GtkBox *) hbox,
		 (GtkWidget *) position_automation_cursor_popover->position_x_tact);
  
  /* position x - 1024th */
  position_automation_cursor_popover->position_x_1024th = (GtkSpinButton *) gtk_spin_button_new_with_range(0.0,
													   1023.0,
													   1.0);
  gtk_spin_button_set_digits(position_automation_cursor_popover->position_x_1024th,
			     0);
  gtk_editable_set_width_chars(GTK_EDITABLE(position_automation_cursor_popover->position_x_1024th),
			       5);
  gtk_spin_button_set_value(position_automation_cursor_popover->position_x_1024th,
			    0.0);
  gtk_box_append((GtkBox *) hbox,
		 (GtkWidget *) position_automation_cursor_popover->position_x_1024th);
...
ags_position_automation_cursor_popover_apply(AgsApplicable *applicable)
{
  ...
  x = gtk_spin_button_get_value_as_int(position_automation_cursor_popover->position_x_tact);
  x_1024th = (1024 * x) + gtk_spin_button_get_value_as_int(position_automation_cursor_popover->position_x_1024th);
  
  focused_automation_edit->cursor_position_x = (gint) floor((double) x_1024th / 64.0);
  ...
  if(hadjustment != NULL){
    gtk_adjustment_set_value(hadjustment,
			     ((floor((double) x_1024th / 64.0) * 64.0 / zoom) * (gtk_adjustment_get_upper(hadjustment) / (AGS_AUTOMATION_DEFAULT_LENGTH / zoom))));
  }
