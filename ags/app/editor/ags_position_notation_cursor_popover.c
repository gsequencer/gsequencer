...
static void ags_position_notation_cursor_popover_class_init(AgsPositionNotationCursorPopoverClass *position_notation_cursor_popover);
static void ags_position_notation_cursor_popover_connectable_interface_init(AgsConnectableInterface *connectable);
static void ags_position_notation_cursor_popover_applicable_interface_init(AgsApplicableInterface *applicable);
static void ags_position_notation_cursor_popover_init(AgsPositionNotationCursorPopover *position_notation_cursor_popover);
static void ags_position_notation_cursor_popover_finalize(GObject *gobject);

static xmlNode* ags_position_notation_cursor_popover_xml_compose(AgsConnectable *connectable);
static void ags_position_notation_cursor_popover_xml_parse(AgsConnectable *connectable,
							   xmlNode *node);

static gboolean ags_position_notation_cursor_popover_is_connected(AgsConnectable *connectable);
static void ags_position_notation_cursor_popover_connect(AgsConnectable *connectable);
static void ags_position_notation_cursor_popover_disconnect(AgsConnectable *connectable);

static void ags_position_notation_cursor_popover_set_update(AgsApplicable *applicable, gboolean update);
static void ags_position_notation_cursor_popover_apply(AgsApplicable *applicable);
static void ags_position_notation_cursor_popover_reset(AgsApplicable *applicable);

static gboolean ags_position_notation_cursor_popover_key_pressed_callback(GtkEventControllerKey *event_controller,
									  guint keyval,
									  guint keycode,
									  GdkModifierType state,
									  AgsPositionNotationCursorPopover *position_notation_cursor_popover);
static void ags_position_notation_cursor_popover_key_released_callback(GtkEventControllerKey *event_controller,
								       guint keyval,
								       guint keycode,
								       GdkModifierType state,
								       AgsPositionNotationCursorPopover *position_notation_cursor_popover);
static gboolean ags_position_notation_cursor_popover_modifiers_callback(GtkEventControllerKey *event_controller,
									GdkModifierType keyval,
									AgsPositionNotationCursorPopover *position_notation_cursor_popover);

static void ags_position_notation_cursor_popover_activate_button_callback(GtkButton *activate_button,
									  AgsPositionNotationCursorPopover *position_notation_cursor_popover);
...
ags_position_notation_cursor_popover_init(AgsPositionNotationCursorPopover *position_notation_cursor_popover)
{
  ...
  /* position x - 256th */
  position_notation_cursor_popover->position_x_256th = (GtkSpinButton *) gtk_spin_button_new_with_range(0.0,
													255.0,
													1.0);
  gtk_spin_button_set_digits(position_notation_cursor_popover->position_x_256th,
			     0);
  gtk_editable_set_width_chars(GTK_EDITABLE(position_notation_cursor_popover->position_x_256th),
			       4);
  gtk_spin_button_set_value(position_notation_cursor_popover->position_x_256th,
			    0.0);
  gtk_box_append((GtkBox *) hbox,
		 (GtkWidget *) position_notation_cursor_popover->position_x_256th);
...
ags_position_notation_cursor_popover_xml_compose(AgsConnectable *connectable)
{
  ...
  str = g_strdup_printf("%f",
			(256.0 * gtk_spin_button_get_value(position_notation_cursor_popover->position_x_tact) + gtk_spin_button_get_value(position_notation_cursor_popover->position_x_256th)));
...
ags_position_notation_cursor_popover_finalize(GObject *gobject)
{
  ...
  ags_connectable_disconnect(AGS_CONNECTABLE(position_notation_cursor_popover));
