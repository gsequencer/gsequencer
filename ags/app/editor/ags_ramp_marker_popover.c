...
static void ags_ramp_marker_popover_class_init(AgsRampMarkerPopoverClass *ramp_marker_popover);
static void ags_ramp_marker_popover_connectable_interface_init(AgsConnectableInterface *connectable);
static void ags_ramp_marker_popover_applicable_interface_init(AgsApplicableInterface *applicable);
static void ags_ramp_marker_popover_init(AgsRampMarkerPopover *ramp_marker_popover);
static void ags_ramp_marker_popover_finalize(GObject *gobject);

static gboolean ags_ramp_marker_popover_is_connected(AgsConnectable *connectable);
static void ags_ramp_marker_popover_connect(AgsConnectable *connectable);
static void ags_ramp_marker_popover_disconnect(AgsConnectable *connectable);

static void ags_ramp_marker_popover_set_update(AgsApplicable *applicable, gboolean update);
static void ags_ramp_marker_popover_apply(AgsApplicable *applicable);
static void ags_ramp_marker_popover_reset(AgsApplicable *applicable);

static gboolean ags_ramp_marker_popover_key_pressed_callback(GtkEventControllerKey *event_controller,
							     guint keyval,
							     guint keycode,
							     GdkModifierType state,
							     AgsRampMarkerPopover *ramp_marker_popover);
static void ags_ramp_marker_popover_key_released_callback(GtkEventControllerKey *event_controller,
							  guint keyval,
							  guint keycode,
							  GdkModifierType state,
							  AgsRampMarkerPopover *ramp_marker_popover);
static gboolean ags_ramp_marker_popover_modifiers_callback(GtkEventControllerKey *event_controller,
							   GdkModifierType keyval,
							   AgsRampMarkerPopover *ramp_marker_popover);

static void ags_ramp_marker_popover_activate_button_callback(GtkButton *activate_button,
							     AgsRampMarkerPopover *ramp_marker_popover);
...
ags_ramp_marker_popover_init(AgsRampMarkerPopover *ramp_marker_popover)
{
  ...
  /* ramp x0 - tact */
  ramp_marker_popover->ramp_x0_tact = (GtkSpinButton *) gtk_spin_button_new_with_range(0.0,
										       AGS_RAMP_MARKER_MAX_BEATS,
										       1.0);
  gtk_spin_button_set_digits(ramp_marker_popover->ramp_x0_tact,
			     0);
  gtk_editable_set_width_chars(GTK_EDITABLE(ramp_marker_popover->ramp_x0_tact),
			       6);
  gtk_spin_button_set_value(ramp_marker_popover->ramp_x0_tact,
			    0.0);
  gtk_box_append(hbox,
		 GTK_WIDGET(ramp_marker_popover->ramp_x0_tact));

  /* ramp x0 - 1024th */
  ramp_marker_popover->ramp_x0_1024th = (GtkSpinButton *) gtk_spin_button_new_with_range(0.0,
											 1023.0,
											 1.0);
  gtk_spin_button_set_digits(ramp_marker_popover->ramp_x0_1024th,
			     0);
  gtk_editable_set_width_chars(GTK_EDITABLE(ramp_marker_popover->ramp_x0_1024th),
			       5);
  gtk_spin_button_set_value(ramp_marker_popover->ramp_x0_1024th,
			    0.0);
  gtk_box_append(hbox,
		 GTK_WIDGET(ramp_marker_popover->ramp_x0_1024th));
  ...
  /* ramp x1 - tact */
  ramp_marker_popover->ramp_x1_tact = (GtkSpinButton *) gtk_spin_button_new_with_range(0.0,
										       AGS_RAMP_MARKER_MAX_BEATS,
										       1.0);
  gtk_spin_button_set_digits(ramp_marker_popover->ramp_x1_tact,
			     0);
  gtk_editable_set_width_chars(GTK_EDITABLE(ramp_marker_popover->ramp_x1_tact),
			       6);
  gtk_spin_button_set_value(ramp_marker_popover->ramp_x1_tact,
			    0.0);
  gtk_box_append(hbox,
		 GTK_WIDGET(ramp_marker_popover->ramp_x1_tact));

  /* ramp x1 - 1024th */
  ramp_marker_popover->ramp_x1_1024th = (GtkSpinButton *) gtk_spin_button_new_with_range(0.0,
											 1023.0,
											 1.0);
  gtk_spin_button_set_digits(ramp_marker_popover->ramp_x1_1024th,
			     0);
  gtk_editable_set_width_chars(GTK_EDITABLE(ramp_marker_popover->ramp_x1_1024th),
			       5);
  gtk_spin_button_set_value(ramp_marker_popover->ramp_x1_1024th,
			    0.0);
  gtk_box_append(hbox,
		 GTK_WIDGET(ramp_marker_popover->ramp_x1_1024th));
...
ags_ramp_marker_popover_apply(AgsApplicable *applicable)
{
  ...
  /* get some values */
  x0 = (1024 * gtk_spin_button_get_value_as_int(ramp_marker_popover->ramp_x0_tact)) + gtk_spin_button_get_value_as_int(ramp_marker_popover->ramp_x0_1024th);
  y0 = gtk_spin_button_get_value(ramp_marker_popover->ramp_y0);

  x1 = (1024 * gtk_spin_button_get_value_as_int(ramp_marker_popover->ramp_x1_tact)) + gtk_spin_button_get_value_as_int(ramp_marker_popover->ramp_x1_1024th);
