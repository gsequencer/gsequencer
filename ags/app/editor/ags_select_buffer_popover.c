...
static void ags_select_buffer_popover_class_init(AgsSelectBufferPopoverClass *select_buffer_popover);
static void ags_select_buffer_popover_connectable_interface_init(AgsConnectableInterface *connectable);
static void ags_select_buffer_popover_applicable_interface_init(AgsApplicableInterface *applicable);
static void ags_select_buffer_popover_init(AgsSelectBufferPopover *select_buffer_popover);
static void ags_select_buffer_popover_finalize(GObject *gobject);

static gboolean ags_select_buffer_popover_is_connected(AgsConnectable *connectable);
static void ags_select_buffer_popover_connect(AgsConnectable *connectable);
static void ags_select_buffer_popover_disconnect(AgsConnectable *connectable);

static void ags_select_buffer_popover_set_update(AgsApplicable *applicable, gboolean update);
static void ags_select_buffer_popover_apply(AgsApplicable *applicable);
static void ags_select_buffer_popover_reset(AgsApplicable *applicable);

static gboolean ags_select_buffer_popover_key_pressed_callback(GtkEventControllerKey *event_controller,
							       guint keyval,
							       guint keycode,
							       GdkModifierType state,
							       AgsSelectBufferPopover *select_buffer_popover);
static void ags_select_buffer_popover_key_released_callback(GtkEventControllerKey *event_controller,
							    guint keyval,
							    guint keycode,
							    GdkModifierType state,
							    AgsSelectBufferPopover *select_buffer_popover);
static gboolean ags_select_buffer_popover_modifiers_callback(GtkEventControllerKey *event_controller,
							     GdkModifierType keyval,
							     AgsSelectBufferPopover *select_buffer_popover);

static void ags_select_buffer_popover_activate_button_callback(GtkButton *activate_button,
							       AgsSelectBufferPopover *select_buffer_popover);
...
ags_select_buffer_popover_finalize(GObject *gobject)
{
  ...
  ags_connectable_disconnect(AGS_CONNECTABLE(select_buffer_popover));
