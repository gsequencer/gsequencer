...
static void ags_drum_input_pad_class_init(AgsDrumInputPadClass *drum_input_pad);
static void ags_drum_input_pad_connectable_interface_init(AgsConnectableInterface *connectable);
static void ags_drum_input_pad_init(AgsDrumInputPad *drum_input_pad);
static void ags_drum_input_pad_finalize(GObject *gobject);

static void ags_drum_input_pad_connect(AgsConnectable *connectable);
static void ags_drum_input_pad_disconnect(AgsConnectable *connectable);

static void ags_drum_input_pad_set_channel(AgsPad *pad, AgsChannel *channel);
static void ags_drum_input_pad_resize_lines(AgsPad *pad, GType line_type,
...
ags_drum_input_pad_get_type()
{
  ...
  if(g_once_init_enter(&g_define_type_id__static)){
    ...
    g_once_init_leave(&g_define_type_id__static, ags_type_drum_input_pad);
  }
