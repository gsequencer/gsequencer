...
ags_fm_synth_input_pad_init(AgsFMSynthInputPad *fm_synth_input_pad)
{
  ...
  gtk_widget_set_visible((GtkWidget *) AGS_PAD(fm_synth_input_pad)->group,
			 FALSE);

  gtk_widget_set_visible((GtkWidget *) AGS_PAD(fm_synth_input_pad)->mute,
			 FALSE);

  gtk_widget_set_visible((GtkWidget *) AGS_PAD(fm_synth_input_pad)->solo,
			 FALSE);
}
