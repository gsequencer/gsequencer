...
static void ags_ladspa_bridge_class_init(AgsLadspaBridgeClass *ladspa_bridge);
static void ags_ladspa_bridge_connectable_interface_init(AgsConnectableInterface *connectable);
static void ags_ladspa_bridge_init(AgsLadspaBridge *ladspa_bridge);
static void ags_ladspa_bridge_set_property(GObject *gobject,
					   guint prop_id,
					   const GValue *value,
					   GParamSpec *param_spec);
static void ags_ladspa_bridge_get_property(GObject *gobject,
					   guint prop_id,
					   GValue *value,
					   GParamSpec *param_spec);
static void ags_ladspa_bridge_finalize(GObject *gobject);

static void ags_ladspa_bridge_connect(AgsConnectable *connectable);
static void ags_ladspa_bridge_disconnect(AgsConnectable *connectable);

static void ags_ladspa_bridge_resize_audio_channels(AgsMachine *machine,
						    guint audio_channels, guint audio_channels_old,
						    gpointer data);
static void ags_ladspa_bridge_resize_pads(AgsMachine *machine, GType channel_type,
					  guint pads, guint pads_old,
					  gpointer data);

static void ags_ladspa_bridge_map_recall(AgsMachine *machine);
...
ags_ladspa_bridge_get_type(void)
{
  ...
  if(g_once_init_enter(&g_define_type_id__static)){
    ...
    g_once_init_leave(&g_define_type_id__static, ags_type_ladspa_bridge);
  }
...
ags_ladspa_bridge_init(AgsLadspaBridge *ladspa_bridge)
{
  ...
  AGS_MACHINE(ladspa_bridge)->bridge = (GtkGrid *) ags_effect_bridge_new(audio);
