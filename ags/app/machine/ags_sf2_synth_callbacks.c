...
static void ags_sf2_synth_open_dialog_response_callback(AgsFileDialog *file_dialog, gint response,
						 AgsMachine *machine);
...
void
ags_sf2_synth_low_pass_enabled_callback(GtkCheckButton *button, AgsSF2Synth *sf2_synth)
{
  AgsAudio *audio;
...
void
ags_sf2_synth_low_pass_cut_off_frequency_callback(AgsDial *dial, AgsSF2Synth *sf2_synth)
{
  AgsAudio *audio;
...
void
ags_sf2_synth_low_pass_filter_gain_callback(AgsDial *dial, AgsSF2Synth *sf2_synth)
{
  AgsAudio *audio;
...
void
ags_sf2_synth_low_pass_no_clip_callback(AgsDial *dial, AgsSF2Synth *sf2_synth)
{
  AgsAudio *audio;
