...
void
ags_sfz_synth_low_pass_enabled_callback(GtkCheckButton *button, AgsSFZSynth *sfz_synth)
{
  AgsAudio *audio;
...
void
ags_sfz_synth_low_pass_cut_off_frequency_callback(AgsDial *dial, AgsSFZSynth *sfz_synth)
{
  AgsAudio *audio;
...
void
ags_sfz_synth_low_pass_filter_gain_callback(AgsDial *dial, AgsSFZSynth *sfz_synth)
{
  AgsAudio *audio;
...
void
ags_sfz_synth_low_pass_no_clip_callback(AgsDial *dial, AgsSFZSynth *sfz_synth)
{
  AgsAudio *audio;
