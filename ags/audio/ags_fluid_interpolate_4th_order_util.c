...
ags_fluid_interpolate_4th_order_util_config()
{
  ...
  if(ags_fluid_interp_coeff_4th_order_initialized){
  ...
  for(i = 0; i < AGS_FLUID_INTERP_MAX; i++){
    ...
    ags_fluid_interp_coeff_4th_order[i][0] = (x * (-0.5 + x * (1 - 0.5 * x)));
    ags_fluid_interp_coeff_4th_order[i][1] = (1.0 + x * x * (1.5 * x - 2.5));
    ags_fluid_interp_coeff_4th_order[i][2] = (x * (0.5 + x * (2.0 - 1.5 * x)));
    ags_fluid_interp_coeff_4th_order[i][3] = (0.5 * x * x * (x - 1.0));
  }
  
  ags_fluid_interp_coeff_4th_order_initialized = TRUE;
...
ags_fluid_interpolate_4th_order_util_alloc()
{
  ...
  ptr[0] = AGS_FLUID_INTERPOLATE_4TH_ORDER_UTIL_INITIALIZER;
						    ...
						    guint samplerate)
{
  ...
  fluid_interpolate_4th_order_util->frame_count = fluid_interpolate_4th_order_util->samplerate / fluid_interpolate_4th_order_util->vibrato_lfo_freq;
}
...
ags_fluid_interpolate_4th_order_util_pitch_s8(AgsFluidInterpolate4thOrderUtil *fluid_interpolate_4th_order_util)
{
  ...
  offset = fluid_interpolate_4th_order_util->offset;
