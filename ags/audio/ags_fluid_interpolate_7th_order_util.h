...
guint ags_fluid_interpolate_7th_order_util_get_audio_buffer_util_format(AgsFluidInterpolate7thOrderUtil *fluid_interpolate_7th_order_util);
void ags_fluid_interpolate_7th_order_util_set_audio_buffer_util_format(AgsFluidInterpolate7thOrderUtil *fluid_interpolate_7th_order_util,
								       guint audio_buffer_util_format);
