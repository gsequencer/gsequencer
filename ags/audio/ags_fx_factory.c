...
#include <ags/audio/fx/ags_fx_seq_synth_audio_processor.h>
...
static GList* ags_fx_factory_create_abyss_synth(AgsAudio *audio,
						  AgsRecallContainer *play_container, AgsRecallContainer *recall_container,
						  gchar *plugin_name,
						  gchar *filename,
						  gchar *effect,
...
GList*
ags_fx_factory_create_tremolo(AgsAudio *audio,
			      AgsRecallContainer *play_container, AgsRecallContainer *recall_container,
			      gchar *plugin_name,
			      gchar *filename,
			      gchar *effect,
			      ...
			      guint create_flags, AgsRecallFlags recall_flags)
{
  ...
  AgsFxTremoloAudioProcessor *fx_tremolo_audio_processor;
  ...
  if(!AGS_IS_RECALL_CONTAINER(play_container) ||
     !AGS_IS_RECALL_CONTAINER(recall_container)){
    g_warning("ags-fx-tremolo recall container not provided");
  ...
  fx_tremolo_audio_processor = NULL;
  ...
  if((AGS_FX_FACTORY_REMAP & (create_flags)) == 0){
    ...
    ags_recall_set_flags((AgsRecall *) fx_tremolo_audio,
			 (AGS_RECALL_TEMPLATE));
    ags_recall_set_ability_flags((AgsRecall *) fx_tremolo_audio,
				 (AGS_SOUND_ABILITY_PLAYBACK |
				  AGS_SOUND_ABILITY_SEQUENCER |
				  AGS_SOUND_ABILITY_NOTATION |
				  AGS_SOUND_ABILITY_WAVE |
				  AGS_SOUND_ABILITY_MIDI));
    ags_recall_set_behaviour_flags((AgsRecall *) fx_tremolo_audio,
				   (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

    ags_audio_insert_recall(audio, (GObject *) fx_tremolo_audio,
			    TRUE,
			    position);
    ags_recall_container_add(play_container,
    ...
    ags_connectable_connect(AGS_CONNECTABLE(fx_tremolo_audio));
    
    /* AgsFxTremoloAudioProcessor */
    fx_tremolo_audio_processor = (AgsFxTremoloAudioProcessor *) g_object_new(AGS_TYPE_FX_TREMOLO_AUDIO_PROCESSOR,
									     "output-soundcard", output_soundcard,
									     "audio", audio,
    ...
    ags_recall_set_flags((AgsRecall *) fx_tremolo_audio_processor,
			 (AGS_RECALL_TEMPLATE));
    ags_recall_set_ability_flags((AgsRecall *) fx_tremolo_audio_processor,
				 (AGS_SOUND_ABILITY_PLAYBACK |
				  AGS_SOUND_ABILITY_SEQUENCER |
				  AGS_SOUND_ABILITY_NOTATION |
				  AGS_SOUND_ABILITY_WAVE |
				  AGS_SOUND_ABILITY_MIDI));
    ags_recall_set_behaviour_flags((AgsRecall *) fx_tremolo_audio_processor,
				   (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

    ags_audio_insert_recall(audio, (GObject *) fx_tremolo_audio_processor,
			    TRUE,
			    position);
    ags_recall_container_add(play_container,
    ...
    ags_connectable_connect(AGS_CONNECTABLE(fx_tremolo_audio_processor));
  }else{
    GList *start_recall_audio_run, *recall_audio_run;
    ...
    if((recall_audio_run = ags_recall_find_template(start_recall_audio_run)) != NULL){
      fx_tremolo_audio_processor = recall_audio_run->data;
      g_object_ref(fx_tremolo_audio_processor);
    }
  }
  ...
  for(i = 0; i < stop_pad - start_pad; i++){
    ...
    for(j = 0; j < stop_audio_channel - start_audio_channel; j++){
      ...
      fx_tremolo_channel = (AgsFxTremoloChannel *) g_object_new(AGS_TYPE_FX_TREMOLO_CHANNEL,
								...
								"recall-container", play_container,
								NULL);
      ags_recall_set_flags((AgsRecall *) fx_tremolo_channel,
			   (AGS_RECALL_TEMPLATE));
      ags_recall_set_ability_flags((AgsRecall *) fx_tremolo_channel,
				   (AGS_SOUND_ABILITY_PLAYBACK |
				    AGS_SOUND_ABILITY_SEQUENCER |
				    AGS_SOUND_ABILITY_NOTATION |
				    AGS_SOUND_ABILITY_WAVE |
				    AGS_SOUND_ABILITY_MIDI));
      ags_recall_set_behaviour_flags((AgsRecall *) fx_tremolo_channel,
				     (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

      ags_channel_insert_recall(channel, (GObject *) fx_tremolo_channel,
				TRUE,
				channel_position);
      ags_recall_container_add(play_container,
      ...
      ags_connectable_connect(AGS_CONNECTABLE(fx_tremolo_channel));
      ...
      fx_tremolo_channel_processor = (AgsFxTremoloChannelProcessor *) g_object_new(AGS_TYPE_FX_TREMOLO_CHANNEL_PROCESSOR,
										   ...
										   "source", channel,
										   "recall-audio", fx_tremolo_audio,
										   "recall-audio-run", fx_tremolo_audio_processor,
										   "recall-channel", fx_tremolo_channel,
										   "recall-container", play_container,
										   NULL);
      ags_recall_set_flags((AgsRecall *) fx_tremolo_channel_processor,
			   (AGS_RECALL_TEMPLATE));
      ags_recall_set_ability_flags((AgsRecall *) fx_tremolo_channel_processor,
				   (AGS_SOUND_ABILITY_PLAYBACK |
				    AGS_SOUND_ABILITY_SEQUENCER |
				    AGS_SOUND_ABILITY_NOTATION |
				    AGS_SOUND_ABILITY_WAVE |
				    AGS_SOUND_ABILITY_MIDI));
      ags_recall_set_behaviour_flags((AgsRecall *) fx_tremolo_channel_processor,
				     (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

      ags_channel_insert_recall(channel, (GObject *) fx_tremolo_channel_processor,
				TRUE,
				channel_position);
      ags_recall_container_add(play_container,
      ...
      ags_connectable_connect(AGS_CONNECTABLE(fx_tremolo_channel_processor));
  ...
  if((AGS_FX_FACTORY_REMAP & (create_flags)) != 0){
    ...
    if(fx_tremolo_audio_processor != NULL){
      g_object_unref(fx_tremolo_audio_processor);
    }
  }
...
GList*
ags_fx_factory_create_wah_wah(AgsAudio *audio,
			      AgsRecallContainer *play_container, AgsRecallContainer *recall_container,
			      gchar *plugin_name,
			      gchar *filename,
			      gchar *effect,
			      ...
			      guint create_flags, AgsRecallFlags recall_flags)
{
  ...
  AgsFxWahWahAudio *fx_wah_wah_audio;
  AgsFxWahWahAudioProcessor *fx_wah_wah_audio_processor;
  ...
  if(!AGS_IS_RECALL_CONTAINER(play_container) ||
     !AGS_IS_RECALL_CONTAINER(recall_container)){
    g_warning("ags-fx-wah_wah recall container not provided");
  ...
  /* audio - play context */
  fx_wah_wah_audio = NULL;
  fx_wah_wah_audio_processor = NULL;
  
  if((AGS_FX_FACTORY_REMAP & (create_flags)) == 0){
    /* AgsFxWahWahAudio */
    fx_wah_wah_audio = (AgsFxWahWahAudio *) g_object_new(AGS_TYPE_FX_WAH_WAH_AUDIO,
							 "output-soundcard", output_soundcard,
							 "audio", audio,
							 "recall-container", play_container,
							 NULL);
    ags_recall_set_flags((AgsRecall *) fx_wah_wah_audio,
			 (AGS_RECALL_TEMPLATE));
    ags_recall_set_ability_flags((AgsRecall *) fx_wah_wah_audio,
				 (AGS_SOUND_ABILITY_PLAYBACK |
				  AGS_SOUND_ABILITY_SEQUENCER |
				  AGS_SOUND_ABILITY_NOTATION |
				  AGS_SOUND_ABILITY_WAVE |
				  AGS_SOUND_ABILITY_MIDI));
    ags_recall_set_behaviour_flags((AgsRecall *) fx_wah_wah_audio,
				   (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

    ags_audio_insert_recall(audio, (GObject *) fx_wah_wah_audio,
			    TRUE,
			    position);
    ags_recall_container_add(play_container,
    ...
    ags_connectable_connect(AGS_CONNECTABLE(fx_wah_wah_audio));
    
    /* AgsFxWahWahAudioProcessor */
    fx_wah_wah_audio_processor = (AgsFxWahWahAudioProcessor *) g_object_new(AGS_TYPE_FX_WAH_WAH_AUDIO_PROCESSOR,
									    "output-soundcard", output_soundcard,
									    "audio", audio,
									    "recall-audio", fx_wah_wah_audio,
									    "recall-container", play_container,
									    NULL);
    ags_recall_set_flags((AgsRecall *) fx_wah_wah_audio_processor,
			 (AGS_RECALL_TEMPLATE));
    ags_recall_set_ability_flags((AgsRecall *) fx_wah_wah_audio_processor,
				 (AGS_SOUND_ABILITY_PLAYBACK |
				  AGS_SOUND_ABILITY_SEQUENCER |
				  AGS_SOUND_ABILITY_NOTATION |
				  AGS_SOUND_ABILITY_WAVE |
				  AGS_SOUND_ABILITY_MIDI));
    ags_recall_set_behaviour_flags((AgsRecall *) fx_wah_wah_audio_processor,
				   (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

    ags_audio_insert_recall(audio, (GObject *) fx_wah_wah_audio_processor,
			    TRUE,
			    position);
    ags_recall_container_add(play_container,
    ...
    ags_connectable_connect(AGS_CONNECTABLE(fx_wah_wah_audio_processor));
  }else{
    GList *start_recall_audio_run, *recall_audio_run;
    ...
    if((recall_audio_run = ags_recall_find_template(start_recall_audio_run)) != NULL){
      fx_wah_wah_audio_processor = recall_audio_run->data;
      g_object_ref(fx_wah_wah_audio_processor);
    }
  }
  ...
  for(i = 0; i < stop_pad - start_pad; i++){
    ...
    for(j = 0; j < stop_audio_channel - start_audio_channel; j++){
      ...
      fx_wah_wah_channel = (AgsFxWahWahChannel *) g_object_new(AGS_TYPE_FX_WAH_WAH_CHANNEL,
							       ...
							       "recall-container", play_container,
							       NULL);
      ags_recall_set_flags((AgsRecall *) fx_wah_wah_channel,
			   (AGS_RECALL_TEMPLATE));
      ags_recall_set_ability_flags((AgsRecall *) fx_wah_wah_channel,
				   (AGS_SOUND_ABILITY_PLAYBACK |
				    AGS_SOUND_ABILITY_SEQUENCER |
				    AGS_SOUND_ABILITY_NOTATION |
				    AGS_SOUND_ABILITY_WAVE |
				    AGS_SOUND_ABILITY_MIDI));
      ags_recall_set_behaviour_flags((AgsRecall *) fx_wah_wah_channel,
				     (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

      ags_channel_insert_recall(channel, (GObject *) fx_wah_wah_channel,
				TRUE,
				channel_position);
      ags_recall_container_add(play_container,
      ...
      ags_connectable_connect(AGS_CONNECTABLE(fx_wah_wah_channel));

      /* AgsFxWahWahChannelProcessor */
      fx_wah_wah_channel_processor = (AgsFxWahWahChannelProcessor *) g_object_new(AGS_TYPE_FX_WAH_WAH_CHANNEL_PROCESSOR,
										  "output-soundcard", output_soundcard,
										  "source", channel,
										  "recall-audio", fx_wah_wah_audio,
										  "recall-audio-run", fx_wah_wah_audio_processor,
										  "recall-channel", fx_wah_wah_channel,
										  "recall-container", play_container,
										  NULL);
      ags_recall_set_flags((AgsRecall *) fx_wah_wah_channel_processor,
			   (AGS_RECALL_TEMPLATE));
      ags_recall_set_ability_flags((AgsRecall *) fx_wah_wah_channel_processor,
				   (AGS_SOUND_ABILITY_PLAYBACK |
				    AGS_SOUND_ABILITY_SEQUENCER |
				    AGS_SOUND_ABILITY_NOTATION |
				    AGS_SOUND_ABILITY_WAVE |
				    AGS_SOUND_ABILITY_MIDI));
      ags_recall_set_behaviour_flags((AgsRecall *) fx_wah_wah_channel_processor,
				     (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

      ags_channel_insert_recall(channel, (GObject *) fx_wah_wah_channel_processor,
				TRUE,
				channel_position);
      ags_recall_container_add(play_container,
      ...
      ags_connectable_connect(AGS_CONNECTABLE(fx_wah_wah_channel_processor));
  ...
  if((AGS_FX_FACTORY_REMAP & (create_flags)) != 0){
    if(fx_wah_wah_audio != NULL){
      g_object_unref(fx_wah_wah_audio);
    }
    
    if(fx_wah_wah_audio_processor != NULL){
      g_object_unref(fx_wah_wah_audio_processor);
    }
  }
...
GList*
ags_fx_factory_create_star_synth(AgsAudio *audio,
				 AgsRecallContainer *play_container, AgsRecallContainer *recall_container,
				 gchar *plugin_name,
				 gchar *filename,
				 gchar *effect,
				 ...
				 guint create_flags, AgsRecallFlags recall_flags)
{
  ...
  if(!AGS_IS_RECALL_CONTAINER(play_container) ||
     !AGS_IS_RECALL_CONTAINER(recall_container)){
    g_warning("ags-fx-star-synth recall container not provided");
  ...
  if((AGS_FX_FACTORY_REMAP & (create_flags)) == 0){
    ...
    fx_star_synth_audio = (AgsFxStarSynthAudio *) g_object_new(AGS_TYPE_FX_STAR_SYNTH_AUDIO,
							       ...
							       "recall-container", play_container,
							       NULL);
    ags_recall_set_flags((AgsRecall *) fx_star_synth_audio,
			 (AGS_RECALL_TEMPLATE));
    ags_recall_set_ability_flags((AgsRecall *) fx_star_synth_audio,
				 (AGS_SOUND_ABILITY_PLAYBACK |
				  AGS_SOUND_ABILITY_NOTATION |
				  AGS_SOUND_ABILITY_MIDI));
    ags_recall_set_behaviour_flags((AgsRecall *) fx_star_synth_audio,
				   (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

    ags_audio_insert_recall(audio, (GObject *) fx_star_synth_audio,
			    TRUE,
			    position);
    ags_recall_container_add(play_container,
			     (AgsRecall *) fx_star_synth_audio);

    start_recall = g_list_prepend(start_recall,
				  fx_star_synth_audio);

    ags_connectable_connect(AGS_CONNECTABLE(fx_star_synth_audio));
    ...
    fx_star_synth_audio_processor = (AgsFxStarSynthAudioProcessor *) g_object_new(AGS_TYPE_FX_STAR_SYNTH_AUDIO_PROCESSOR,
										  ...
										  "recall-container", play_container,
										  NULL);
    ags_recall_set_flags((AgsRecall *) fx_star_synth_audio_processor,
			 (AGS_RECALL_TEMPLATE));
    ags_recall_set_ability_flags((AgsRecall *) fx_star_synth_audio_processor,
				 (AGS_SOUND_ABILITY_PLAYBACK |
				  AGS_SOUND_ABILITY_NOTATION |
				  AGS_SOUND_ABILITY_MIDI));
    ags_recall_set_behaviour_flags((AgsRecall *) fx_star_synth_audio_processor,
				   (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

    ags_audio_insert_recall(audio, (GObject *) fx_star_synth_audio_processor,
			    TRUE,
			    position);
    ags_recall_container_add(play_container,
			     (AgsRecall *) fx_star_synth_audio_processor);
    
    start_recall = g_list_prepend(start_recall,
				  fx_star_synth_audio_processor);

    ags_connectable_connect(AGS_CONNECTABLE(fx_star_synth_audio_processor));
  }else{
    GList *start_recall_audio_run, *recall_audio_run;
    
    fx_star_synth_audio = (AgsFxStarSynthAudio *) ags_recall_container_get_recall_audio(play_container);

    if(fx_star_synth_audio != NULL){
      g_object_ref(fx_star_synth_audio);
    }

    start_recall_audio_run = ags_recall_container_get_recall_audio_run(play_container);

    if((recall_audio_run = ags_recall_find_template(start_recall_audio_run)) != NULL){
      fx_star_synth_audio_processor = recall_audio_run->data;
      g_object_ref(fx_star_synth_audio_processor);
    }
  }
  ...
  for(i = 0; i < stop_pad - start_pad; i++){
    ...
    for(j = 0; j < stop_audio_channel - start_audio_channel; j++){
      ...
      fx_star_synth_channel = (AgsFxStarSynthChannel *) g_object_new(AGS_TYPE_FX_STAR_SYNTH_CHANNEL,
								     ...
								     "recall-container", play_container,
								     NULL);
      ags_recall_set_flags((AgsRecall *) fx_star_synth_channel,
			   (AGS_RECALL_TEMPLATE));
      ags_recall_set_ability_flags((AgsRecall *) fx_star_synth_channel,
				   (AGS_SOUND_ABILITY_PLAYBACK |
				    AGS_SOUND_ABILITY_NOTATION |
				    AGS_SOUND_ABILITY_MIDI));
      ags_recall_set_behaviour_flags((AgsRecall *) fx_star_synth_channel,
				     (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

      ags_channel_insert_recall(channel, (GObject *) fx_star_synth_channel,
				TRUE,
				channel_position);
      ags_recall_container_add(play_container,
			       (AgsRecall *) fx_star_synth_channel);

      start_recall = g_list_prepend(start_recall,
				    fx_star_synth_channel);

      ags_connectable_connect(AGS_CONNECTABLE(fx_star_synth_channel));

      /* AgsFxStarSynthChannelProcessor */
      fx_star_synth_channel_processor = (AgsFxStarSynthChannelProcessor *) g_object_new(AGS_TYPE_FX_STAR_SYNTH_CHANNEL_PROCESSOR,
											"filename", filename,
											"effect", effect,						    
											"output-soundcard", output_soundcard,
											"source", channel,
											...
											"recall-channel", fx_star_synth_channel,
											"recall-container", play_container,
											NULL);
      ags_recall_set_flags((AgsRecall *) fx_star_synth_channel_processor,
			   (AGS_RECALL_TEMPLATE));
      ags_recall_set_ability_flags((AgsRecall *) fx_star_synth_channel_processor,
				   (AGS_SOUND_ABILITY_PLAYBACK |
				    AGS_SOUND_ABILITY_NOTATION |
				    AGS_SOUND_ABILITY_MIDI));
      ags_recall_set_behaviour_flags((AgsRecall *) fx_star_synth_channel_processor,
				     (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

      ags_channel_insert_recall(channel, (GObject *) fx_star_synth_channel_processor,
				TRUE,
				channel_position);
      ags_recall_container_add(play_container,
			       (AgsRecall *) fx_star_synth_channel_processor);

      start_recall = g_list_prepend(start_recall,
				    fx_star_synth_channel_processor);

      ags_connectable_connect(AGS_CONNECTABLE(fx_star_synth_channel_processor));
  ...
  if((AGS_FX_FACTORY_REMAP & (create_flags)) == 0){
    ...
    fx_star_synth_audio = (AgsFxStarSynthAudio *) ags_recall_container_get_recall_audio(recall_container);
...
GList*
ags_fx_factory_create_seq_synth(AgsAudio *audio,
				 AgsRecallContainer *play_container, AgsRecallContainer *recall_container,
				 gchar *plugin_name,
				 gchar *filename,
				 gchar *effect,
				 ...
				 guint create_flags, AgsRecallFlags recall_flags)
{
  ...
  AgsFxSeqSynthAudioProcessor *fx_seq_synth_audio_processor;
  AgsFxSeqSynthChannel *fx_seq_synth_channel;
  AgsFxSeqSynthChannelProcessor *fx_seq_synth_channel_processor;
  ...
  if(!AGS_IS_RECALL_CONTAINER(play_container) ||
     !AGS_IS_RECALL_CONTAINER(recall_container)){
    g_warning("ags-fx-seq-synth recall container not provided");
  ...
  /* audio - play context */
  fx_seq_synth_audio = NULL;
  fx_seq_synth_audio_processor = NULL;
  ...
  if((AGS_FX_FACTORY_REMAP & (create_flags)) == 0){
    ...
    fx_seq_synth_audio = (AgsFxSeqSynthAudio *) g_object_new(AGS_TYPE_FX_SEQ_SYNTH_AUDIO,
							       ...
							       "recall-container", play_container,
							       NULL);
    ags_recall_set_flags((AgsRecall *) fx_seq_synth_audio,
			 (AGS_RECALL_TEMPLATE));
    ags_recall_set_ability_flags((AgsRecall *) fx_seq_synth_audio,
				 (AGS_SOUND_ABILITY_PLAYBACK |
				  AGS_SOUND_ABILITY_NOTATION |
				  AGS_SOUND_ABILITY_MIDI));
    ags_recall_set_behaviour_flags((AgsRecall *) fx_seq_synth_audio,
				   (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

    ags_audio_insert_recall(audio, (GObject *) fx_seq_synth_audio,
			    TRUE,
			    position);
    ags_recall_container_add(play_container,
			     (AgsRecall *) fx_seq_synth_audio);

    start_recall = g_list_prepend(start_recall,
				  fx_seq_synth_audio);

    ags_connectable_connect(AGS_CONNECTABLE(fx_seq_synth_audio));
    
    /* AgsFxSeqSynthAudioProcessor */
    fx_seq_synth_audio_processor = (AgsFxSeqSynthAudioProcessor *) g_object_new(AGS_TYPE_FX_SEQ_SYNTH_AUDIO_PROCESSOR,
										  "filename", filename,
										  "effect", effect,						    
										  "output-soundcard", output_soundcard,
										  "audio", audio,
										  "recall-audio", fx_seq_synth_audio,
										  "recall-container", play_container,
										  NULL);
    ags_recall_set_flags((AgsRecall *) fx_seq_synth_audio_processor,
			 (AGS_RECALL_TEMPLATE));
    ags_recall_set_ability_flags((AgsRecall *) fx_seq_synth_audio_processor,
				 (AGS_SOUND_ABILITY_PLAYBACK |
				  AGS_SOUND_ABILITY_NOTATION |
				  AGS_SOUND_ABILITY_MIDI));
    ags_recall_set_behaviour_flags((AgsRecall *) fx_seq_synth_audio_processor,
				   (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

    ags_audio_insert_recall(audio, (GObject *) fx_seq_synth_audio_processor,
			    TRUE,
			    position);
    ags_recall_container_add(play_container,
			     (AgsRecall *) fx_seq_synth_audio_processor);
    
    start_recall = g_list_prepend(start_recall,
				  fx_seq_synth_audio_processor);

    ags_connectable_connect(AGS_CONNECTABLE(fx_seq_synth_audio_processor));
  }else{
    GList *start_recall_audio_run, *recall_audio_run;
    
    fx_seq_synth_audio = (AgsFxSeqSynthAudio *) ags_recall_container_get_recall_audio(play_container);

    if(fx_seq_synth_audio != NULL){
      g_object_ref(fx_seq_synth_audio);
    }

    start_recall_audio_run = ags_recall_container_get_recall_audio_run(play_container);

    if((recall_audio_run = ags_recall_find_template(start_recall_audio_run)) != NULL){
      fx_seq_synth_audio_processor = recall_audio_run->data;
      g_object_ref(fx_seq_synth_audio_processor);
    }
  }
  ...
  for(i = 0; i < stop_pad - start_pad; i++){
    ...
    for(j = 0; j < stop_audio_channel - start_audio_channel; j++){
      ...
      fx_seq_synth_channel = (AgsFxSeqSynthChannel *) g_object_new(AGS_TYPE_FX_SEQ_SYNTH_CHANNEL,
								     ...
								     "recall-container", play_container,
								     NULL);
      ags_recall_set_flags((AgsRecall *) fx_seq_synth_channel,
			   (AGS_RECALL_TEMPLATE));
      ags_recall_set_ability_flags((AgsRecall *) fx_seq_synth_channel,
				   (AGS_SOUND_ABILITY_PLAYBACK |
				    AGS_SOUND_ABILITY_NOTATION |
				    AGS_SOUND_ABILITY_MIDI));
      ags_recall_set_behaviour_flags((AgsRecall *) fx_seq_synth_channel,
				     (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

      ags_channel_insert_recall(channel, (GObject *) fx_seq_synth_channel,
				TRUE,
				channel_position);
      ags_recall_container_add(play_container,
			       (AgsRecall *) fx_seq_synth_channel);

      start_recall = g_list_prepend(start_recall,
				    fx_seq_synth_channel);

      ags_connectable_connect(AGS_CONNECTABLE(fx_seq_synth_channel));

      /* AgsFxSeqSynthChannelProcessor */
      fx_seq_synth_channel_processor = (AgsFxSeqSynthChannelProcessor *) g_object_new(AGS_TYPE_FX_SEQ_SYNTH_CHANNEL_PROCESSOR,
											"filename", filename,
											"effect", effect,						    
											"output-soundcard", output_soundcard,
											"source", channel,
											"recall-audio", fx_seq_synth_audio,
											"recall-audio-run", fx_seq_synth_audio_processor,
											"recall-channel", fx_seq_synth_channel,
											"recall-container", play_container,
											NULL);
      ags_recall_set_flags((AgsRecall *) fx_seq_synth_channel_processor,
			   (AGS_RECALL_TEMPLATE));
      ags_recall_set_ability_flags((AgsRecall *) fx_seq_synth_channel_processor,
				   (AGS_SOUND_ABILITY_PLAYBACK |
				    AGS_SOUND_ABILITY_NOTATION |
				    AGS_SOUND_ABILITY_MIDI));
      ags_recall_set_behaviour_flags((AgsRecall *) fx_seq_synth_channel_processor,
				     (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

      ags_channel_insert_recall(channel, (GObject *) fx_seq_synth_channel_processor,
				TRUE,
				channel_position);
      ags_recall_container_add(play_container,
			       (AgsRecall *) fx_seq_synth_channel_processor);

      start_recall = g_list_prepend(start_recall,
				    fx_seq_synth_channel_processor);

      ags_connectable_connect(AGS_CONNECTABLE(fx_seq_synth_channel_processor));
  ...
  if((AGS_FX_FACTORY_REMAP & (create_flags)) != 0){
    if(fx_seq_synth_audio != NULL){
      g_object_unref(fx_seq_synth_audio);
    }
    
    if(fx_seq_synth_audio_processor != NULL){
      g_object_unref(fx_seq_synth_audio_processor);
    }
  }
  ...
  if((AGS_FX_FACTORY_REMAP & (create_flags)) == 0){
    ...
    fx_seq_synth_audio = (AgsFxSeqSynthAudio *) ags_recall_container_get_recall_audio(recall_container);
...
GList*
ags_fx_factory_create_raven_synth(AgsAudio *audio,
				  AgsRecallContainer *play_container, AgsRecallContainer *recall_container,
				  gchar *plugin_name,
				  gchar *filename,
				  gchar *effect,
				  ...
				  guint create_flags, AgsRecallFlags recall_flags)
{
  ...
  AgsFxRavenSynthChannel *fx_raven_synth_channel;
  ...
  if(!AGS_IS_RECALL_CONTAINER(play_container) ||
     !AGS_IS_RECALL_CONTAINER(recall_container)){
    g_warning("ags-fx-raven-synth recall container not provided");
  ...
  if((AGS_FX_FACTORY_REMAP & (create_flags)) == 0){
    ...
    fx_raven_synth_audio = (AgsFxRavenSynthAudio *) g_object_new(AGS_TYPE_FX_RAVEN_SYNTH_AUDIO,
								 ...
								 "recall-container", play_container,
								 NULL);
    ags_recall_set_flags((AgsRecall *) fx_raven_synth_audio,
			 (AGS_RECALL_TEMPLATE));
    ags_recall_set_ability_flags((AgsRecall *) fx_raven_synth_audio,
				 (AGS_SOUND_ABILITY_PLAYBACK |
				  AGS_SOUND_ABILITY_NOTATION |
				  AGS_SOUND_ABILITY_MIDI));
    ags_recall_set_behaviour_flags((AgsRecall *) fx_raven_synth_audio,
				   (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

    ags_audio_insert_recall(audio, (GObject *) fx_raven_synth_audio,
			    TRUE,
			    position);
    ags_recall_container_add(play_container,
			     (AgsRecall *) fx_raven_synth_audio);

    start_recall = g_list_prepend(start_recall,
				  fx_raven_synth_audio);

    ags_connectable_connect(AGS_CONNECTABLE(fx_raven_synth_audio));
    
    /* AgsFxRavenSynthAudioProcessor */
    fx_raven_synth_audio_processor = (AgsFxRavenSynthAudioProcessor *) g_object_new(AGS_TYPE_FX_RAVEN_SYNTH_AUDIO_PROCESSOR,
										    "filename", filename,
										    "effect", effect,						    
										    "output-soundcard", output_soundcard,
										    "audio", audio,
										    ...
										    "recall-container", play_container,
										    NULL);
    ags_recall_set_flags((AgsRecall *) fx_raven_synth_audio_processor,
			 (AGS_RECALL_TEMPLATE));
    ags_recall_set_ability_flags((AgsRecall *) fx_raven_synth_audio_processor,
				 (AGS_SOUND_ABILITY_PLAYBACK |
				  AGS_SOUND_ABILITY_NOTATION |
				  AGS_SOUND_ABILITY_MIDI));
    ags_recall_set_behaviour_flags((AgsRecall *) fx_raven_synth_audio_processor,
				   (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

    ags_audio_insert_recall(audio, (GObject *) fx_raven_synth_audio_processor,
			    TRUE,
			    position);
    ags_recall_container_add(play_container,
			     (AgsRecall *) fx_raven_synth_audio_processor);
    
    start_recall = g_list_prepend(start_recall,
				  fx_raven_synth_audio_processor);

    ags_connectable_connect(AGS_CONNECTABLE(fx_raven_synth_audio_processor));
  }else{
    GList *start_recall_audio_run, *recall_audio_run;
    
    fx_raven_synth_audio = (AgsFxRavenSynthAudio *) ags_recall_container_get_recall_audio(play_container);

    if(fx_raven_synth_audio != NULL){
      g_object_ref(fx_raven_synth_audio);
    }

    start_recall_audio_run = ags_recall_container_get_recall_audio_run(play_container);

    if((recall_audio_run = ags_recall_find_template(start_recall_audio_run)) != NULL){
      fx_raven_synth_audio_processor = recall_audio_run->data;
      g_object_ref(fx_raven_synth_audio_processor);
    }
  }
  ...
  for(i = 0; i < stop_pad - start_pad; i++){
    ...
    for(j = 0; j < stop_audio_channel - start_audio_channel; j++){
      ...
      fx_raven_synth_channel = (AgsFxRavenSynthChannel *) g_object_new(AGS_TYPE_FX_RAVEN_SYNTH_CHANNEL,
								       "filename", filename,
								       "effect", effect,						    
								       "output-soundcard", output_soundcard,
								       "source", channel,
								       ...
								       "recall-container", play_container,
								       NULL);
      ags_recall_set_flags((AgsRecall *) fx_raven_synth_channel,
			   (AGS_RECALL_TEMPLATE));
      ags_recall_set_ability_flags((AgsRecall *) fx_raven_synth_channel,
				   (AGS_SOUND_ABILITY_PLAYBACK |
				    AGS_SOUND_ABILITY_NOTATION |
				    AGS_SOUND_ABILITY_MIDI));
      ags_recall_set_behaviour_flags((AgsRecall *) fx_raven_synth_channel,
				     (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

      ags_channel_insert_recall(channel, (GObject *) fx_raven_synth_channel,
				TRUE,
				channel_position);
      ags_recall_container_add(play_container,
			       (AgsRecall *) fx_raven_synth_channel);

      start_recall = g_list_prepend(start_recall,
				    fx_raven_synth_channel);

      ags_connectable_connect(AGS_CONNECTABLE(fx_raven_synth_channel));

      /* AgsFxRavenSynthChannelProcessor */
      fx_raven_synth_channel_processor = (AgsFxRavenSynthChannelProcessor *) g_object_new(AGS_TYPE_FX_RAVEN_SYNTH_CHANNEL_PROCESSOR,
											  "filename", filename,
											  "effect", effect,						    
											  "output-soundcard", output_soundcard,
											  "source", channel,
											  ...
											  "recall-channel", fx_raven_synth_channel,
											  "recall-container", play_container,
											  NULL);
      ags_recall_set_flags((AgsRecall *) fx_raven_synth_channel_processor,
			   (AGS_RECALL_TEMPLATE));
      ags_recall_set_ability_flags((AgsRecall *) fx_raven_synth_channel_processor,
				   (AGS_SOUND_ABILITY_PLAYBACK |
				    AGS_SOUND_ABILITY_NOTATION |
				    AGS_SOUND_ABILITY_MIDI));
      ags_recall_set_behaviour_flags((AgsRecall *) fx_raven_synth_channel_processor,
				     (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

      ags_channel_insert_recall(channel, (GObject *) fx_raven_synth_channel_processor,
				TRUE,
				channel_position);
      ags_recall_container_add(play_container,
			       (AgsRecall *) fx_raven_synth_channel_processor);

      start_recall = g_list_prepend(start_recall,
				    fx_raven_synth_channel_processor);

      ags_connectable_connect(AGS_CONNECTABLE(fx_raven_synth_channel_processor));
  ...
  if((AGS_FX_FACTORY_REMAP & (create_flags)) == 0){
    ...
    fx_raven_synth_audio = (AgsFxRavenSynthAudio *) ags_recall_container_get_recall_audio(recall_container);
...
GList*
ags_fx_factory_create_modular_synth(AgsAudio *audio,
				    AgsRecallContainer *play_container, AgsRecallContainer *recall_container,
				    gchar *plugin_name,
				    gchar *filename,
				    gchar *effect,
				    ...
				    guint create_flags, AgsRecallFlags recall_flags)
{
  ...
  AgsFxModularSynthChannel *fx_modular_synth_channel;
  ...
  if(!AGS_IS_RECALL_CONTAINER(play_container) ||
     !AGS_IS_RECALL_CONTAINER(recall_container)){
    g_warning("ags-fx-modular-synth recall container not provided");
  ...
  if((AGS_FX_FACTORY_REMAP & (create_flags)) == 0){
    ...
    fx_modular_synth_audio = (AgsFxModularSynthAudio *) g_object_new(AGS_TYPE_FX_MODULAR_SYNTH_AUDIO,
								     ...
								     "recall-container", play_container,
								     NULL);
    ags_recall_set_flags((AgsRecall *) fx_modular_synth_audio,
			 (AGS_RECALL_TEMPLATE));
    ags_recall_set_ability_flags((AgsRecall *) fx_modular_synth_audio,
				 (AGS_SOUND_ABILITY_PLAYBACK |
				  AGS_SOUND_ABILITY_NOTATION |
				  AGS_SOUND_ABILITY_MIDI));
    ags_recall_set_behaviour_flags((AgsRecall *) fx_modular_synth_audio,
				   (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

    ags_audio_insert_recall(audio, (GObject *) fx_modular_synth_audio,
			    TRUE,
			    position);
    ags_recall_container_add(play_container,
			     (AgsRecall *) fx_modular_synth_audio);

    start_recall = g_list_prepend(start_recall,
				  fx_modular_synth_audio);

    ags_connectable_connect(AGS_CONNECTABLE(fx_modular_synth_audio));
    
    /* AgsFxModularSynthAudioProcessor */
    fx_modular_synth_audio_processor = (AgsFxModularSynthAudioProcessor *) g_object_new(AGS_TYPE_FX_MODULAR_SYNTH_AUDIO_PROCESSOR,
											"filename", filename,
											"effect", effect,						    
											"output-soundcard", output_soundcard,
											"audio", audio,
											...
											"recall-container", play_container,
											NULL);
    ags_recall_set_flags((AgsRecall *) fx_modular_synth_audio_processor,
			 (AGS_RECALL_TEMPLATE));
    ags_recall_set_ability_flags((AgsRecall *) fx_modular_synth_audio_processor,
				 (AGS_SOUND_ABILITY_PLAYBACK |
				  AGS_SOUND_ABILITY_NOTATION |
				  AGS_SOUND_ABILITY_MIDI));
    ags_recall_set_behaviour_flags((AgsRecall *) fx_modular_synth_audio_processor,
				   (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

    ags_audio_insert_recall(audio, (GObject *) fx_modular_synth_audio_processor,
			    TRUE,
			    position);
    ags_recall_container_add(play_container,
			     (AgsRecall *) fx_modular_synth_audio_processor);
    
    start_recall = g_list_prepend(start_recall,
				  fx_modular_synth_audio_processor);

    ags_connectable_connect(AGS_CONNECTABLE(fx_modular_synth_audio_processor));
  }else{
    GList *start_recall_audio_run, *recall_audio_run;
    
    fx_modular_synth_audio = (AgsFxModularSynthAudio *) ags_recall_container_get_recall_audio(play_container);

    if(fx_modular_synth_audio != NULL){
      g_object_ref(fx_modular_synth_audio);
    }

    start_recall_audio_run = ags_recall_container_get_recall_audio_run(play_container);

    if((recall_audio_run = ags_recall_find_template(start_recall_audio_run)) != NULL){
      fx_modular_synth_audio_processor = recall_audio_run->data;
      g_object_ref(fx_modular_synth_audio_processor);
    }
  }
  ...
  for(i = 0; i < stop_pad - start_pad; i++){
    ...
    for(j = 0; j < stop_audio_channel - start_audio_channel; j++){
      ...
      fx_modular_synth_channel = (AgsFxModularSynthChannel *) g_object_new(AGS_TYPE_FX_MODULAR_SYNTH_CHANNEL,
									   "filename", filename,
									   "effect", effect,						    
									   "output-soundcard", output_soundcard,
									   "source", channel,
									   ...
									   "recall-container", play_container,
									   NULL);
      ags_recall_set_flags((AgsRecall *) fx_modular_synth_channel,
			   (AGS_RECALL_TEMPLATE));
      ags_recall_set_ability_flags((AgsRecall *) fx_modular_synth_channel,
				   (AGS_SOUND_ABILITY_PLAYBACK |
				    AGS_SOUND_ABILITY_NOTATION |
				    AGS_SOUND_ABILITY_MIDI));
      ags_recall_set_behaviour_flags((AgsRecall *) fx_modular_synth_channel,
				     (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

      ags_channel_insert_recall(channel, (GObject *) fx_modular_synth_channel,
				TRUE,
				channel_position);
      ags_recall_container_add(play_container,
			       (AgsRecall *) fx_modular_synth_channel);

      start_recall = g_list_prepend(start_recall,
				    fx_modular_synth_channel);

      ags_connectable_connect(AGS_CONNECTABLE(fx_modular_synth_channel));

      /* AgsFxModularSynthChannelProcessor */
      fx_modular_synth_channel_processor = (AgsFxModularSynthChannelProcessor *) g_object_new(AGS_TYPE_FX_MODULAR_SYNTH_CHANNEL_PROCESSOR,
											      "filename", filename,
											      "effect", effect,						    
											      "output-soundcard", output_soundcard,
											      "source", channel,
											      ...
											      "recall-channel", fx_modular_synth_channel,
											      "recall-container", play_container,
											      NULL);
      ags_recall_set_flags((AgsRecall *) fx_modular_synth_channel_processor,
			   (AGS_RECALL_TEMPLATE));
      ags_recall_set_ability_flags((AgsRecall *) fx_modular_synth_channel_processor,
				   (AGS_SOUND_ABILITY_PLAYBACK |
				    AGS_SOUND_ABILITY_NOTATION |
				    AGS_SOUND_ABILITY_MIDI));
      ags_recall_set_behaviour_flags((AgsRecall *) fx_modular_synth_channel_processor,
				     (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

      ags_channel_insert_recall(channel, (GObject *) fx_modular_synth_channel_processor,
				TRUE,
				channel_position);
      ags_recall_container_add(play_container,
			       (AgsRecall *) fx_modular_synth_channel_processor);

      start_recall = g_list_prepend(start_recall,
				    fx_modular_synth_channel_processor);

      ags_connectable_connect(AGS_CONNECTABLE(fx_modular_synth_channel_processor));
  ...
  if((AGS_FX_FACTORY_REMAP & (create_flags)) == 0){
    ...
    fx_modular_synth_audio = (AgsFxModularSynthAudio *) ags_recall_container_get_recall_audio(recall_container);
...
GList*
ags_fx_factory_create_abyss_synth(AgsAudio *audio,
				  AgsRecallContainer *play_container, AgsRecallContainer *recall_container,
				  gchar *plugin_name,
				  gchar *filename,
				  gchar *effect,
				  ...
				  guint create_flags, AgsRecallFlags recall_flags)
{
  ...
  AgsFxAbyssSynthChannel *fx_abyss_synth_channel;
  ...
  if(!AGS_IS_RECALL_CONTAINER(play_container) ||
     !AGS_IS_RECALL_CONTAINER(recall_container)){
    g_warning("ags-fx-abyss-synth recall container not provided");
  ...
  if((AGS_FX_FACTORY_REMAP & (create_flags)) == 0){
    ...
    fx_abyss_synth_audio = (AgsFxAbyssSynthAudio *) g_object_new(AGS_TYPE_FX_ABYSS_SYNTH_AUDIO,
								 ...
								 "recall-container", play_container,
								 NULL);
    ags_recall_set_flags((AgsRecall *) fx_abyss_synth_audio,
			 (AGS_RECALL_TEMPLATE));
    ags_recall_set_ability_flags((AgsRecall *) fx_abyss_synth_audio,
				 (AGS_SOUND_ABILITY_PLAYBACK |
				  AGS_SOUND_ABILITY_NOTATION |
				  AGS_SOUND_ABILITY_MIDI));
    ags_recall_set_behaviour_flags((AgsRecall *) fx_abyss_synth_audio,
				   (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

    ags_audio_insert_recall(audio, (GObject *) fx_abyss_synth_audio,
			    TRUE,
			    position);
    ags_recall_container_add(play_container,
			     (AgsRecall *) fx_abyss_synth_audio);

    start_recall = g_list_prepend(start_recall,
				  fx_abyss_synth_audio);

    ags_connectable_connect(AGS_CONNECTABLE(fx_abyss_synth_audio));
    
    /* AgsFxAbyssSynthAudioProcessor */
    fx_abyss_synth_audio_processor = (AgsFxAbyssSynthAudioProcessor *) g_object_new(AGS_TYPE_FX_ABYSS_SYNTH_AUDIO_PROCESSOR,
										    "filename", filename,
										    "effect", effect,						    
										    "output-soundcard", output_soundcard,
										    "audio", audio,
										    ...
										    "recall-container", play_container,
										    NULL);
    ags_recall_set_flags((AgsRecall *) fx_abyss_synth_audio_processor,
			 (AGS_RECALL_TEMPLATE));
    ags_recall_set_ability_flags((AgsRecall *) fx_abyss_synth_audio_processor,
				 (AGS_SOUND_ABILITY_PLAYBACK |
				  AGS_SOUND_ABILITY_NOTATION |
				  AGS_SOUND_ABILITY_MIDI));
    ags_recall_set_behaviour_flags((AgsRecall *) fx_abyss_synth_audio_processor,
				   (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

    ags_audio_insert_recall(audio, (GObject *) fx_abyss_synth_audio_processor,
			    TRUE,
			    position);
    ags_recall_container_add(play_container,
			     (AgsRecall *) fx_abyss_synth_audio_processor);
    
    start_recall = g_list_prepend(start_recall,
				  fx_abyss_synth_audio_processor);

    ags_connectable_connect(AGS_CONNECTABLE(fx_abyss_synth_audio_processor));
  }else{
    GList *start_recall_audio_run, *recall_audio_run;
    
    fx_abyss_synth_audio = (AgsFxAbyssSynthAudio *) ags_recall_container_get_recall_audio(play_container);

    if(fx_abyss_synth_audio != NULL){
      g_object_ref(fx_abyss_synth_audio);
    }

    start_recall_audio_run = ags_recall_container_get_recall_audio_run(play_container);

    if((recall_audio_run = ags_recall_find_template(start_recall_audio_run)) != NULL){
      fx_abyss_synth_audio_processor = recall_audio_run->data;
      g_object_ref(fx_abyss_synth_audio_processor);
    }
  }
  ...
  for(i = 0; i < stop_pad - start_pad; i++){
    ...
    for(j = 0; j < stop_audio_channel - start_audio_channel; j++){
      ...
      /* AgsFxAbyssSynthChannel */
      fx_abyss_synth_channel = (AgsFxAbyssSynthChannel *) g_object_new(AGS_TYPE_FX_ABYSS_SYNTH_CHANNEL,
								       "filename", filename,
								       "effect", effect,						    
								       "output-soundcard", output_soundcard,
								       "source", channel,
								       ...
								       "recall-container", play_container,
								       NULL);
      ags_recall_set_flags((AgsRecall *) fx_abyss_synth_channel,
			   (AGS_RECALL_TEMPLATE));
      ags_recall_set_ability_flags((AgsRecall *) fx_abyss_synth_channel,
				   (AGS_SOUND_ABILITY_PLAYBACK |
				    AGS_SOUND_ABILITY_NOTATION |
				    AGS_SOUND_ABILITY_MIDI));
      ags_recall_set_behaviour_flags((AgsRecall *) fx_abyss_synth_channel,
				     (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

      ags_channel_insert_recall(channel, (GObject *) fx_abyss_synth_channel,
				TRUE,
				channel_position);
      ags_recall_container_add(play_container,
			       (AgsRecall *) fx_abyss_synth_channel);

      start_recall = g_list_prepend(start_recall,
				    fx_abyss_synth_channel);

      ags_connectable_connect(AGS_CONNECTABLE(fx_abyss_synth_channel));

      /* AgsFxAbyssSynthChannelProcessor */
      fx_abyss_synth_channel_processor = (AgsFxAbyssSynthChannelProcessor *) g_object_new(AGS_TYPE_FX_ABYSS_SYNTH_CHANNEL_PROCESSOR,
											  "filename", filename,
											  "effect", effect,						    
											  "output-soundcard", output_soundcard,
											  "source", channel,
											  ...
											  "recall-channel", fx_abyss_synth_channel,
											  "recall-container", play_container,
											  NULL);
      ags_recall_set_flags((AgsRecall *) fx_abyss_synth_channel_processor,
			   (AGS_RECALL_TEMPLATE));
      ags_recall_set_ability_flags((AgsRecall *) fx_abyss_synth_channel_processor,
				   (AGS_SOUND_ABILITY_PLAYBACK |
				    AGS_SOUND_ABILITY_NOTATION |
				    AGS_SOUND_ABILITY_MIDI));
      ags_recall_set_behaviour_flags((AgsRecall *) fx_abyss_synth_channel_processor,
				     (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

      ags_channel_insert_recall(channel, (GObject *) fx_abyss_synth_channel_processor,
				TRUE,
				channel_position);
      ags_recall_container_add(play_container,
			       (AgsRecall *) fx_abyss_synth_channel_processor);

      start_recall = g_list_prepend(start_recall,
				    fx_abyss_synth_channel_processor);

      ags_connectable_connect(AGS_CONNECTABLE(fx_abyss_synth_channel_processor));
  ...
  if((AGS_FX_FACTORY_REMAP & (create_flags)) == 0){
    ...
    fx_abyss_synth_audio = (AgsFxAbyssSynthAudio *) ags_recall_container_get_recall_audio(recall_container);
...
#if defined(AGS_WITH_AUDIO_UNIT_PLUGINS)
GList*
ags_fx_factory_create_audio_unit(AgsAudio *audio,
				 AgsRecallContainer *play_container, AgsRecallContainer *recall_container,
				 gchar *plugin_name,
				 gchar *filename,
				 gchar *effect,
				 ...
				 guint create_flags, AgsRecallFlags recall_flags)
{
  ...
  if(!AGS_IS_RECALL_CONTAINER(play_container) ||
     !AGS_IS_RECALL_CONTAINER(recall_container)){
    g_warning("ags-fx-audio-unit recall container not provided");
  ...
  fx_audio_unit_audio_processor = NULL;
  ...
  if((AGS_FX_FACTORY_REMAP & (create_flags)) == 0){
    ...
    if(is_instrument){
      ags_recall_set_ability_flags((AgsRecall *) fx_audio_unit_audio,
				   (AGS_SOUND_ABILITY_PLAYBACK |
				    AGS_SOUND_ABILITY_NOTATION |
				    AGS_SOUND_ABILITY_MIDI));
    }else{
    ...
    ags_recall_set_behaviour_flags((AgsRecall *) fx_audio_unit_audio,
				   (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

    ags_audio_insert_recall(audio, (GObject *) fx_audio_unit_audio,
			    TRUE,
			    position);
    ags_recall_container_add(play_container,
			     (AgsRecall *) fx_audio_unit_audio);
    
    start_recall = g_list_prepend(start_recall,
				  fx_audio_unit_audio);

    ags_connectable_connect(AGS_CONNECTABLE(fx_audio_unit_audio));
    ...
    fx_audio_unit_audio_processor = (AgsFxAudioUnitAudioProcessor *) g_object_new(AGS_TYPE_FX_AUDIO_UNIT_AUDIO_PROCESSOR,
										  ...
										  "recall-container", play_container,
										  NULL);
    ags_recall_set_flags((AgsRecall *) fx_audio_unit_audio_processor,
			 (AGS_RECALL_TEMPLATE));

    if(is_instrument){
      ags_recall_set_ability_flags((AgsRecall *) fx_audio_unit_audio_processor,
				   (AGS_SOUND_ABILITY_PLAYBACK |
				    AGS_SOUND_ABILITY_NOTATION |
				    AGS_SOUND_ABILITY_MIDI));
    }else{
    ...
    ags_recall_set_behaviour_flags((AgsRecall *) fx_audio_unit_audio_processor,
				   (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

    ags_audio_insert_recall(audio, (GObject *) fx_audio_unit_audio_processor,
			    TRUE,
			    position);
    ags_recall_container_add(play_container,
			     (AgsRecall *) fx_audio_unit_audio_processor);
    
    start_recall = g_list_prepend(start_recall,
				  fx_audio_unit_audio_processor);
    ...
    fx_audio_unit_audio = (AgsFxAudioUnitAudio *) ags_recall_container_get_recall_audio(play_container);

    if(fx_audio_unit_audio != NULL){
      g_object_ref(fx_audio_unit_audio);
    }

    start_recall_audio_run = ags_recall_container_get_recall_audio_run(play_container);

    if((recall_audio_run = ags_recall_find_template(start_recall_audio_run)) != NULL){
      fx_audio_unit_audio_processor = recall_audio_run->data;
      g_object_ref(fx_audio_unit_audio_processor);
    }
  ...
  for(i = 0; i < stop_pad - start_pad; i++){
    ...
    for(j = 0; j < stop_audio_channel - start_audio_channel; j++){
      ...
      /* AgsFxAudioUnitChannel */
      fx_audio_unit_channel = (AgsFxAudioUnitChannel *) g_object_new(AGS_TYPE_FX_AUDIO_UNIT_CHANNEL,
								     "filename", filename,
								     "effect", effect,						    
								     "output-soundcard", output_soundcard,
								     "source", channel,
								     ...
								     "recall-container", play_container,
								     NULL);
      ags_recall_set_flags((AgsRecall *) fx_audio_unit_channel,
			   (AGS_RECALL_TEMPLATE));

      if(is_instrument){
	ags_recall_set_ability_flags((AgsRecall *) fx_audio_unit_channel,
				     (AGS_SOUND_ABILITY_PLAYBACK |
				      AGS_SOUND_ABILITY_NOTATION |
				      AGS_SOUND_ABILITY_MIDI));
      }else{
	ags_recall_set_ability_flags((AgsRecall *) fx_audio_unit_channel,
      ...
      ags_recall_set_behaviour_flags((AgsRecall *) fx_audio_unit_channel,
				     (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

      ags_channel_insert_recall(channel, (GObject *) fx_audio_unit_channel,
				TRUE,
				channel_position);
      ags_recall_container_add(play_container,
			       (AgsRecall *) fx_audio_unit_channel);

      start_recall = g_list_prepend(start_recall,
				    fx_audio_unit_channel);

      ags_connectable_connect(AGS_CONNECTABLE(fx_audio_unit_channel));
      ...
      fx_audio_unit_channel_processor = (AgsFxAudioUnitChannelProcessor *) g_object_new(AGS_TYPE_FX_AUDIO_UNIT_CHANNEL_PROCESSOR,
											...
											"source", channel,
											"recall-audio", fx_audio_unit_audio,
											"recall-audio-run", fx_audio_unit_audio_processor,
											"recall-channel", fx_audio_unit_channel,
											"recall-container", play_container,
											NULL);
      ags_recall_set_flags((AgsRecall *) fx_audio_unit_channel_processor,
			   (AGS_RECALL_TEMPLATE));

      if(is_instrument){
	ags_recall_set_ability_flags((AgsRecall *) fx_audio_unit_channel_processor,
				     (AGS_SOUND_ABILITY_PLAYBACK |
				      AGS_SOUND_ABILITY_NOTATION |
				      AGS_SOUND_ABILITY_MIDI));
      }else{
	ags_recall_set_ability_flags((AgsRecall *) fx_audio_unit_channel_processor,
      ...
      ags_recall_set_behaviour_flags((AgsRecall *) fx_audio_unit_channel_processor,
				     (((AGS_FX_FACTORY_OUTPUT & create_flags) != 0) ? AGS_SOUND_BEHAVIOUR_CHAINED_TO_OUTPUT: AGS_SOUND_BEHAVIOUR_CHAINED_TO_INPUT));

      ags_channel_insert_recall(channel, (GObject *) fx_audio_unit_channel_processor,
				TRUE,
				channel_position);
      ags_recall_container_add(play_container,
			       (AgsRecall *) fx_audio_unit_channel_processor);

      start_recall = g_list_prepend(start_recall,
				    fx_audio_unit_channel_processor);

      ags_connectable_connect(AGS_CONNECTABLE(fx_audio_unit_channel_processor));
  ...
  if((AGS_FX_FACTORY_REMAP & (create_flags)) != 0){
    ...
    if(fx_audio_unit_audio_processor != NULL){
      g_object_unref(fx_audio_unit_audio_processor);
    }
  }
  ...
  if((AGS_FX_FACTORY_REMAP & (create_flags)) == 0){
    ...
    fx_audio_unit_audio = (AgsFxAudioUnitAudio *) ags_recall_container_get_recall_audio(recall_container);
		      ...
		      guint create_flags, AgsRecallFlags recall_flags)
{
  ...
  if(!g_ascii_strncasecmp(plugin_name,
    ...
    start_recall = ags_fx_factory_create_volume(audio,
				...
				"ags-fx-tremolo",
				15)){
    start_recall = ags_fx_factory_create_tremolo(audio,
						 play_container, recall_container,
						 plugin_name,
						 filename,
						 effect,
    ...
    start_recall = ags_fx_factory_create_envelope(audio,
				...
				"ags-fx-wah-wah",
				15)){
    start_recall = ags_fx_factory_create_wah_wah(audio,
						 play_container, recall_container,
						 plugin_name,
						 filename,
						 effect,
    ...
    start_recall = ags_fx_factory_create_sfz_synth(audio,
				...
				"ags-fx-star-synth",
				18)){
    start_recall = ags_fx_factory_create_star_synth(audio,
						    play_container, recall_container,
						    plugin_name,
						    filename,
						    effect,
				...
				"ags-fx-seq-synth",
				17)){
    start_recall = ags_fx_factory_create_seq_synth(audio,
						   play_container, recall_container,
						   plugin_name,
						   filename,
						   effect,
				...
				"ags-fx-raven-synth",
				19)){
    start_recall = ags_fx_factory_create_raven_synth(audio,
						     play_container, recall_container,
						     plugin_name,
						     filename,
						     effect,
				...
				21)){
    start_recall = ags_fx_factory_create_modular_synth(audio,
						       play_container, recall_container,
						       plugin_name,
						       filename,
						       effect,
				...
				"ags-fx-abyss-synth",
				18)){
    start_recall = ags_fx_factory_create_abyss_synth(audio,
						     play_container, recall_container,
						     plugin_name,
						     filename,
						     effect,
