 ...
 */
typedef enum{
  AGS_RECALL_MIDI1_BANK_SELECT = AGS_RECALL_UTIL_MIDI1_CONTROL_CHANGE(0xb0, 0x0),
  AGS_RECALL_MIDI1_MODULATION_WHEEL = AGS_RECALL_UTIL_MIDI1_CONTROL_CHANGE(0xb0, 0x1),
  AGS_RECALL_MIDI1_BREATH_CONTROLLER = AGS_RECALL_UTIL_MIDI1_CONTROL_CHANGE(0xb0, 0x2),
  AGS_RECALL_MIDI1_FOOT_CONTROLLER = AGS_RECALL_UTIL_MIDI1_CONTROL_CHANGE(0xb0, 0x4),
  AGS_RECALL_MIDI1_PORTAMENTO_TIME = AGS_RECALL_UTIL_MIDI1_CONTROL_CHANGE(0xb0, 0x5),
  AGS_RECALL_MIDI1_CHANNEL_VOLUME = AGS_RECALL_UTIL_MIDI1_CONTROL_CHANGE(0xb0, 0x7),
  AGS_RECALL_MIDI1_BALANCE = AGS_RECALL_UTIL_MIDI1_CONTROL_CHANGE(0xb0, 0x8),
  AGS_RECALL_MIDI1_PAN = AGS_RECALL_UTIL_MIDI1_CONTROL_CHANGE(0xb0, 0xa),
  AGS_RECALL_MIDI1_CC_24 = AGS_RECALL_UTIL_MIDI1_CONTROL_CHANGE(0xb0, 0x18),
  AGS_RECALL_MIDI1_CC_25 = AGS_RECALL_UTIL_MIDI1_CONTROL_CHANGE(0xb0, 0x19),
  AGS_RECALL_MIDI1_CC_26 = AGS_RECALL_UTIL_MIDI1_CONTROL_CHANGE(0xb0, 0x1a),
  AGS_RECALL_MIDI1_CC_27 = AGS_RECALL_UTIL_MIDI1_CONTROL_CHANGE(0xb0, 0x1b),
  AGS_RECALL_MIDI1_CC_28 = AGS_RECALL_UTIL_MIDI1_CONTROL_CHANGE(0xb0, 0x1c),
  AGS_RECALL_MIDI1_CC_29 = AGS_RECALL_UTIL_MIDI1_CONTROL_CHANGE(0xb0, 0x1d),
  AGS_RECALL_MIDI1_CC_30 = AGS_RECALL_UTIL_MIDI1_CONTROL_CHANGE(0xb0, 0x1e),
  AGS_RECALL_MIDI1_CC_31 = AGS_RECALL_UTIL_MIDI1_CONTROL_CHANGE(0xb0, 0x1f),
  AGS_RECALL_MIDI1_EXPRESSION_CONTROLLER = AGS_RECALL_UTIL_MIDI1_CONTROL_CHANGE(0xb0, 0xb),
  AGS_RECALL_MIDI1_EFFECT_CONTROL_1 = AGS_RECALL_UTIL_MIDI1_CONTROL_CHANGE(0xb0, 0xc),
  AGS_RECALL_MIDI1_EFFECT_CONTROL_2 = AGS_RECALL_UTIL_MIDI1_CONTROL_CHANGE(0xb0, 0xd),
  AGS_RECALL_MIDI1_GENERAL_PURPOSE_CONTROLLER_1 = AGS_RECALL_UTIL_MIDI1_CONTROL_CHANGE(0xb0, 0x10),
  AGS_RECALL_MIDI1_GENERAL_PURPOSE_CONTROLLER_2 = AGS_RECALL_UTIL_MIDI1_CONTROL_CHANGE(0xb0, 0x11),
  AGS_RECALL_MIDI1_GENERAL_PURPOSE_CONTROLLER_3 = AGS_RECALL_UTIL_MIDI1_CONTROL_CHANGE(0xb0, 0x12),
  AGS_RECALL_MIDI1_GENERAL_PURPOSE_CONTROLLER_4 = AGS_RECALL_UTIL_MIDI1_CONTROL_CHANGE(0xb0, 0x13),
  AGS_RECALL_MIDI1_CHANGE_PROGRAM = AGS_RECALL_UTIL_MIDI1_CONTROL_CHANGE(0xc0, 0x0),
  AGS_RECALL_MIDI1_CHANGE_PRESSURE = AGS_RECALL_UTIL_MIDI1_CONTROL_CHANGE(0xd0, 0x0),
  AGS_RECALL_MIDI1_PITCH_BEND = AGS_RECALL_UTIL_MIDI1_CONTROL_CHANGE(0xe0, 0x0),
  AGS_RECALL_MIDI1_SONG_POSITION = AGS_RECALL_UTIL_MIDI1_CONTROL_CHANGE(0xf2, 0x0),
  AGS_RECALL_MIDI1_SONG_SELECT = AGS_RECALL_UTIL_MIDI1_CONTROL_CHANGE(0xf3, 0x0),
  AGS_RECALL_MIDI1_TUNE_REQUEST = AGS_RECALL_UTIL_MIDI1_CONTROL_CHANGE(0xf6, 0x0),
}AgsRecallMidi1ControlChange;
 ...
 */
typedef enum{
  AGS_RECALL_MIDI2_MIDI1_BANK_SELECT                   = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0xb0, 0x0, 0x0, 0),
  AGS_RECALL_MIDI2_MIDI1_MODULATION_WHEEL              = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0xb0, 0x1, 0x0, 0),
  AGS_RECALL_MIDI2_MIDI1_BREATH_CONTROLLER             = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0xb0, 0x2, 0x0, 0),
  AGS_RECALL_MIDI2_MIDI1_FOOT_CONTROLLER               = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0xb0, 0x4, 0x0, 0),
  AGS_RECALL_MIDI2_MIDI1_PORTAMENTO_TIME               = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0xb0, 0x5, 0x0, 0),
  AGS_RECALL_MIDI2_MIDI1_CHANNEL_VOLUME                = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0xb0, 0x7, 0x0, 0),
  AGS_RECALL_MIDI2_MIDI1_BALANCE                       = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0xb0, 0x8, 0x0, 0),
  AGS_RECALL_MIDI2_MIDI1_PAN                           = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0xb0, 0xa, 0x0, 0),
  AGS_RECALL_MIDI2_MIDI1_EXPRESSION_CONTROLLER         = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0xb0, 0xb, 0x0, 0),
  AGS_RECALL_MIDI2_MIDI1_EFFECT_CONTROL_1              = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0xb0, 0xc, 0x0, 0),
  AGS_RECALL_MIDI2_MIDI1_EFFECT_CONTROL_2              = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0xb0, 0xd, 0x0, 0),
  AGS_RECALL_MIDI2_MIDI1_GENERAL_PURPOSE_CONTROLLER_1  = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0xb0, 0x10, 0x0, 0),
  AGS_RECALL_MIDI2_MIDI1_GENERAL_PURPOSE_CONTROLLER_2  = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0xb0, 0x11, 0x0, 0),
  AGS_RECALL_MIDI2_MIDI1_GENERAL_PURPOSE_CONTROLLER_3  = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0xb0, 0x12, 0x0, 0),
  AGS_RECALL_MIDI2_MIDI1_GENERAL_PURPOSE_CONTROLLER_4  = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0xb0, 0x13, 0x0, 0),
  AGS_RECALL_MIDI2_MIDI1_CHANGE_PROGRAM                = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0xc0, 0x0, 0x0, 0),
  AGS_RECALL_MIDI2_MIDI1_CHANGE_PRESSURE               = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0xd0, 0x0, 0x0, 0),
  AGS_RECALL_MIDI2_MIDI1_PITCH_BEND                    = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0xe0, 0x0, 0x0, 0),
  AGS_RECALL_MIDI2_CHANGE_PROGRAM                      = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0xc0, 0xc0, 0x0, 0),
  AGS_RECALL_MIDI2_CHANGE_PRESSURE                     = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0xd0, 0xd0, 0x0, 0),
  AGS_RECALL_MIDI2_PITCH_BEND                          = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0xe0, 0xe0, 0x0, 0),
  AGS_RECALL_MIDI2_MODULATION                          = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0x40, 0xb0, 0x0, 1),
  AGS_RECALL_MIDI2_BREATH                              = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0x40, 0xb0, 0x0, 2),
  AGS_RECALL_MIDI2_PITCH_7_25                          = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0x40, 0xb0, 0x0, 3),
  AGS_RECALL_MIDI2_VOLUME                              = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0x40, 0xb0, 0x0, 7),
  AGS_RECALL_MIDI2_BALANCE                             = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0x40, 0xb0, 0x0, 8),
  AGS_RECALL_MIDI2_PAN                                 = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0x40, 0xb0, 0x0, 10),
  AGS_RECALL_MIDI2_EXPRESSION                          = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0x40, 0xb0, 0x0, 11),
  AGS_RECALL_MIDI2_CC_24                               = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0x40, 0xb0, 0x0, 24),
  AGS_RECALL_MIDI2_CC_25                               = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0x40, 0xb0, 0x0, 25),
  AGS_RECALL_MIDI2_CC_26                               = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0x40, 0xb0, 0x0, 26),
  AGS_RECALL_MIDI2_CC_27                               = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0x40, 0xb0, 0x0, 27),
  AGS_RECALL_MIDI2_CC_28                               = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0x40, 0xb0, 0x0, 28),
  AGS_RECALL_MIDI2_CC_29                               = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0x40, 0xb0, 0x0, 29),
  AGS_RECALL_MIDI2_CC_30                               = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0x40, 0xb0, 0x0, 30),
  AGS_RECALL_MIDI2_CC_31                               = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0x40, 0xb0, 0x0, 31),
  AGS_RECALL_MIDI2_SOUND_VARIATION                     = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0x40, 0xb0, 0x0, 70),
  AGS_RECALL_MIDI2_TIMBRE                              = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0x40, 0xb0, 0x0, 71),
  AGS_RECALL_MIDI2_RELEASE                             = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0x40, 0xb0, 0x0, 72),
  AGS_RECALL_MIDI2_ATTACK                              = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0x40, 0xb0, 0x0, 73),
  AGS_RECALL_MIDI2_BRIGHTNESS                          = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0x40, 0xb0, 0x0, 74),
  AGS_RECALL_MIDI2_DECAY                               = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0x40, 0xb0, 0x0, 75),
  AGS_RECALL_MIDI2_VIBRATO_RATE                        = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0x40, 0xb0, 0x0, 76),
  AGS_RECALL_MIDI2_VIBRATO_DEPTH                       = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0x40, 0xb0, 0x0, 77),
  AGS_RECALL_MIDI2_VIBRATO_DELAY                       = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0x40, 0xb0, 0x0, 78),
  AGS_RECALL_MIDI2_SOUND_CONTROLLER_10                 = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0x40, 0xb0, 0x0, 79),
  AGS_RECALL_MIDI2_EFFECTS_1                           = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0x40, 0xb0, 0x0, 91),
  AGS_RECALL_MIDI2_EFFECTS_2                           = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0x40, 0xb0, 0x0, 92),
  AGS_RECALL_MIDI2_EFFECTS_3                           = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0x40, 0xb0, 0x0, 93),
  AGS_RECALL_MIDI2_EFFECTS_4                           = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0x40, 0xb0, 0x0, 94),
  AGS_RECALL_MIDI2_EFFECTS_5                           = AGS_RECALL_UTIL_MIDI2_CONTROL_CHANGE(0x40, 0xb0, 0x0, 95),
}AgsRecallMidi2ControlChange;
