...
ags_core_audio_devin_port_free(AgsSoundcard *soundcard)
{
  ...
  if(core_audio_devin->note_256th_delay >= 1.0){
    ...
    for(i = 1; i < (guint) floor(1.0 / (core_audio_devin->note_256th_delay)) && note_256th_attack_lower + (guint) floor((double) i * (core_audio_devin->note_256th_delay * (double) buffer_size)) < buffer_size; i++){
      if(note_256th_attack_lower + (guint) floor((double) i * (core_audio_devin->note_256th_delay * (double) buffer_size)) < note_256th_attack_upper + (guint) floor(core_audio_devin->note_256th_delay * (double) buffer_size)){
	core_audio_devin->note_256th_offset_last = core_audio_devin->note_256th_offset + i;
      }
    }
  }
...
ags_core_audio_devin_tic(AgsSoundcard *soundcard)
{
  ...
  if(delay_counter + 1.0 >= floor(delay)){
	...
	if(note_256th_attack_lower + ((guint) floor(1.0 / note_256th_delay) * (note_256th_delay * buffer_size)) < buffer_size){
	  ...
	  core_audio_devin->note_256th_offset_last = core_audio_devin->note_256th_offset + (guint) floor(1.0 / note_256th_delay) - 1;
	}
      }
    ...
    core_audio_devin->note_256th_offset = (16 * core_audio_devin->note_offset) + (guint) floor((core_audio_devin->delay_counter + 1.0) * (1.0 / note_256th_delay));
