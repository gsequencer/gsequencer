 ...
 * @AGS_CORE_AUDIO_DEVOUT_PRE_SYNC_DEVICE_WAIT: device initial sync wait
 * @AGS_CORE_AUDIO_DEVOUT_PRE_SYNC_DEVICE_DONE: device initial sync done
 * @AGS_CORE_AUDIO_DEVOUT_PRE_SYNC_CALLBACK_WAIT: callback initial sync wait
 * @AGS_CORE_AUDIO_DEVOUT_PRE_SYNC_CALLBACK_DONE: callback initial sync done
 * 
...
typedef enum{
  ...
  AGS_CORE_AUDIO_DEVOUT_PRE_SYNC_DEVICE_WAIT           = 1 <<  6,
  AGS_CORE_AUDIO_DEVOUT_PRE_SYNC_DEVICE_DONE           = 1 <<  7,
  AGS_CORE_AUDIO_DEVOUT_PRE_SYNC_CALLBACK_WAIT         = 1 <<  8,
  AGS_CORE_AUDIO_DEVOUT_PRE_SYNC_CALLBACK_DONE         = 1 <<  9,
}AgsCoreAudioDevoutSyncFlags;
...
struct _AgsCoreAudioDevout
{
  ...
  AgsCoreAudioDevoutFlags flags;
  AgsConnectableFlags connectable_flags;
  volatile AgsCoreAudioDevoutSyncFlags sync_flags;
...
gboolean ags_core_audio_devout_test_flags(AgsCoreAudioDevout *core_audio_devout, AgsCoreAudioDevoutFlags flags);
void ags_core_audio_devout_set_flags(AgsCoreAudioDevout *core_audio_devout, AgsCoreAudioDevoutFlags flags);
void ags_core_audio_devout_unset_flags(AgsCoreAudioDevout *core_audio_devout, AgsCoreAudioDevoutFlags flags);
