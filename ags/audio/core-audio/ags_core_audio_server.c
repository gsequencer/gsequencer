						     ...
						     gchar **param_strv, GValue *param_value)
{
  ...
  if(is_output){
    ...
    core_audio_devout->port_name[0] = g_strdup(card_id->data);
    ...
    core_audio_devin->port_name[0] = g_strdup(card_id->data);
						     ...
						     gchar **param_strv, GValue *param_value)
{
  ...
  if(!is_output){
    ...
    core_audio_midiin->port_name[0] = g_strdup(card_id->data);
