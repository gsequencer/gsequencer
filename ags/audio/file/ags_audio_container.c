...
static void ags_audio_container_class_init(AgsAudioContainerClass *audio_container);
static void ags_audio_container_connectable_interface_init(AgsConnectableInterface *connectable);
static void ags_audio_container_init(AgsAudioContainer *audio_container);
static void ags_audio_container_set_property(GObject *gobject,
					     guint prop_id,
					     const GValue *value,
					     GParamSpec *param_spec);
static void ags_audio_container_get_property(GObject *gobject,
					     guint prop_id,
					     GValue *value,
					     GParamSpec *param_spec);
static void ags_audio_container_finalize(GObject *object);

static AgsUUID* ags_audio_container_get_uuid(AgsConnectable *connectable);
static gboolean ags_audio_container_has_resource(AgsConnectable *connectable);
static gboolean ags_audio_container_is_ready(AgsConnectable *connectable);
static void ags_audio_container_add_to_registry(AgsConnectable *connectable);
static void ags_audio_container_remove_from_registry(AgsConnectable *connectable);
static xmlNode* ags_audio_container_list_resource(AgsConnectable *connectable);
static xmlNode* ags_audio_container_xml_compose(AgsConnectable *connectable);
static void ags_audio_container_xml_parse(AgsConnectable *connectable,
					  xmlNode *node);
static gboolean ags_audio_container_is_connected(AgsConnectable *connectable);
static void ags_audio_container_connect(AgsConnectable *connectable);
static void ags_audio_container_disconnect(AgsConnectable *connectable);
