			 ...
			 guint frame_count, guint format)
{
  ...
  if(do_write){
    ...
    ags_gstreamer_file_audio_src_unset_status_flags(gstreamer_file_audio_src, AGS_GSTREAMER_FILE_AUDIO_SRC_STATUS_WAIT);

    g_cond_signal(&(gstreamer_file_audio_src->wakeup_cond));
