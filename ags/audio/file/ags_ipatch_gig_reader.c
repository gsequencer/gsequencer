...
static void ags_ipatch_gig_reader_class_init(AgsIpatchGigReaderClass *ipatch_gig_reader);
static void ags_ipatch_gig_reader_connectable_interface_init(AgsConnectableInterface *connectable);
static void ags_ipatch_gig_reader_init(AgsIpatchGigReader *ipatch_gig_reader);
static void ags_ipatch_gig_reader_set_property(GObject *gobject,
					       guint prop_id,
					       const GValue *value,
					       GParamSpec *param_spec);
static void ags_ipatch_gig_reader_get_property(GObject *gobject,
					       guint prop_id,
					       GValue *value,
					       GParamSpec *param_spec);
static void ags_ipatch_gig_reader_dispose(GObject *gobject);
static void ags_ipatch_gig_reader_finalize(GObject *gobject);

static AgsUUID* ags_ipatch_gig_reader_get_uuid(AgsConnectable *connectable);
static gboolean ags_ipatch_gig_reader_has_resource(AgsConnectable *connectable);
static gboolean ags_ipatch_gig_reader_is_ready(AgsConnectable *connectable);
static void ags_ipatch_gig_reader_add_to_registry(AgsConnectable *connectable);
static void ags_ipatch_gig_reader_remove_from_registry(AgsConnectable *connectable);
static xmlNode* ags_ipatch_gig_reader_list_resource(AgsConnectable *connectable);
static xmlNode* ags_ipatch_gig_reader_xml_compose(AgsConnectable *connectable);
static void ags_ipatch_gig_reader_xml_parse(AgsConnectable *connectable,
					    xmlNode *node);
static gboolean ags_ipatch_gig_reader_is_connected(AgsConnectable *connectable);
static void ags_ipatch_gig_reader_connect(AgsConnectable *connectable);
static void ags_ipatch_gig_reader_disconnect(AgsConnectable *connectable);
			   ...
			   IpatchFileHandle *handle)
{
  ...
  error = NULL;
  ipatch_gig_reader->base = (IpatchBase *) ipatch_dls_reader_load(reader,
								  &error);
