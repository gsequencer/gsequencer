...
static void ags_ipatch_sf2_reader_class_init(AgsIpatchSF2ReaderClass *ipatch_sf2_reader);
static void ags_ipatch_sf2_reader_connectable_interface_init(AgsConnectableInterface *connectable);
static void ags_ipatch_sf2_reader_init(AgsIpatchSF2Reader *ipatch_sf2_reader);
static void ags_ipatch_sf2_reader_set_property(GObject *gobject,
					       guint prop_id,
					       const GValue *value,
					       GParamSpec *param_spec);
static void ags_ipatch_sf2_reader_get_property(GObject *gobject,
					       guint prop_id,
					       GValue *value,
					       GParamSpec *param_spec);
static void ags_ipatch_sf2_reader_dispose(GObject *gobject);
static void ags_ipatch_sf2_reader_finalize(GObject *gobject);

static AgsUUID* ags_ipatch_sf2_reader_get_uuid(AgsConnectable *connectable);
static gboolean ags_ipatch_sf2_reader_has_resource(AgsConnectable *connectable);
static gboolean ags_ipatch_sf2_reader_is_ready(AgsConnectable *connectable);
static void ags_ipatch_sf2_reader_add_to_registry(AgsConnectable *connectable);
static void ags_ipatch_sf2_reader_remove_from_registry(AgsConnectable *connectable);
static xmlNode* ags_ipatch_sf2_reader_list_resource(AgsConnectable *connectable);
static xmlNode* ags_ipatch_sf2_reader_xml_compose(AgsConnectable *connectable);
static void ags_ipatch_sf2_reader_xml_parse(AgsConnectable *connectable,
					    xmlNode *node);
static gboolean ags_ipatch_sf2_reader_is_connected(AgsConnectable *connectable);
static void ags_ipatch_sf2_reader_connect(AgsConnectable *connectable);
static void ags_ipatch_sf2_reader_disconnect(AgsConnectable *connectable);
