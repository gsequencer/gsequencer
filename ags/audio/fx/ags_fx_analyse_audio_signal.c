...
static void ags_fx_analyse_audio_signal_class_init(AgsFxAnalyseAudioSignalClass *fx_analyse_audio_signal);
static void ags_fx_analyse_audio_signal_init(AgsFxAnalyseAudioSignal *fx_analyse_audio_signal);
static void ags_fx_analyse_audio_signal_dispose(GObject *gobject);
static void ags_fx_analyse_audio_signal_finalize(GObject *gobject);

static void ags_fx_analyse_audio_signal_real_run_inter(AgsRecall *recall);
...
const gchar *ags_fx_analyse_audio_signal_plugin_name = "ags-fx-analyse";
...
ags_fx_analyse_audio_signal_get_type()
{
  ...
  if(g_once_init_enter(&g_define_type_id__static)){
    ...
    g_once_init_leave(&g_define_type_id__static, ags_type_fx_analyse_audio_signal);
  }
