...
static void ags_fx_analyse_channel_processor_class_init(AgsFxAnalyseChannelProcessorClass *fx_analyse_channel_processor);
static void ags_fx_analyse_channel_processor_init(AgsFxAnalyseChannelProcessor *fx_analyse_channel_processor);
static void ags_fx_analyse_channel_processor_dispose(GObject *gobject);
static void ags_fx_analyse_channel_processor_finalize(GObject *gobject);

static void ags_fx_analyse_channel_processor_real_run_inter(AgsRecall *recall);
