...
#ifndef __AGS_FX_CHORUS_CHANNEL_H__
#define __AGS_FX_CHORUS_CHANNEL_H__
...
typedef struct _AgsFxChorusChannel AgsFxChorusChannel;
typedef struct _AgsFxChorusChannelClass AgsFxChorusChannelClass;
...
GType ags_fx_chorus_channel_get_type();

/*  */
AgsFxChorusChannel* ags_fx_chorus_channel_new(AgsChannel *channel);

G_END_DECLS

#endif /*__AGS_FX_CHORUS_CHANNEL_H__*/
