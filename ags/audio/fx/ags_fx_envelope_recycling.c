...
static void ags_fx_envelope_recycling_class_init(AgsFxEnvelopeRecyclingClass *fx_envelope_recycling);
static void ags_fx_envelope_recycling_init(AgsFxEnvelopeRecycling *fx_envelope_recycling);
static void ags_fx_envelope_recycling_dispose(GObject *gobject);
static void ags_fx_envelope_recycling_finalize(GObject *gobject);
