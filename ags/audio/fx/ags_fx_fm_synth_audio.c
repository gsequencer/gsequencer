...
ags_fx_fm_synth_audio_get_type()
{
  ...
  if(g_once_init_enter(&g_define_type_id__static)){
    ...
    g_once_init_leave(&g_define_type_id__static, ags_type_fx_fm_synth_audio);
  }
...
ags_fx_fm_synth_audio_init(AgsFxFMSynthAudio *fx_fm_synth_audio)
{
  ...
  fx_fm_synth_audio->synth_2_oscillator = g_object_new(AGS_TYPE_PORT,
						       "plugin-name", ags_fx_fm_synth_audio_plugin_name,
						       "specifier", "./synth-2-oscillator[0]",
						       "control-port", "19/47",
						       "port-value-is-pointer", FALSE,
						       "port-value-type", G_TYPE_FLOAT,
						       "port-value-size", sizeof(gfloat),
  ...
  fx_fm_synth_audio->synth_2_lfo_oscillator = g_object_new(AGS_TYPE_PORT,
							   "plugin-name", ags_fx_fm_synth_audio_plugin_name,
							   "specifier", "./synth-2-lfo-oscillator[0]",
							   "control-port", "24/47",
							   "port-value-is-pointer", FALSE,
							   "port-value-type", G_TYPE_FLOAT,
							   "port-value-size", sizeof(gfloat),
  ...
  fx_fm_synth_audio->synth_2_lfo_frequency = g_object_new(AGS_TYPE_PORT,
							  "plugin-name", ags_fx_fm_synth_audio_plugin_name,
							  "specifier", "./synth-2-lfo-frequency[0]",
							  "control-port", "25/47",
							  "port-value-is-pointer", FALSE,
							  "port-value-type", G_TYPE_FLOAT,
							  "port-value-size", sizeof(gfloat),
  ...
  fx_fm_synth_audio->synth_2_lfo_tuning = g_object_new(AGS_TYPE_PORT,
						       "plugin-name", ags_fx_fm_synth_audio_plugin_name,
						       "specifier", "./synth-2-lfo-tuning[0]",
						       "control-port", "27/47",
						       "port-value-is-pointer", FALSE,
						       "port-value-type", G_TYPE_FLOAT,
						       "port-value-size", sizeof(gfloat),
  ...
  g_signal_connect_after(fx_fm_synth_audio->pitch_type, "safe-write",
			 G_CALLBACK(ags_fx_fm_synth_audio_pitch_type_callback), fx_fm_synth_audio);
  ...
  fx_fm_synth_audio->chorus_lfo_frequency->port_value.ags_port_float = (gfloat) 0.01;
...
void
ags_fx_fm_synth_audio_pitch_type_callback(AgsPort *port, GValue *value,
					  AgsFxFMSynthAudio *fx_fm_synth_audio)
{
