...
static void ags_fx_fm_synth_audio_processor_class_init(AgsFxFMSynthAudioProcessorClass *fx_fm_synth_audio_processor);
static void ags_fx_fm_synth_audio_processor_init(AgsFxFMSynthAudioProcessor *fx_fm_synth_audio_processor);
static void ags_fx_fm_synth_audio_processor_dispose(GObject *gobject);
static void ags_fx_fm_synth_audio_processor_finalize(GObject *gobject);
...
ags_fx_fm_synth_audio_processor_get_type()
{
  ...
  if(g_once_init_enter(&g_define_type_id__static)){
    ...
    g_once_init_leave(&g_define_type_id__static, ags_type_fx_fm_synth_audio_processor);
  }
