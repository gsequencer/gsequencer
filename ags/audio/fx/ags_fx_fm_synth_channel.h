...
#ifndef __AGS_FX_FM_SYNTH_CHANNEL_H__
#define __AGS_FX_FM_SYNTH_CHANNEL_H__
...
typedef struct _AgsFxFMSynthChannel AgsFxFMSynthChannel;
typedef struct _AgsFxFMSynthChannelClass AgsFxFMSynthChannelClass;
...
#endif /*__AGS_FX_FM_SYNTH_CHANNEL_H__*/
