...
#ifndef __AGS_FX_FM_SYNTH_CHANNEL_PROCESSOR_H__
#define __AGS_FX_FM_SYNTH_CHANNEL_PROCESSOR_H__
...
typedef struct _AgsFxFMSynthChannelProcessor AgsFxFMSynthChannelProcessor;
typedef struct _AgsFxFMSynthChannelProcessorClass AgsFxFMSynthChannelProcessorClass;
...
/*  */
AgsFxFMSynthChannelProcessor* ags_fx_fm_synth_channel_processor_new(AgsChannel *channel);

G_END_DECLS

#endif /*__AGS_FX_FM_SYNTH_CHANNEL_PROCESSOR_H__*/
