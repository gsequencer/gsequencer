...
#ifndef __AGS_FX_FM_SYNTH_RECYCLING_H__
#define __AGS_FX_FM_SYNTH_RECYCLING_H__
...
typedef struct _AgsFxFMSynthRecycling AgsFxFMSynthRecycling;
typedef struct _AgsFxFMSynthRecyclingClass AgsFxFMSynthRecyclingClass;

struct _AgsFxFMSynthRecycling
{
  AgsRecallRecycling recall_recycling;
};

struct _AgsFxFMSynthRecyclingClass
{
  AgsRecallRecyclingClass recall_recycling;
};

GType ags_fx_fm_synth_recycling_get_type();

/*  */
AgsFxFMSynthRecycling* ags_fx_fm_synth_recycling_new(AgsRecycling *recycling);

G_END_DECLS

#endif /*__AGS_FX_FM_SYNTH_RECYCLING_H__*/
