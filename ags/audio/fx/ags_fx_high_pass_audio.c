...
static void ags_fx_high_pass_audio_class_init(AgsFxHighPassAudioClass *fx_high_pass_audio);
static void ags_fx_high_pass_audio_init(AgsFxHighPassAudio *fx_high_pass_audio);
static void ags_fx_high_pass_audio_dispose(GObject *gobject);
static void ags_fx_high_pass_audio_finalize(GObject *gobject);
...
static const gchar *ags_fx_high_pass_audio_plugin_name = "ags-fx-high-pass";

static const gchar* ags_fx_high_pass_audio_specifier[] = {
  NULL,
};

static const gchar* ags_fx_high_pass_audio_control_port[] = {
  NULL,
};
...
ags_fx_high_pass_audio_get_type()
{
  ...
  if(g_once_init_enter(&g_define_type_id__static)){
    ...
    g_once_init_leave(&g_define_type_id__static, ags_type_fx_high_pass_audio);
  }
