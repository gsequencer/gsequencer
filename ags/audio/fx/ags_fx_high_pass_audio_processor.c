...
static gpointer ags_fx_high_pass_audio_processor_parent_class = NULL;
...
ags_fx_high_pass_audio_processor_get_type()
{
  ...
  if(g_once_init_enter (&g_define_type_id__volatile)){
    GType ags_type_fx_high_pass_audio_processor = 0;

    static const GTypeInfo ags_fx_high_pass_audio_processor_info = {
      sizeof (AgsFxHighPassAudioProcessorClass),
      NULL, /* base_init */
      NULL, /* base_finalize */
      (GClassInitFunc) ags_fx_high_pass_audio_processor_class_init,
      NULL, /* class_finalize */
      NULL, /* class_audio_processor */
      sizeof (AgsFxHighPassAudioProcessor),
      0,    /* n_preallocs */
      (GInstanceInitFunc) ags_fx_high_pass_audio_processor_init,
    };

    ags_type_fx_high_pass_audio_processor = g_type_register_static(AGS_TYPE_RECALL_AUDIO_RUN,
								   "AgsFxHighPassAudioProcessor",
								   &ags_fx_high_pass_audio_processor_info,
								   0);

    g_once_init_leave(&g_define_type_id__volatile, ags_type_fx_high_pass_audio_processor);
  }
...
void
ags_fx_high_pass_audio_processor_class_init(AgsFxHighPassAudioProcessorClass *fx_high_pass_audio_processor)
{
  GObjectClass *gobject;
  
  ags_fx_high_pass_audio_processor_parent_class = g_type_class_peek_parent(fx_high_pass_audio_processor);

  /* GObjectClass */
  gobject = (GObjectClass *) fx_high_pass_audio_processor;

  gobject->dispose = ags_fx_high_pass_audio_processor_dispose;
  gobject->finalize = ags_fx_high_pass_audio_processor_finalize;
}
...
void
ags_fx_high_pass_audio_processor_dispose(GObject *gobject)
{
  AgsFxHighPassAudioProcessor *fx_high_pass_audio_processor;
  
  fx_high_pass_audio_processor = AGS_FX_HIGH_PASS_AUDIO_PROCESSOR(gobject);
  
  /* call parent */
  G_OBJECT_CLASS(ags_fx_high_pass_audio_processor_parent_class)->dispose(gobject);
}

void
ags_fx_high_pass_audio_processor_finalize(GObject *gobject)
{
  AgsFxHighPassAudioProcessor *fx_high_pass_audio_processor;
  ...
  /* call parent */
  G_OBJECT_CLASS(ags_fx_high_pass_audio_processor_parent_class)->finalize(gobject);
}
 ...
 *
 * Returns: the new #AgsFxHighPassAudioProcessor
 *
 * Since: 3.13.0
 */
AgsFxHighPassAudioProcessor*
ags_fx_high_pass_audio_processor_new(AgsAudio *audio)
{
  ...
  return(fx_high_pass_audio_processor);
}
