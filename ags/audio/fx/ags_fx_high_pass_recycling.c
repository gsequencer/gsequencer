...
static void ags_fx_high_pass_recycling_class_init(AgsFxHighPassRecyclingClass *fx_high_pass_recycling);
static void ags_fx_high_pass_recycling_init(AgsFxHighPassRecycling *fx_high_pass_recycling);
static void ags_fx_high_pass_recycling_dispose(GObject *gobject);
static void ags_fx_high_pass_recycling_finalize(GObject *gobject);
...
static const gchar *ags_fx_high_pass_recycling_plugin_name = "ags-fx-high-pass";
