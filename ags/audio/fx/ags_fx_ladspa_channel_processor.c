...
static void ags_fx_ladspa_channel_processor_class_init(AgsFxLadspaChannelProcessorClass *fx_ladspa_channel_processor);
static void ags_fx_ladspa_channel_processor_init(AgsFxLadspaChannelProcessor *fx_ladspa_channel_processor);
static void ags_fx_ladspa_channel_processor_dispose(GObject *gobject);
static void ags_fx_ladspa_channel_processor_finalize(GObject *gobject);
...
static const gchar *ags_fx_ladspa_channel_processor_plugin_name = "ags-fx-ladspa";
