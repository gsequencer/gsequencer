...
#ifndef __AGS_FX_LFO_AUDIO_PROCESSOR_H__
#define __AGS_FX_LFO_AUDIO_PROCESSOR_H__
...
typedef struct _AgsFxLfoAudioProcessor AgsFxLfoAudioProcessor;
typedef struct _AgsFxLfoAudioProcessorClass AgsFxLfoAudioProcessorClass;

struct _AgsFxLfoAudioProcessor
{
  AgsRecallAudioRun recall_audio_run;  
};

struct _AgsFxLfoAudioProcessorClass
{
  AgsRecallAudioRunClass recall_audio_run;
};

GType ags_fx_lfo_audio_processor_get_type();

/*  */
AgsFxLfoAudioProcessor* ags_fx_lfo_audio_processor_new(AgsAudio *audio);

G_END_DECLS

#endif /*__AGS_FX_LFO_AUDIO_PROCESSOR_H__*/
