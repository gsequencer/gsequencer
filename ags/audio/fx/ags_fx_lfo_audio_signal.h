...
#ifndef __AGS_FX_LFO_AUDIO_SIGNAL_H__
#define __AGS_FX_LFO_AUDIO_SIGNAL_H__
...
typedef struct _AgsFxLfoAudioSignal AgsFxLfoAudioSignal;
typedef struct _AgsFxLfoAudioSignalClass AgsFxLfoAudioSignalClass;

struct _AgsFxLfoAudioSignal
{
...
struct _AgsFxLfoAudioSignalClass
{
  AgsRecallAudioSignalClass recall_audio_signal;
};

GType ags_fx_lfo_audio_signal_get_type();

/*  */
AgsFxLfoAudioSignal* ags_fx_lfo_audio_signal_new(AgsAudioSignal *audio_signal);

G_END_DECLS

#endif /*__AGS_FX_LFO_AUDIO_SIGNAL_H__*/
