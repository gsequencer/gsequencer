...
static void ags_fx_lfo_recycling_class_init(AgsFxLfoRecyclingClass *fx_lfo_recycling);
static void ags_fx_lfo_recycling_init(AgsFxLfoRecycling *fx_lfo_recycling);
static void ags_fx_lfo_recycling_dispose(GObject *gobject);
static void ags_fx_lfo_recycling_finalize(GObject *gobject);
...
static const gchar *ags_fx_lfo_recycling_plugin_name = "ags-fx-lfo";
...
ags_fx_lfo_recycling_get_type()
{
  ...
  if(g_once_init_enter(&g_define_type_id__static)){
    ...
    g_once_init_leave(&g_define_type_id__static, ags_type_fx_lfo_recycling);
  }
