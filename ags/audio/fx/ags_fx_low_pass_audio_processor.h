...
#ifndef __AGS_FX_LOW_PASS_AUDIO_PROCESSOR_H__
#define __AGS_FX_LOW_PASS_AUDIO_PROCESSOR_H__
...
typedef struct _AgsFxLowPassAudioProcessor AgsFxLowPassAudioProcessor;
typedef struct _AgsFxLowPassAudioProcessorClass AgsFxLowPassAudioProcessorClass;

struct _AgsFxLowPassAudioProcessor
{
  AgsRecallAudioRun recall_audio_run;  
};

struct _AgsFxLowPassAudioProcessorClass
{
  AgsRecallAudioRunClass recall_audio_run;
};

GType ags_fx_low_pass_audio_processor_get_type();

/*  */
AgsFxLowPassAudioProcessor* ags_fx_low_pass_audio_processor_new(AgsAudio *audio);

G_END_DECLS

#endif /*__AGS_FX_LOW_PASS_AUDIO_PROCESSOR_H__*/
