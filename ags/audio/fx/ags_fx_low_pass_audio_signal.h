...
#ifndef __AGS_FX_LOW_PASS_AUDIO_SIGNAL_H__
#define __AGS_FX_LOW_PASS_AUDIO_SIGNAL_H__
...
typedef struct _AgsFxLowPassAudioSignal AgsFxLowPassAudioSignal;
typedef struct _AgsFxLowPassAudioSignalClass AgsFxLowPassAudioSignalClass;

struct _AgsFxLowPassAudioSignal
{
...
struct _AgsFxLowPassAudioSignalClass
{
  AgsRecallAudioSignalClass recall_audio_signal;
};

GType ags_fx_low_pass_audio_signal_get_type();

/*  */
AgsFxLowPassAudioSignal* ags_fx_low_pass_audio_signal_new(AgsAudioSignal *audio_signal);

G_END_DECLS

#endif /*__AGS_FX_LOW_PASS_AUDIO_SIGNAL_H__*/
