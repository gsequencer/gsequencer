...
#ifndef __AGS_FX_LOW_PASS_CHANNEL_H__
#define __AGS_FX_LOW_PASS_CHANNEL_H__
...
typedef struct _AgsFxLowPassChannel AgsFxLowPassChannel;
typedef struct _AgsFxLowPassChannelClass AgsFxLowPassChannelClass;

struct _AgsFxLowPassChannel
{
...
struct _AgsFxLowPassChannelClass
{
  AgsRecallChannelClass recall_channel;
};

GType ags_fx_low_pass_channel_get_type();

/*  */
AgsFxLowPassChannel* ags_fx_low_pass_channel_new(AgsChannel *channel);

G_END_DECLS

#endif /*__AGS_FX_LOW_PASS_CHANNEL_H__*/
