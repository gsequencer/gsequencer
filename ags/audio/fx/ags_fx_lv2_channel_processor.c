...
static void ags_fx_lv2_channel_processor_class_init(AgsFxLv2ChannelProcessorClass *fx_lv2_channel_processor);
static void ags_fx_lv2_channel_processor_init(AgsFxLv2ChannelProcessor *fx_lv2_channel_processor);
static void ags_fx_lv2_channel_processor_dispose(GObject *gobject);
static void ags_fx_lv2_channel_processor_finalize(GObject *gobject);
...
ags_fx_lv2_channel_processor_get_type()
{
  ...
  if(g_once_init_enter(&g_define_type_id__static)){
    ...
    g_once_init_leave(&g_define_type_id__static, ags_type_fx_lv2_channel_processor);
  }
