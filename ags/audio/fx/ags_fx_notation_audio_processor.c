...
ags_fx_notation_audio_processor_init(AgsFxNotationAudioProcessor *fx_notation_audio_processor)
{
  ...
  fx_notation_audio_processor->note_256th_offset_counter = 0;
  fx_notation_audio_processor->note_256th_offset_counter_last = (guint) floor(1.0 / fx_notation_audio_processor->note_256th_delay);

  fx_notation_audio_processor->note_256th_current_offset_counter = 0;
				     ...
				     guint whence)
{
  ...
  case AGS_SEEK_CUR:
	...
	fx_notation_audio_processor->current_offset_counter = notation_counter;
      ...
      fx_notation_audio_processor->note_256th_offset_counter = 
	fx_notation_audio_processor->note_256th_current_offset_counter = 16 * notation_counter;
	...
	for(i = 1; i < (guint) floor(1.0 / (note_256th_delay)) && note_256th_attack_lower + (guint) floor((double) i * (note_256th_delay * (double) buffer_size)) < buffer_size; i++){
	  if(note_256th_attack_lower + (guint) floor((double) i * (note_256th_delay * (double) buffer_size)) < note_256th_attack_upper + (guint) floor(note_256th_delay * (double) buffer_size)){
	    fx_notation_audio_processor->note_256th_offset_counter_last = 
	      fx_notation_audio_processor->note_256th_current_offset_counter_last = fx_notation_audio_processor->note_256th_offset_counter + i;
	  }
	}
      }
  ...
  case AGS_SEEK_SET:
	...
	fx_notation_audio_processor->current_offset_counter = offset;
      ...
      fx_notation_audio_processor->note_256th_offset_counter =
	fx_notation_audio_processor->note_256th_current_offset_counter = 16 * offset;
...
ags_fx_notation_audio_processor_run_init_pre(AgsRecall *recall)
{
  ...
  fx_notation_audio_processor->note_256th_offset_counter = 0;  
  fx_notation_audio_processor->note_256th_offset_counter_last = 0;

  fx_notation_audio_processor->note_256th_current_offset_counter = 0;
  fx_notation_audio_processor->note_256th_current_offset_counter_last = (guint) floor(1.0 / fx_notation_audio_processor->note_256th_delay);
...
ags_fx_notation_audio_processor_run_inter(AgsRecall *recall)
{
  ...
  fx_notation_audio_processor->note_256th_offset_counter = fx_notation_audio_processor->note_256th_current_offset_counter;
  fx_notation_audio_processor->note_256th_offset_counter_last = fx_notation_audio_processor->note_256th_current_offset_counter_last;
...
#if 0
  g_message("delay-counter[%f] run-inter() %d %d", fx_notation_audio_processor->delay_counter, fx_notation_audio_processor->note_256th_offset_counter, fx_notation_audio_processor->note_256th_offset_counter_last);
#endif
...
ags_fx_notation_audio_processor_real_play(AgsFxNotationAudioProcessor *fx_notation_audio_processor)
{
  ...
  guint64 offset_counter;
  guint note_256th_offset_counter, note_256th_offset_counter_last;
  guint audio_channel;
  gdouble delay_counter;
  ...
  if(has_16th_pulse){
    ...
    if(notation != NULL){
      ...
      start_note = ags_notation_find_note_256th_range(notation->data,
						      16 * (guint) floor((double) note_256th_offset_counter / 16.0),
						      16 * (guint) ceil((double) note_256th_offset_counter_last / 16.0),
						      FALSE);
#else
      start_note = ags_notation_find_note_256th_range(notation->data,
						      note_256th_offset_counter,
						      note_256th_offset_counter_last,
						      FALSE);
#endif
  ...
  note = fx_notation_audio_processor->note_256th;
  ...
  while(note != NULL){
    ...
    g_message("x0_256th %d_%d -> %d, [%d - %d]", x0_256th, x1_256th, offset_counter, note_256th_offset_counter, note_256th_offset_counter_last);
#if 0
#endif
      
    if((x0_256th >= note_256th_offset_counter) &&
       (x0_256th <= note_256th_offset_counter_last)){
...
ags_fx_notation_audio_processor_real_counter_change(AgsFxNotationAudioProcessor *fx_notation_audio_processor)
{
  ...
  if(delay_counter + 1.0 >= floor(delay)){
    ...
    if(do_loop &&
      ...
      fx_notation_audio_processor->note_256th_current_offset_counter = 16 * loop_start;

      if(note_256th_attack_lower < attack){
	if(fx_notation_audio_processor->note_256th_current_offset_counter - ((attack - note_256th_attack_lower) / (note_256th_delay * (double) buffer_size)) > fx_notation_audio_processor->note_256th_offset_counter_last){
	  fx_notation_audio_processor->note_256th_current_offset_counter -= (guint) floor((attack - note_256th_attack_lower) / (note_256th_delay * (double) buffer_size));
	}
      }
	...
	if(note_256th_attack_lower < note_256th_attack_upper){
	  fx_notation_audio_processor->note_256th_current_offset_counter_last += (guint) floor((buffer_size - note_256th_attack_lower) / (note_256th_delay * (double) buffer_size));
	}
      }
    }else{
      fx_notation_audio_processor->current_offset_counter = offset_counter + 1;

      fx_notation_audio_processor->note_256th_current_offset_counter = fx_notation_audio_processor->note_256th_offset_counter_last + 1;
    ...
    fx_notation_audio_processor->current_delay_counter = delay_counter + 1.0 - delay;
