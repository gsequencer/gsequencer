...
#ifndef __AGS_FX_PATTERN_AUDIO_SIGNAL_H__
#define __AGS_FX_PATTERN_AUDIO_SIGNAL_H__
...
#define AGS_FX_PATTERN_AUDIO_SIGNAL_CLASS(class)        (G_TYPE_CHECK_CLASS_CAST((class), AGS_TYPE_FX_PATTERN_AUDIO_SIGNAL, AgsFxPatternAudioSignal))
...
typedef struct _AgsFxPatternAudioSignal AgsFxPatternAudioSignal;
typedef struct _AgsFxPatternAudioSignalClass AgsFxPatternAudioSignalClass;

struct _AgsFxPatternAudioSignal
{
  AgsRecallAudioSignal recall_audio_signal;
};

struct _AgsFxPatternAudioSignalClass
{
...
GType ags_fx_pattern_audio_signal_get_type();
...
/*  */
AgsFxPatternAudioSignal* ags_fx_pattern_audio_signal_new(AgsAudioSignal *audio_signal);

G_END_DECLS

#endif /*__AGS_FX_PATTERN_AUDIO_SIGNAL_H__*/
