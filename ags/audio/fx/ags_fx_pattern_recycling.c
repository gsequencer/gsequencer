...
static void ags_fx_pattern_recycling_class_init(AgsFxPatternRecyclingClass *fx_pattern_recycling);
static void ags_fx_pattern_recycling_init(AgsFxPatternRecycling *fx_pattern_recycling);
static void ags_fx_pattern_recycling_dispose(GObject *gobject);
static void ags_fx_pattern_recycling_finalize(GObject *gobject);
...
static const gchar *ags_fx_pattern_recycling_plugin_name = "ags-fx-pattern";
