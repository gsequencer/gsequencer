...
static void ags_fx_peak_channel_class_init(AgsFxPeakChannelClass *fx_peak_channel);
static void ags_fx_peak_channel_init(AgsFxPeakChannel *fx_peak_channel);
static void ags_fx_peak_channel_set_property(GObject *gobject,
					     guint prop_id,
					     const GValue *value,
					     GParamSpec *param_spec);
static void ags_fx_peak_channel_get_property(GObject *gobject,
					     guint prop_id,
					     GValue *value,
					     GParamSpec *param_spec);
static void ags_fx_peak_channel_dispose(GObject *gobject);
static void ags_fx_peak_channel_finalize(GObject *gobject);

static void ags_fx_peak_channel_notify_buffer_size_callback(GObject *gobject,
							    GParamSpec *pspec,
							    gpointer user_data);
...
ags_fx_peak_channel_get_type()
{
  ...
  if(g_once_init_enter(&g_define_type_id__static)){
    ...
    g_once_init_leave(&g_define_type_id__static, ags_type_fx_peak_channel);
  }
