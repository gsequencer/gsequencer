...
#ifndef __AGS_FX_PLAYBACK_AUDIO_SIGNAL_H__
#define __AGS_FX_PLAYBACK_AUDIO_SIGNAL_H__
...
#define AGS_FX_PLAYBACK_AUDIO_SIGNAL_CLASS(class)        (G_TYPE_CHECK_CLASS_CAST((class), AGS_TYPE_FX_PLAYBACK_AUDIO_SIGNAL, AgsFxPlaybackAudioSignal))
...
typedef struct _AgsFxPlaybackAudioSignal AgsFxPlaybackAudioSignal;
typedef struct _AgsFxPlaybackAudioSignalClass AgsFxPlaybackAudioSignalClass;
...
GType ags_fx_playback_audio_signal_get_type();

/*  */
AgsFxPlaybackAudioSignal* ags_fx_playback_audio_signal_new(AgsAudioSignal *audio_signal);

G_END_DECLS

#endif /*__AGS_FX_PLAYBACK_AUDIO_SIGNAL_H__*/
