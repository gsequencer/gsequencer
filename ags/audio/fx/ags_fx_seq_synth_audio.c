...
static void ags_fx_seq_synth_audio_class_init(AgsFxSeqSynthAudioClass *fx_seq_synth_audio);
static void ags_fx_seq_synth_audio_init(AgsFxSeqSynthAudio *fx_seq_synth_audio);
static void ags_fx_seq_synth_audio_set_property(GObject *gobject,
						guint prop_id,
						const GValue *value,
						GParamSpec *param_spec);
static void ags_fx_seq_synth_audio_get_property(GObject *gobject,
						guint prop_id,
						GValue *value,
						GParamSpec *param_spec);
static void ags_fx_seq_synth_audio_dispose(GObject *gobject);
static void ags_fx_seq_synth_audio_finalize(GObject *gobject);

static void ags_fx_seq_synth_audio_notify_audio_callback(GObject *gobject,
							 GParamSpec *pspec,
							 gpointer user_data);
static void ags_fx_seq_synth_audio_notify_buffer_size_callback(GObject *gobject,
							       GParamSpec *pspec,
							       gpointer user_data);
static void ags_fx_seq_synth_audio_notify_format_callback(GObject *gobject,
							  GParamSpec *pspec,
							  gpointer user_data);
static void ags_fx_seq_synth_audio_notify_samplerate_callback(GObject *gobject,
							      GParamSpec *pspec,
							      gpointer user_data);

static void ags_fx_seq_synth_audio_set_audio_channels_callback(AgsAudio *audio,
							       guint audio_channels, guint audio_channels_old,
							       AgsFxSeqSynthAudio *fx_seq_synth_audio);

static void ags_fx_seq_synth_audio_pitch_type_callback(AgsPort *port, GValue *value,
						       AgsFxSeqSynthAudio *fx_seq_synth_audio);

static void ags_fx_seq_synth_audio_chorus_pitch_type_callback(AgsPort *port, GValue *value,
							      AgsFxSeqSynthAudio *fx_seq_synth_audio);
...
static const gchar *ags_fx_seq_synth_audio_plugin_name = "ags-fx-seq-synth";

static const gchar* ags_fx_seq_synth_audio_specifier[] = {
