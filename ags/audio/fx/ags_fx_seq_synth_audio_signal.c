...
void ags_fx_seq_synth_audio_signal_class_init(AgsFxSeqSynthAudioSignalClass *fx_seq_synth_audio_signal);
void ags_fx_seq_synth_audio_signal_init(AgsFxSeqSynthAudioSignal *fx_seq_synth_audio_signal);
void ags_fx_seq_synth_audio_signal_dispose(GObject *gobject);
void ags_fx_seq_synth_audio_signal_finalize(GObject *gobject);

void ags_fx_seq_synth_audio_signal_stream_feed(AgsFxNotationAudioSignal *fx_notation_audio_signal,
...
void ags_fx_seq_synth_audio_signal_notify_remove(AgsFxNotationAudioSignal *fx_notation_audio_signal,
						 AgsAudioSignal *source,
						 AgsNote *note,
						 guint x0, guint x1,
						 guint y);
