					  ...
					  gdouble delay, guint buffer_size)
{
  ...
  note_256th_offset_lower = AGS_FX_NOTATION_AUDIO_PROCESSOR(fx_seq_synth_audio_processor)->note_256th_offset_lower;

  note_256th_delay = AGS_FX_NOTATION_AUDIO_PROCESSOR(fx_seq_synth_audio_processor)->note_256th_delay;
