...
static void ags_fx_seq_synth_channel_class_init(AgsFxSeqSynthChannelClass *fx_seq_synth_channel);
static void ags_fx_seq_synth_channel_init(AgsFxSeqSynthChannel *fx_seq_synth_channel);
static void ags_fx_seq_synth_channel_dispose(GObject *gobject);
static void ags_fx_seq_synth_channel_finalize(GObject *gobject);
