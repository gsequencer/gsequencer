...
#ifndef __AGS_FX_SF2_SYNTH_CHANNEL_H__
#define __AGS_FX_SF2_SYNTH_CHANNEL_H__
...
typedef struct _AgsFxSF2SynthChannel AgsFxSF2SynthChannel;
typedef struct _AgsFxSF2SynthChannelClass AgsFxSF2SynthChannelClass;

struct _AgsFxSF2SynthChannel
{
  AgsFxNotationChannel fx_notation_channel;
};

struct _AgsFxSF2SynthChannelClass
{
  AgsFxNotationChannelClass fx_notation_channel;
};

GType ags_fx_sf2_synth_channel_get_type();

/*  */
AgsFxSF2SynthChannel* ags_fx_sf2_synth_channel_new(AgsChannel *channel);

G_END_DECLS

#endif /*__AGS_FX_SF2_SYNTH_CHANNEL_H__*/
