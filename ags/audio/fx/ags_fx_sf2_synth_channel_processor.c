...
static void ags_fx_sf2_synth_channel_processor_class_init(AgsFxSF2SynthChannelProcessorClass *fx_sf2_synth_channel_processor);
static void ags_fx_sf2_synth_channel_processor_init(AgsFxSF2SynthChannelProcessor *fx_sf2_synth_channel_processor);
static void ags_fx_sf2_synth_channel_processor_dispose(GObject *gobject);
static void ags_fx_sf2_synth_channel_processor_finalize(GObject *gobject);
...
ags_fx_sf2_synth_channel_processor_get_type()
{
  ...
  if(g_once_init_enter(&g_define_type_id__static)){
    ...
    g_once_init_leave(&g_define_type_id__static, ags_type_fx_sf2_synth_channel_processor);
  }
