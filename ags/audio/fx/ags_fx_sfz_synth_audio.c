...
static void ags_fx_sfz_synth_audio_class_init(AgsFxSFZSynthAudioClass *fx_sfz_synth_audio);
static void ags_fx_sfz_synth_audio_init(AgsFxSFZSynthAudio *fx_sfz_synth_audio);
static void ags_fx_sfz_synth_audio_set_property(GObject *gobject,
						guint prop_id,
						const GValue *value,
						GParamSpec *param_spec);
static void ags_fx_sfz_synth_audio_get_property(GObject *gobject,
						guint prop_id,
						GValue *value,
						GParamSpec *param_spec);
static void ags_fx_sfz_synth_audio_dispose(GObject *gobject);
static void ags_fx_sfz_synth_audio_finalize(GObject *gobject);

static void ags_fx_sfz_synth_audio_notify_audio_callback(GObject *gobject,
							 GParamSpec *pspec,
							 gpointer user_data);
static void ags_fx_sfz_synth_audio_notify_buffer_size_callback(GObject *gobject,
							       GParamSpec *pspec,
							       gpointer user_data);
static void ags_fx_sfz_synth_audio_notify_format_callback(GObject *gobject,
							  GParamSpec *pspec,
							  gpointer user_data);
static void ags_fx_sfz_synth_audio_notify_samplerate_callback(GObject *gobject,
							      GParamSpec *pspec,
							      gpointer user_data);

static void ags_fx_sfz_synth_audio_set_audio_channels_callback(AgsAudio *audio,
							       guint audio_channels, guint audio_channels_old,
							       AgsFxSFZSynthAudio *fx_sfz_synth_audio);

static void ags_fx_sfz_synth_audio_synth_pitch_type_callback(AgsPort *port, GValue *value,
							     AgsFxSFZSynthAudio *fx_sfz_synth_audio);
static void ags_fx_sfz_synth_audio_chorus_pitch_type_callback(AgsPort *port, GValue *value,
							      AgsFxSFZSynthAudio *fx_sfz_synth_audio);
...
static AgsPluginPort* ags_fx_sfz_synth_audio_get_low_pass_enabled_plugin_port();
...
static const gchar *ags_fx_sfz_synth_audio_plugin_name = "ags-fx-sfz-synth";

static const gchar* ags_fx_sfz_synth_audio_specifier[] = {
  "./synth-octave[0]",
  "./synth-key[0]",
  "./synth-pitch-type[0]",
  "./synth-volume[0]",
...
ags_fx_sfz_synth_audio_get_type()
{
  ...
  if(g_once_init_enter(&g_define_type_id__static)){
    ...
    g_once_init_leave(&g_define_type_id__static, ags_type_fx_sfz_synth_audio);
  }
...
ags_fx_sfz_synth_audio_class_init(AgsFxSFZSynthAudioClass *fx_sfz_synth_audio)
{
  ...
  /**
   * AgsFxSFZSynthAudio:low-pass-enabled:
   *
...
ags_fx_sfz_synth_audio_init(AgsFxSFZSynthAudio *fx_sfz_synth_audio)
{
  ...
  fx_sfz_synth_audio->synth_pitch_type->port_value.ags_port_float = (gfloat) AGS_PITCH_TYPE_FLUID_INTERPOLATE_4TH_ORDER;
  ...
  /* low-pass enabled */
  fx_sfz_synth_audio->low_pass_enabled = g_object_new(AGS_TYPE_PORT,
						      "plugin-name", ags_fx_sfz_synth_audio_plugin_name,
  ...
  fx_sfz_synth_audio->low_pass_enabled->port_value.ags_port_float = (gfloat) FALSE;

  g_object_set(fx_sfz_synth_audio->low_pass_enabled,
	       "plugin-port", ags_fx_sfz_synth_audio_get_low_pass_enabled_plugin_port(),
	       NULL);

  ags_recall_add_port((AgsRecall *) fx_sfz_synth_audio,
		      fx_sfz_synth_audio->low_pass_enabled);
				    ...
				    GParamSpec *param_spec)
{
  ...
  case PROP_LOW_PASS_ENABLED:
  {
    ...
    if(port == fx_sfz_synth_audio->low_pass_enabled){
      g_rec_mutex_unlock(recall_mutex);	

      return;
    }

    if(fx_sfz_synth_audio->low_pass_enabled != NULL){
      g_object_unref(G_OBJECT(fx_sfz_synth_audio->low_pass_enabled));
    }
    ...
    fx_sfz_synth_audio->low_pass_enabled = port;
				    ...
				    GParamSpec *param_spec)
{
  ...
  case PROP_LOW_PASS_ENABLED:
  {
    ...
    g_value_set_object(value, fx_sfz_synth_audio->low_pass_enabled);
...
ags_fx_sfz_synth_audio_dispose(GObject *gobject)
{
  ...
  if(fx_sfz_synth_audio->low_pass_enabled != NULL){
    ...
    fx_sfz_synth_audio->low_pass_enabled = NULL;
  }
  ...
  if(fx_sfz_synth_audio->low_pass_cut_off_frequency != NULL){
    ...
    fx_sfz_synth_audio->low_pass_cut_off_frequency = NULL;
  }
  ...
  if(fx_sfz_synth_audio->low_pass_filter_gain != NULL){
    ...
    fx_sfz_synth_audio->low_pass_filter_gain = NULL;
  }
  ...
  if(fx_sfz_synth_audio->low_pass_no_clip != NULL){
    ...
    fx_sfz_synth_audio->low_pass_no_clip = NULL;
  }
...
static AgsPluginPort*
ags_fx_sfz_synth_audio_get_low_pass_enabled_plugin_port()
{
  static AgsPluginPort *plugin_port = NULL;
