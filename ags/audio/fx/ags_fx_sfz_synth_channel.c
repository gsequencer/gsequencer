...
static void ags_fx_sfz_synth_channel_class_init(AgsFxSFZSynthChannelClass *fx_sfz_synth_channel);
static void ags_fx_sfz_synth_channel_init(AgsFxSFZSynthChannel *fx_sfz_synth_channel);
static void ags_fx_sfz_synth_channel_dispose(GObject *gobject);
static void ags_fx_sfz_synth_channel_finalize(GObject *gobject);
...
static const gchar *ags_fx_sfz_synth_channel_plugin_name = "ags-fx-sfz-synth";

static const gchar* ags_fx_sfz_synth_channel_specifier[] = {
  NULL,
};

static const gchar* ags_fx_sfz_synth_channel_control_port[] = {
  NULL,
};
