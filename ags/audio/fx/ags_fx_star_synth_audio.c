...
static void ags_fx_star_synth_audio_class_init(AgsFxStarSynthAudioClass *fx_star_synth_audio);
static void ags_fx_star_synth_audio_init(AgsFxStarSynthAudio *fx_star_synth_audio);
static void ags_fx_star_synth_audio_set_property(GObject *gobject,
						 guint prop_id,
						 const GValue *value,
						 GParamSpec *param_spec);
static void ags_fx_star_synth_audio_get_property(GObject *gobject,
						 guint prop_id,
						 GValue *value,
						 GParamSpec *param_spec);
static void ags_fx_star_synth_audio_dispose(GObject *gobject);
static void ags_fx_star_synth_audio_finalize(GObject *gobject);

static void ags_fx_star_synth_audio_notify_audio_callback(GObject *gobject,
							  GParamSpec *pspec,
							  gpointer user_data);
static void ags_fx_star_synth_audio_notify_buffer_size_callback(GObject *gobject,
								GParamSpec *pspec,
								gpointer user_data);
static void ags_fx_star_synth_audio_notify_format_callback(GObject *gobject,
							   GParamSpec *pspec,
							   gpointer user_data);
static void ags_fx_star_synth_audio_notify_samplerate_callback(GObject *gobject,
							       GParamSpec *pspec,
							       gpointer user_data);

static void ags_fx_star_synth_audio_set_audio_channels_callback(AgsAudio *audio,
								guint audio_channels, guint audio_channels_old,
								AgsFxStarSynthAudio *fx_star_synth_audio);

static void ags_fx_star_synth_audio_pitch_type_callback(AgsPort *port, GValue *value,
							AgsFxStarSynthAudio *fx_star_synth_audio);

static void ags_fx_star_synth_audio_chorus_pitch_type_callback(AgsPort *port, GValue *value,
							       AgsFxStarSynthAudio *fx_star_synth_audio);
...
static const gchar *ags_fx_star_synth_audio_plugin_name = "ags-fx-star-synth";

static const gchar* ags_fx_star_synth_audio_specifier[] = {
