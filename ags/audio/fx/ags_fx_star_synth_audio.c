...
ags_fx_star_synth_audio_init(AgsFxStarSynthAudio *fx_star_synth_audio)
{
  ...
  fx_star_synth_audio->pitch_type->port_value.ags_port_float = (gfloat) 0.0;
						    ...
						    gpointer user_data)
{
  ...
  for(i = 0; i < AGS_SOUND_SCOPE_LAST; i++){
	...
	/* set buffer length */
	ags_star_synth_util_set_buffer_length(channel_data->synth,
					      buffer_size);
					       ...
					       gpointer user_data)
{
  ...
  for(i = 0; i < AGS_SOUND_SCOPE_LAST; i++){
	...
	ags_star_synth_util_set_format(channel_data->synth,
				       format);
						   ...
						   gpointer user_data)
{
  ...
  for(i = 0; i < AGS_SOUND_SCOPE_LAST; i++){
	...
	ags_star_synth_util_set_samplerate(channel_data->synth,
					   samplerate);
...
ags_fx_star_synth_audio_channel_data_alloc()
{
  ...
  /* star synth util */
  channel_data->synth = ags_star_synth_util_alloc();
...
ags_fx_star_synth_audio_channel_data_free(AgsFxStarSynthAudioChannelData *channel_data)
{
  ...
  /* star synth util */
  ags_star_synth_util_free(channel_data->synth);
