...
static void ags_fx_star_synth_audio_processor_class_init(AgsFxStarSynthAudioProcessorClass *fx_star_synth_audio_processor);
static void ags_fx_star_synth_audio_processor_init(AgsFxStarSynthAudioProcessor *fx_star_synth_audio_processor);
static void ags_fx_star_synth_audio_processor_dispose(GObject *gobject);
static void ags_fx_star_synth_audio_processor_finalize(GObject *gobject);
