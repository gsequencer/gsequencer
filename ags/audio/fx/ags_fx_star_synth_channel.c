...
static void ags_fx_star_synth_channel_class_init(AgsFxStarSynthChannelClass *fx_star_synth_channel);
static void ags_fx_star_synth_channel_init(AgsFxStarSynthChannel *fx_star_synth_channel);
static void ags_fx_star_synth_channel_dispose(GObject *gobject);
static void ags_fx_star_synth_channel_finalize(GObject *gobject);
