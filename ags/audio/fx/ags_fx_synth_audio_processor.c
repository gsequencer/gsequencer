...
static void ags_fx_synth_audio_processor_class_init(AgsFxSynthAudioProcessorClass *fx_synth_audio_processor);
static void ags_fx_synth_audio_processor_init(AgsFxSynthAudioProcessor *fx_synth_audio_processor);
static void ags_fx_synth_audio_processor_dispose(GObject *gobject);
static void ags_fx_synth_audio_processor_finalize(GObject *gobject);
