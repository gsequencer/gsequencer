...
#ifndef __AGS_FX_TWO_PASS_ALIASE_CHANNEL_PROCESSOR_H__
#define __AGS_FX_TWO_PASS_ALIASE_CHANNEL_PROCESSOR_H__
...
typedef struct _AgsFxTwoPassAliaseChannelProcessor AgsFxTwoPassAliaseChannelProcessor;
typedef struct _AgsFxTwoPassAliaseChannelProcessorClass AgsFxTwoPassAliaseChannelProcessorClass;

struct _AgsFxTwoPassAliaseChannelProcessor
{
  AgsRecallChannelRun recall_channel_run;
};

struct _AgsFxTwoPassAliaseChannelProcessorClass
{
  AgsRecallChannelRunClass recall_channel_run;
};

GType ags_fx_two_pass_aliase_channel_processor_get_type();

/*  */
AgsFxTwoPassAliaseChannelProcessor* ags_fx_two_pass_aliase_channel_processor_new(AgsChannel *channel);

G_END_DECLS

#endif /*__AGS_FX_TWO_PASS_ALIASE_CHANNEL_PROCESSOR_H__*/
