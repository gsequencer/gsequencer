...
ags_jack_midiin_finalize(GObject *gobject)
{
  ...
  pthread_mutex_destroy(jack_midiin->mutex);
  free(jack_midiin->mutex);

  pthread_mutexattr_destroy(jack_midiin->mutexattr);
  free(jack_midiin->mutexattr);
