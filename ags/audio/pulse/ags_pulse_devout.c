...
void ags_pulse_devout_get_note_256th_offset(AgsSoundcard *soundcard,
					    guint *note_256th_offset_lower,
					    guint *note_256th_offset_upper);

void ags_pulse_devout_get_note_256th_attack(AgsSoundcard *soundcard,
					    guint *note_256th_attack_lower,
					    guint *note_256th_attack_upper);

guint ags_pulse_devout_get_note_256th_attack_at_position(AgsSoundcard *soundcard,
							 guint note_256th_attack_position);

void ags_pulse_devout_get_note_256th_attack_position(AgsSoundcard *soundcard,
						     guint *note_256th_attack_position_lower,
						     guint *note_256th_attack_position_upper);

guint ags_pulse_devout_get_note_256th_attack_of_16th_pulse(AgsSoundcard *soundcard);
guint ags_pulse_devout_get_note_256th_attack_of_16th_pulse_position(AgsSoundcard *soundcard);
...
ags_pulse_devout_soundcard_interface_init(AgsSoundcardInterface *soundcard)
{
  ...
  soundcard->get_note_256th_offset = ags_pulse_devout_get_note_256th_offset;

  soundcard->get_note_256th_attack = ags_pulse_devout_get_note_256th_attack;

  soundcard->get_note_256th_attack_at_position = ags_pulse_devout_get_note_256th_attack_at_position;

  soundcard->get_note_256th_attack_position = ags_pulse_devout_get_note_256th_attack_position;

  soundcard->get_note_256th_attack_of_16th_pulse = ags_pulse_devout_get_note_256th_attack_of_16th_pulse;
  soundcard->get_note_256th_attack_of_16th_pulse_position = ags_pulse_devout_get_note_256th_attack_of_16th_pulse_position;
}
...
ags_pulse_devout_init(AgsPulseDevout *pulse_devout)
{
  ...
  if(segmentation != NULL){
    ...
    pulse_devout->delay_factor = 1.0 / numerator * (numerator / denominator);
...
ags_pulse_devout_port_free(AgsSoundcard *soundcard)
{
  ...
  pulse_devout->note_256th_offset_last = pulse_devout->note_256th_offset;
...
ags_pulse_devout_tic(AgsSoundcard *soundcard)
{
  ...
  note_256th_delay = pulse_devout->note_256th_delay;

  attack = pulse_devout->attack[pulse_devout->tic_counter];
  ...
  absolute_delay = ags_pulse_devout_get_absolute_delay(soundcard);
  ...
  prev_note_256th_offset_last = pulse_devout->note_256th_offset_last;
  ...
  pulse_devout->note_256th_delay_counter += 1.0;    
  
  if((note_256th_delay <= 1.0 ||
      pulse_devout->note_256th_delay_counter >= note_256th_delay) &&
    ...
    if(do_loop &&
      ...
      if(pulse_devout->tic_counter == (guint) AGS_SOUNDCARD_DEFAULT_PERIOD){
    ...
    if(note_256th_delay <= 1.0){
      ...
      if(pulse_devout->note_256th_delay_counter >= note_256th_delay){
	pulse_devout->note_256th_offset = next_note_256th_offset_lower;
	pulse_devout->note_256th_offset_last = next_note_256th_offset_upper;
				 ...
				 guint note_offset)
{
  ...
  pulse_devout->note_256th_offset = 16 * note_offset;
...
void
ags_pulse_devout_get_note_256th_offset(AgsSoundcard *soundcard,
				       guint *note_256th_offset_lower,
				       guint *note_256th_offset_upper)
{
  AgsPulseDevout *pulse_devout;
  ...
  if(note_256th_offset_lower != NULL){
    note_256th_offset_lower[0] = pulse_devout->note_256th_offset;
  }

  if(note_256th_offset_upper != NULL){
    note_256th_offset_upper[0] = pulse_devout->note_256th_offset_last;
  }
...
void
ags_pulse_devout_get_note_256th_attack(AgsSoundcard *soundcard,
				       guint *note_256th_attack_lower,
				       guint *note_256th_attack_upper)
{
  AgsPulseDevout *pulse_devout;
  ...
  note_256th_attack = g_list_nth_data(pulse_devout->note_256th_attack,
				      nth_list);
...
guint
ags_pulse_devout_get_note_256th_attack_at_position(AgsSoundcard *soundcard,
						   guint note_256th_attack_position)
{
  AgsPulseDevout *pulse_devout;
...
void
ags_pulse_devout_get_note_256th_attack_position(AgsSoundcard *soundcard,
						guint *note_256th_attack_position_lower,
						guint *note_256th_attack_position_upper)
{
  AgsPulseDevout *pulse_devout;
  ...
  attack_position = pulse_devout->tic_counter;

  local_attack = pulse_devout->attack[attack_position];
  ...
  position_lower = 16 * pulse_devout->tic_counter;
...
guint
ags_pulse_devout_get_note_256th_attack_of_16th_pulse(AgsSoundcard *soundcard)
{
  AgsPulseDevout *pulse_devout;
  ...
  note_256th_attack_of_16th_pulse = pulse_devout->note_256th_attack_of_16th_pulse;
...
guint
ags_pulse_devout_get_note_256th_attack_of_16th_pulse_position(AgsSoundcard *soundcard)
{
  AgsPulseDevout *pulse_devout;
  ...
  position = pulse_devout->note_256th_attack_of_16th_pulse_position;
...
ags_pulse_devout_adjust_delay_and_attack(AgsPulseDevout *pulse_devout)
{
  ...
  ags_soundcard_util_adjust_delay_and_attack((GObject *) pulse_devout);
}
