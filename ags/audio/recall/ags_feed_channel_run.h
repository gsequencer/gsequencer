...
#ifndef __AGS_FEED_CHANNEL_RUN_H__
#define __AGS_FEED_CHANNEL_RUN_H__
...
typedef struct _AgsFeedChannelRun AgsFeedChannelRun;
typedef struct _AgsFeedChannelRunClass AgsFeedChannelRunClass;

struct _AgsFeedChannelRun
{
  AgsRecallChannelRun recall_channel_run;
};

struct _AgsFeedChannelRunClass
{
