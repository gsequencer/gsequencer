...
ags_remove_recall_container_get_type()
{
  ...
  if(g_once_init_enter (&g_define_type_id__volatile)){
    GType ags_type_remove_recall_container;
    ...
    g_once_init_leave (&g_define_type_id__volatile, ags_type_remove_recall_container);
  }
...
ags_remove_recall_container_class_init(AgsRemoveRecallContainerClass *remove_recall_container)
{
  ...
  param_spec = g_param_spec_object("audio",
				   ...
				   i18n_pspec("The audio of remove recall container task"),
				   AGS_TYPE_AUDIO,
  ...
  param_spec = g_param_spec_object("recall-container",
				   ...
				   i18n_pspec("The recall container of remove recall container task"),
