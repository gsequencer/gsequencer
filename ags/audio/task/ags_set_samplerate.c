...
static void ags_set_samplerate_class_init(AgsSetSamplerateClass *set_samplerate);
static void ags_set_samplerate_init(AgsSetSamplerate *set_samplerate);
static void ags_set_samplerate_set_property(GObject *gobject,
					    guint prop_id,
					    const GValue *value,
					    GParamSpec *param_spec);
static void ags_set_samplerate_get_property(GObject *gobject,
					    guint prop_id,
					    GValue *value,
					    GParamSpec *param_spec);
static void ags_set_samplerate_dispose(GObject *gobject);
static void ags_set_samplerate_finalize(GObject *gobject);

static void ags_set_samplerate_launch(AgsTask *task);

static void ags_set_samplerate_audio_signal(AgsSetSamplerate *set_samplerate, AgsAudioSignal *audio_signal);
static void ags_set_samplerate_recycling(AgsSetSamplerate *set_samplerate, AgsRecycling *recycling);
static void ags_set_samplerate_channel(AgsSetSamplerate *set_samplerate, AgsChannel *channel);
static void ags_set_samplerate_audio(AgsSetSamplerate *set_samplerate, AgsAudio *audio);
static void ags_set_samplerate_soundcard(AgsSetSamplerate *set_samplerate, GObject *soundcard);
