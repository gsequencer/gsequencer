...
static void ags_start_audio_class_init(AgsStartAudioClass *start_audio);
static void ags_start_audio_init(AgsStartAudio *start_audio);
static void ags_start_audio_set_property(GObject *gobject,
					 guint prop_id,
					 const GValue *value,
					 GParamSpec *param_spec);
static void ags_start_audio_get_property(GObject *gobject,
					 guint prop_id,
					 GValue *value,
					 GParamSpec *param_spec);
static void ags_start_audio_dispose(GObject *gobject);
static void ags_start_audio_finalize(GObject *gobject);

static void ags_start_audio_launch(AgsTask *task);
...
ags_start_audio_get_type()
{
  ...
  if(g_once_init_enter(&g_define_type_id__static)){
    ...
    g_once_init_leave(&g_define_type_id__static, ags_type_start_audio);
  }
