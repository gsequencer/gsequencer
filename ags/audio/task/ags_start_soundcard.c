...
static void ags_start_soundcard_class_init(AgsStartSoundcardClass *start_soundcard);
static void ags_start_soundcard_init(AgsStartSoundcard *start_soundcard);
static void ags_start_soundcard_set_property(GObject *gobject,
					     guint prop_id,
					     const GValue *value,
					     GParamSpec *param_spec);
static void ags_start_soundcard_get_property(GObject *gobject,
					     guint prop_id,
					     GValue *value,
					     GParamSpec *param_spec);
static void ags_start_soundcard_dispose(GObject *gobject);
static void ags_start_soundcard_finalize(GObject *gobject);

static void ags_start_soundcard_launch(AgsTask *task);
...
ags_start_soundcard_get_type()
{
  ...
  if(g_once_init_enter(&g_define_type_id__static)){
    ...
    g_once_init_leave(&g_define_type_id__static, ags_type_start_soundcard);
  }
