  ...
  case PROP_PROCESSING:
    {
      ...
      audio_thread->processing = processing;
  ...
  case PROP_PROCESSING:
    {
      ...
      g_value_set_boolean(value, audio_thread->processing);
  ...
  case PROP_TASK_LAUNCHER:
    {
      ...
      g_value_set_object(value, G_OBJECT(audio_thread->task_launcher));
