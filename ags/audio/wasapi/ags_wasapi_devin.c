...
void ags_wasapi_devin_get_note_256th_attack(AgsSoundcard *soundcard,
					    guint *note_256th_attack_lower,
					    guint *note_256th_attack_upper);

guint ags_wasapi_devin_get_note_256th_attack_at_position(AgsSoundcard *soundcard,
							 guint note_256th_attack_position);

void ags_wasapi_devin_get_note_256th_attack_position(AgsSoundcard *soundcard,
						     guint *note_256th_attack_position_lower,
						     guint *note_256th_attack_position_upper);

guint ags_wasapi_devin_get_note_256th_attack_of_16th_pulse(AgsSoundcard *soundcard);
guint ags_wasapi_devin_get_note_256th_attack_of_16th_pulse_position(AgsSoundcard *soundcard);
...
ags_wasapi_devin_soundcard_interface_init(AgsSoundcardInterface *soundcard)
{
  ...
  soundcard->get_note_256th_attack = ags_wasapi_devin_get_note_256th_attack;

  soundcard->get_note_256th_attack_at_position = ags_wasapi_devin_get_note_256th_attack_at_position;

  soundcard->get_note_256th_attack_position = ags_wasapi_devin_get_note_256th_attack_position;

  soundcard->get_note_256th_attack_of_16th_pulse = ags_wasapi_devin_get_note_256th_attack_of_16th_pulse;
  soundcard->get_note_256th_attack_of_16th_pulse_position = ags_wasapi_devin_get_note_256th_attack_of_16th_pulse_position;
}
...
ags_wasapi_devin_init(AgsWasapiDevin *wasapi_devin)
{
  ...
  /* delay and attack */
  absolute_delay = ags_soundcard_get_absolute_delay(AGS_SOUNDCARD(wasapi_devin));

  wasapi_devin->delay = (gdouble *) g_malloc((int) 2 * AGS_SOUNDCARD_DEFAULT_PERIOD * sizeof(gdouble));
  
  wasapi_devin->attack = (guint *) g_malloc((int) 2 * AGS_SOUNDCARD_DEFAULT_PERIOD * sizeof(guint));

  wasapi_devin->note_256th_delay = absolute_delay / 16.0;
  ...
  if(wasapi_devin->note_256th_delay < 1.0){
    guint buffer_size;
    ...
    if(note_256th_attack_lower < note_256th_attack_upper){
      wasapi_devin->note_256th_offset_last = wasapi_devin->note_256th_offset + ((note_256th_attack_upper - note_256th_attack_lower) / (wasapi_devin->note_256th_delay * (double) buffer_size));
    }
  }
}
...
ags_wasapi_devin_tic(AgsSoundcard *soundcard)
{
  ...
  note_256th_delay = wasapi_devin->note_256th_delay;
  ...
  if((note_256th_delay <= 1.0 ||
	...
	current_note_256th_attack = ags_soundcard_get_note_256th_attack_at_position(soundcard,
      ...
      wasapi_devin->note_256th_attack_of_16th_pulse = current_note_256th_attack;
      wasapi_devin->note_256th_attack_of_16th_pulse_position += i;
...
void
ags_wasapi_devin_get_note_256th_attack(AgsSoundcard *soundcard,
				       guint *note_256th_attack_lower,
				       guint *note_256th_attack_upper)
{
  AgsWasapiDevin *wasapi_devin;
  ...
  note_256th_attack = g_list_nth_data(wasapi_devin->note_256th_attack,
				      nth_list);
...
guint
ags_wasapi_devin_get_note_256th_attack_at_position(AgsSoundcard *soundcard,
						   guint note_256th_attack_position)
{
  AgsWasapiDevin *wasapi_devin;
...
void
ags_wasapi_devin_get_note_256th_attack_position(AgsSoundcard *soundcard,
						guint *note_256th_attack_position_lower,
						guint *note_256th_attack_position_upper)
{
  AgsWasapiDevin *wasapi_devin;
  ...
  attack_position = wasapi_devin->tic_counter;

  local_attack = wasapi_devin->attack[attack_position];
  ...
  position_lower = 16 * wasapi_devin->tic_counter;
  ...
  local_note_256th_attack = g_list_nth_data(wasapi_devin->note_256th_attack,
					    nth_list);

  for(i = 1; local_note_256th_attack[position_lower] + (i * note_256th_delay * buffer_size) < buffer_size; i++){
...
guint
ags_wasapi_devin_get_note_256th_attack_of_16th_pulse(AgsSoundcard *soundcard)
{
  AgsWasapiDevin *wasapi_devin;
  ...
  note_256th_attack_of_16th_pulse = wasapi_devin->note_256th_attack_of_16th_pulse;
...
guint
ags_wasapi_devin_get_note_256th_attack_of_16th_pulse_position(AgsSoundcard *soundcard)
{
  AgsWasapiDevin *wasapi_devin;
  ...
  position = wasapi_devin->note_256th_attack_of_16th_pulse_position;
