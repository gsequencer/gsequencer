...
ags_wasapi_devout_init(AgsWasapiDevout *wasapi_devout)
{
  ...
  wasapi_devout->delay = (gdouble *) g_malloc((int) 2 * AGS_SOUNDCARD_DEFAULT_PERIOD * sizeof(gdouble));
  
  wasapi_devout->attack = (guint *) g_malloc((int) 2 * AGS_SOUNDCARD_DEFAULT_PERIOD * sizeof(guint));
...
ags_wasapi_devout_tic(AgsSoundcard *soundcard)
{
  ...
  absolute_delay = ags_wasapi_devout_get_absolute_delay(soundcard);
  ...
  prev_note_256th_offset_last = wasapi_devout->note_256th_offset_last;
  ...
  if((note_256th_delay <= 1.0 ||
	...
	current_note_256th_attack = ags_soundcard_get_note_256th_attack_at_position(soundcard,
      ...
      wasapi_devout->note_256th_attack_of_16th_pulse = current_note_256th_attack;
    ...
    if(do_loop &&
      ...
      if(wasapi_devout->tic_counter == (guint) AGS_SOUNDCARD_DEFAULT_PERIOD){
