...
/* STRING:ULONG,STRING,STRING,STRING,STRING,UINT,POINTER (ags_marshallers.list:37) */
...
/* POINTER:VOID (ags_marshallers.list:38) */
...
/* POINTER:UINT (ags_marshallers.list:39) */
...
/* POINTER:POINTER,UINT (ags_marshallers.list:40) */
...
/* POINTER:STRING,STRING (ags_marshallers.list:41) */
...
/* POINTER:POINTER,STRING,STRING (ags_marshallers.list:42) */
...
/* OBJECT:VOID (ags_marshallers.list:43) */
...
/* OBJECT:OBJECT (ags_marshallers.list:44) */
...
/* OBJECT:STRING,STRING,STRING (ags_marshallers.list:45) */
...
/* OBJECT:OBJECT,POINTER,POINTER (ags_marshallers.list:46) */
...
/* OBJECT:OBJECT,OBJECT (ags_marshallers.list:47) */
