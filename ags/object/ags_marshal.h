...
/* VOID:OBJECT,UINT (ags_marshallers.list:22) */
...
/* VOID:OBJECT,OBJECT (ags_marshallers.list:23) */
...
/* VOID:OBJECT,OBJECT,OBJECT,INT,BOOLEAN (ags_marshallers.list:24) */
...
/* VOID:OBJECT,OBJECT,OBJECT,OBJECT,OBJECT,OBJECT,UINT,INT,BOOLEAN (ags_marshallers.list:25) */
...
/* VOID:OBJECT,OBJECT,OBJECT,OBJECT,OBJECT,OBJECT,OBJECT,OBJECT (ags_marshallers.list:26) */
...
/* ULONG:VOID (ags_marshallers.list:27) */
...
/* INT:VOID (ags_marshallers.list:28) */
...
/* BOOLEAN:OBJECT,OBJECT (ags_marshallers.list:29) */
...
/* STRING:STRING,STRING (ags_marshallers.list:30) */
...
/* STRING:ULONG,STRING,STRING,STRING,STRING,UINT,POINTER (ags_marshallers.list:31) */
...
/* POINTER:VOID (ags_marshallers.list:32) */
...
/* POINTER:UINT (ags_marshallers.list:33) */
...
/* POINTER:POINTER,UINT (ags_marshallers.list:34) */
...
/* POINTER:STRING,STRING (ags_marshallers.list:35) */
