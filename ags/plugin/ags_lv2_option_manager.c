 ...
 * @option_ressource: the #AgsOptionRessource-struct as key
 * @data: the data
 *
 * Inserts a data into hash associated with @option_ressource.
 * 
 ...
 * @lv2_option_manager: the #AgsLv2OptionManager
 * @option_ressource: the struct to remove
 * 
 * Removes an entry associated with @option_ressource.
 *
 ...
 * @lv2_option_manager: the #AgsLv2OptionManager
 * @option_ressource: the #AgsLv2OptionRessource to lookup
 *
 * Lookup a ressource associated with @option_ressource in
 * @lv2_option_manager.
 *
			      ...
			      AgsLv2OptionRessource *option_ressource)
{
  ...
  value = (GValue *) g_hash_table_lookup(lv2_option_manager->ressource,
					 uri);
...
void
ags_lv2_option_manager_real_get_option(AgsLv2OptionManager *option_manager,
				       LV2_Handle instance,
				       LV2_Options_Option* options,
				       GError **error)
{
 ...
 * @option_manager: the #AgsLv2OptionManager
 ...
 */
void
ags_lv2_option_manager_get_option(AgsLv2OptionManager *option_manager,
				  LV2_Handle instance,
				  LV2_Options_Option* options,
				  GError **error)
{
...
void
ags_lv2_option_manager_real_set_option(AgsLv2OptionManager *option_manager,
				       LV2_Handle instance,
				       LV2_Options_Option* options,
				       GError **error)
{
 ...
 */
void
ags_lv2_option_manager_set_option(AgsLv2OptionManager *option_manager,
				  LV2_Handle instance,
				  LV2_Options_Option* options,
				  GError **error)
{
