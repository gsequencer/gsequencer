...
static void ags_lv2_worker_manager_class_init(AgsLv2WorkerManagerClass *lv2_worker_manager);
static void ags_lv2_worker_manager_init(AgsLv2WorkerManager *lv2_worker_manager);
static void ags_lv2_worker_manager_finalize(GObject *gobject);
...
static AgsLv2WorkerManager *ags_lv2_worker_manager = NULL;
