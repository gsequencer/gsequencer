...
#define AGS_FUNCTIONAL_LOOP_006_XML_TEST_FILE_SETUP_FILENAME SRCDIR "/" "ags/test/X/examples/ags-loop-000.xml"
...
main(int argc, char **argv)
{
  ...
  pSuite = CU_add_suite("AgsFuncitonalAudioConfigTest", ags_functional_loop_006_xml_test_init_suite, ags_functional_loop_006_xml_test_clean_suite);
