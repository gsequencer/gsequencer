...
void ags_functional_machine_link_test_ffplayer();
...
main(int argc, char **argv)
{
  ...
  if((CU_add_test(pSuite, "functional test of GSequencer machine link master mixer\0", ags_functional_machine_link_test_master_mixer) == NULL) ||
     ...
     (CU_add_test(pSuite, "functional test of GSequencer machine link fplayer\0", ags_functional_machine_link_test_ffplayer) == NULL) ||
