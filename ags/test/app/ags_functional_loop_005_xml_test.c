...
#define AGS_FUNCTIONAL_LOOP_005_XML_TEST_DEFAULT_IDLE_TIME (3.0 * G_USEC_PER_SEC)
...
#define AGS_FUNCTIONAL_LOOP_005_XML_TEST_FILE_SETUP_FILENAME AGS_SRC_DIR "/" "ags/test/app/examples/ags-loop-005.xml"
...
struct timespec ags_functional_loop_005_xml_test_default_timeout = {
  300,
  0,
};
...
ags_functional_loop_005_xml_test_init_suite()
{
  ...
  ags_functional_test_util_idle_condition_and_timeout(AGS_FUNCTIONAL_TEST_UTIL_IDLE_CONDITION(ags_functional_test_util_idle_test_widget_realized),
						      &ags_functional_loop_005_xml_test_default_timeout,
  ...
  ags_functional_test_util_idle(AGS_FUNCTIONAL_LOOP_005_XML_TEST_DEFAULT_IDLE_TIME);
...
main(int argc, char **argv)
{
  ...
  pSuite = CU_add_suite("AgsFunctionalLoop005XmlTest", ags_functional_loop_005_xml_test_init_suite, ags_functional_loop_005_xml_test_clean_suite);
