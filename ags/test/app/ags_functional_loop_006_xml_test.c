...
#define AGS_FUNCTIONAL_LOOP_006_XML_TEST_DEFAULT_IDLE_TIME (3.0 * G_USEC_PER_SEC)
...
#define AGS_FUNCTIONAL_LOOP_006_XML_TEST_FILE_SETUP_FILENAME AGS_SRC_DIR "/" "ags/test/app/examples/ags-loop-006.xml"
...
ags_functional_loop_006_xml_test_init_suite()
{
  ...
  ags_functional_test_util_idle(AGS_FUNCTIONAL_LOOP_006_XML_TEST_DEFAULT_IDLE_TIME);
