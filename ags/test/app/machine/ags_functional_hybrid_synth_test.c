...
int ags_functional_hybrid_synth_test_init_suite();
int ags_functional_hybrid_synth_test_clean_suite();

void ags_functional_hybrid_synth_test_resize_pads();
void ags_functional_hybrid_synth_test_resize_audio_channels();

#define AGS_FUNCTIONAL_HYBRID_SYNTH_TEST_RESIZE_OUTPUT_PADS (5)
#define AGS_FUNCTIONAL_HYBRID_SYNTH_TEST_RESIZE_INPUT_PADS (15)

#define AGS_FUNCTIONAL_HYBRID_SYNTH_TEST_RESIZE_AUDIO_CHANNELS (0)

#define AGS_FUNCTIONAL_HYBRID_SYNTH_TEST_CONFIG "[generic]\n"	\
...
struct timespec ags_functional_hybrid_synth_test_default_timeout = {
  300,
  0,
};

void
ags_functional_hybrid_synth_test_add_test()
{
  /* add the tests to the suite */
  if((CU_add_test(pSuite, "functional test of AgsHybridSynth resize pads", ags_functional_hybrid_synth_test_resize_pads) == NULL) ||
     (CU_add_test(pSuite, "functional test of AgsHybridSynth resize audio channels", ags_functional_hybrid_synth_test_resize_audio_channels) == NULL)){
    CU_cleanup_registry();
 ...
 */
int
ags_functional_hybrid_synth_test_clean_suite()
{  
  return(0);
}

void
ags_functional_hybrid_synth_test_resize_pads()
{
...
main(int argc, char **argv)
{
  ...
  pSuite = CU_add_suite("AgsFunctionalHybridSynthTest", ags_functional_hybrid_synth_test_init_suite, ags_functional_hybrid_synth_test_clean_suite);
  ...
  ags_functional_test_util_do_run(argc, argv,
				  ags_functional_hybrid_synth_test_add_test, &is_available);
