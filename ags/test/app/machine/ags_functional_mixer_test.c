...
#define AGS_FUNCTIONAL_MIXER_TEST_DEFAULT_IDLE_TIME (3.0 * G_USEC_PER_SEC)
...
struct timespec ags_functional_mixer_test_default_timeout = {
  300,
  0,
};
...
ags_functional_mixer_test_add_test()
{
  ...
  if((CU_add_test(pSuite, "functional test of AgsMixer resize pads", ags_functional_mixer_test_resize_pads) == NULL) ||
     (CU_add_test(pSuite, "functional test of AgsMixer resize audio channels", ags_functional_mixer_test_resize_audio_channels) == NULL)){
    CU_cleanup_registry();
...
ags_functional_mixer_test_resize_pads()
{
  ...
  ags_functional_test_util_idle(AGS_FUNCTIONAL_MIXER_TEST_DEFAULT_IDLE_TIME);
  ...
  mixer = g_list_nth_data(start_list,
			  nth_machine);
  ...
  ags_functional_test_util_idle_condition_and_timeout(AGS_FUNCTIONAL_TEST_UTIL_IDLE_CONDITION(ags_functional_test_util_idle_test_widget_visible),
						      &ags_functional_mixer_test_default_timeout,
						      &(AGS_MACHINE(mixer)->machine_editor_dialog));

  ags_functional_test_util_sync();
  
  ags_functional_test_util_idle_condition_and_timeout(AGS_FUNCTIONAL_TEST_UTIL_IDLE_CONDITION(ags_functional_test_util_idle_test_widget_visible),
						      &ags_functional_mixer_test_default_timeout,
						      &(AGS_MACHINE_EDITOR_DIALOG(AGS_MACHINE(mixer)->machine_editor_dialog)->machine_editor));

  ags_functional_test_util_sync();

  ags_functional_test_util_idle_condition_and_timeout(AGS_FUNCTIONAL_TEST_UTIL_IDLE_CONDITION(ags_functional_test_util_idle_test_widget_visible),
						      &ags_functional_mixer_test_default_timeout,
						      &(AGS_MACHINE_EDITOR_DIALOG(AGS_MACHINE(mixer)->machine_editor_dialog)->machine_editor->resize_editor));
  ...
  /* response ok */
  properties = AGS_MACHINE(mixer)->machine_editor_dialog;  
...
main(int argc, char **argv)
{
  ...
  pSuite = CU_add_suite("AgsFunctionalMixerTest", ags_functional_mixer_test_init_suite, ags_functional_mixer_test_clean_suite);
