...
main(int argc, char **argv)
{
  ...
  if((CU_add_test(pSuite, "test of ags_sfz_synth_util.c copy s8", ags_sfz_synth_util_test_copy_s8) == NULL) ||
     ...
     (CU_add_test(pSuite, "test of ags_sfz_synth_util.c copy s16", ags_sfz_synth_util_test_copy_s24) == NULL) ||
     (CU_add_test(pSuite, "test of ags_sfz_synth_util.c copy s16", ags_sfz_synth_util_test_copy_s32) == NULL) ||
     (CU_add_test(pSuite, "test of ags_sfz_synth_util.c copy s16", ags_sfz_synth_util_test_copy_s64) == NULL) ||
     (CU_add_test(pSuite, "test of ags_sfz_synth_util.c copy s16", ags_sfz_synth_util_test_copy_float) == NULL) ||
     (CU_add_test(pSuite, "test of ags_sfz_synth_util.c copy s16", ags_sfz_synth_util_test_copy_double) == NULL) ||
