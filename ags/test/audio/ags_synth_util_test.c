...
void ags_synth_util_test_get_audio_buffer_util_format();
void ags_synth_util_test_set_audio_buffer_util_format();
...
ags_synth_util_test_copy()
{
  ...
  synth_util.audio_buffer_util_format = AGS_AUDIO_BUFFER_UTIL_S16;
  ...
  CU_ASSERT(ptr->audio_buffer_util_format == synth_util.audio_buffer_util_format);
...
void
ags_synth_util_test_get_audio_buffer_util_format()
{
  //TODO:JK: implement me
}

void
ags_synth_util_test_set_audio_buffer_util_format()
{
  //TODO:JK: implement me
}
...
main(int argc, char **argv)
{
  ...
  if((CU_add_test(pSuite, "test of ags_synth_util.c alloc", ags_synth_util_test_alloc) == NULL) ||
     ...
     (CU_add_test(pSuite, "test of ags_synth_util.c get audio buffer util format", ags_synth_util_test_get_audio_buffer_util_format) == NULL) ||
     (CU_add_test(pSuite, "test of ags_synth_util.c set audio buffer util format", ags_synth_util_test_set_audio_buffer_util_format) == NULL) ||
     ...
     (CU_add_test(pSuite, "test of ags_synth_util.c sin s8", ags_synth_util_test_sin_s8) == NULL) ||
