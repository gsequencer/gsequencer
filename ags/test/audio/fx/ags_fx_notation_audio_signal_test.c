...
ags_fx_notation_audio_signal_test_run_inter()
{
  ...
  /* run inter - attempt #1 */
  fx_notation_audio_processor->frame_clock->delay_counter = 1.0;
  
  ags_recall_run_inter(fx_notation_audio_signal);

  /* run inter - attempt #2 */
  fx_notation_audio_processor->frame_clock->delay_counter = 0.0;
  fx_notation_audio_processor->frame_clock->note_offset = 1;
