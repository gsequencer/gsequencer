...
int ags_buffer_channel_test_init_suite();
int ags_buffer_channel_test_clean_suite();
 ...
 */
int
ags_buffer_channel_test_init_suite()
{ 
...
void
ags_buffer_channel_test_port()
{
  AgsBufferChannel *buffer_channel;
  AgsPort *port;

  buffer_channel = ags_buffer_channel_new(audio->output,
					  audio->input);

  CU_ASSERT(buffer_channel != NULL);
  CU_ASSERT(AGS_IS_BUFFER_CHANNEL(buffer_channel));
...
main(int argc, char **argv)
{
  ...
  pSuite = CU_add_suite("AgsBufferChannelTest", ags_buffer_channel_test_init_suite, ags_buffer_channel_test_clean_suite);
  ...
  if((CU_add_test(pSuite, "test of AgsBufferChannel port", ags_buffer_channel_test_port) == NULL)){
    CU_cleanup_registry();
