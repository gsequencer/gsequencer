...
int ags_capture_wave_audio_test_init_suite();
int ags_capture_wave_audio_test_clean_suite();

void ags_capture_wave_audio_test_port();
 ...
 */
int
ags_capture_wave_audio_test_init_suite()
{ 
...
void
ags_capture_wave_audio_test_port()
{
  AgsCaptureWaveAudio *capture_wave_audio;
  AgsPort *port;

  capture_wave_audio = ags_capture_wave_audio_new(audio);

  CU_ASSERT(capture_wave_audio != NULL);
  CU_ASSERT(AGS_IS_CAPTURE_WAVE_AUDIO(capture_wave_audio));
...
main(int argc, char **argv)
{
  ...
  pSuite = CU_add_suite("AgsCaptureWaveAudioTest", ags_capture_wave_audio_test_init_suite, ags_capture_wave_audio_test_clean_suite);
  ...
  if((CU_add_test(pSuite, "test of AgsCaptureWaveAudio port", ags_capture_wave_audio_test_port) == NULL)){
    CU_cleanup_registry();
