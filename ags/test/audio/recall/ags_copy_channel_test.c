...
int ags_copy_channel_test_init_suite();
int ags_copy_channel_test_clean_suite();

void ags_copy_channel_test_port();
 ...
 */
int
ags_copy_channel_test_clean_suite()
{  
...
void
ags_copy_channel_test_port()
{
  AgsCopyChannel *copy_channel;
  AgsPort *port;

  copy_channel = ags_copy_channel_new(audio->output,
					  audio->input);

  CU_ASSERT(copy_channel != NULL);
  CU_ASSERT(AGS_IS_COPY_CHANNEL(copy_channel));
...
main(int argc, char **argv)
{
  ...
  pSuite = CU_add_suite("AgsCopyChannelTest", ags_copy_channel_test_init_suite, ags_copy_channel_test_clean_suite);
  ...
  if((CU_add_test(pSuite, "test of AgsCopyChannel port", ags_copy_channel_test_port) == NULL)){
    CU_cleanup_registry();
