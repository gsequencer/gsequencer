...
int ags_count_beats_audio_test_init_suite();
int ags_count_beats_audio_test_clean_suite();

void ags_count_beats_audio_test_port();
 ...
 */
int
ags_count_beats_audio_test_init_suite()
{ 
 ...
 */
int
ags_count_beats_audio_test_clean_suite()
{  
...
void
ags_count_beats_audio_test_port()
{
  ...
  CU_ASSERT(count_beats_audio != NULL);
  CU_ASSERT(AGS_IS_COUNT_BEATS_AUDIO(count_beats_audio));

  /* test ports - sequencer */
  port = NULL;
...
main(int argc, char **argv)
{
  ...
  pSuite = CU_add_suite("AgsCountBeatsAudioTest", ags_count_beats_audio_test_init_suite, ags_count_beats_audio_test_clean_suite);
  ...
  if((CU_add_test(pSuite, "test of AgsCountBeatsAudio port", ags_count_beats_audio_test_port) == NULL)){
    CU_cleanup_registry();
