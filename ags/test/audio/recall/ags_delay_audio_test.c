...
int ags_delay_audio_test_init_suite();
int ags_delay_audio_test_clean_suite();

void ags_delay_audio_test_port();
 ...
 */
int
ags_delay_audio_test_init_suite()
{ 
 ...
 */
int
ags_delay_audio_test_clean_suite()
{  
...
ags_delay_audio_test_port()
{
  ...
  CU_ASSERT(delay_audio != NULL);
  CU_ASSERT(AGS_IS_DELAY_AUDIO(delay_audio));

  /* test ports */
  port = NULL;
  g_object_get(delay_audio,
	       "sequencer-delay", &port,
	       NULL);
...
main(int argc, char **argv)
{
  ...
  pSuite = CU_add_suite("AgsDelayAudioTest", ags_delay_audio_test_init_suite, ags_delay_audio_test_clean_suite);
  ...
  if((CU_add_test(pSuite, "test of AgsDelayAudio port", ags_delay_audio_test_port) == NULL)){
    CU_cleanup_registry();
