...
int ags_envelope_audio_signal_test_init_suite();
int ags_envelope_audio_signal_test_clean_suite();

void ags_envelope_audio_signal_test_run_inter();

void ags_envelope_audio_signal_test_run_inter_callback(AgsRecall *recall, gpointer data);

#define AGS_ENVELOPE_AUDIO_SIGNAL_TEST_RUN_INTER_AUDIO_SIGNAL_LENGTH (24)
...
void
ags_envelope_audio_signal_test_run_inter_callback(AgsRecall *recall, gpointer data)
{
...
main(int argc, char **argv)
{
  ...
  pSuite = CU_add_suite("AgsEnvelopeAudioSignalTest", ags_envelope_audio_signal_test_init_suite, ags_envelope_audio_signal_test_clean_suite);
  ...
  if((CU_add_test(pSuite, "test of AgsEnvelopeAudioSignal run inter", ags_envelope_audio_signal_test_run_inter) == NULL)){
    CU_cleanup_registry();
