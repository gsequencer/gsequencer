...
int ags_envelope_channel_test_init_suite();
int ags_envelope_channel_test_clean_suite();

void ags_envelope_channel_test_port();
 ...
 */
int
ags_envelope_channel_test_init_suite()
{ 
 ...
 */
int
ags_envelope_channel_test_clean_suite()
{  
...
void
ags_envelope_channel_test_port()
{
  AgsEnvelopeChannel *envelope_channel;
  AgsPort *port;

  envelope_channel = ags_envelope_channel_new(audio->input);

  CU_ASSERT(envelope_channel != NULL);
  CU_ASSERT(AGS_IS_ENVELOPE_CHANNEL(envelope_channel));
...
main(int argc, char **argv)
{
  ...
  pSuite = CU_add_suite("AgsEnvelopeChannelTest", ags_envelope_channel_test_init_suite, ags_envelope_channel_test_clean_suite);
  ...
  if((CU_add_test(pSuite, "test of AgsEnvelopeChannel port", ags_envelope_channel_test_port) == NULL)){
    CU_cleanup_registry();
