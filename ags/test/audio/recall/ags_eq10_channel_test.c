...
int ags_eq10_channel_test_init_suite();
int ags_eq10_channel_test_clean_suite();

void ags_eq10_channel_test_port();
 ...
 */
int
ags_eq10_channel_test_init_suite()
{ 
 ...
 */
int
ags_eq10_channel_test_clean_suite()
{  
...
void
ags_eq10_channel_test_port()
{
  AgsEq10Channel *eq10_channel;
  AgsPort *port;

  eq10_channel = ags_eq10_channel_new(audio->input);

  CU_ASSERT(eq10_channel != NULL);
  CU_ASSERT(AGS_IS_EQ10_CHANNEL(eq10_channel));
...
main(int argc, char **argv)
{
  ...
  pSuite = CU_add_suite("AgsEq10ChannelTest", ags_eq10_channel_test_init_suite, ags_eq10_channel_test_clean_suite);
  ...
  if((CU_add_test(pSuite, "test of AgsEq10Channel port", ags_eq10_channel_test_port) == NULL)){
    CU_cleanup_registry();
