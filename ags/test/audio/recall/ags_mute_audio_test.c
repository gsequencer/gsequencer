...
int ags_mute_audio_test_init_suite();
int ags_mute_audio_test_clean_suite();

void ags_mute_audio_test_port();
 ...
 */
int
ags_mute_audio_test_init_suite()
{ 
...
void
ags_mute_audio_test_port()
{
  AgsMuteAudio *mute_audio;
  AgsPort *port;

  mute_audio = ags_mute_audio_new(audio);

  CU_ASSERT(mute_audio != NULL);
  CU_ASSERT(AGS_IS_MUTE_AUDIO(mute_audio));
...
main(int argc, char **argv)
{
  ...
  pSuite = CU_add_suite("AgsMuteAudioTest", ags_mute_audio_test_init_suite, ags_mute_audio_test_clean_suite);
  ...
  if((CU_add_test(pSuite, "test of AgsMuteAudio port", ags_mute_audio_test_port) == NULL)){
    CU_cleanup_registry();
