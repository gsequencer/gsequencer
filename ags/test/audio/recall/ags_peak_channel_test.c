...
int ags_peak_channel_test_init_suite();
int ags_peak_channel_test_clean_suite();

void ags_peak_channel_test_port();
 ...
 */
int
ags_peak_channel_test_init_suite()
{ 
 ...
 */
int
ags_peak_channel_test_clean_suite()
{  
...
void
ags_peak_channel_test_port()
{
  AgsPeakChannel *peak_channel;
  AgsPort *port;

  peak_channel = ags_peak_channel_new(audio->input);

  CU_ASSERT(peak_channel != NULL);
  CU_ASSERT(AGS_IS_PEAK_CHANNEL(peak_channel));
...
main(int argc, char **argv)
{
  ...
  pSuite = CU_add_suite("AgsPeakChannelTest", ags_peak_channel_test_init_suite, ags_peak_channel_test_clean_suite);
  ...
  if((CU_add_test(pSuite, "test of AgsPeakChannel port", ags_peak_channel_test_port) == NULL)){
    CU_cleanup_registry();
