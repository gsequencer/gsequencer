...
int ags_play_audio_test_init_suite();
int ags_play_audio_test_clean_suite();

void ags_play_audio_test_port();
 ...
 */
int
ags_play_audio_test_init_suite()
{ 
 ...
 */
int
ags_play_audio_test_clean_suite()
{  
...
void
ags_play_audio_test_port()
{
  AgsPlayAudio *play_audio;
  AgsPort *port;

  play_audio = ags_play_audio_new(audio);

  CU_ASSERT(play_audio != NULL);
  CU_ASSERT(AGS_IS_PLAY_AUDIO(play_audio));
...
main(int argc, char **argv)
{
  ...
  pSuite = CU_add_suite("AgsPlayAudioTest", ags_play_audio_test_init_suite, ags_play_audio_test_clean_suite);
  ...
  if((CU_add_test(pSuite, "test of AgsPlayAudio port", ags_play_audio_test_port) == NULL)){
    CU_cleanup_registry();
