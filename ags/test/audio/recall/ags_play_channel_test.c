...
int ags_play_channel_test_init_suite();
int ags_play_channel_test_clean_suite();
 ...
 */
int
ags_play_channel_test_init_suite()
{ 
 ...
 */
int
ags_play_channel_test_clean_suite()
{  
...
void
ags_play_channel_test_port()
{
  AgsPlayChannel *play_channel;
  AgsPort *port;

  play_channel = ags_play_channel_new(audio->input);

  CU_ASSERT(play_channel != NULL);
  CU_ASSERT(AGS_IS_PLAY_CHANNEL(play_channel));
...
main(int argc, char **argv)
{
  ...
  pSuite = CU_add_suite("AgsPlayChannelTest", ags_play_channel_test_init_suite, ags_play_channel_test_clean_suite);
  ...
  if((CU_add_test(pSuite, "test of AgsPlayChannel port", ags_play_channel_test_port) == NULL)){
    CU_cleanup_registry();
