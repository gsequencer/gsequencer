...
int ags_play_wave_audio_test_init_suite();
int ags_play_wave_audio_test_clean_suite();

void ags_play_wave_audio_test_port();
 ...
 */
int
ags_play_wave_audio_test_init_suite()
{ 
 ...
 */
int
ags_play_wave_audio_test_clean_suite()
{  
...
void
ags_play_wave_audio_test_port()
{
  AgsPlayWaveAudio *play_wave_audio;
  AgsPort *port;

  play_wave_audio = ags_play_wave_audio_new(audio);

  CU_ASSERT(play_wave_audio != NULL);
  CU_ASSERT(AGS_IS_PLAY_WAVE_AUDIO(play_wave_audio));
...
main(int argc, char **argv)
{
  ...
  pSuite = CU_add_suite("AgsPlayWaveAudioTest", ags_play_wave_audio_test_init_suite, ags_play_wave_audio_test_clean_suite);
  ...
  if((CU_add_test(pSuite, "test of AgsPlayWaveAudio port", ags_play_wave_audio_test_port) == NULL)){
    CU_cleanup_registry();
