...
int ags_play_wave_channel_test_init_suite();
int ags_play_wave_channel_test_clean_suite();

void ags_play_wave_channel_test_port();
 ...
 */
int
ags_play_wave_channel_test_clean_suite()
{  
...
void
ags_play_wave_channel_test_port()
{
  AgsPlayWaveChannel *play_wave_channel;
  AgsPort *port;

  play_wave_channel = ags_play_wave_channel_new(audio->input);

  CU_ASSERT(play_wave_channel != NULL);
  CU_ASSERT(AGS_IS_PLAY_WAVE_CHANNEL(play_wave_channel));
...
main(int argc, char **argv)
{
  ...
  pSuite = CU_add_suite("AgsPlayWaveChannelTest", ags_play_wave_channel_test_init_suite, ags_play_wave_channel_test_clean_suite);
  ...
  if((CU_add_test(pSuite, "test of AgsPlayWaveChannel port", ags_play_wave_channel_test_port) == NULL)){
    CU_cleanup_registry();
