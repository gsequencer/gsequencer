...
int ags_route_dssi_audio_test_init_suite();
int ags_route_dssi_audio_test_clean_suite();
 ...
 */
int
ags_route_dssi_audio_test_init_suite()
{ 
...
void
ags_route_dssi_audio_test_port()
{
  AgsRouteDssiAudio *route_dssi_audio;
  AgsPort *port;

  route_dssi_audio = ags_route_dssi_audio_new(audio);

  CU_ASSERT(route_dssi_audio != NULL);
  CU_ASSERT(AGS_IS_ROUTE_DSSI_AUDIO(route_dssi_audio));

  /* test ports */
  port = NULL;
  g_object_get(route_dssi_audio,
	       "notation-input", &port,
	       NULL);
...
main(int argc, char **argv)
{
  ...
  pSuite = CU_add_suite("AgsRouteDssiAudioTest", ags_route_dssi_audio_test_init_suite, ags_route_dssi_audio_test_clean_suite);
  ...
  if((CU_add_test(pSuite, "test of AgsRouteDssiAudio port", ags_route_dssi_audio_test_port) == NULL)){
    CU_cleanup_registry();
