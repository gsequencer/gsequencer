...
int ags_volume_channel_test_init_suite();
int ags_volume_channel_test_clean_suite();

void ags_volume_channel_test_port();
 ...
 */
int
ags_volume_channel_test_init_suite()
{ 
 ...
 */
int
ags_volume_channel_test_clean_suite()
{  
...
void
ags_volume_channel_test_port()
{
  AgsVolumeChannel *volume_channel;
  AgsPort *port;

  volume_channel = ags_volume_channel_new(audio->input);

  CU_ASSERT(volume_channel != NULL);
  CU_ASSERT(AGS_IS_VOLUME_CHANNEL(volume_channel));
...
main(int argc, char **argv)
{
  ...
  pSuite = CU_add_suite("AgsVolumeChannelTest", ags_volume_channel_test_init_suite, ags_volume_channel_test_clean_suite);
  ...
  if((CU_add_test(pSuite, "test of AgsVolumeChannel port", ags_volume_channel_test_port) == NULL)){
    CU_cleanup_registry();
