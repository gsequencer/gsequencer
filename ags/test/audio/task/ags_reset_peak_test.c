...
int ags_reset_peak_test_init_suite();
int ags_reset_peak_test_clean_suite();

void ags_reset_peak_test_launch();
 ...
 */
int
ags_reset_peak_test_init_suite()
{ 
 ...
 */
int
ags_reset_peak_test_clean_suite()
{  
...
ags_reset_peak_test_launch()
{
  ...
  CU_ASSERT(AGS_IS_RESET_PEAK(reset_peak));
  ...
  ags_port_safe_write(AGS_PEAK_CHANNEL(list->data)->buffer_computed,
		      &value);

  /* test */
  ags_task_launch(reset_peak);

  ags_port_safe_read(AGS_PEAK_CHANNEL(list->data)->buffer_computed,
		     &value);
...
main(int argc, char **argv)
{
  ...
  pSuite = CU_add_suite("AgsResetPeakTest", ags_reset_peak_test_init_suite, ags_reset_peak_test_clean_suite);
  ...
  if((CU_add_test(pSuite, "test of AgsResetPeak launch", ags_reset_peak_test_launch) == NULL)){
    CU_cleanup_registry();
