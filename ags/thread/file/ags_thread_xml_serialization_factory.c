...
GType
ags_thread_xml_serialization_factory_get_type()
{
  static volatile gsize g_define_type_id__volatile = 0;

  if(g_once_init_enter (&g_define_type_id__volatile)){
    GType ags_type_thread_xml_serialization_factory;
    ...
    g_once_init_leave (&g_define_type_id__volatile, ags_type_thread_xml_serialization_factory);
  }
