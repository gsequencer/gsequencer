...
extern "C" {
  ...
  {
    extern const Steinberg::TUID IUpdateHandler__iid;

    return((AgsVstTUID *) (&IUpdateHandler__iid));
  }
  ...
  {
    extern const Steinberg::TUID IDependent__iid;

    return((AgsVstTUID *) (&IDependent__iid));
  }
