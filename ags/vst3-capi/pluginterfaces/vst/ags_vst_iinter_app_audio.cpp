...
extern "C" {
  ...
  {
    return((AgsVstTUID *) &(Steinberg::Vst::IInterAppAudioHost::iid));
  }
  ...
  {
    return((AgsVstTUID *) &(Steinberg::Vst::IInterAppAudioConnectionNotification::iid));
  }
  ...
  {
    return((AgsVstTUID *) &(Steinberg::Vst::IInterAppAudioPresetManager::iid));
  }
