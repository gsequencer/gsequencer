				...
				guint audio_signal_level)
{
  ...
  auto void ags_channel_recursive_play_init_resolve_channel_recall(AgsChannel *channel,
								   AgsGroupId group_id);
  auto void ags_channel_recursive_play_init_resolve_audio_recall(AgsAudio *audio,
								 guint audio_channel,
								 AgsGroupId group_id);
  ...
  auto void ags_channel_recursive_play_init_channel_recall(AgsChannel *channel,
							   AgsGroupId group_id);
  auto void ags_channel_recursive_play_init_audio_recall(AgsAudio *audio, guint audio_channel,
							 AgsGroupId group_id);
				      ...
				      AgsChannel *old_channel_link, AgsChannel *old_link_link)
{
  ...
  auto void ags_channel_reset_get_next_group_id_lists(AgsAudio *audio, AgsChannel *channel,
						      gboolean new_level, GList *audio_signal_level,
						      GList *group_id_list, GList **next_group_id_list,
						      GList *child_group_id_list, GList **next_group_id_list,
  ...
  void ags_channel_reset_get_next_group_id_lists(AgsAudio *audio, AgsChannel *channel,
    ...
    if(new_level){
      ...
      *next_invalid_child_group_id_list = ;
    }else{
      *next_group_id_list = group_id_list;
      *next_child_group_id_list = child_group_id_list;

      *next_invalid_group_id_list = next_invalid_group_id_list;
      *next_invalid_child_group_id_list = next_invalid_child_group_id_list;
    }
  }
  ...
  GList* ags_channel_tillrecycling_collect_devout_play_down_input(AgsChannel *output,
	...
	if(current->devout_play != NULL){
	  list = g_list_prepend(list,
				(collect_group_id ? AGS_GROUP_ID_TO_POINTER(current->devout_play->group_id): current->devout_play));
	}
	/* go down */
  ...
  GList* ags_channel_tillrecycling_collect_devout_play_down(AgsChannel *current,
    ...
    if(audio->devout_play != NULL){
      list = g_list_prepend(list,
			    (collect_group_id ? AGS_GROUP_ID_TO_POINTER(audio->devout_play->group_id): audio->devout_play));
    }
						       ...
						       GList *invalid_group_id_list, GList *invalid_child_group_id_list)
  {
    AgsAudio *audio;
    AgsChannel *current;
    GList *next_group_id_list, *next_child_group_id_list;
	...
	ags_channel_recursive_reset_group_id_down(current->link,
						  next_group_id_list, next_child_group_id_list,
	...
	current = current->next;
      ...
      /* go down */
      ags_channel_recursive_reset_group_id_down();
    }
  }
						 ...
						 GList *invalid_group_id_list, GList *invalid_child_group_id_list)
  {
    ...
    /* reset on AgsAudio */
    ags_audio_reset_group_id();

    /* go down */
    ags_channel_recursive_reset_group_id_down_input();
  }
  ...
  void ags_channel_recursive_unset_group_id_down(AgsChannel *output,
						 GList *invalid_group_id_list, GList *invalid_child_group_id_list)
  {
  ...
  if(channel->devout_play != NULL){
    channel_lower_devout_play_list = g_list_prepend(channel_lower_devout_play_list,
						    channel->devout_play);
  }

  channel_lower_devout_play_list = ags_channel_tillrecycling_collect_devout_play_down(channel->link,
  ...
  if(old_link_link->devout_play != NULL){
    invalid_lower_group_id_list = g_list_prepend(invalid_lower_group_id_list,
						 AGS_GROUP_ID_TO_POINTER(old_link_link->devout_play->group_id));
  }

  invalid_lower_group_id_list = ags_channel_tillrecycling_collect_devout_play_down(old_link_link->link,
  ...
  ags_channel_recursive_reset_group_id_down(channel,
					    ...
					    channel_lower_devout_play_list, audio_signal_level,
  ...
  /* go up */
  ags_channel_recursive_unset_group_id_down(old_channel_link,
					    invalid_upper_group_id_list, invalid_upper_child_group_id_list);
