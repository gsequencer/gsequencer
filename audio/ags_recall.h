...
typedef enum{
  ...
  AGS_RECALL_DISTINCTS_REAL     = 1 << 2,
  AGS_RECALL_IS_REAL            = 1 << 3,
  AGS_RECALL_PERSISTENT         = 1 << 4,
  AGS_RECALL_DONE               = 1 << 5,
  AGS_RECALL_REMOVE             = 1 << 6,
  AGS_RECALL_HIDE               = 1 << 7,
  AGS_RECALL_PROPAGATE_DONE     = 1 << 8, // see ags_recall_real_remove
}AgsRecallFlags;
