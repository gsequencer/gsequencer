...
gtk_api_doc="/usr/share/doc/libgtk-4-doc/gtk4"
...
$( find ${builddir}/docs/reference/libags-gui/libags-gui-html -name "*.html" -type f -exec sed -i '' -e "s@../gtk4@${gtk_api_doc}@g" {} \; )
$( find ${builddir}/docs/reference/libgsequencer/libgsequencer-html -name "*.html" -type f -exec sed -i '' -e "s@../gobject@${gobject_api_doc}@g" {} \; )
$( find ${builddir}/docs/reference/libgsequencer/libgsequencer-html -name "*.html" -type f -exec sed -i '' -e "s@../gtk4@${gtk_api_doc}@g" {} \; )
