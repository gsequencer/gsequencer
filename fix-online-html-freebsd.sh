...
$( find ${builddir}/docs/reference/libags/libags-html -name "*.html" -type f -exec sed -i '' -e "s@../gobject@https://docs.gtk.org/gobject/@g" {} \; )
$( find ${builddir}/docs/reference/libags-audio/libags-audio-html -name "*.html" -type f -exec sed -i '' -e "s@../gobject@https://docs.gtk.org/gobject/@g" {} \; )
$( find ${builddir}/docs/reference/libags-audio/libags-audio-html -name "*.html" -type f -exec sed -i '' -e "s@../libags-html@../libags@g" {} \; )
$( find ${builddir}/docs/reference/libags-gui/libags-gui-html -name "*.html" -type f -exec sed -i '' -e "s@../gobject@https://docs.gtk.org/gobject/@g" {} \; )
$( find ${builddir}/docs/reference/libags-gui/libags-gui-html -name "*.html" -type f -exec sed -i '' -e "s@../gtk4@https://docs.gtk.org/gtk4/@g" {} \; )
...
$( find ${builddir}/docs/reference/libgsequencer/libgsequencer-html -name "*.html" -type f -exec sed -i '' -e "s@../gtk4@https://docs.gtk.org/gtk4/@g" {} \; )
