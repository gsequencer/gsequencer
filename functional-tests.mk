...
# libadd and ldadd
libgsequencer_test_LIBADD += libgsequencer.la libags_gui.la libags_audio.la libags_server.la libags_thread.la libags.la libags_thread.la -lcunit  -lm \
	$(LIBAO_LIBS) $(LIBASOUND2_LIBS) $(LIBXML2_LIBS) $(SNDFILE_LIBS) $(LIBINSTPATCH_LIBS) $(JSON_GLIB_LIBS) $(GOBJECT_LIBS) $(LIBSOUP_LIBS) $(JACK_LIBS) $(GSTREAMER_LIBS) $(FONTCONFIG_LIBS) $(GDKPIXBUF_LIBS) $(CAIRO_LIBS) $(GTK_LIBS)  $(WEBKITGTK_LIBS) $(POPPLER_LIBS) $(GTK_MAC_INTEGRATION_LIBS) $(W32API_LIBS)

gsequencer_functional_test_LDADD += libgsequencer.la libags_gui.la libags_audio.la libags_server.la libags_thread.la libags.la libags_thread.la libgsequencer_test.la -lcunit  -lm \
	$(LIBAO_LIBS) $(LIBASOUND2_LIBS) $(LIBXML2_LIBS) $(SNDFILE_LIBS) $(LIBINSTPATCH_LIBS) $(JSON_GLIB_LIBS) $(GOBJECT_LIBS) $(LIBSOUP_LIBS) $(JACK_LIBS) $(GSTREAMER_LIBS) $(FONTCONFIG_LIBS) $(GDKPIXBUF_LIBS) $(CAIRO_LIBS) $(GTK_LIBS)  $(WEBKITGTK_LIBS) $(POPPLER_LIBS) $(GTK_MAC_INTEGRATION_LIBS) $(W32API_LIBS)
...
FUNCTIONAL_TEST_CFLAGS = -fpermissive -Wno-error=incompatible-pointer-types -Wno-error=pedantic


FUNCTIONAL_AUDIO_TEST_CFLAGS =  $(LIBAO_CFLAGS) $(LIBASOUND2_CFLAGS) $(LIBDSSIALSACOMPAT_CFLAGS) $(LIBXML2_CFLAGS) $(SNDFILE_CFLAGS) $(LIBINSTPATCH_CFLAGS) $(JSON_GLIB_CFLAGS) $(GOBJECT_CFLAGS) $(LIBSOUP_CFLAGS) $(JACK_CFLAGS) $(GSTREAMER_CFLAGS)

FUNCTIONAL_UI_TEST_CFLAGS = $(LIBAO_CFLAGS) $(LIBASOUND2_CFLAGS) $(LIBDSSIALSACOMPAT_CFLAGS) $(LIBXML2_CFLAGS) $(SNDFILE_CFLAGS) $(LIBINSTPATCH_CFLAGS) $(JSON_GLIB_CFLAGS) $(GOBJECT_CFLAGS) $(LIBSOUP_CFLAGS) $(JACK_CFLAGS) $(GSTREAMER_CFLAGS) \
	$(FONTCONFIG_CFLAGS) $(GDKPIXBUF_CFLAGS) $(CAIRO_CFLAGS) $(GTK_CFLAGS) $(WEBKITGTK_CFLAGS) $(POPPLER_CFLAGS) $(GTK_MAC_INTEGRATION_CFLAGS) $(W32API_CFLAGS)
...
libgsequencer_test_la_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_server_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_AUDIO_TEST_CFLAGS)
...
ags_functional_frame_clock_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_AUDIO_TEST_CFLAGS)
...
ags_functional_audio_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_AUDIO_TEST_CFLAGS)
...
ags_functional_pitch_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_AUDIO_TEST_CFLAGS)
...
ags_functional_fast_pitch_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_AUDIO_TEST_CFLAGS)
...
ags_functional_fourier_transform_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_AUDIO_TEST_CFLAGS)
...
ags_functional_osc_server_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_AUDIO_TEST_CFLAGS)
...
ags_functional_osc_xmlrpc_server_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_AUDIO_TEST_CFLAGS)
...
ags_functional_machine_add_and_destroy_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_machine_link_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_line_member_add_and_destroy_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_notation_editor_workflow_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_automation_editor_workflow_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_panel_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_spectrometer_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_equalizer10_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_mixer_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_drum_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_matrix_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_synth_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_fm_synth_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_syncsynth_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_fm_syncsynth_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_hybrid_synth_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_hybrid_fm_synth_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_ffplayer_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_sf2_synth_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_pitch_sampler_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_sfz_synth_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_audiorec_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_notation_edit_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_audio_config_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_loop_000_xml_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_loop_001_xml_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_loop_002_xml_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_loop_003_xml_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_loop_004_xml_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_loop_005_xml_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_loop_006_xml_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_loop_007_xml_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_loop_008_xml_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
...
ags_functional_loop_010_xml_test_CFLAGS = $(CFLAGS) $(FUNCTIONAL_TEST_CFLAGS) $(FUNCTIONAL_UI_TEST_CFLAGS)
