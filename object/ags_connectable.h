...
#define AGS_CONNECTABLE_INTERFACE(vtable)       (G_TYPE_CHECK_INTERFACE_CAST((vtable), AGS_TYPE_CONNECTABLE, AgsConnectableInterface))
#define AGS_IS_CONNECTABLE(obj)                 (G_TYPE_CHECK_INSTANCE_TYPE((obj), AGS_TYPE_CONNECTABLE))
#define AGS_IS_CONNECTABLE_INTERFACE(vtable)    (G_TYPE_CHECK_INTERFACE_TYPE((vtable), AGS_TYPE_CONNECTABLE))
