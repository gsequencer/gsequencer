...
int ags_midi_dialog_add_callback(GtkWidget *widget, AgsMidiDialog *midi_dialog);
int ags_midi_dialog_remove_callback(GtkWidget *widget, AgsMidiDialog *midi_dialog);
