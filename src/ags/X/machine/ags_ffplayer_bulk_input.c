...
#include <ags/X/ags_ffplayer_bulk_input_callbacks.h>
...
static guint ffplayer_bulk_input_signals[LAST_SIGNAL];
...
ags_ffplayer_bulk_input_get_type(void)
{
  ...
  if(!ags_type_ffplayer_bulk_input){
    ...
    ags_type_ffplayer_bulk_input = g_type_register_static(GTK_TYPE_VBOX,
...
ags_ffplayer_bulk_input_class_init(AgsFFPlayerBulkInputClass *ffplayer_bulk_input)
{
  ...
  /* GObjectClass */
  gobject = G_OBJECT_CLASS(ffplayer_bulk_input);
}
