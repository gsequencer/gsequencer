...
#define AGS_DEVOUT_DEFAULT_TACT_JIFFIE (AGS_DEVOUT_DEFAULT_BPM / 60.0 / AGS_DEVOUT_DEFAULT_TACT)
...
struct _AgsDevoutPlay
{
  ...
  AgsGroupId group_id[3]; // if source is an AgsChannel or an AgsAudio
