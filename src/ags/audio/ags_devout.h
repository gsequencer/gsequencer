...
#define AGS_DEVOUT_DEFAULT_BUFFER_SIZE (943)
...
#define AGS_DEVOUT_DEFAULT_TACT ((0.0133) * (1000.0 / 440.0) * (1.0 / 45.0) * 4.0)
...
#define AGS_DEVOUT_DEFAULT_DELAY (0.0133 * AGS_DEVOUT_DEFAULT_JIFFIE * (1000.0 / 940.0) * (60.0 / AGS_DEVOUT_DEFAULT_BPM))
