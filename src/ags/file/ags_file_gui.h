...
xmlNode* ags_file_write_window(xmlNode *parent, AgsWindow *window);

/* AgsMenuBar */
void ags_file_read_menu_bar(xmlNode *node, AgsMenuBar **menu_bar);
xmlNode* ags_file_write_menu_bar(xmlNode *parent, AgsMenuBar *menu_bar);

/* AgsMachineCounter */
void ags_file_read_machine_counter(xmlNode *node, AgsMachineCounter **machine_counter);
xmlNode* ags_file_write_machine_counter(xmlNode *parent, AgsMachineCounter *machine_counter);

void ags_file_read_machine_counter_list(xmlNode *node, GList **machine_counter);
xmlNode* ags_file_write_machine_counter_list(xmlNode *parent, GList *machine_counter);

/* AgsMachine */
void ags_file_read_machine(xmlNode *node, AgsMachine **machine);
xmlNode* ags_file_write_machine(xmlNode *parent, AgsMachine *machine);

void ags_file_read_machine_list(xmlNode *node, GList **machine);
xmlNode* ags_file_write_machine_list(xmlNode *parent, GList *machine);

void ags_file_read_panel(xmlNode *node, AgsMachine *panel);
xmlNode* ags_file_write_panel(xmlNode *parent, AgsMachine *panel);

void ags_file_read_mixer(xmlNode *node, AgsMachine *mixer);
xmlNode* ags_file_write_mixer(xmlNode *parent, AgsMachine *mixer);

void ags_file_read_drum(xmlNode *node, AgsMachine *drum);
xmlNode* ags_file_write_drum(xmlNode *parent, AgsMachine *drum);

void ags_file_read_matrix(xmlNode *node, AgsMachine *matrix);
xmlNode* ags_file_write_matrix(xmlNode *parent, AgsMachine *matrix);

void ags_file_read_synth(xmlNode *node, AgsMachine *synth);
xmlNode* ags_file_write_synth(xmlNode *parent, AgsMachine *synth);

void ags_file_read_ffplayer(xmlNode *node, AgsMachine *ffplayer);
xmlNode* ags_file_write_ffplayer(xmlNode *parent, AgsMachine *ffplayer);

/* AgsPad */
void ags_file_read_pad(xmlNode *node, AgsPad **pad);
xmlNode* ags_file_write_pad(xmlNode *parent, AgsPad *pad);

void ags_file_read_pad_list(xmlNode *node, GList **pad);
xmlNode* ags_file_write_pad_list(xmlNode *parent, GList *pad);

void ags_file_read_mixer_input_pad(xmlNode *node, AgsPad *mixer_input_pad);
xmlNode* ags_file_write_mixer_input_pad(xmlNode *parent, AgsPad *mixer_input_pad);

void ags_file_read_mixer_output_pad(xmlNode *node, AgsPad *mixer_output_pad);
xmlNode* ags_file_write_mixer_output_pad(xmlNode *parent, AgsPad *mixer_output_pad);

void ags_file_read_drum_input_pad(xmlNode *node, AgsPad *drum_input_pad);
xmlNode* ags_file_write_drum_input_pad(xmlNode *parent, AgsPad *drum_input_pad);

void ags_file_read_drum_output_pad(xmlNode *node, AgsPad *drum_output_pad);
xmlNode* ags_file_write_drum_output_pad(xmlNode *parent, AgsPad *drum_output_pad);

/* AgsLine */
void ags_file_read_line(xmlNode *node, AgsLine **line);
xmlNode* ags_file_write_line(xmlNode *parent, AgsLine *line);

void ags_file_read_line_list(xmlNode *node, GList **line);
xmlNode* ags_file_write_line_list(xmlNode *parent, GList *line);

void ags_file_read_drum_input_line(xmlNode *node, AgsLine *drum_output_line);
xmlNode* ags_file_write_drum_input_line(xmlNode *parent, AgsLine *drum_output_line);

void ags_file_read_drum_output_line(xmlNode *node, AgsLine *drum_output_line);
xmlNode* ags_file_write_drum_output_line(xmlNode *parent, AgsLine *drum_output_line);

void ags_file_read_oscillator(xmlNode *node, AgsOscillator *oscillator);
xmlNode* ags_file_write_oscillator(xmlNode *parent, AgsOscillator *oscillator);

/* AgsLineMember */
void ags_file_read_line_member(xmlNode *node, AgsLineMember **line_member);
xmlNode* ags_file_write_line_member(xmlNode *parent, AgsLineMember *line_member);

void ags_file_read_line_member_list(xmlNode *node, GList **line_member);
xmlNode* ags_file_write_line_member_list(xmlNode *parent, GList *line_member);
...
xmlNode* ags_file_write_editor(xmlNode *parent, AgsEditor *editor);

/* AgsToolbar */
void ags_file_read_toolbar(xmlNode *node, AgsToolbar **toolbar);
xmlNode* ags_file_write_toolbar(xmlNode *parent, AgsToolbar *toolbar);

/* AgsNotebook */
void ags_file_read_notebook(xmlNode *node, AgsNotebook **notebook);
xmlNode* ags_file_write_notebook(xmlNode *parent, AgsNotebook *notebook);

/* AgsNavigation */
void ags_file_read_navigation(xmlNode *node, AgsNavigation **navigation);
xmlNode* ags_file_write_navigation(xmlNode *parent, AgsNavigation *navigation);
