...
/* VOID:UINT,INT (ags_marshallers.list:4) */
void
...
/* VOID:UINT,DOUBLE (ags_marshallers.list:5) */
void
...
/* VOID:ULONG,UINT (ags_marshallers.list:6) */
void
...
/* VOID:DOUBLE,DOUBLE (ags_marshallers.list:7) */
void
...
/* VOID:ULONG,UINT,UINT (ags_marshallers.list:8) */
void
...
/* VOID:OBJECT,UINT (ags_marshallers.list:9) */
void
...
/* VOID:OBJECT,OBJECT (ags_marshallers.list:10) */
void
...
/* VOID:OBJECT,OBJECT,OBJECT,INT,BOOLEAN (ags_marshallers.list:11) */
void
...
/* VOID:OBJECT,OBJECT,OBJECT,OBJECT,OBJECT,OBJECT,UINT,INT,BOOLEAN (ags_marshallers.list:12) */
void
...
/* VOID:OBJECT,OBJECT,OBJECT,OBJECT,OBJECT,OBJECT,OBJECT,OBJECT (ags_marshallers.list:13) */
void
...
/* BOOLEAN:OBJECT,OBJECT (ags_marshallers.list:14) */
void
...
void
g_cclosure_user_marshal_STRING__ULONG_STRING_STRING_STRING_STRING (GClosure     *closure,
                                                                   GValue       *return_value G_GNUC_UNUSED,
                                                                   guint         n_param_values,
                                                                   const GValue *param_values,
                                                                   gpointer      invocation_hint G_GNUC_UNUSED,
                                                                   gpointer      marshal_data)
{
  typedef gchar* (*GMarshalFunc_STRING__ULONG_STRING_STRING_STRING_STRING) (gpointer     data1,
                                                                            gulong       arg_1,
                                                                            gpointer     arg_2,
                                                                            gpointer     arg_3,
                                                                            gpointer     arg_4,
                                                                            gpointer     arg_5,
                                                                            gpointer     data2);
  register GMarshalFunc_STRING__ULONG_STRING_STRING_STRING_STRING callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  gchar* v_return;
  ...
  callback = (GMarshalFunc_STRING__ULONG_STRING_STRING_STRING_STRING) (marshal_data ? marshal_data : cc->callback);
...
/* OBJECT:OBJECT,POINTER,POINTER (ags_marshallers.list:17) */
void
...
/* OBJECT:OBJECT,OBJECT (ags_marshallers.list:18) */
void
