...
void
ags_functional_menu_bar_util_activate_path(GtkMenuBar *menu_bar,
					   gchar *path)
{
  GtkMenu *menu;
  ...
  auto gboolean ags_functional_menu_bar_util_activate_path_recursive(GtkMenu *menu);

  gboolean ags_functional_menu_bar_util_activate_path_recursive(GtkMenu *menu){
    GList *list, *list_start;
